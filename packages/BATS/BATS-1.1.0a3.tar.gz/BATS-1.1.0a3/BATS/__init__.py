...
__All__=['__init__', 'main', 'TrialSimulation', 'CalPosteriorProbability']

from .BATS import __init__
from .BATS import main
from .BATS import FixedTrial as TrialSimulation
from .BATS import CalPosteriorProbability as CalPosteriorProbability
