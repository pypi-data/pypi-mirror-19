...
setup(name='BitVector',
      ...
      url='https://engineering.purdue.edu/kak/dist/BitVector-3.4.6.html',
      download_url='https://engineering.purdue.edu/kak/dist/BitVector-3.4.6.tar.gz#md5=921cbfad82d0282a3b5aa52eb0f59887',
