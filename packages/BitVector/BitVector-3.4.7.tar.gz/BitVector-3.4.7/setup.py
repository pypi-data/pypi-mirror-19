...
setup(name='BitVector',
      ...
      url='https://engineering.purdue.edu/kak/dist/BitVector-3.4.7.html',
      download_url='https://engineering.purdue.edu/kak/dist/BitVector-3.4.7.tar.gz#md5=cb9a16eb3629f91fa51976b20a0a34af',
