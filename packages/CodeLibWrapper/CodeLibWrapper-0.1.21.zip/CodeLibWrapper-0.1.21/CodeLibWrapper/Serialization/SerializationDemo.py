...
serialize Python objects to XMLFunction and back.

The system is very lightweight and was not intended for complex XMLFunction
...
def main():
    ...
    # This is not for use, just to see how XMLFunction compares to Python
    data_output = '''
    {'documents': [
