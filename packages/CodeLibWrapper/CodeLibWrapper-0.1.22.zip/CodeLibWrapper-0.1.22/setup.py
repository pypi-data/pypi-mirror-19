...
setup (
    ...
    packages=find_packages(exclude=['UnConfirmCode/*.*']),
    package_data={
        'CodeLibWrapper': ['Template/Sample_EnvironmentConfig.xml','README.txt','License.txt','Upgrade.bat','Uninstall.bat','requirements.txt'],
