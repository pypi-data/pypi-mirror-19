...
setup (
    ...
    packages=find_packages(exclude=['UnConfirmCode','PythonStudyCase']),
    package_data={
        '': ['Template/Sample_EnvironmentConfig.xml','README.txt','License.txt','Upgrade.bat','Uninstall.bat','requirements.txt'],
