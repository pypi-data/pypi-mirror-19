# -*- coding: utf-8 -*-
'''
XML2Py - XMLFunction to Python de-serialization

This code transforms an XMLFunction document into a Python data structure
...
class XML2Py:
    ...
    def parse(self, xmlString):
        '''
        processes XMLFunction string into Python data structure
        '''
