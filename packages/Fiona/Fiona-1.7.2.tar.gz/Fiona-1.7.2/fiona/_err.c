...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/usr/local/Cellar/gdal/1.11.3_1/include/cpl_error.h"
        ],
        "include_dirs": [
...
static PyObject *__pyx_pw_5fiona_4_err_17GDALErrCtxManager_3__exit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__exit__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "__exit__") < 0)) __PYX_ERR(0, 61, __pyx_L3_error)
      }
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("__exit__", 0, 0, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 61, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
    __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_exception_map); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_GetItemInt(__pyx_t_3, __pyx_v_err_no, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyBytes_FromString(__pyx_v_msg); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = NULL;
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "fiona._err")) {
      if (unlikely(PyDict_SetItemString(modules, "fiona._err", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_5fiona_4_err_GDALErrCtxManager) < 0) __PYX_ERR(0, 54, __pyx_L1_error)
  __pyx_type_5fiona_4_err_GDALErrCtxManager.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "GDALErrCtxManager", (PyObject *)&__pyx_type_5fiona_4_err_GDALErrCtxManager) < 0) __PYX_ERR(0, 54, __pyx_L1_error)
 ...
 */
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_1, __pyx_builtin_RuntimeError) < 0) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 */
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_2, __pyx_builtin_MemoryError) < 0) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 */
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_3, __pyx_builtin_IOError) < 0) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 */
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_4, __pyx_builtin_IOError) < 0) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 */
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_5, __pyx_builtin_TypeError) < 0) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 */
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_6, __pyx_builtin_ValueError) < 0) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 */
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_7, __pyx_builtin_AssertionError) < 0) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 */
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_8, __pyx_builtin_IOError) < 0) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 *     }
 */
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_9, __pyx_builtin_KeyboardInterrupt) < 0) __PYX_ERR(0, 41, __pyx_L1_error)
 ...
 * 
 */
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_10, __pyx_builtin_ValueError) < 0) __PYX_ERR(0, 41, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_exception_map, __pyx_t_1) < 0) __PYX_ERR(0, 40, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_5fiona_4_err_GDALErrCtxManager), __pyx_empty_tuple, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cpl_errs, __pyx_t_1) < 0) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
