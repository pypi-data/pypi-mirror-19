...
"""Central Interface for interacting with API.AI

The Assitant object routes requests to :class:`ask <flask_assistant.ask>` :func:`action` decorated functions.
...
class Assistant(object):
   ...
   The assistant object is responsible for mapping an API.AI agent's JSON requests.
   to Intent-specific :func:`action` view functions.
   The action functions are properly matched based on the intent name, required parameters, and contexts present in the API.AI JSON
