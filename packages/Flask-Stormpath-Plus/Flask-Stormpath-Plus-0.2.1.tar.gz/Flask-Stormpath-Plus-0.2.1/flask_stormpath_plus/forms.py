...
class RegistrationForm(Form):
    ...
    password  = \
        PasswordField('Password', validators=[InputRequired('You must supply a password.')])
...
class LoginForm(Form):
    ...
    password = \
        PasswordField('Password', validators=[InputRequired('Password required.')])
...
class ChangePasswordForm(Form):
    ...
    password_again = \
        PasswordField('Password (again)', validators=[
