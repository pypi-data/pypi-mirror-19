...
__author__ = 'Timothy, Inc.'
__license__ = 'Apache'
__copyright__ = '(c) 2012 - 2016 Timothy'
...
class StormpathManager(object):
    ...
    def init_app(self, app):
        ...
        blueprint = Blueprint('flask_stormpath_plus', 'flask_stormpath_plus', template_folder='templates')
    ...
    def get_salt(self):
        try:
            ...
            salt= self.app.config['SECRET_KEY']

        except ValueError:
            print 'there is not SECRET_KEY of your app'
