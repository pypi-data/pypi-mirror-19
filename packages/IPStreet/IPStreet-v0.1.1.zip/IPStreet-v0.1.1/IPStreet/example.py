from IPStreet import client, query, utils
...
if __name__ == '__main__':
    ...
    # print(ngram_results)
    # utils.results_to_csv(ngram_results, "test.csv")
    ...
    basic_data_query.add_application_number("10778419")
    basic_data_query.add_application_number("13563548")
    basic_data_query.add_grant_number("7477713")
    basic_data_query.add_grant_number("8636638")
    basic_data_query.add_publication_number("20020178089")
    basic_data_query.add_publication_number("20070106570")
    ...
    basic_data_query.print_current_query()
    basic_data_results = client.send(basic_data_query)
    for i in basic_data_results:
        print(i)
    # #
    #
    # ########################################################################
