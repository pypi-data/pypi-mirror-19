        ...
        for app in settings.APPLICATIONS:
            ...
            if os.path.exists(caminho):
                ...
                if staging:
                    ...
                    # Alterações para o Fred
                    if 'docker' in app[0]:
                        stage_branch = 'docker-compose_tweaks'
                    if 'pagamento' in app[0]:
                        stage_branch = 'linux_base'
                ...
                if branch in ['production', 'staging', 'beta', 'release', 'master', 'docker-compose_tweaks', 'linux_base']:
                    print(
