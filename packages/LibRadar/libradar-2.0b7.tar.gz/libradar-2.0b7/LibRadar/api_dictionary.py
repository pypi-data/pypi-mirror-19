...
#
#   You don't need to run this again!!! Just use Data/IntermediateData/invokeFormat.txt.py
#
...
class ApiDictionaryGenerator(Singleton):
    ...
    def __init__(self):
        ...
        self.txt_invoke_format = open(SCRIPT_PATH + "/Data/IntermediateData/invokeFormat.txt.py", 'w')
        self.ignore_list = [
            "Ljava/lang",
            "Ljava/util/logging",
            "Landroid/util/Log",
