...
#
#       tag_rules.csv.py is a projection from un-obfuscated package name to its detailed information.
#
#   Usage:
#       Run this script or just modify Data/IntermediateData/tag_rules.csv.py
