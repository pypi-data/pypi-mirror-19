# -*- coding: utf-8 -*-
'''
Py2XML - Python to XMLFunction serialization

This code transforms a Python data structures into an XMLFunction document
...
class Py2XML():
    def __init__(self):
        ...
        self.data = ""  # where we store the processed XMLFunction string

    def parse(self, pythonObj, objName=None):
        '''
        processes Python data structure into XMLFunction string
    ...
    def _PyDict2XML(self, pyDictObj, objName=None):
        ...
        They can store XMLFunction attributes and/or children
        '''
        tagStr = ""  # XMLFunction string for this level
        attributes = {}  # attribute key/value pairs
        attrStr = ""  # attribute string of this level
        childStr = ""  # XMLFunction string of this level's children
        ...
        # create XMLFunction string for attributes
    ...
    def _PyList2XML(self, pyListObj, objName=None):
        ...
        '''
        tagStr = ""  # XMLFunction string for this level
        childStr = ""  # XMLFunction string of children
...
def main():
    python_object = {'documents': [{'formats': [
        {'info': {'uri': 'http://www.python.org/newness-of-python.pdf', 'pages': '245'}, 'type': 'pdf'},
        {'info': {'uri': 'http://www.python.org/newness-of-python.html'}, 'type': 'web'}],
                                    'copyright': {'url': 'http://www.creativecommons.org/', 'date': 'June 24, 2009',
                                                  'type': 'CC'}, 'title': 'The Newness of Python',
                                    'date': 'June 6, 2009', 'text': ['Python is very nice. Very, very nice.'],
                                    'author': 'John Doe'}]}
