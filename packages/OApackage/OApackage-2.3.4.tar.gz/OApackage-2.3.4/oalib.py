...
_oalib.MAXCOLS_swigconstant(_oalib)
MAXCOLS = _oalib.MAXCOLS

_oalib.MAXROWS_swigconstant(_oalib)
MAXROWS = _oalib.MAXROWS

_oalib.CLEAN_ARRAY_LINK_swigconstant(_oalib)
CLEAN_ARRAY_LINK = _oalib.CLEAN_ARRAY_LINK

_oalib.OACHECK_swigconstant(_oalib)
OACHECK = _oalib.OACHECK

_oalib.FREQELEM_swigconstant(_oalib)
FREQELEM = _oalib.FREQELEM

_oalib.SYMMBLOCKS_swigconstant(_oalib)
SYMMBLOCKS = _oalib.SYMMBLOCKS

_oalib.TPLUSCOLUMN_swigconstant(_oalib)
TPLUSCOLUMN = _oalib.TPLUSCOLUMN

_oalib.oacolSortName_swigconstant(_oalib)
...
def print_copyright_old():
    ...
    Print copyright statement. 
    """
    return _oalib.print_copyright_old()
...
def print_options(*args):
    """
    print_options(std::ostream & outx)
    print_options()
...
def ncombscacheNumber():
    """
    ncombscacheNumber() -> int

    int ncombscacheNumber() 
    """
    return _oalib.ncombscacheNumber()

def initncombscache(N):
    """
    initncombscache(int N)

    void initncombscache(int N)

    initialize datastructure, this function is not thread safe 
    """
    return _oalib.initncombscache(N)

def ncombscache(n, k):
    """
    ncombscache(int n, int k) -> long
...
class indexsort(object):
    ...
    def __init__(self, nn):
        ...
        indexsort::indexsort(const std::vector< Type > &vals)
...
class symmetry_group(object):
    ...
    def __init__(self, *args):
        ...
        __init__(symmetry_group self, GWLPvalueVector vals, bool ascending=True, int verbose=0) -> symmetry_group
        __init__(symmetry_group self, GWLPvalueVector vals, bool ascending=True) -> symmetry_group
        __init__(symmetry_group self, GWLPvalueVector vals) -> symmetry_group
        __init__(symmetry_group self, std::vector< mvalue_t< int >,std::allocator< mvalue_t< int > > > const & vals, bool ascending=True, int verbose=0) -> symmetry_group
        __init__(symmetry_group self, std::vector< mvalue_t< int >,std::allocator< mvalue_t< int > > > const & vals, bool ascending=True) -> symmetry_group
        __init__(symmetry_group self, std::vector< mvalue_t< int >,std::allocator< mvalue_t< int > > > const & vals) -> symmetry_group
...
class symmetry_group_walker(object):
    ...
    def __init__(self, sg):
        ...
        symmetry_group_walker::symmetry_group_walker(symmetry_group sg) 
        """
    ...
    def init(self):
        """
        init(symmetry_group_walker self)

        void
        symmetry_group_walker::init() 
        """
        return _oalib.symmetry_group_walker_init(self)
...
def ipow(*args):
    ...
    unsigned int ipow(unsigned int x,
    unsigned int p)
...
def dummy():
    """dummy() -> Eigen::VectorXd"""
    return _oalib.dummy()

def dummy2():
    """dummy2() -> Eigen::MatrixXd"""
    return _oalib.dummy2()

def Fval(N, strength):
    """Fval(int N, int strength) -> intVector"""
    return _oalib.Fval(N, strength)
...
_oalib.ORDER_LEX_swigconstant(_oalib)
ORDER_LEX = _oalib.ORDER_LEX

_oalib.ORDER_J5_swigconstant(_oalib)
...
class arraydata_t(object):
    ...
    def set_colgroups_jj(self, sg, jj):
        """
        set_colgroups_jj(arraydata_t self, symmetry_group sg, int jj)

        void
        arraydata_t::set_colgroups_jj(const symmetry_group &sg, int jj) 
        """
        return _oalib.arraydata_t_set_colgroups_jj(self, sg, jj)
    ...
    def calcoaindex(self, strength):
        """
        calcoaindex(arraydata_t self, colindex_t strength)

        void
        arraydata_t::calcoaindex(colindex_t strength) 
        """
        return _oalib.arraydata_t_calcoaindex(self, strength)
    ...
    def create_root(self):
        ...
        """
        return _oalib.arraydata_t_create_root(self)
    ...
    def reset_strength(self, t):
        """
        reset_strength(arraydata_t self, colindex_t t)
        ...
        t:  
        """
        return _oalib.arraydata_t_reset_strength(self, t)
...
def equal_array_cols(A, col, col2, nrows, rstart, rend):
    """equal_array_cols(carray_t * A, colindex_t col, colindex_t col2, rowindex_t nrows, rowindex_t rstart, rowindex_t rend) -> int"""
    return _oalib.equal_array_cols(A, col, col2, nrows, rstart, rend)
...
def perform_inv_column_permutation(source, target, perm, nrows, ncols):
    """perform_inv_column_permutation(array_t const * source, array_t * target, colperm_t perm, int nrows, int ncols)"""
    return _oalib.perform_inv_column_permutation(source, target, perm, nrows, ncols)

def perform_inv_row_permutation(source, target, perm, nrows, ncols):
    """perform_inv_row_permutation(array_t const * source, array_t * target, rowperm_t perm, int nrows, int ncols)"""
    return _oalib.perform_inv_row_permutation(source, target, perm, nrows, ncols)
...
class array_link(object):
    ...
    def is_conference(self):
        ...
        """
        return _oalib.array_link_is_conference(self)
    ...
    def selectFirstRows(self, n):
        """
        selectFirstRows(array_link self, int n) -> array_link
        ...
        """
        return _oalib.array_link_selectFirstRows(self, n)


    def selectFirstColumns(self, n):
        """
        selectFirstColumns(array_link self, int n) -> array_link
        ...
        """
        return _oalib.array_link_selectFirstColumns(self, n)


    def selectLastColumns(self, n):
        """
        selectLastColumns(array_link self, int n) -> array_link
        ...
        """
        return _oalib.array_link_selectLastColumns(self, n)
    ...
    def PECsequence(self):
        ...
        """
        return _oalib.array_link_PECsequence(self)
    ...
    def getModelMatrix(self, order, intercept=1):
        """
        ...
        """
        return _oalib.array_link_getModelMatrix(self, order, intercept)
    ...
    def setconstant(self, val):
        """
        setconstant(array_link self, array_t val)
        ...
        """
        return _oalib.array_link_setconstant(self, val)


    def setvalue(self, *args):
        """
        setvalue(array_link self, int row, int col, int val)
        setvalue(array_link self, int row, int col, double val)
    ...
    def _setvalue(self, row, col, val):
        """
        _setvalue(array_link self, int row, int col, int val)
        ...
        """
        return _oalib.array_link__setvalue(self, row, col, val)


    def negateRow(self, r):
        """
        negateRow(array_link self, rowindex_t r)
        ...
        multiply a row by -1 
        """
        return _oalib.array_link_negateRow(self, r)
    ...
    def columnEqual(self, rl, rhs, rr):
        """
        columnEqual(array_link self, int rl, array_link rhs, int rr) -> bool
        ...
        """
        return _oalib.array_link_columnEqual(self, rl, rhs, rr)
    ...
    def create_root(self, ad):
        """
        create_root(array_link self, arraydata_t ad)
        ...
        """
        return _oalib.array_link_create_root(self, ad)
    ...
    def maxelement(self):
        """
        maxelement(array_link self) -> array_t

        array_t
        array_link::maxelement() const 
        """
        return _oalib.array_link_maxelement(self)


    def setcolumn(self, c, al, sc=0):
        """
        setcolumn(array_link self, int c, array_link al, int sc=0)
        setcolumn(array_link self, int c, array_link al)
        ...
        """
        return _oalib.array_link_setcolumn(self, c, al, sc)
    ...
    def __init__(self, *args):
        ...
        __init__(array_link self, Eigen::MatrixXd & m) -> array_link
        ...
        array_link::array_link(const std::vector< int > &v, rowindex_t nrows,
    ...
    def columnGreater(self, c1, rhs, c2):
        """
        columnGreater(array_link self, int c1, array_link rhs, int c2) -> int
        ...
        array 
        """
        return _oalib.array_link_columnGreater(self, c1, rhs, c2)


    def showarrayS(self):
        """
        showarrayS(array_link self) -> std::string

        std::string
        array_link::showarrayS() const 
        """
        return _oalib.array_link_showarrayS(self)


    def data(self):
        """data(array_link self) -> long"""
...
def hstack(*args):
    """
    hstack(array_link al, array_link b) -> array_link
    hstack(array_link al, charVector b) -> array_link
    """
...
def vstack(A, B):
    """vstack(charVector A, charVector B) -> charVector"""
    return _oalib.vstack(A, B)

def perform_column_permutation(*args):
    """
    perform_column_permutation(carray_t * source, array_t * target, colperm_t perm, int nrows, int ncols)
    perform_column_permutation(array_link source, array_link target, intVector perm)
    """
    return _oalib.perform_column_permutation(*args)

def perform_row_permutation(*args):
    """
    perform_row_permutation(array_t const * source, array_t * target, rowperm_t perm, int nrows, int ncols)
    perform_row_permutation(array_link source, array_link target, intVector perm)
    """
    return _oalib.perform_row_permutation(*args)

def arraylink2arraydata(al, extracols=0, strength=2):
    """
    arraylink2arraydata(array_link al, int extracols=0, int strength=2) -> arraydata_t
    arraylink2arraydata(array_link al, int extracols=0) -> arraydata_t
    arraylink2arraydata(array_link al) -> arraydata_t
    """
    return _oalib.arraylink2arraydata(al, extracols, strength)

def addConstant(lst, v):
    """addConstant(arraylist_t lst, int v) -> arraylist_t"""
    return _oalib.addConstant(lst, v)
...
def predictJ(array, N, k):
    """predictJ(array_t const * array, int const N, int const k) -> int"""
    return _oalib.predictJ(array, N, k)
...
class jstruct_t(object):
    ...
    A = _swig_property(_oalib.jstruct_t_A_get, _oalib.jstruct_t_A_set)
    ...
    def __init__(self, *args):
        ...
        jstruct_t::jstruct_t(const array_link &al, int jj=4) 
        """
...
class jstructconference_t(jstructbase_t):
    ...
    def __init__(self, *args):
        ...
        jstructconference_t::jstructconference_t(const array_link &al, int
        jj=4) 
        """
...
def create_root(*args):
    """
    create_root(array_t * array, arraydata_t ad)
    create_root(arraydata_t ad, arraylist_t solutions)
    """
    return _oalib.create_root(*args)

def array_cmp(A, B, r, c):
    """array_cmp(carray_p A, carray_p B, rowindex_t const r, colindex_t const c) -> int"""
    return _oalib.array_cmp(A, B, r, c)

def fastJupdateValue(N, tmpval):
    """fastJupdateValue(rowindex_t N, carray_t * tmpval) -> int"""
    return _oalib.fastJupdateValue(N, tmpval)

def fastJupdate(array, N, J, pp, tmp):
    """fastJupdate(array_t const * array, rowindex_t N, int const J, colindex_t const * pp, array_t * tmp)"""
    return _oalib.fastJupdate(array, N, J, pp, tmp)

def jvalue(ar, J, pp):
    """jvalue(array_link ar, int const J, int const * pp) -> int"""
    return _oalib.jvalue(ar, J, pp)
...
class array_transformation_t(object):
    ...
    def __init__(self, *args):
        """
        __init__(array_transformation_t self, arraydata_t ad) -> array_transformation_t
        __init__(array_transformation_t self, arraydata_t ad) -> array_transformation_t
        __init__(array_transformation_t self) -> array_transformation_t
        __init__(array_transformation_t self, array_transformation_t at) -> array_transformation_t
    ...
    def applygeneric(self, al):
        """
        applygeneric(array_transformation_t self, array_link al) -> array_link

        array_link array_transformation_t::applygeneric(const array_link &al)
        const

        apply transformation to an array_link object 
        """
        return _oalib.array_transformation_t_applygeneric(self, al)
    ...
    def apply(self, *args):
        """
        apply(array_transformation_t self, array_link al) -> array_link
    ...
    def setrowperm(self, rp):
        """
        setrowperm(array_transformation_t self, intVector rp)
        ...
        """
        return _oalib.array_transformation_t_setrowperm(self, rp)


    def setcolperm(self, colperm):
        """
        setcolperm(array_transformation_t self, intVector colperm)

        void
        array_transformation_t::setcolperm(std::vector< int > colperm) 
        """
        return _oalib.array_transformation_t_setcolperm(self, colperm)


    def setlevelperm(self, colindex, lvlperm):
        """
        setlevelperm(array_transformation_t self, int colindex, intVector lvlperm)

        void
        array_transformation_t::setlevelperm(int colindex, std::vector< int >
        lvlperm) 
        """
        return _oalib.array_transformation_t_setlevelperm(self, colindex, lvlperm)
...
class conference_transformation_t(object):
    ...
    def __init__(self, *args):
        ...
        conference_transformation_t::conference_transformation_t(const
    ...
    def inverse(self):
        ...
        conference_transformation_t conference_transformation_t::inverse()
        const
...
_oalib.ATEXT_swigconstant(_oalib)
ATEXT = _oalib.ATEXT

_oalib.ALATEX_swigconstant(_oalib)
ALATEX = _oalib.ALATEX

_oalib.ABINARY_swigconstant(_oalib)
ABINARY = _oalib.ABINARY

_oalib.ABINARY_DIFF_swigconstant(_oalib)
ABINARY_DIFF = _oalib.ABINARY_DIFF

_oalib.ABINARY_DIFFZERO_swigconstant(_oalib)
ABINARY_DIFFZERO = _oalib.ABINARY_DIFFZERO

_oalib.AERROR_swigconstant(_oalib)
AERROR = _oalib.AERROR

_oalib.A_AUTOMATIC_swigconstant(_oalib)
A_AUTOMATIC = _oalib.A_AUTOMATIC

_oalib.READ_swigconstant(_oalib)
READ = _oalib.READ

_oalib.WRITE_swigconstant(_oalib)
WRITE = _oalib.WRITE

_oalib.READWRITE_swigconstant(_oalib)
...
class arrayfile_t(object):
    ...
    def __init__(self, *args):
        ...
        arrayfile::arrayfile_t::arrayfile_t(const std::string fname, int
    ...
    def readarrays(self, *args):
        ...
        arraylist_t arrayfile::arrayfile_t::readarrays(int nmax=NARRAYS_MAX,
        int verbose=1)
...
def arrayfileinfo(fname, n, nr, nc):
    """arrayfileinfo(char const * fname, int & n, int & nr, int & nc)"""
    return _oalib.arrayfileinfo(fname, n, nr, nc)
...
def readarrayfile(*args):
    ...
    readarrayfile(char const * fname, arraylist_t arraylist, int verbose=1, int * setcols=None, rowindex_t * setrows=None, int * setbits=None) -> int
    readarrayfile(char const * fname, arraylist_t arraylist, int verbose=1, int * setcols=None, rowindex_t * setrows=None) -> int
...
def writearrayfile(*args):
    ...
    writearrayfile(char const * fname, arraylist_t arraylist, arrayfile::arrayfilemode_t mode) -> int
    writearrayfile(char const * fname, arraylist_t arraylist) -> int
    writearrayfile(char const * fname, array_link al, arrayfile::arrayfilemode_t mode) -> int
    writearrayfile(char const * fname, array_link al) -> int
    """
    return _oalib.writearrayfile(*args)

def appendarrayfile(fname, al):
    """appendarrayfile(char const * fname, array_link al) -> int"""
    return _oalib.appendarrayfile(fname, al)
...
def save_arrays(*args):
    """
    save_arrays(arraylist_t solutions, arraydata_t ad, int const n_arrays, int const n_procs, char const * resultprefix, arrayfile::arrayfilemode_t mode) -> int
    save_arrays(arraylist_t solutions, arraydata_t ad, int const n_arrays, int const n_procs, char const * resultprefix) -> int
    """
    return _oalib.save_arrays(*args)
...
def selectArrays(*args):
    ...
    selectArrays(arraylist_t al, intVector idx) -> arraylist_t
    selectArrays(arraylist_t al, longVector idx) -> arraylist_t
    selectArrays(arraylist_t al, intVector idx, arraylist_t fl)
    selectArrays(arraylist_t al, longVector idx, arraylist_t fl)
    """
    return _oalib.selectArrays(*args)

def appendArrays(al, dst):
    """appendArrays(arraylist_t al, arraylist_t dst)"""
    return _oalib.appendArrays(al, dst)
...
def array2eigenX2(al):
    """array2eigenX2(array_link al) -> MatrixFloat"""
    return _oalib.array2eigenX2(al)

def array2eigenX1(al, intercept=1):
    """
    array2eigenX1(array_link al, int intercept=1) -> MatrixFloat
    array2eigenX1(array_link al) -> MatrixFloat
    """
    return _oalib.array2eigenX1(al, intercept)

def array2eigenModelMatrix(al):
    """array2eigenModelMatrix(array_link al) -> MatrixFloat"""
    return _oalib.array2eigenModelMatrix(al)

def array2eigenME(al, verbose=1):
    """
    array2eigenME(array_link al, int verbose=1) -> MatrixFloat
    array2eigenME(array_link al) -> MatrixFloat
    """
    return _oalib.array2eigenME(al, verbose)

def array2eigenModelMatrixMixed(al, verbose=1):
    """
    array2eigenModelMatrixMixed(array_link al, int verbose=1) -> std::pair< MatrixFloat,MatrixFloat >
    array2eigenModelMatrixMixed(array_link al) -> std::pair< MatrixFloat,MatrixFloat >
    """
    return _oalib.array2eigenModelMatrixMixed(al, verbose)

def arrayInFile(al, afile, verbose=1):
    """
    arrayInFile(array_link al, char const * afile, int verbose=1) -> int
    arrayInFile(array_link al, char const * afile) -> int
    """
    return _oalib.arrayInFile(al, afile, verbose)

def arrayInList(al, ll, verbose=1):
    """
    arrayInList(array_link al, arraylist_t ll, int verbose=1) -> int
    arrayInList(array_link al, arraylist_t ll) -> int
    """
    return _oalib.arrayInList(al, ll, verbose)
...
def printfd_handler(file, func, line, message):
    ...
    void printfd_handler(const
    char *file, const char *func, int line, const char *message,...) 
    """
    return _oalib.printfd_handler(file, func, line, message)

_oalib.LOGERROR_swigconstant(_oalib)
LOGERROR = _oalib.LOGERROR

_oalib.SYSTEM_swigconstant(_oalib)
SYSTEM = _oalib.SYSTEM

_oalib.QUIET_swigconstant(_oalib)
QUIET = _oalib.QUIET

_oalib.NORMAL_swigconstant(_oalib)
NORMAL = _oalib.NORMAL

_oalib.DEBUG_swigconstant(_oalib)
DEBUG = _oalib.DEBUG

_oalib.EXTRADEBUG_swigconstant(_oalib)
...
def checkloglevel(l):
    """
    checkloglevel(int l) -> bool

    bool checkloglevel(int l) 
    """
    return _oalib.checkloglevel(l)
...
def mycheck_handler(file, func, line, condition, message):
    """
    mycheck_handler(char const * file, char const * func, int line, int condition, char const * message)

    void mycheck_handler(const
    char *file, const char *func, int line, int condition, const char
    *message,...) 
    """
    return _oalib.mycheck_handler(file, func, line, condition, message)

def myassert(condition, str=None):
    """
    myassert(int condition, char const * str=None)
    myassert(int condition)

    void myassert(int condition, const
    char *str=0) 
    """
    return _oalib.myassert(condition, str)

def myassertdebug2(condition, str):
    """
    myassertdebug2(int condition, char const * str)

    void myassertdebug2(int
    condition, const char *str) 
    """
    return _oalib.myassertdebug2(condition, str)

def cprintf(check, message):
    """
    cprintf(int check, char const * message) -> int

    int cprintf(int check, const char
    *message,...) 
    """
...
def next_comb_s(comb, k, n):
    ...
    int next_comb_s(int *comb, int k,
    int n)
...
def print_array(*args):
    """
    print_array(char const * str, array_t const * array, rowindex_t const r, colindex_t const c)
    print_array(array_t const * array, rowindex_t const r, colindex_t const c)
    print_array(array_link A)

    void print_array(const array_link
    &A)
...
def countelements(array, nelements, maxval, elements):
    """
    countelements(carray_t * array, int const nelements, int const maxval, int * elements)

    void countelements(carray_t
    *array, const int nelements, const int maxval, int *elements)

    Counts the number of occurences of each value in an array. 
    """
    return _oalib.countelements(array, nelements, maxval, elements)
...
def oafilestring(*args):
    """
    oafilestring(arraydata_t ad) -> std::string
    oafilestring(rowindex_t rows, colindex_t cols, array_t * s) -> std::string
    ...
    """
    return _oalib.oafilestring(*args)

def printtime():
    """
    printtime() -> std::string

    std::string printtime() 
    """
    return _oalib.printtime()

def replaceString(subject, search, replace):
    """
    replaceString(std::string subject, std::string const & search, std::string const & replace) -> std::string
    ...
    """
    return _oalib.replaceString(subject, search, replace)

def printdoubleasbits(decker):
    """
    ...
    """
    return _oalib.printdoubleasbits(decker)

def detXtX(mymatrix, verbose=1):
    """
    detXtX(Eigen::MatrixXd const & mymatrix, int verbose=1) -> double
    detXtX(Eigen::MatrixXd const & mymatrix) -> double

    double detXtX(const Eigen::MatrixXd
    &mymatrix, int verbose=1)

    calculate determinant of X^T X by using the SVD 
    """
    return _oalib.detXtX(mymatrix, verbose)

def detXtXfloat(mymatrix, verbose=1):
    """
    detXtXfloat(Eigen::MatrixXf const & mymatrix, int verbose=1) -> double
    detXtXfloat(Eigen::MatrixXf const & mymatrix) -> double

    double detXtXfloat(const
    Eigen::MatrixXf &mymatrix, int verbose=1) 
    """
    return _oalib.detXtXfloat(mymatrix, verbose)

def DAEefficiecyWithSVD(x, Deff, vif, Eeff, rank, verbose):
    """
    DAEefficiecyWithSVD(Eigen::MatrixXd const & x, double & Deff, double & vif, double & Eeff, int & rank, int verbose)
    ...
    using SVD. 
    """
    return _oalib.DAEefficiecyWithSVD(x, Deff, vif, Eeff, rank, verbose)

def array_rank_D_B(al, ret=None, verbose=0):
    """
    array_rank_D_B(array_link al, doubleVector ret=None, int verbose=0) -> int
    array_rank_D_B(array_link al, doubleVector ret=None) -> int
    array_rank_D_B(array_link al) -> int

    int array_rank_D_B(const
    ...
    """
    return _oalib.array_rank_D_B(al, ret, verbose)
...
def VIFefficiency(al, verbose=0):
    """
    VIFefficiency(array_link al, int verbose=0) -> double
    VIFefficiency(array_link al) -> double
    ...
    """
    return _oalib.VIFefficiency(al, verbose)

def Aefficiency(al, verbose=0):
    """
    Aefficiency(array_link al, int verbose=0) -> double
    Aefficiency(array_link al) -> double
    ...
    """
    return _oalib.Aefficiency(al, verbose)

def Eefficiency(al, verbose=0):
    """
    Eefficiency(array_link al, int verbose=0) -> double
    Eefficiency(array_link al) -> double
    ...
    """
    return _oalib.Eefficiency(al, verbose)

def Aefficiencies(al, verbose=0):
    """
    Aefficiencies(array_link al, int verbose=0) -> doubleVector
    Aefficiencies(array_link al) -> doubleVector
    ...
    """
    return _oalib.Aefficiencies(al, verbose)

def projDeff(al, kp, verbose):
    """
    projDeff(array_link al, int kp, int verbose) -> doubleVector

    std::vector< double > projDeff(const
    array_link &al, int kp, int verbose)

    Return the D-efficiencies for the projection designs. 
    """
    return _oalib.projDeff(al, kp, verbose)

def PECsequence(al, verbose=0):
    """
    PECsequence(array_link al, int verbose=0) -> doubleVector
    PECsequence(array_link al) -> doubleVector
    ...
    """
    return _oalib.PECsequence(al, verbose)

def distance_distribution(al):
    """
    distance_distribution(array_link al) -> doubleVector
    ...
    """
    return _oalib.distance_distribution(al)
...
def GWLP(al, verbose=0, truncate=1):
    """
    GWLP(array_link al, int verbose=0, int truncate=1) -> doubleVector
    GWLP(array_link al, int verbose=0) -> doubleVector
    GWLP(array_link al) -> doubleVector
    ...
    """
    return _oalib.GWLP(al, verbose, truncate)
...
def projectionGWLPs(al):
    """
    projectionGWLPs(array_link al) -> GWLPvalueVector

    std::vector< GWLPvalue >
...
def sortGWLP(arg1):
    """
    sortGWLP(GWLPvalueVector arg1) -> GWLPvalueVector
...
def projectionGWLPvalues(al):
    """
    projectionGWLPvalues(array_link al) -> doubleVector
    ...
    projection values 
    """
    return _oalib.projectionGWLPvalues(al)
...
def array2secondorder(al):
    """
    array2secondorder(array_link al) -> array_link
    ...
    """
    return _oalib.array2secondorder(al)

def array2xf(al):
    """
    array2xf(array_link al) -> array_link

    array_link array2xf(const array_link
    &al)

    add intercept and second order interactions to a 2-level array 
    """
    return _oalib.array2xf(al)

def array2xfeigen(al):
    """
    array2xfeigen(array_link al) -> Eigen::MatrixXd
    ...
    """
    return _oalib.array2xfeigen(al)
...
def arrayrankInfo(*args):
    ...
    arrayrankInfo(array_link al, int verbose=1) -> int
    arrayrankInfo(array_link al) -> int

    int arrayrankInfo(const
...
def arraylink2eigen(al):
    """
    arraylink2eigen(array_link al) -> Eigen::MatrixXd
    ...
    """
    return _oalib.arraylink2eigen(al)
class rankStructure(object):
    ...
    def __init__(self, *args):
        ...
        rankStructure::rankStructure(int nsub=3, int id=-1)
    ...
    def matrixP(self):
        """
        matrixP(rankStructure self) -> rankStructure::EigenDecomp::PermutationType

        EigenDecomp::PermutationType rankStructure::matrixP() const

        helper function 
        """
        return _oalib.rankStructure_matrixP(self)


    def rankdirect(self, A):
        """
        rankdirect(rankStructure self, Eigen::MatrixXd const & A) -> int
        ...
        """
        return _oalib.rankStructure_rankdirect(self, A)


    def rankxfdirect(self, al):
        """
        rankxfdirect(rankStructure self, array_link al) -> int
        ...
        directly 
        """
        return _oalib.rankStructure_rankxfdirect(self, al)


    def rankxf(self, al):
        """
        rankxf(rankStructure self, array_link al) -> int
        ...
        """
        return _oalib.rankStructure_rankxf(self, al)
...
def conditionNumber(M):
    """
    conditionNumber(array_link M) -> double
    ...
    """
    return _oalib.conditionNumber(M)

_oalib.PARETOFUNCTION_DEFAULT_swigconstant(_oalib)
PARETOFUNCTION_DEFAULT = _oalib.PARETOFUNCTION_DEFAULT

_oalib.PARETOFUNCTION_J5_swigconstant(_oalib)
...
def parsePareto(arraylist, verbose, paretomethod=PARETOFUNCTION_DEFAULT):
    """
    parsePareto(arraylist_t arraylist, int verbose, paretomethod_t paretomethod=PARETOFUNCTION_DEFAULT) -> ParetoLong
    parsePareto(arraylist_t arraylist, int verbose) -> ParetoLong

    Pareto< mvalue_t < long >, long >
...
def A3A4(al):
    ...
    mvalue_t< long > A3A4(const array_link
    &al)
...
def F4(al, verbose=1):
    ...
    mvalue_t< long > F4(const array_link &al,
    int verbose=1)
...
def Cvalue2Dvalue(C, ka):
    """
    Cvalue2Dvalue(double C, int ka) -> double

    double Cvalue2Dvalue(double C,
    int ka)

    convert C value to D-efficiency value 
    """
    return _oalib.Cvalue2Dvalue(C, ka)

def Dvalue2Cvalue(A, ka):
    """
    Dvalue2Cvalue(double A, int ka) -> double

    double Dvalue2Cvalue(double A,
    int ka)

    convert D-efficiency value to C value 
    """
    return _oalib.Dvalue2Cvalue(A, ka)

def get_oaindex(s, strength, N):
    """
    get_oaindex(array_t const * s, colindex_t const strength, colindex_t const N) -> int

    int get_oaindex(const array_t *s,
    const colindex_t strength, const colindex_t N)

    Return index of an array. 
    """
    return _oalib.get_oaindex(s, strength, N)
...
def scoreD(dd, alpha):
    """
    scoreD(doubleVector dd, doubleVector alpha) -> double

    double scoreD(const std::vector<
    double > dd, const std::vector< double > alpha)

    calculate score from from set of efficiencies 
    """
    return _oalib.scoreD(dd, alpha)

_oalib.DOPTIM_UPDATE_swigconstant(_oalib)
DOPTIM_UPDATE = _oalib.DOPTIM_UPDATE

_oalib.DOPTIM_SWAP_swigconstant(_oalib)
DOPTIM_SWAP = _oalib.DOPTIM_SWAP

_oalib.DOPTIM_FLIP_swigconstant(_oalib)
DOPTIM_FLIP = _oalib.DOPTIM_FLIP

_oalib.DOPTIM_AUTOMATIC_swigconstant(_oalib)
DOPTIM_AUTOMATIC = _oalib.DOPTIM_AUTOMATIC

_oalib.DOPTIM_NONE_swigconstant(_oalib)
...
def optimDeff2level(A0, arrayclass, alpha, verbose=1, optimmethod=DOPTIM_AUTOMATIC, niter=100000, nabort=0):
    """
    optimDeff2level(array_link A0, arraydata_t arrayclass, doubleVector alpha, int verbose=1, int optimmethod=DOPTIM_AUTOMATIC, int niter=100000, int nabort=0) -> array_link
    optimDeff2level(array_link A0, arraydata_t arrayclass, doubleVector alpha, int verbose=1, int optimmethod=DOPTIM_AUTOMATIC, int niter=100000) -> array_link
    optimDeff2level(array_link A0, arraydata_t arrayclass, doubleVector alpha, int verbose=1, int optimmethod=DOPTIM_AUTOMATIC) -> array_link
    optimDeff2level(array_link A0, arraydata_t arrayclass, doubleVector alpha, int verbose=1) -> array_link
    optimDeff2level(array_link A0, arraydata_t arrayclass, doubleVector alpha) -> array_link
    ...
    debugging function 
    """
    return _oalib.optimDeff2level(A0, arrayclass, alpha, verbose, optimmethod, niter, nabort)
...
def DoptimizeDebug(arrayclass, nrestarts, alpha, verbose, method=DOPTIM_AUTOMATIC, niter=300000, maxtime=100000, nabort=5000):
    """
    DoptimizeDebug(arraydata_t arrayclass, int nrestarts, doubleVector alpha, int verbose, int method=DOPTIM_AUTOMATIC, int niter=300000, double maxtime=100000, int nabort=5000) -> DoptimReturn
    DoptimizeDebug(arraydata_t arrayclass, int nrestarts, doubleVector alpha, int verbose, int method=DOPTIM_AUTOMATIC, int niter=300000, double maxtime=100000) -> DoptimReturn
    DoptimizeDebug(arraydata_t arrayclass, int nrestarts, doubleVector alpha, int verbose, int method=DOPTIM_AUTOMATIC, int niter=300000) -> DoptimReturn
    DoptimizeDebug(arraydata_t arrayclass, int nrestarts, doubleVector alpha, int verbose, int method=DOPTIM_AUTOMATIC) -> DoptimReturn
    DoptimizeDebug(arraydata_t arrayclass, int nrestarts, doubleVector alpha, int verbose) -> DoptimReturn
    ...
    helper function 
    """
    return _oalib.DoptimizeDebug(arrayclass, nrestarts, alpha, verbose, method, niter, maxtime, nabort)
...
class OAextend(object):
    ...
    def __init__(self, *args):
        ...
        OAextend::OAextend(arraydata_t &ad) 
        """
    ...
    def updateArraydata(self, ad=None):
        """
        updateArraydata(OAextend self, arraydata_t ad=None)
        updateArraydata(OAextend self)

        void
        OAextend::updateArraydata(arraydata_t *ad=0) const 
        """
        return _oalib.OAextend_updateArraydata(self, ad)


    def getPreferredAlgorithm(ad, verbose=0):
        """
        getPreferredAlgorithm(arraydata_t ad, int verbose=0) -> algorithm_t
        getPreferredAlgorithm(arraydata_t ad) -> algorithm_t
        """
        return _oalib.OAextend_getPreferredAlgorithm(ad, verbose)

    getPreferredAlgorithm = staticmethod(getPreferredAlgorithm)

    def info(self, vb=1):
        """
        info(OAextend self, int vb=1)
        info(OAextend self)

        void OAextend::info(int vb=1)
        const

        print configuration to stdout 
        """
        return _oalib.OAextend_info(self, vb)
...
def OAextend_getPreferredAlgorithm(ad, verbose=0):
    """
    getPreferredAlgorithm(arraydata_t ad, int verbose=0) -> algorithm_t
    OAextend_getPreferredAlgorithm(arraydata_t ad) -> algorithm_t
    """
    return _oalib.OAextend_getPreferredAlgorithm(ad, verbose)
...
def extend_arraylist(*args):
    """
    extend_arraylist(arraylist_t alist, arraydata_t fullad, OAextend oaextend, colindex_t extensioncol, arraylist_t extensions) -> int
    extend_arraylist(arraylist_t alist, arraydata_t fullad, OAextend oaextend) -> arraylist_t
    extend_arraylist(arraylist_t alist, arraydata_t fullad) -> arraylist_t
...
def extend_array(*args):
    """
    extend_array(array_link al, arraydata_t fullad, OAextend oaextend) -> arraylist_t
...
def runExtendRoot(adata, nmax, verbose=0):
    """
    runExtendRoot(arraydata_t adata, int nmax, int verbose=0) -> arraylist_t
    runExtendRoot(arraydata_t adata, int nmax) -> arraylist_t
    ...
    """
    return _oalib.runExtendRoot(adata, nmax, verbose)

_oalib.DFILTER_NONE_swigconstant(_oalib)
DFILTER_NONE = _oalib.DFILTER_NONE

_oalib.DFILTER_BASIC_swigconstant(_oalib)
DFILTER_BASIC = _oalib.DFILTER_BASIC

_oalib.DFILTER_MULTI_swigconstant(_oalib)
DFILTER_MULTI = _oalib.DFILTER_MULTI

_oalib.DCALC_ALWAYS_swigconstant(_oalib)
DCALC_ALWAYS = _oalib.DCALC_ALWAYS

_oalib.DCALC_COND_swigconstant(_oalib)
...
class split(object):
    """Proxy of C++ split class."""

    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    st = _swig_property(_oalib.split_st_get, _oalib.split_st_set)
    count = _swig_property(_oalib.split_count_get, _oalib.split_count_set)
    stacksize = _swig_property(_oalib.split_stacksize_get, _oalib.split_stacksize_set)
    nvalid = _swig_property(_oalib.split_nvalid_get, _oalib.split_nvalid_set)
    cvalidpos = _swig_property(_oalib.split_cvalidpos_get, _oalib.split_cvalidpos_set)
    valid = _swig_property(_oalib.split_valid_get, _oalib.split_valid_set)

    def __init__(self, stacksize, maxs=26):
        """
        __init__(split self, rowindex_t stacksize, int maxs=26) -> split
        __init__(split self, rowindex_t stacksize) -> split
        """
        this = _oalib.new_split(stacksize, maxs)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _oalib.delete_split
    __del__ = lambda self: None

    def position(self):
        """position(split self) -> rowindex_t"""
        return _oalib.split_position(self)


    def show(self):
        """show(split self)"""
        return _oalib.split_show(self)

split_swigregister = _oalib.split_swigregister
split_swigregister(split)


_oalib.LMC_LESS_swigconstant(_oalib)
LMC_LESS = _oalib.LMC_LESS

_oalib.LMC_EQUAL_swigconstant(_oalib)
LMC_EQUAL = _oalib.LMC_EQUAL

_oalib.LMC_MORE_swigconstant(_oalib)
LMC_MORE = _oalib.LMC_MORE

_oalib.LMC_NONSENSE_swigconstant(_oalib)
LMC_NONSENSE = _oalib.LMC_NONSENSE

_oalib.MODE_ORIGINAL_swigconstant(_oalib)
MODE_ORIGINAL = _oalib.MODE_ORIGINAL

_oalib.MODE_J4_swigconstant(_oalib)
MODE_J4 = _oalib.MODE_J4

_oalib.MODE_J5ORDER_swigconstant(_oalib)
MODE_J5ORDER = _oalib.MODE_J5ORDER

_oalib.MODE_J5ORDERX_swigconstant(_oalib)
MODE_J5ORDERX = _oalib.MODE_J5ORDERX

_oalib.MODE_INVALID_swigconstant(_oalib)
MODE_INVALID = _oalib.MODE_INVALID

_oalib.MODE_AUTOSELECT_swigconstant(_oalib)
MODE_AUTOSELECT = _oalib.MODE_AUTOSELECT

_oalib.MODE_LMC_SYMMETRY_swigconstant(_oalib)
MODE_LMC_SYMMETRY = _oalib.MODE_LMC_SYMMETRY

_oalib.MODE_LMC_2LEVEL_swigconstant(_oalib)
MODE_LMC_2LEVEL = _oalib.MODE_LMC_2LEVEL

_oalib.MODE_LMC_DEBUG_swigconstant(_oalib)
MODE_LMC_DEBUG = _oalib.MODE_LMC_DEBUG

_oalib.MODE_J5ORDERXFAST_swigconstant(_oalib)
MODE_J5ORDERXFAST = _oalib.MODE_J5ORDERXFAST
...
_oalib.INITCOLUMN_ZERO_swigconstant(_oalib)
INITCOLUMN_ZERO = _oalib.INITCOLUMN_ZERO

_oalib.INITCOLUMN_PREVIOUS_swigconstant(_oalib)
INITCOLUMN_PREVIOUS = _oalib.INITCOLUMN_PREVIOUS

_oalib.INITCOLUMN_J5_swigconstant(_oalib)
INITCOLUMN_J5 = _oalib.INITCOLUMN_J5

_oalib.J5_ORIGINAL_swigconstant(_oalib)
J5_ORIGINAL = _oalib.J5_ORIGINAL

_oalib.J5_45_swigconstant(_oalib)
J5_45 = _oalib.J5_45
...
def apply_hadamard(*args):
    """
    apply_hadamard(arraydata_t ad, array_t * array, colindex_t hcol)
    apply_hadamard(array_link al, colindex_t hcol)

    void apply_hadamard(array_link
    &al, colindex_t hcol)

    Apply Hadamard transformation to orthogonal array. 
    """
    return _oalib.apply_hadamard(*args)
class LMC_static_struct_t(object):
    """
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    LMC_non_root_init = _swig_property(_oalib.LMC_static_struct_t_LMC_non_root_init_get, _oalib.LMC_static_struct_t_LMC_non_root_init_set)
    LMC_root_init = _swig_property(_oalib.LMC_static_struct_t_LMC_root_init_get, _oalib.LMC_static_struct_t_LMC_root_init_set)
    LMC_reduce_root_rowperms_init = _swig_property(_oalib.LMC_static_struct_t_LMC_reduce_root_rowperms_init_get, _oalib.LMC_static_struct_t_LMC_reduce_root_rowperms_init_set)
    ad = _swig_property(_oalib.LMC_static_struct_t_ad_get, _oalib.LMC_static_struct_t_ad_set)
    LMC_root_rowperms_init = _swig_property(_oalib.LMC_static_struct_t_LMC_root_rowperms_init_get, _oalib.LMC_static_struct_t_LMC_root_rowperms_init_set)
    nrootrowperms = _swig_property(_oalib.LMC_static_struct_t_nrootrowperms_get, _oalib.LMC_static_struct_t_nrootrowperms_set)
    rootrowperms = _swig_property(_oalib.LMC_static_struct_t_rootrowperms_get, _oalib.LMC_static_struct_t_rootrowperms_set)
    LMC_root_rowperms_init_full = _swig_property(_oalib.LMC_static_struct_t_LMC_root_rowperms_init_full_get, _oalib.LMC_static_struct_t_LMC_root_rowperms_init_full_set)
    nrootrowperms_full = _swig_property(_oalib.LMC_static_struct_t_nrootrowperms_full_get, _oalib.LMC_static_struct_t_nrootrowperms_full_set)
    rootrowperms_full = _swig_property(_oalib.LMC_static_struct_t_rootrowperms_full_get, _oalib.LMC_static_struct_t_rootrowperms_full_set)
    colbuffer = _swig_property(_oalib.LMC_static_struct_t_colbuffer_get, _oalib.LMC_static_struct_t_colbuffer_set)
    dyndata_p = _swig_property(_oalib.LMC_static_struct_t_dyndata_p_get, _oalib.LMC_static_struct_t_dyndata_p_set)
    colperm_p = _swig_property(_oalib.LMC_static_struct_t_colperm_p_get, _oalib.LMC_static_struct_t_colperm_p_set)
    localcolperm_p = _swig_property(_oalib.LMC_static_struct_t_localcolperm_p_get, _oalib.LMC_static_struct_t_localcolperm_p_set)
    current_trans = _swig_property(_oalib.LMC_static_struct_t_current_trans_get, _oalib.LMC_static_struct_t_current_trans_set)

    def __init__(self):
        """
        __init__(LMC_static_struct_t self) -> LMC_static_struct_t

        LMC_static_struct_t::LMC_static_struct_t() 
        """
        this = _oalib.new_LMC_static_struct_t()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _oalib.delete_LMC_static_struct_t
    __del__ = lambda self: None

    def show(self, verbose=1):
        """
        show(LMC_static_struct_t self, int verbose=1)
        show(LMC_static_struct_t self)

        void
        LMC_static_struct_t::show(int verbose=1) const 
        """
        return _oalib.LMC_static_struct_t_show(self, verbose)


    def init(self, adp):
        """
        init(LMC_static_struct_t self, arraydata_t adp)

        void
        LMC_static_struct_t::init(const arraydata_t *adp) 
        """
        return _oalib.LMC_static_struct_t_init(self, adp)


    def freeall(self):
        """
        freeall(LMC_static_struct_t self)

        void
        LMC_static_struct_t::freeall() 
        """
        return _oalib.LMC_static_struct_t_freeall(self)


    def update(self, adp):
        """
        update(LMC_static_struct_t self, arraydata_t adp) -> int
        ...
        """
        return _oalib.LMC_static_struct_t_update(self, adp)


    def needUpdate(self, adp):
        """
        needUpdate(LMC_static_struct_t self, arraydata_t adp) -> int

        int
        LMC_static_struct_t::needUpdate(const arraydata_t *adp) const 
        """
        return _oalib.LMC_static_struct_t_needUpdate(self, adp)


    def init_root_stage(self, lperm_p, colperm_p, adp):
        """
        init_root_stage(LMC_static_struct_t self, levelperm_t *& lperm_p, colperm_t *& colperm_p, arraydata_t adp)

        void
        LMC_static_struct_t::init_root_stage(levelperm_t *&lperm_p, colperm_t
        *&colperm_p, const arraydata_t *adp) 
        """
        return _oalib.LMC_static_struct_t_init_root_stage(self, lperm_p, colperm_p, adp)


    def init_nonroot_stage(self, lperm_p, colperm_p, localcolperm_p, dynd_p, dynd_p_nelem, colbuffer, adp):
        """
        init_nonroot_stage(LMC_static_struct_t self, levelperm_t *& lperm_p, colperm_t *& colperm_p, colperm_t *& localcolperm_p, dyndata_t **& dynd_p, int & dynd_p_nelem, array_t *& colbuffer, arraydata_t adp)
        ...
        *adp) const 
        """
        return _oalib.LMC_static_struct_t_init_nonroot_stage(self, lperm_p, colperm_p, localcolperm_p, dynd_p, dynd_p_nelem, colbuffer, adp)


    def init_rootrowperms(self, totalperms, rootrowperms, lperm_p):
        """
        init_rootrowperms(LMC_static_struct_t self, int & totalperms, rowperm_t *& rootrowperms, levelperm_t *& lperm_p)
        ...
        *&rootrowperms, levelperm_t *&lperm_p)
        ...
        """
        return _oalib.LMC_static_struct_t_init_rootrowperms(self, totalperms, rootrowperms, lperm_p)


    def init_rootrowperms_full(self, totalperms, rootrowperms, lperm_p):
        """
        init_rootrowperms_full(LMC_static_struct_t self, int & totalperms, rowperm_t *& rootrowperms, levelperm_t *& lperm_p)

        void LMC_static_struct_t::init_rootrowperms_full(int &totalperms,
        rowperm_t *&rootrowperms, levelperm_t *&lperm_p)

        Static initialization of root row permutations (full group) 
        """
        return _oalib.LMC_static_struct_t_init_rootrowperms_full(self, totalperms, rootrowperms, lperm_p)

LMC_static_struct_t_swigregister = _oalib.LMC_static_struct_t_swigregister
LMC_static_struct_t_swigregister(LMC_static_struct_t)


def getGlobalStaticIndexed(n):
    """
    getGlobalStaticIndexed(int n) -> LMC_static_struct_t

    LMC_static_struct_t*
    getGlobalStaticIndexed(int n) 
    """
    return _oalib.getGlobalStaticIndexed(n)

def cleanGlobalStaticIndexed():
    """
    ...
    cleanGlobalStaticIndexed() 
    """
    return _oalib.cleanGlobalStaticIndexed()

def getGlobalStatic():
    """
    getGlobalStatic() -> LMC_static_struct_t
    ...
    releaseGlobalStatic 
    """
    return _oalib.getGlobalStatic()

def releaseGlobalStatic(p):
    """
    ...
    releaseGlobalStatic(LMC_static_struct_t *p) 
    """
    return _oalib.releaseGlobalStatic(p)

def cleanGlobalStatic():
    """
    cleanGlobalStatic()

    void cleanGlobalStatic() 
    """
    return _oalib.cleanGlobalStatic()

def getGlobalStaticOne():
    """
    getGlobalStaticOne() -> LMC_static_struct_t

    LMC_static_struct_t&
    getGlobalStaticOne() 
    """
    return _oalib.getGlobalStaticOne()

_oalib.REDUCTION_INITIAL_swigconstant(_oalib)
REDUCTION_INITIAL = _oalib.REDUCTION_INITIAL

_oalib.REDUCTION_CHANGED_swigconstant(_oalib)
REDUCTION_CHANGED = _oalib.REDUCTION_CHANGED

_oalib.OA_TEST_swigconstant(_oalib)
OA_TEST = _oalib.OA_TEST

_oalib.OA_REDUCE_swigconstant(_oalib)
OA_REDUCE = _oalib.OA_REDUCE

_oalib.OA_REDUCE_PARTIAL_swigconstant(_oalib)
OA_REDUCE_PARTIAL = _oalib.OA_REDUCE_PARTIAL
class arraysymmetry(object):
    """
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    rowperm = _swig_property(_oalib.arraysymmetry_rowperm_get, _oalib.arraysymmetry_rowperm_set)
    colperm = _swig_property(_oalib.arraysymmetry_colperm_get, _oalib.arraysymmetry_colperm_set)
    rowpermpool = _swig_property(_oalib.arraysymmetry_rowpermpool_get, _oalib.arraysymmetry_rowpermpool_set)
    __swig_destroy__ = _oalib.delete_arraysymmetry
    __del__ = lambda self: None

    def __init__(self, *args):
        """
        __init__(arraysymmetry self, dyndata_t dyndata) -> arraysymmetry
        __init__(arraysymmetry self, arraysymmetry rhs) -> arraysymmetry

        arraysymmetry::arraysymmetry(const arraysymmetry &rhs)

        copy constructor 
        """
        this = _oalib.new_arraysymmetry(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def __eq__(self, as2):
        """__eq__(arraysymmetry self, arraysymmetry as2) -> int"""
        return _oalib.arraysymmetry___eq__(self, as2)


    def N(self):
        """
        N(arraysymmetry self) -> int

        int arraysymmetry::N() const

        """
        return _oalib.arraysymmetry_N(self)


    def show(self):
        """
        show(arraysymmetry self)

        void
        arraysymmetry::show() const 
        """
        return _oalib.arraysymmetry_show(self)

arraysymmetry_swigregister = _oalib.arraysymmetry_swigregister
arraysymmetry_swigregister(arraysymmetry)


def rootPlus(ad):
    """
    rootPlus(arraydata_t ad) -> array_link

    array_link rootPlus(const
    arraydata_t &ad)

    helper function 
    """
    return _oalib.rootPlus(ad)

_oalib.INIT_STATE_INVALID_swigconstant(_oalib)
INIT_STATE_INVALID = _oalib.INIT_STATE_INVALID

_oalib.COPY_swigconstant(_oalib)
COPY = _oalib.COPY

_oalib.INIT_swigconstant(_oalib)
INIT = _oalib.INIT

_oalib.SETROOT_swigconstant(_oalib)
...
class LMCreduction_t(object):
    ...
    symms = _swig_property(_oalib.LMCreduction_t_symms_get, _oalib.LMCreduction_t_symms_set)
    ...
    def __init__(self, *args):
        ...
        __init__(LMCreduction_t self, arraydata_t ad) -> LMCreduction_t

        LMCreduction_t::LMCreduction_t(const arraydata_t *ad)
    ...
    def clearSymmetries(self):
        """
        clearSymmetries(LMCreduction_t self)

        void
        LMCreduction_t::clearSymmetries() 
        """
        return _oalib.LMCreduction_t_clearSymmetries(self)
    ...
    def getStaticReference(self):
        """
        getStaticReference(LMCreduction_t self) -> LMC_static_struct_t

        LMC_static_struct_t& LMCreduction_t::getStaticReference()

        return a reference to a LMC_static_struct_t object 
        """
        return _oalib.LMCreduction_t_getStaticReference(self)
    ...
    def doBreak(self, ret):
        """
        doBreak(LMCreduction_t self, lmc_t ret) -> bool

        bool
        LMCreduction_t::doBreak(lmc_t ret) 
        """
        return _oalib.LMCreduction_t_doBreak(self, ret)
...
class dyndata_t(object):
    ...
    def __init__(self, *args):
        ...
        dyndata_t::dyndata_t(const dyndata_t &) 
        """
    ...
    def initsymmetry(self, arraysymm, sd, ncols):
        """
        initsymmetry(dyndata_t self, arraysymmetry arraysymm, symmdata sd, int ncols)
        ...
        """
        return _oalib.dyndata_t_initsymmetry(self, arraysymm, sd, ncols)
    ...
    def allocrowsortl(self):
        """
        allocrowsortl(dyndata_t self)
        ...
        """
        return _oalib.dyndata_t_allocrowsortl(self)
...
def check_root_form(array, ad):
    """
    check_root_form(array_t const * array, arraydata_t ad) -> bool

    bool check_root_form(const
    array_t *array, const arraydata_t &ad)

    return true if target is in root form, otherwise return false 
    """
    return _oalib.check_root_form(array, ad)

def jj45val(array, N, jj, comb, j5val=-1, dosort=1):
    """
    jj45val(carray_t * array, rowindex_t N, int jj, colperm_t const comb, int j5val=-1, int dosort=1) -> jj45_t
    jj45val(carray_t * array, rowindex_t N, int jj, colperm_t const comb, int j5val=-1) -> jj45_t
    jj45val(carray_t * array, rowindex_t N, int jj, colperm_t const comb) -> jj45_t

    jj45_t jj45val(carray_t *array,
    rowindex_t N, int jj, const colperm_t comb, int j5val=-1, int
    dosort=1)

    return value based on J4-J5 ordering 
    """
    return _oalib.jj45val(array, N, jj, comb, j5val, dosort)

def random_transformation(array, adp):
    """
    random_transformation(array_t * array, arraydata_t adp)
    ...
    """
    return _oalib.random_transformation(array, adp)

def LMCreduction_train(*args):
    """
    LMCreduction_train(array_link al, arraydata_t ad, LMCreduction_t reduction, OAextend oaextend) -> lmc_t
    LMCreduction_train(array_t const * original, arraydata_t ad, dyndata_t dyndata, LMCreduction_t reduction, OAextend oaextend) -> lmc_t
    ...
    &oaextend) 
    """
    return _oalib.LMCreduction_train(*args)

def LMCreduce(original, array, ad, dyndata, reduction, oaextend):
    """
    LMCreduce(array_t const * original, array_t const * array, arraydata_t ad, dyndata_t dyndata, LMCreduction_t reduction, OAextend oaextend) -> lmc_t

    lmc_t LMCreduce(array_t const
    *original, array_t const *array, const arraydata_t *ad, const
    ...
    helper function 
    """
    return _oalib.LMCreduce(original, array, ad, dyndata, reduction, oaextend)

def LMCcheck(*args):
    """
    LMCcheck(array_t const * array, arraydata_t ad, OAextend oaextend, LMCreduction_t reduction) -> lmc_t
    LMCcheck(array_link al, arraydata_t ad, OAextend oaextend, LMCreduction_t reduction) -> lmc_t
...
def LMCcheckOriginal(al):
    """
    LMCcheckOriginal(array_link al) -> lmc_t

    lmc_t LMCcheckOriginal(const
    array_link &al)

    direct LMC check using the original LMC check 
    """
    return _oalib.LMCcheckOriginal(al)

def calculateSymmetryGroups(al, adata, oaextend, verbose=1, hack=0):
    """
    calculateSymmetryGroups(array_link al, arraydata_t adata, OAextend oaextend, int verbose=1, int hack=0) -> LMCreduction_t
    calculateSymmetryGroups(array_link al, arraydata_t adata, OAextend oaextend, int verbose=1) -> LMCreduction_t
    calculateSymmetryGroups(array_link al, arraydata_t adata, OAextend oaextend) -> LMCreduction_t
    ...
    helper function 
    """
    return _oalib.calculateSymmetryGroups(al, adata, oaextend, verbose, hack)

def LMCcheckSymmetryMethod(al, ad, oaextend, reduction, reductionsub, dverbose):
    """
    LMCcheckSymmetryMethod(array_link al, arraydata_t ad, OAextend oaextend, LMCreduction_t reduction, LMCreduction_t reductionsub, int dverbose) -> lmc_t
    ...
    """
    return _oalib.LMCcheckSymmetryMethod(al, ad, oaextend, reduction, reductionsub, dverbose)
...
def reductionDOP(al, verbose=0):
    """
    reductionDOP(array_link al, int verbose=0) -> array_transformation_t
    reductionDOP(array_link al) -> array_transformation_t

    array_transformation_t
    reductionDOP(const array_link &al, int verbose=0) 
    """
    return _oalib.reductionDOP(al, verbose)

def selectUniqueArrays(xlist, earrays, verbose=1):
    """
    selectUniqueArrays(arraylist_t xlist, arraylist_t earrays, int verbose=1)
    selectUniqueArrays(arraylist_t xlist, arraylist_t earrays)

    void
    selectUniqueArrays(arraylist_t &xlist, arraylist_t &earrays, int
    verbose=1) 
    """
    return _oalib.selectUniqueArrays(xlist, earrays, verbose)

def reduceLMCform(al):
    """
    reduceLMCform(array_link al) -> array_link

    array_link reduceLMCform(const
    array_link &al)

    reduce an array to canonical form using LMC ordering 
    """
    return _oalib.reduceLMCform(al)

def reduceDOPform(al, verbose=0):
    """
    reduceDOPform(array_link al, int verbose=0) -> array_link
    reduceDOPform(array_link al) -> array_link

    array_link reduceDOPform(const
    array_link &al, int verbose=0)

    reduce an array to canonical form using delete-1-factor ordering 
    """
    return _oalib.reduceDOPform(al, verbose)
...
def LMCcheckLex(*args):
    ...
    LMCcheckLex(array_link al, arraydata_t ad) -> lmc_t

    lmc_t LMCcheckLex(array_link
...
def LMCcheckj4(al, ad, reduction, oaextend, jj=4):
    """
    LMCcheckj4(array_link al, arraydata_t ad, LMCreduction_t reduction, OAextend oaextend, int jj=4) -> lmc_t
    LMCcheckj4(array_link al, arraydata_t ad, LMCreduction_t reduction, OAextend oaextend) -> lmc_t

    lmc_t LMCcheckj4(array_link const
    &al, arraydata_t const &ad, LMCreduction_t &reduction, const OAextend
    &oaextend, int jj=4) 
    """
    return _oalib.LMCcheckj4(al, ad, reduction, oaextend, jj)

def LMCcheckj5(al, ad, reduction, oaextend, hack=0):
    """
    LMCcheckj5(array_link al, arraydata_t ad, LMCreduction_t reduction, OAextend oaextend, int hack=0) -> lmc_t
    LMCcheckj5(array_link al, arraydata_t ad, LMCreduction_t reduction, OAextend oaextend) -> lmc_t

    lmc_t LMCcheckj5(array_link const
    &al, arraydata_t const &ad, LMCreduction_t &reduction, const OAextend
    &oaextend, int hack=0)

    Perform LMC check with J5 ordering. 
    """
    return _oalib.LMCcheckj5(al, ad, reduction, oaextend, hack)

def root_row_permutation_from_index(permindex, ad, lperms):
    """
    root_row_permutation_from_index(int permindex, arraydata_t ad, levelperm_t * lperms)

    void
    root_row_permutation_from_index(int permindex, const arraydata_t *ad,
    levelperm_t *lperms) 
    """
    return _oalib.root_row_permutation_from_index(permindex, ad, lperms)

def create_root_permutations_index(ad, totalpermsr):
    """
    create_root_permutations_index(arraydata_t ad, int & totalpermsr) -> rowperm_t *

    rowperm_t*
    create_root_permutations_index(const arraydata_t *ad, int
    &totalpermsr) 
    """
    return _oalib.create_root_permutations_index(ad, totalpermsr)

def create_root_permutations_index_helper(rperms, lperms, ad, level, permcounter):
    """
    create_root_permutations_index_helper(rowperm_t * rperms, levelperm_t * lperms, arraydata_t ad, int level, int & permcounter)

    void
    create_root_permutations_index_helper(rowperm_t *rperms, levelperm_t
    *lperms, const arraydata_t *ad, int level, int &permcounter) 
    """
    return _oalib.create_root_permutations_index_helper(rperms, lperms, ad, level, permcounter)

def print_rowsort(rowsort, N):
    """
    print_rowsort(rowsort_t rowsort, int N)

    void print_rowsort(rowsort_t
    *rowsort, int N) 
    """
...
def print_fracs(logl=NORMAL):
    """
    print_fracs(int logl=NORMAL)
    print_fracs()

    void print_fracs(int logl=NORMAL)

    """
    return _oalib.print_fracs(logl)
...
def clear_fracs():
    ...
    void clear_fracs() 
    """
    return _oalib.clear_fracs()

_oalib.ISOTOPY_swigconstant(_oalib)
ISOTOPY = _oalib.ISOTOPY

_oalib.MATRIX_ISOMORPHISM_swigconstant(_oalib)
MATRIX_ISOMORPHISM = _oalib.MATRIX_ISOMORPHISM

_oalib.CONFERENCE_ISOMORPHISM_swigconstant(_oalib)
CONFERENCE_ISOMORPHISM = _oalib.CONFERENCE_ISOMORPHISM

_oalib.OA_ISOMORPHISM_swigconstant(_oalib)
OA_ISOMORPHISM = _oalib.OA_ISOMORPHISM

def reduceNauty(G, colors, verbose=0):
    """
    reduceNauty(array_link G, intVector colors, int verbose=0) -> intVector
    reduceNauty(array_link G, intVector colors) -> intVector
    ...
    graph. 
    """
    return _oalib.reduceNauty(G, colors, verbose)

def transformGraph(G, tr, verbose=1):
    """
    transformGraph(array_link G, intVector tr, int verbose=1) -> array_link
    transformGraph(array_link G, intVector tr) -> array_link
    """
    return _oalib.transformGraph(G, tr, verbose)

def reduceOAnauty(*args):
    """
    reduceOAnauty(array_link al, int verbose=0) -> array_transformation_t
    reduceOAnauty(array_link al) -> array_transformation_t
    reduceOAnauty(array_link al, int verbose, arraydata_t ad) -> array_transformation_t
    """
    return _oalib.reduceOAnauty(*args)

def array2graph(*args):
    """
    array2graph(array_link al, int verbose=1) -> pairGraphColors
    array2graph(array_link al) -> pairGraphColors
    array2graph(array_link al, int verbose, arraydata_t ad) -> pairGraphColors
    """
...
def unittest_nautynormalform(al, verbose=1):
    """
    unittest_nautynormalform(array_link al, int verbose=1) -> int
    unittest_nautynormalform(array_link al) -> int
    """
...
class depth_extend_sub_t(object):
    ...
    def __init__(self, nn=0):
        ...
        depth_extend_sub_t::depth_extend_sub_t(int nn=0) 
        """
    ...
    def updateExtensionPointers(self, extcol):
        ...
        std::vector< int > depth_extend_sub_t::updateExtensionPointers(int
        extcol) 
        """
    ...
    def selectArraysXX(self, al, elist):
        ...
        arraylist_t depth_extend_sub_t::selectArraysXX(const array_link &al,
...
class depth_extend_t(object):
    ...
    def __init__(self, *args):
        ...
        depth_extend_t::depth_extend_t(const depth_extend_t &de) 
        """
...
_oalib.DEPTH_DIRECT_swigconstant(_oalib)
DEPTH_DIRECT = _oalib.DEPTH_DIRECT

_oalib.DEPTH_EXTENSIONS_swigconstant(_oalib)
...
def print_cperm(*args):
    """
    print_cperm(charVector c)
    print_cperm(char const * msg, charVector c)

    void print_cperm(const cperm &c)

    print a candidate extension 
    """
    return _oalib.print_cperm(*args)

def partial_inner_product(a, al, col, rmax):
    """
    partial_inner_product(charVector a, array_link al, int col, int rmax) -> int
    ...
    """
    return _oalib.partial_inner_product(a, al, col, rmax)

def showCandidates(cc):
    """
    showCandidates(cpermVector cc)
    ...
    """
    return _oalib.showCandidates(cc)
class conf_candidates_t(object):
    """
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ce = _swig_property(_oalib.conf_candidates_t_ce_get, _oalib.conf_candidates_t_ce_set)

    def info(self, verbose=1):
        """
        info(conf_candidates_t self, int verbose=1)
        info(conf_candidates_t self)

        void
        conf_candidates_t::info(int verbose=1) const 
        """
        return _oalib.conf_candidates_t_info(self, verbose)


    def __init__(self):
        """
        __init__(conf_candidates_t self) -> conf_candidates_t
        ...
        C++ includes: conference.h 
        """
        this = _oalib.new_conf_candidates_t()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _oalib.delete_conf_candidates_t
    __del__ = lambda self: None
conf_candidates_t_swigregister = _oalib.conf_candidates_t_swigregister
conf_candidates_t_swigregister(conf_candidates_t)
...
def reduceConferenceTransformation(al, verbose):
    """
    reduceConferenceTransformation(array_link al, int verbose) -> conference_transformation_t

    conference_transformation_t reduceConferenceTransformation(const
    array_link &al, int verbose)

    reduce conference matrix to normal form 
    """
    return _oalib.reduceConferenceTransformation(al, verbose)
class conference_extend_t(object):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    first = _swig_property(_oalib.conference_extend_t_first_get, _oalib.conference_extend_t_first_set)
    second = _swig_property(_oalib.conference_extend_t_second_get, _oalib.conference_extend_t_second_set)
    extensions = _swig_property(_oalib.conference_extend_t_extensions_get, _oalib.conference_extend_t_extensions_set)
    ...
    def __init__(self):
        ...
        C++ includes: conference.h 
        """
        this = _oalib.new_conference_extend_t()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    __del__ = lambda self: None
conference_extend_t_swigregister = _oalib.conference_extend_t_swigregister
conference_extend_t_swigregister(conference_extend_t)


def checkZeroPosition(p, zero_position):
    """checkZeroPosition(charVector p, int zero_position) -> bool"""
    return _oalib.checkZeroPosition(p, zero_position)

def filterZeroPosition(lst, zero_position):
    """filterZeroPosition(cpermVector lst, int zero_position) -> cpermVector"""
    return _oalib.filterZeroPosition(lst, zero_position)
class conference_options(object):
    """
    C++ includes: conference.h
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    maxzpos = _swig_property(_oalib.conference_options_maxzpos_get, _oalib.conference_options_maxzpos_set)

    def __init__(self, maxpos=-1):
        """
        __init__(conference_options self, int maxpos=-1) -> conference_options
        __init__(conference_options self) -> conference_options

        conference_options::conference_options(int maxpos=-1) 
        """
        this = _oalib.new_conference_options(maxpos)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _oalib.delete_conference_options
    __del__ = lambda self: None
conference_options_swigregister = _oalib.conference_options_swigregister
conference_options_swigregister(conference_options)

class CandidateGeneratorX(object):
    """Proxy of C++ CandidateGeneratorX class."""

    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ct = _swig_property(_oalib.CandidateGeneratorX_ct_get, _oalib.CandidateGeneratorX_ct_set)
    verbose = _swig_property(_oalib.CandidateGeneratorX_verbose_get, _oalib.CandidateGeneratorX_verbose_set)
    cande = _swig_property(_oalib.CandidateGeneratorX_cande_get, _oalib.CandidateGeneratorX_cande_set)
    alz = _swig_property(_oalib.CandidateGeneratorX_alz_get, _oalib.CandidateGeneratorX_alz_set)

    def __init__(self, al, ct):
        """__init__(CandidateGeneratorX self, array_link al, conference_t ct) -> CandidateGeneratorX"""
        this = _oalib.new_CandidateGeneratorX(al, ct)
        try:
            self.this.append(this)
        except Exception:
            self.this = this

    def generateConfCandidatesZero(self, al, kz):
        """generateConfCandidatesZero(CandidateGeneratorX self, array_link al, int kz) -> cpermVector"""
        return _oalib.CandidateGeneratorX_generateConfCandidatesZero(self, al, kz)


    def showCandidates(self):
        """
        showCandidates(CandidateGeneratorX self)
        ...
        show a list of candidate extensions 
        """
        return _oalib.CandidateGeneratorX_showCandidates(self)


    def updateLastValid(self, lv):
        """updateLastValid(CandidateGeneratorX self, int lv)"""
        return _oalib.CandidateGeneratorX_updateLastValid(self, lv)

    __swig_destroy__ = _oalib.delete_CandidateGeneratorX
    __del__ = lambda self: None
CandidateGeneratorX_swigregister = _oalib.CandidateGeneratorX_swigregister
CandidateGeneratorX_swigregister(CandidateGeneratorX)

class CandidateGeneratorBase(object):
    """Proxy of C++ CandidateGeneratorBase class."""

    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ct = _swig_property(_oalib.CandidateGeneratorBase_ct_get, _oalib.CandidateGeneratorBase_ct_set)
    verbose = _swig_property(_oalib.CandidateGeneratorBase_verbose_get, _oalib.CandidateGeneratorBase_verbose_set)
    al = _swig_property(_oalib.CandidateGeneratorBase_al_get, _oalib.CandidateGeneratorBase_al_set)
    last_valid = _swig_property(_oalib.CandidateGeneratorBase_last_valid_get, _oalib.CandidateGeneratorBase_last_valid_set)

    def __init__(self, al, ct):
        """__init__(CandidateGeneratorBase self, array_link al, conference_t ct) -> CandidateGeneratorBase"""
        this = _oalib.new_CandidateGeneratorBase(al, ct)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def showCandidates(self, verbose=1):
        ...
        showCandidates(CandidateGeneratorBase self)
    ...
    __del__ = lambda self: None
CandidateGeneratorBase_swigregister = _oalib.CandidateGeneratorBase_swigregister
CandidateGeneratorBase_swigregister(CandidateGeneratorBase)

class CandidateGeneratorConference(CandidateGeneratorBase):
    """Proxy of C++ CandidateGeneratorConference class."""

    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, al, ct, zero_position=-1):
        """
        __init__(CandidateGeneratorConference self, array_link al, conference_t ct, int zero_position=-1) -> CandidateGeneratorConference
        __init__(CandidateGeneratorConference self, array_link al, conference_t ct) -> CandidateGeneratorConference
        """
        this = _oalib.new_CandidateGeneratorConference(al, ct, zero_position)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def generateCandidates(self, al):
        """generateCandidates(CandidateGeneratorConference self, array_link al) -> cpermVector"""
        return _oalib.CandidateGeneratorConference_generateCandidates(self, al)


    def generateCandidatesZero(self, al, kz):
        """generateCandidatesZero(CandidateGeneratorConference self, array_link al, int kz) -> cpermVector"""
...
class CandidateGeneratorZero(CandidateGeneratorBase):
    """Proxy of C++ CandidateGeneratorZero class."""

    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, al, ct, zero_position):
        """__init__(CandidateGeneratorZero self, array_link al, conference_t ct, int zero_position) -> CandidateGeneratorZero"""
        this = _oalib.new_CandidateGeneratorZero(al, ct, zero_position)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def generateCandidates(self, al):
        """generateCandidates(CandidateGeneratorZero self, array_link al) -> cpermVector"""
        return _oalib.CandidateGeneratorZero_generateCandidates(self, al)

    __swig_destroy__ = _oalib.delete_CandidateGeneratorZero
    __del__ = lambda self: None
CandidateGeneratorZero_swigregister = _oalib.CandidateGeneratorZero_swigregister
CandidateGeneratorZero_swigregister(CandidateGeneratorZero)

class CandidateGeneratorInflate(object):
    """Proxy of C++ CandidateGeneratorInflate class."""

    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ct = _swig_property(_oalib.CandidateGeneratorInflate_ct_get, _oalib.CandidateGeneratorInflate_ct_set)
    verbose = _swig_property(_oalib.CandidateGeneratorInflate_verbose_get, _oalib.CandidateGeneratorInflate_verbose_set)
    generators = _swig_property(_oalib.CandidateGeneratorInflate_generators_get, _oalib.CandidateGeneratorInflate_generators_set)

    def __init__(self, al, ct):
        """__init__(CandidateGeneratorInflate self, array_link al, conference_t ct) -> CandidateGeneratorInflate"""
        this = _oalib.new_CandidateGeneratorInflate(al, ct)
        try:
            self.this.append(this)
        except Exception:
            self.this = this

    def generateConfCandidates(self, al, kz):
        """generateConfCandidates(CandidateGeneratorInflate self, array_link al, int kz) -> cpermVector"""
        return _oalib.CandidateGeneratorInflate_generateConfCandidates(self, al, kz)


    def showCandidates(self, verbose=1):
        """
        showCandidates(CandidateGeneratorInflate self, int verbose=1)
        showCandidates(CandidateGeneratorInflate self)
        ...
        show a list of candidate extensions 
        """
        return _oalib.CandidateGeneratorInflate_showCandidates(self, verbose)

    __swig_destroy__ = _oalib.delete_CandidateGeneratorInflate
    __del__ = lambda self: None
CandidateGeneratorInflate_swigregister = _oalib.CandidateGeneratorInflate_swigregister
CandidateGeneratorInflate_swigregister(CandidateGeneratorInflate)
...
class CandidateGeneratorDouble(CandidateGeneratorBase):
    ...
    def __init__(self, al, ct):
        ...
        CandidateGeneratorDouble::CandidateGeneratorDouble(const array_link
    ...
    def generateCandidates(self, al):
        """generateCandidates(CandidateGeneratorDouble self, array_link al) -> cpermVector"""
...
def extend_conference_matrix(al, ct, extcol, verbose=1, maxzpos=-1):
    """
    extend_conference_matrix(array_link al, conference_t ct, int extcol, int verbose=1, int maxzpos=-1) -> conference_extend_t
    extend_conference_matrix(array_link al, conference_t ct, int extcol, int verbose=1) -> conference_extend_t
    extend_conference_matrix(array_link al, conference_t ct, int extcol) -> conference_extend_t
    ...
    """
    return _oalib.extend_conference_matrix(al, ct, extcol, verbose, maxzpos)

def extend_conference_matrix_generator(al, ct, extcol, verbose, maxzpos, cgenerator):
    """
    extend_conference_matrix_generator(array_link al, conference_t ct, int extcol, int verbose, int maxzpos, CandidateGeneratorConference cgenerator) -> conference_extend_t

    conference_extend_t extend_conference_matrix_generator(const
    array_link &al, const conference_t &ct, int extcol, int verbose, int
    maxzpos, const CandidateGenerator &cgenerator)

    helper function 
    """
    return _oalib.extend_conference_matrix_generator(al, ct, extcol, verbose, maxzpos, cgenerator)

def extend_conference(lst, ctype, verbose, select_isomorphism_classes=0):
    """
    extend_conference(arraylist_t lst, conference_t ctype, int verbose, int select_isomorphism_classes=0) -> arraylist_t
    extend_conference(arraylist_t lst, conference_t ctype, int verbose) -> arraylist_t
    ...
    """
    return _oalib.extend_conference(lst, ctype, verbose, select_isomorphism_classes)

def extend_conference_plain(lst, ctype, verbose, select_isomorphism_classes=0):
    """
    extend_conference_plain(arraylist_t lst, conference_t ctype, int verbose, int select_isomorphism_classes=0) -> arraylist_t
    extend_conference_plain(arraylist_t lst, conference_t ctype, int verbose) -> arraylist_t
    ...
    """
    return _oalib.extend_conference_plain(lst, ctype, verbose, select_isomorphism_classes)

def extend_conference_restricted(lst, ctype, verbose):
    """
    extend_conference_restricted(arraylist_t lst, conference_t ctype, int verbose) -> arraylist_t
    ...
    Extend a list of conference designs with a single column 
    """
    return _oalib.extend_conference_restricted(lst, ctype, verbose)

def extend_double_conference(lst, ctype, verbose):
    """
    extend_double_conference(arraylist_t lst, conference_t ctype, int verbose) -> arraylist_t

    arraylist_t
    extend_double_conference(const arraylist_t &lst, const conference_t
    ctype, int verbose) 
    """
    return _oalib.extend_double_conference(lst, ctype, verbose)
...
def selectConferenceIsomorpismIndices(lst, verbose, itype=CONFERENCE_ISOMORPHISM):
    ...
    std::vector<int> selectConferenceIsomorpismIndices(const arraylist_t
...
def selectLMC0(list, verbose, ctype):
    ...
    arraylist_t selectLMC0(const
    arraylist_t &list, int verbose, const conference_t &ctype) 
    """
    return _oalib.selectLMC0(list, verbose, ctype)

def generateConferenceExtensions(al, ct, kz, verbose=1, filtersymm=1, filterj2=1):
    """
    generateConferenceExtensions(array_link al, conference_t ct, int kz, int verbose=1, int filtersymm=1, int filterj2=1) -> cpermVector
    generateConferenceExtensions(array_link al, conference_t ct, int kz, int verbose=1, int filtersymm=1) -> cpermVector
    generateConferenceExtensions(array_link al, conference_t ct, int kz, int verbose=1) -> cpermVector
    generateConferenceExtensions(array_link al, conference_t ct, int kz) -> cpermVector

    std::vector<cperm> generateConferenceExtensions(const array_link &al,
    ...
    """
    return _oalib.generateConferenceExtensions(al, ct, kz, verbose, filtersymm, filterj2)

def generateConferenceRestrictedExtensions(al, ct, kz, verbose=1, filtersymm=1, filterip=1):
    """
    generateConferenceRestrictedExtensions(array_link al, conference_t ct, int kz, int verbose=1, int filtersymm=1, int filterip=1) -> cpermVector
    generateConferenceRestrictedExtensions(array_link al, conference_t ct, int kz, int verbose=1, int filtersymm=1) -> cpermVector
    generateConferenceRestrictedExtensions(array_link al, conference_t ct, int kz, int verbose=1) -> cpermVector
    generateConferenceRestrictedExtensions(array_link al, conference_t ct, int kz) -> cpermVector

    std::vector<cperm> generateConferenceRestrictedExtensions(const
    ...
    """
    return _oalib.generateConferenceRestrictedExtensions(al, ct, kz, verbose, filtersymm, filterip)

def generateDoubleConferenceExtensions(al, ct, verbose=1, filtersymm=1, filterip=1, filterJ3=0, filtersymminline=1):
    """
    generateDoubleConferenceExtensions(array_link al, conference_t ct, int verbose=1, int filtersymm=1, int filterip=1, int filterJ3=0, int filtersymminline=1) -> cpermVector
    generateDoubleConferenceExtensions(array_link al, conference_t ct, int verbose=1, int filtersymm=1, int filterip=1, int filterJ3=0) -> cpermVector
    generateDoubleConferenceExtensions(array_link al, conference_t ct, int verbose=1, int filtersymm=1, int filterip=1) -> cpermVector
    generateDoubleConferenceExtensions(array_link al, conference_t ct, int verbose=1, int filtersymm=1) -> cpermVector
    generateDoubleConferenceExtensions(array_link al, conference_t ct, int verbose=1) -> cpermVector
    generateDoubleConferenceExtensions(array_link al, conference_t ct) -> cpermVector

    std::vector<cperm> generateDoubleConferenceExtensions(const array_link
    &al, const conference_t &ct, int verbose=1, int filtersymm=1, int
    filterip=1, int filterJ3=0, int filtersymminline=1) 
    """
    return _oalib.generateDoubleConferenceExtensions(al, ct, verbose, filtersymm, filterip, filterJ3, filtersymminline)

def generateSingleConferenceExtensions(al, ct, kz, verbose, filtersymm, filterj2, filterj3, filtersymminline):
    """generateSingleConferenceExtensions(array_link al, conference_t ct, int kz, int verbose, int filtersymm, int filterj2, int filterj3, int filtersymminline) -> cpermVector"""
    return _oalib.generateSingleConferenceExtensions(al, ct, kz, verbose, filtersymm, filterj2, filterj3, filtersymminline)

def generateConferenceExtensionsOld(al, ct, kz, verbose, filtersymm, filterj2):
    """generateConferenceExtensionsOld(array_link al, conference_t ct, int kz, int verbose, int filtersymm, int filterj2) -> cpermVector"""
    return _oalib.generateConferenceExtensionsOld(al, ct, kz, verbose, filtersymm, filterj2)

def maxz(al, k=-1):
    """
    maxz(array_link al, int k=-1) -> int
...
def LMC0check(al, verbose=0):
    ...
    lmc_t LMC0check(const array_link
    &al, int verbose=0)
...
def satisfy_symm(*args):
    """
    satisfy_symm(charVector c, symmdata sd, int rowstart=2) -> int
    satisfy_symm(charVector c, symmdata sd) -> int
    satisfy_symm(charVector c, intVector check_indices, int rowstart=2) -> int
    satisfy_symm(charVector c, intVector check_indices) -> int
    satisfy_symm(charVector c, intVector check_indices, int rowstart, int rowend) -> int

    int satisfy_symm(const cperm &c,
    ...
    symmetry test 
    """
    return _oalib.satisfy_symm(*args)

def ipcheck(col, al, cstart=2, verbose=0):
    """
    ipcheck(charVector col, array_link al, int cstart=2, int verbose=0) -> int
    ipcheck(charVector col, array_link al, int cstart=2) -> int
    ipcheck(charVector col, array_link al) -> int

    int ipcheck(const cperm &col, const
    array_link &al, int cstart=2, int verbose=0) 
    """
    return _oalib.ipcheck(col, al, cstart, verbose)

def minz(al, k):
    """
    minz(array_link al, int k) -> int

    int minz(const array_link &al, int k)

    return minimal position of zero in design 
    """
    return _oalib.minz(al, k)
class DconferenceFilter(object):
    ...
    def __init__(self, _als, filtersymm_, filterj2_, filterj3_=1):
        ...
        DconferenceFilter::DconferenceFilter(const array_link &_als, int
    ...
    def filterList(self, lst, verbose=0):
        """
        filterList(DconferenceFilter self, cpermVector lst, int verbose=0) -> cpermVector
        filterList(DconferenceFilter self, cpermVector lst) -> cpermVector

        std::vector<cperm> DconferenceFilter::filterList(const std::vector<
    ...
    def filterListJ2last(self, lst):
        """
        filterListJ2last(DconferenceFilter self, cpermVector lst) -> cpermVector

        std::vector<cperm> DconferenceFilter::filterListJ2last(const
        std::vector< cperm > &lst) const 
        """
        return _oalib.DconferenceFilter_filterListJ2last(self, lst)


    def filterListZero(self, lst):
        """
        filterListZero(DconferenceFilter self, cpermVector lst) -> cpermVector

        std::vector<cperm> DconferenceFilter::filterListZero(const
        std::vector< cperm > &lst) const
    ...
    def filterJpartial(self, c, r):
        """
        filterJpartial(DconferenceFilter self, charVector c, int r) -> bool
        ...
        """
        return _oalib.DconferenceFilter_filterJpartial(self, c, r)


    def filterJ(self, c, j2start=0):
        """
        filterJ(DconferenceFilter self, charVector c, int j2start=0) -> bool
        filterJ(DconferenceFilter self, charVector c) -> bool
        ...
        """
        return _oalib.DconferenceFilter_filterJ(self, c, j2start)
    ...
    def filterReason(self, c):
        """
        filterReason(DconferenceFilter self, charVector c) -> bool
        ...
        return True of the extension satisfies all checks 
        """
        return _oalib.DconferenceFilter_filterReason(self, c)


    def filterJ3(self, c):
        """
        filterJ3(DconferenceFilter self, charVector c) -> bool
        ...
        """
        return _oalib.DconferenceFilter_filterJ3(self, c)


    def filterJ3s(self, c, idxstart):
        """
        filterJ3s(DconferenceFilter self, charVector c, int idxstart) -> bool
        ...
        pairs 
        """
        return _oalib.DconferenceFilter_filterJ3s(self, c, idxstart)


    def filterJ3r(self, c):
        """
        filterJ3r(DconferenceFilter self, charVector c) -> bool
        ...
        return True of the candidate satisfies the J3 check 
        """
        return _oalib.DconferenceFilter_filterJ3r(self, c)


    def filterJ3inline(self, c):
        """
        filterJ3inline(DconferenceFilter self, charVector c) -> bool
        ...
        return True of the candidate satisfies the J3 check 
        """
        return _oalib.DconferenceFilter_filterJ3inline(self, c)


    def filterSymmetry(self, c):
        """
        filterSymmetry(DconferenceFilter self, charVector c) -> bool
        ...
        """
        return _oalib.DconferenceFilter_filterSymmetry(self, c)
...
def generateDoubleConferenceExtensionsInflate(al, ct, verbose, filterj2, filterj3, kstart=2):
    """
    generateDoubleConferenceExtensionsInflate(array_link al, conference_t ct, int verbose, int filterj2, int filterj3, int kstart=2) -> cpermVector
    generateDoubleConferenceExtensionsInflate(array_link al, conference_t ct, int verbose, int filterj2, int filterj3) -> cpermVector

    std::vector<cperm> generateDoubleConferenceExtensionsInflate(const
    array_link &al, const conference_t &ct, int verbose, int filterj2, int
    filterj3, int kstart=2) 
    """
    return _oalib.generateDoubleConferenceExtensionsInflate(al, ct, verbose, filterj2, filterj3, kstart)

def inflateCandidateExtension(basecandidate, als, alsg, check_indices, ct, verbose, filter):
    """
    inflateCandidateExtension(charVector basecandidate, array_link als, symmetry_group alsg, intVector check_indices, conference_t ct, int verbose, DconferenceFilter filter) -> cpermVector
    ...
    """
    return _oalib.inflateCandidateExtension(basecandidate, als, alsg, check_indices, ct, verbose, filter)

def setdtsymm(arg1):
    """setdtsymm(double arg1)"""
    return _oalib.setdtsymm(arg1)

def getdtsymm():
    """getdtsymm() -> double"""
    return _oalib.getdtsymm()

def setdtlmc(arg1):
    """setdtlmc(double arg1)"""
    return _oalib.setdtlmc(arg1)

def getdtlmc():
    """getdtlmc() -> double"""
    return _oalib.getdtlmc()

def adddtlmc(arg1):
    """adddtlmc(double arg1)"""
    return _oalib.adddtlmc(arg1)

def extend_array_dynamic(*args):
    """
    extend_array_dynamic(arraylist_t alist, arraydata_t adx, OAextend oaextend, arraylist_t earrays, vector_vector_double edata, int kfinal, double Afinal, int directcheck, int verbose=1) -> int
    extend_array_dynamic(arraylist_t alist, arraydata_t adx, OAextend oaextend, arraylist_t earrays, vector_vector_double edata, int kfinal, double Afinal, int directcheck) -> int
    extend_array_dynamic(array_link al, arraydata_t adx, OAextend oaextend, arraylist_t earrays, vector_vector_double edata, dextend_t dextend, int kfinal, double Afinal, int rs, int verbose=1) -> int
    extend_array_dynamic(array_link al, arraydata_t adx, OAextend oaextend, arraylist_t earrays, vector_vector_double edata, dextend_t dextend, int kfinal, double Afinal, int rs) -> int
    """
    return _oalib.extend_array_dynamic(*args)

def extend_array_large(origarray, fullad, extensioncol, extensions, oaextend, largecol):
    """extend_array_large(carray_t * origarray, arraydata_t fullad, colindex_t extensioncol, arraylist_t extensions, OAextend oaextend, int largecol) -> int"""
    return _oalib.extend_array_large(origarray, fullad, extensioncol, extensions, oaextend, largecol)

def extend_array_el(al, fullad, extensions, oaextend, verbose=1):
    """
    extend_array_el(array_link al, arraydata_t fullad, arraylist_t extensions, OAextend oaextend, int verbose=1) -> int
    extend_array_el(array_link al, arraydata_t fullad, arraylist_t extensions, OAextend oaextend) -> int
    """
    return _oalib.extend_array_el(al, fullad, extensions, oaextend, verbose)
...
class mvalue_t_long(object):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    v = _swig_property(_oalib.mvalue_t_long_v_get, _oalib.mvalue_t_long_v_set)
    HIGH = _oalib.mvalue_t_long_HIGH
    LOW = _oalib.mvalue_t_long_LOW
    d = _swig_property(_oalib.mvalue_t_long_d_get, _oalib.mvalue_t_long_d_set)
...
class mvalue_t_double(object):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    v = _swig_property(_oalib.mvalue_t_double_v_get, _oalib.mvalue_t_double_v_set)
    HIGH = _oalib.mvalue_t_double_HIGH
    LOW = _oalib.mvalue_t_double_LOW
    d = _swig_property(_oalib.mvalue_t_double_d_get, _oalib.mvalue_t_double_d_set)
...
class ParetoLong(object):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    verbose = _swig_property(_oalib.ParetoLong_verbose_get, _oalib.ParetoLong_verbose_set)
    elements = _swig_property(_oalib.ParetoLong_elements_get, _oalib.ParetoLong_elements_set)

    def __init__(self):
        """
        __init__(Pareto<(mvalue_t<(long)>,long)> self) -> ParetoLong

        Pareto< ValueType, IndexType
        >::Pareto()

        constructor 
        """
        this = _oalib.new_ParetoLong()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _oalib.delete_ParetoLong
    __del__ = lambda self: None

    def number(self):
        """
        number(ParetoLong self) -> int

        int Pareto< ValueType,
        IndexType >::number() const

        return the total number of Pareto optimal values 
        """
        return _oalib.ParetoLong_number(self)


    def numberindices(self):
        """
        numberindices(ParetoLong self) -> int
        ...
        """
        return _oalib.ParetoLong_numberindices(self)


    def __repr__(self):
        """
        __repr__(ParetoLong self) -> std::string

        std::string Pareto<
        ValueType, IndexType >::__repr__() const 
        """
        return _oalib.ParetoLong___repr__(self)


    def showvalue(p):
        """showvalue(mvalueVector p)"""
        return _oalib.ParetoLong_showvalue(p)

    showvalue = staticmethod(showvalue)

    def show(self, verbose=1):
        """
        show(ParetoLong self, int verbose=1)
        show(ParetoLong self)

        void Pareto< ValueType,
        IndexType >::show(int verbose=1)

        show the current set of Pareto optimal elements 
        """
        return _oalib.ParetoLong_show(self, verbose)


    def allindicesdeque(self):
        """
        allindicesdeque(ParetoLong self) -> longDeque
        ...
        """
        return _oalib.ParetoLong_allindicesdeque(self)


    def allindices(self):
        """
        allindices(ParetoLong self) -> longVector
        ...
        """
        return _oalib.ParetoLong_allindices(self)


    def allvalues(self):
        """
        allvalues(ParetoLong self) -> std::vector< Pareto< mvalue_t< long >,long >::pValue,std::allocator< Pareto< mvalue_t< long >,long >::pValue > >

        std::vector<pValue> Pareto<
        ValueType, IndexType >::allvalues() const

        return all Paretop optimal elements 
        """
        return _oalib.ParetoLong_allvalues(self)


    def addvalue(self, val, idx):
        """
        addvalue(ParetoLong self, mvalueVector val, long const idx) -> bool

        bool Pareto< ValueType,
        IndexType >::addvalue(const pValue val, const IndexType idx)

        add a new element 
        """
        return _oalib.ParetoLong_addvalue(self, val, idx)

ParetoLong_swigregister = _oalib.ParetoLong_swigregister
ParetoLong_swigregister(ParetoLong)

def ParetoLong_showvalue(p):
    """ParetoLong_showvalue(mvalueVector p)"""
    return _oalib.ParetoLong_showvalue(p)

class ParetoMLong(object):
    """
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    verbose = _swig_property(_oalib.ParetoMLong_verbose_get, _oalib.ParetoMLong_verbose_set)
    elements = _swig_property(_oalib.ParetoMLong_elements_get, _oalib.ParetoMLong_elements_set)

    def __init__(self):
        """
        __init__(Pareto<(mvalue_t<(long)>,long)> self) -> ParetoMLong
        ...
        constructor 
        """
        this = _oalib.new_ParetoMLong()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _oalib.delete_ParetoMLong
    __del__ = lambda self: None

    def number(self):
        """
        number(ParetoMLong self) -> int
        ...
        return the total number of Pareto optimal values 
        """
        return _oalib.ParetoMLong_number(self)


    def numberindices(self):
        """
        numberindices(ParetoMLong self) -> int
        ...
        return the toal number Pareto optimal objects 
        """
        return _oalib.ParetoMLong_numberindices(self)


    def __repr__(self):
        """
        __repr__(ParetoMLong self) -> std::string

        std::string Pareto<
        ValueType, IndexType >::__repr__() const 
        """
        return _oalib.ParetoMLong___repr__(self)


    def showvalue(p):
        """showvalue(mvalueVector p)"""
        return _oalib.ParetoMLong_showvalue(p)

    showvalue = staticmethod(showvalue)

    def show(self, verbose=1):
        """
        show(ParetoMLong self, int verbose=1)
        show(ParetoMLong self)
        ...
        show the current set of Pareto optimal elements 
        """
        return _oalib.ParetoMLong_show(self, verbose)


    def allindicesdeque(self):
        """
        allindicesdeque(ParetoMLong self) -> longDeque
        ...
        return all indices of the Pareto optimal elements as a std::deque 
        """
        return _oalib.ParetoMLong_allindicesdeque(self)


    def allindices(self):
        """
        allindices(ParetoMLong self) -> longVector
        ...
        return all indices of the Pareto optimal elements 
        """
        return _oalib.ParetoMLong_allindices(self)


    def allvalues(self):
        """
        allvalues(ParetoMLong self) -> std::vector< Pareto< mvalue_t< long >,long >::pValue,std::allocator< Pareto< mvalue_t< long >,long >::pValue > >
        ...
        return all Paretop optimal elements 
        """
        return _oalib.ParetoMLong_allvalues(self)


    def addvalue(self, val, idx):
        """
        addvalue(ParetoMLong self, mvalueVector val, long const idx) -> bool
        ...
        add a new element 
        """
        return _oalib.ParetoMLong_addvalue(self, val, idx)

ParetoMLong_swigregister = _oalib.ParetoMLong_swigregister
ParetoMLong_swigregister(ParetoMLong)

def ParetoMLong_showvalue(p):
    """ParetoMLong_showvalue(mvalueVector p)"""
    return _oalib.ParetoMLong_showvalue(p)
...
class ParetoElementLong(object):
    ...
    def dominates(self, v):
        """
        dominates(ParetoElementLong self, mvalueVector v) -> bool
    ...
    def isdominated(self, v):
        """
        isdominated(ParetoElementLong self, mvalueVector v) -> bool
    ...
    def equal(self, v):
        """
        equal(ParetoElementLong self, mvalueVector v) -> bool
...
class ParetoMElementLong(object):
    ...
    def dominates(self, v):
        """
        dominates(ParetoMElementLong self, mvalueVector v) -> bool
    ...
    def isdominated(self, v):
        """
        isdominated(ParetoMElementLong self, mvalueVector v) -> bool
    ...
    def equal(self, v):
        """
        equal(ParetoMElementLong self, mvalueVector v) -> bool
...
class mvalueVector(object):
    ...
    def iterator(self):
        """iterator(mvalueVector self) -> SwigPyIterator"""
        return _oalib.mvalueVector_iterator(self)

    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        """__nonzero__(mvalueVector self) -> bool"""
        return _oalib.mvalueVector___nonzero__(self)


    def __bool__(self):
        """__bool__(mvalueVector self) -> bool"""
        return _oalib.mvalueVector___bool__(self)


    def __len__(self):
        """__len__(mvalueVector self) -> std::vector< mvalue_t< long > >::size_type"""
        return _oalib.mvalueVector___len__(self)


    def __getslice__(self, i, j):
        """__getslice__(mvalueVector self, std::vector< mvalue_t< long > >::difference_type i, std::vector< mvalue_t< long > >::difference_type j) -> mvalueVector"""
        return _oalib.mvalueVector___getslice__(self, i, j)


    def __setslice__(self, *args):
        """
        __setslice__(mvalueVector self, std::vector< mvalue_t< long > >::difference_type i, std::vector< mvalue_t< long > >::difference_type j)
        __setslice__(mvalueVector self, std::vector< mvalue_t< long > >::difference_type i, std::vector< mvalue_t< long > >::difference_type j, mvalueVector v)
        """
        return _oalib.mvalueVector___setslice__(self, *args)


    def __delslice__(self, i, j):
        """__delslice__(mvalueVector self, std::vector< mvalue_t< long > >::difference_type i, std::vector< mvalue_t< long > >::difference_type j)"""
        return _oalib.mvalueVector___delslice__(self, i, j)


    def __delitem__(self, *args):
        """
        __delitem__(mvalueVector self, std::vector< mvalue_t< long > >::difference_type i)
        __delitem__(mvalueVector self, PySliceObject * slice)
        """
        return _oalib.mvalueVector___delitem__(self, *args)


    def __getitem__(self, *args):
        """
        __getitem__(mvalueVector self, PySliceObject * slice) -> mvalueVector
        __getitem__(mvalueVector self, std::vector< mvalue_t< long > >::difference_type i) -> mvalue_t_long
        """
        return _oalib.mvalueVector___getitem__(self, *args)


    def __setitem__(self, *args):
        """
        __setitem__(mvalueVector self, PySliceObject * slice, mvalueVector v)
        __setitem__(mvalueVector self, PySliceObject * slice)
        __setitem__(mvalueVector self, std::vector< mvalue_t< long > >::difference_type i, mvalue_t_long x)
        """
        return _oalib.mvalueVector___setitem__(self, *args)


    def pop(self):
        """pop(mvalueVector self) -> mvalue_t_long"""
        return _oalib.mvalueVector_pop(self)


    def append(self, x):
        """append(mvalueVector self, mvalue_t_long x)"""
        return _oalib.mvalueVector_append(self, x)


    def empty(self):
        """empty(mvalueVector self) -> bool"""
        return _oalib.mvalueVector_empty(self)


    def size(self):
        """size(mvalueVector self) -> std::vector< mvalue_t< long > >::size_type"""
        return _oalib.mvalueVector_size(self)


    def swap(self, v):
        """swap(mvalueVector self, mvalueVector v)"""
        return _oalib.mvalueVector_swap(self, v)


    def begin(self):
        """begin(mvalueVector self) -> std::vector< mvalue_t< long > >::iterator"""
        return _oalib.mvalueVector_begin(self)


    def end(self):
        """end(mvalueVector self) -> std::vector< mvalue_t< long > >::iterator"""
        return _oalib.mvalueVector_end(self)


    def rbegin(self):
        """rbegin(mvalueVector self) -> std::vector< mvalue_t< long > >::reverse_iterator"""
        return _oalib.mvalueVector_rbegin(self)


    def rend(self):
        """rend(mvalueVector self) -> std::vector< mvalue_t< long > >::reverse_iterator"""
        return _oalib.mvalueVector_rend(self)


    def clear(self):
        """clear(mvalueVector self)"""
        return _oalib.mvalueVector_clear(self)


    def get_allocator(self):
        """get_allocator(mvalueVector self) -> std::vector< mvalue_t< long > >::allocator_type"""
        return _oalib.mvalueVector_get_allocator(self)


    def pop_back(self):
        """pop_back(mvalueVector self)"""
        return _oalib.mvalueVector_pop_back(self)


    def erase(self, *args):
        """
        erase(mvalueVector self, std::vector< mvalue_t< long > >::iterator pos) -> std::vector< mvalue_t< long > >::iterator
        erase(mvalueVector self, std::vector< mvalue_t< long > >::iterator first, std::vector< mvalue_t< long > >::iterator last) -> std::vector< mvalue_t< long > >::iterator
        """
        return _oalib.mvalueVector_erase(self, *args)


    def __init__(self, *args):
        """
        __init__(std::vector<(mvalue_t<(long)>)> self) -> mvalueVector
        __init__(std::vector<(mvalue_t<(long)>)> self, mvalueVector arg2) -> mvalueVector
        __init__(std::vector<(mvalue_t<(long)>)> self, std::vector< mvalue_t< long > >::size_type size) -> mvalueVector
        __init__(std::vector<(mvalue_t<(long)>)> self, std::vector< mvalue_t< long > >::size_type size, mvalue_t_long value) -> mvalueVector
        """
        this = _oalib.new_mvalueVector(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def push_back(self, x):
        """push_back(mvalueVector self, mvalue_t_long x)"""
        return _oalib.mvalueVector_push_back(self, x)


    def front(self):
        """front(mvalueVector self) -> mvalue_t_long"""
        return _oalib.mvalueVector_front(self)


    def back(self):
        """back(mvalueVector self) -> mvalue_t_long"""
        return _oalib.mvalueVector_back(self)


    def assign(self, n, x):
        """assign(mvalueVector self, std::vector< mvalue_t< long > >::size_type n, mvalue_t_long x)"""
        return _oalib.mvalueVector_assign(self, n, x)


    def resize(self, *args):
        """
        resize(mvalueVector self, std::vector< mvalue_t< long > >::size_type new_size)
        resize(mvalueVector self, std::vector< mvalue_t< long > >::size_type new_size, mvalue_t_long x)
        """
        return _oalib.mvalueVector_resize(self, *args)


    def insert(self, *args):
        """
        insert(mvalueVector self, std::vector< mvalue_t< long > >::iterator pos, mvalue_t_long x) -> std::vector< mvalue_t< long > >::iterator
        insert(mvalueVector self, std::vector< mvalue_t< long > >::iterator pos, std::vector< mvalue_t< long > >::size_type n, mvalue_t_long x)
        """
        return _oalib.mvalueVector_insert(self, *args)


    def reserve(self, n):
        """reserve(mvalueVector self, std::vector< mvalue_t< long > >::size_type n)"""
        return _oalib.mvalueVector_reserve(self, n)


    def capacity(self):
        """capacity(mvalueVector self) -> std::vector< mvalue_t< long > >::size_type"""
        return _oalib.mvalueVector_capacity(self)

    __swig_destroy__ = _oalib.delete_mvalueVector
    __del__ = lambda self: None
mvalueVector_swigregister = _oalib.mvalueVector_swigregister
mvalueVector_swigregister(mvalueVector)
...
class GWLPvalueVector(object):
    ...
    def iterator(self):
        """iterator(GWLPvalueVector self) -> SwigPyIterator"""
        return _oalib.GWLPvalueVector_iterator(self)

    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        """__nonzero__(GWLPvalueVector self) -> bool"""
        return _oalib.GWLPvalueVector___nonzero__(self)


    def __bool__(self):
        """__bool__(GWLPvalueVector self) -> bool"""
        return _oalib.GWLPvalueVector___bool__(self)


    def __len__(self):
        """__len__(GWLPvalueVector self) -> std::vector< mvalue_t< double > >::size_type"""
        return _oalib.GWLPvalueVector___len__(self)


    def __getslice__(self, i, j):
        """__getslice__(GWLPvalueVector self, std::vector< mvalue_t< double > >::difference_type i, std::vector< mvalue_t< double > >::difference_type j) -> GWLPvalueVector"""
        return _oalib.GWLPvalueVector___getslice__(self, i, j)


    def __setslice__(self, *args):
        """
        __setslice__(GWLPvalueVector self, std::vector< mvalue_t< double > >::difference_type i, std::vector< mvalue_t< double > >::difference_type j)
        __setslice__(GWLPvalueVector self, std::vector< mvalue_t< double > >::difference_type i, std::vector< mvalue_t< double > >::difference_type j, GWLPvalueVector v)
        """
        return _oalib.GWLPvalueVector___setslice__(self, *args)


    def __delslice__(self, i, j):
        """__delslice__(GWLPvalueVector self, std::vector< mvalue_t< double > >::difference_type i, std::vector< mvalue_t< double > >::difference_type j)"""
        return _oalib.GWLPvalueVector___delslice__(self, i, j)


    def __delitem__(self, *args):
        """
        __delitem__(GWLPvalueVector self, std::vector< mvalue_t< double > >::difference_type i)
        __delitem__(GWLPvalueVector self, PySliceObject * slice)
        """
        return _oalib.GWLPvalueVector___delitem__(self, *args)


    def __getitem__(self, *args):
        """
        __getitem__(GWLPvalueVector self, PySliceObject * slice) -> GWLPvalueVector
        __getitem__(GWLPvalueVector self, std::vector< mvalue_t< double > >::difference_type i) -> mvalue_t_double
        """
        return _oalib.GWLPvalueVector___getitem__(self, *args)


    def __setitem__(self, *args):
        """
        __setitem__(GWLPvalueVector self, PySliceObject * slice, GWLPvalueVector v)
        __setitem__(GWLPvalueVector self, PySliceObject * slice)
        __setitem__(GWLPvalueVector self, std::vector< mvalue_t< double > >::difference_type i, mvalue_t_double x)
        """
        return _oalib.GWLPvalueVector___setitem__(self, *args)


    def pop(self):
        """pop(GWLPvalueVector self) -> mvalue_t_double"""
        return _oalib.GWLPvalueVector_pop(self)


    def append(self, x):
        """append(GWLPvalueVector self, mvalue_t_double x)"""
        return _oalib.GWLPvalueVector_append(self, x)


    def empty(self):
        """empty(GWLPvalueVector self) -> bool"""
        return _oalib.GWLPvalueVector_empty(self)


    def size(self):
        """size(GWLPvalueVector self) -> std::vector< mvalue_t< double > >::size_type"""
        return _oalib.GWLPvalueVector_size(self)


    def swap(self, v):
        """swap(GWLPvalueVector self, GWLPvalueVector v)"""
        return _oalib.GWLPvalueVector_swap(self, v)


    def begin(self):
        """begin(GWLPvalueVector self) -> std::vector< mvalue_t< double > >::iterator"""
        return _oalib.GWLPvalueVector_begin(self)


    def end(self):
        """end(GWLPvalueVector self) -> std::vector< mvalue_t< double > >::iterator"""
        return _oalib.GWLPvalueVector_end(self)


    def rbegin(self):
        """rbegin(GWLPvalueVector self) -> std::vector< mvalue_t< double > >::reverse_iterator"""
        return _oalib.GWLPvalueVector_rbegin(self)


    def rend(self):
        """rend(GWLPvalueVector self) -> std::vector< mvalue_t< double > >::reverse_iterator"""
        return _oalib.GWLPvalueVector_rend(self)


    def clear(self):
        """clear(GWLPvalueVector self)"""
        return _oalib.GWLPvalueVector_clear(self)


    def get_allocator(self):
        """get_allocator(GWLPvalueVector self) -> std::vector< mvalue_t< double > >::allocator_type"""
        return _oalib.GWLPvalueVector_get_allocator(self)


    def pop_back(self):
        """pop_back(GWLPvalueVector self)"""
        return _oalib.GWLPvalueVector_pop_back(self)


    def erase(self, *args):
        """
        erase(GWLPvalueVector self, std::vector< mvalue_t< double > >::iterator pos) -> std::vector< mvalue_t< double > >::iterator
        erase(GWLPvalueVector self, std::vector< mvalue_t< double > >::iterator first, std::vector< mvalue_t< double > >::iterator last) -> std::vector< mvalue_t< double > >::iterator
        """
        return _oalib.GWLPvalueVector_erase(self, *args)


    def __init__(self, *args):
        """
        __init__(std::vector<(mvalue_t<(double)>)> self) -> GWLPvalueVector
        __init__(std::vector<(mvalue_t<(double)>)> self, GWLPvalueVector arg2) -> GWLPvalueVector
        __init__(std::vector<(mvalue_t<(double)>)> self, std::vector< mvalue_t< double > >::size_type size) -> GWLPvalueVector
        __init__(std::vector<(mvalue_t<(double)>)> self, std::vector< mvalue_t< double > >::size_type size, mvalue_t_double value) -> GWLPvalueVector
        """
        this = _oalib.new_GWLPvalueVector(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def push_back(self, x):
        """push_back(GWLPvalueVector self, mvalue_t_double x)"""
        return _oalib.GWLPvalueVector_push_back(self, x)


    def front(self):
        """front(GWLPvalueVector self) -> mvalue_t_double"""
        return _oalib.GWLPvalueVector_front(self)


    def back(self):
        """back(GWLPvalueVector self) -> mvalue_t_double"""
        return _oalib.GWLPvalueVector_back(self)


    def assign(self, n, x):
        """assign(GWLPvalueVector self, std::vector< mvalue_t< double > >::size_type n, mvalue_t_double x)"""
        return _oalib.GWLPvalueVector_assign(self, n, x)


    def resize(self, *args):
        """
        resize(GWLPvalueVector self, std::vector< mvalue_t< double > >::size_type new_size)
        resize(GWLPvalueVector self, std::vector< mvalue_t< double > >::size_type new_size, mvalue_t_double x)
        """
        return _oalib.GWLPvalueVector_resize(self, *args)


    def insert(self, *args):
        """
        insert(GWLPvalueVector self, std::vector< mvalue_t< double > >::iterator pos, mvalue_t_double x) -> std::vector< mvalue_t< double > >::iterator
        insert(GWLPvalueVector self, std::vector< mvalue_t< double > >::iterator pos, std::vector< mvalue_t< double > >::size_type n, mvalue_t_double x)
        """
        return _oalib.GWLPvalueVector_insert(self, *args)


    def reserve(self, n):
        """reserve(GWLPvalueVector self, std::vector< mvalue_t< double > >::size_type n)"""
        return _oalib.GWLPvalueVector_reserve(self, n)


    def capacity(self):
        """capacity(GWLPvalueVector self) -> std::vector< mvalue_t< double > >::size_type"""
        return _oalib.GWLPvalueVector_capacity(self)

    __swig_destroy__ = _oalib.delete_GWLPvalueVector
    __del__ = lambda self: None
GWLPvalueVector_swigregister = _oalib.GWLPvalueVector_swigregister
GWLPvalueVector_swigregister(GWLPvalueVector)

class cpermVector(object):
    """Proxy of C++ std::vector<(cperm)> class."""

    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def iterator(self):
        """iterator(cpermVector self) -> SwigPyIterator"""
        return _oalib.cpermVector_iterator(self)

    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        """__nonzero__(cpermVector self) -> bool"""
        return _oalib.cpermVector___nonzero__(self)


    def __bool__(self):
        """__bool__(cpermVector self) -> bool"""
        return _oalib.cpermVector___bool__(self)


    def __len__(self):
        """__len__(cpermVector self) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::size_type"""
        return _oalib.cpermVector___len__(self)


    def __getslice__(self, i, j):
        """__getslice__(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type i, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type j) -> cpermVector"""
        return _oalib.cpermVector___getslice__(self, i, j)


    def __setslice__(self, *args):
        """
        __setslice__(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type i, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type j)
        __setslice__(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type i, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type j, cpermVector v)
        """
        return _oalib.cpermVector___setslice__(self, *args)


    def __delslice__(self, i, j):
        """__delslice__(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type i, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type j)"""
        return _oalib.cpermVector___delslice__(self, i, j)


    def __delitem__(self, *args):
        """
        __delitem__(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type i)
        __delitem__(cpermVector self, PySliceObject * slice)
        """
        return _oalib.cpermVector___delitem__(self, *args)


    def __getitem__(self, *args):
        """
        __getitem__(cpermVector self, PySliceObject * slice) -> cpermVector
        __getitem__(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type i) -> charVector
        """
        return _oalib.cpermVector___getitem__(self, *args)


    def __setitem__(self, *args):
        """
        __setitem__(cpermVector self, PySliceObject * slice, cpermVector v)
        __setitem__(cpermVector self, PySliceObject * slice)
        __setitem__(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::difference_type i, charVector x)
        """
        return _oalib.cpermVector___setitem__(self, *args)


    def pop(self):
        """pop(cpermVector self) -> charVector"""
        return _oalib.cpermVector_pop(self)


    def append(self, x):
        """append(cpermVector self, charVector x)"""
        return _oalib.cpermVector_append(self, x)


    def empty(self):
        """empty(cpermVector self) -> bool"""
        return _oalib.cpermVector_empty(self)


    def size(self):
        """size(cpermVector self) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::size_type"""
        return _oalib.cpermVector_size(self)


    def swap(self, v):
        """swap(cpermVector self, cpermVector v)"""
        return _oalib.cpermVector_swap(self, v)


    def begin(self):
        """begin(cpermVector self) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::iterator"""
        return _oalib.cpermVector_begin(self)


    def end(self):
        """end(cpermVector self) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::iterator"""
        return _oalib.cpermVector_end(self)


    def rbegin(self):
        """rbegin(cpermVector self) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::reverse_iterator"""
        return _oalib.cpermVector_rbegin(self)


    def rend(self):
        """rend(cpermVector self) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::reverse_iterator"""
        return _oalib.cpermVector_rend(self)


    def clear(self):
        """clear(cpermVector self)"""
        return _oalib.cpermVector_clear(self)


    def get_allocator(self):
        """get_allocator(cpermVector self) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::allocator_type"""
        return _oalib.cpermVector_get_allocator(self)


    def pop_back(self):
        """pop_back(cpermVector self)"""
        return _oalib.cpermVector_pop_back(self)


    def erase(self, *args):
        """
        erase(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::iterator pos) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::iterator
        erase(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::iterator first, std::vector< std::vector< signed char,std::allocator< signed char > > >::iterator last) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::iterator
        """
        return _oalib.cpermVector_erase(self, *args)


    def __init__(self, *args):
        """
        __init__(std::vector<(cperm)> self) -> cpermVector
        __init__(std::vector<(cperm)> self, cpermVector arg2) -> cpermVector
        __init__(std::vector<(cperm)> self, std::vector< std::vector< signed char,std::allocator< signed char > > >::size_type size) -> cpermVector
        __init__(std::vector<(cperm)> self, std::vector< std::vector< signed char,std::allocator< signed char > > >::size_type size, charVector value) -> cpermVector
        """
        this = _oalib.new_cpermVector(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def push_back(self, x):
        """push_back(cpermVector self, charVector x)"""
        return _oalib.cpermVector_push_back(self, x)


    def front(self):
        """front(cpermVector self) -> charVector"""
        return _oalib.cpermVector_front(self)


    def back(self):
        """back(cpermVector self) -> charVector"""
        return _oalib.cpermVector_back(self)


    def assign(self, n, x):
        """assign(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::size_type n, charVector x)"""
        return _oalib.cpermVector_assign(self, n, x)


    def resize(self, *args):
        """
        resize(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::size_type new_size)
        resize(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::size_type new_size, charVector x)
        """
        return _oalib.cpermVector_resize(self, *args)


    def insert(self, *args):
        """
        insert(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::iterator pos, charVector x) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::iterator
        insert(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::iterator pos, std::vector< std::vector< signed char,std::allocator< signed char > > >::size_type n, charVector x)
        """
        return _oalib.cpermVector_insert(self, *args)


    def reserve(self, n):
        """reserve(cpermVector self, std::vector< std::vector< signed char,std::allocator< signed char > > >::size_type n)"""
        return _oalib.cpermVector_reserve(self, n)


    def capacity(self):
        """capacity(cpermVector self) -> std::vector< std::vector< signed char,std::allocator< signed char > > >::size_type"""
        return _oalib.cpermVector_capacity(self)

    __swig_destroy__ = _oalib.delete_cpermVector
    __del__ = lambda self: None
cpermVector_swigregister = _oalib.cpermVector_swigregister
cpermVector_swigregister(cpermVector)
...
def calculateArrayParetoJ5long(al, verbose):
    """
    calculateArrayParetoJ5long(array_link al, int verbose) -> mvalueVector
...
def iarray_get(a, index):
    """iarray_get(int * a, int index) -> double"""
    return _oalib.iarray_get(a, index)
