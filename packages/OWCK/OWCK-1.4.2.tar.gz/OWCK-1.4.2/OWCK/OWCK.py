...
if __name__ == '__main__':
    ...
    model = OWCK(regr='constant', corr='absolute_exponential', 
         n_cluster=10, min_leaf_size=0, cluster_method='tree', 
         overlap=0.0, beta0=None,
         storage_mode='full', verbose=False, theta0=np.random.rand(), thetaL=[0], 
         thetaU=[0], optimizer='fmin_cobyla', random_start=1, nugget=0.000001,
