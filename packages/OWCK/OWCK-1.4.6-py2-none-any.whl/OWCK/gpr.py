...
class GaussianProcess(BaseEstimator, RegressorMixin):
    ...
    def reduced_likelihood_function(self, theta=None, eval_dx=False):
        """
        ...
        detR = (np.diag(C) ** 2.).prod()
        detR_ = detR ** (1. / n_samples)

        # Compute/Organize output
        reduced_likelihood_function_value = - sigma2.sum() * detR_
        ...
        if eval_dx:
            scale = detR ** (1. / n_samples) / n_samples
