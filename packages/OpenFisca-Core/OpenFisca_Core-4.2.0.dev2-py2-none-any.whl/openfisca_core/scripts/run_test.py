...
def build_parser():
    ...
    parser.add_argument('-m', '--relative_error_margin', help = u"relative error margin to use for tests that don't define any", action = 'store', type = float)
    parser.add_argument('-M', '--absolute_error_margin', help = u"absolute error margin to use for tests that don't define any", action = 'store', type = float)
...
def main():
    ...
    options = {
        ...
        'relative_error_margin': args.relative_error_margin,
        'absolute_error_margin': args.absolute_error_margin,
        }
