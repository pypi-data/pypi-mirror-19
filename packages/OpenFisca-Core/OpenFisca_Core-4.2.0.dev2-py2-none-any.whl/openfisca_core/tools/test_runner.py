...
def run_tests(tax_benefit_system, path, options = {}):
    ...
    **Testing options**:
    ...
    Key                     Type        Role
    ======================  ==========  =========================================
    force                   ``bool``    See :any:`openfisca-run-test` options doc
    verbose                 ``bool``    See :any:`openfisca-run-test` options doc
    name_filter             ``str``     See :any:`openfisca-run-test` options doc
    absolute_error_margin   ``float``   See :any:`openfisca-run-test` options doc
    relative_error_margin   ``float``   See :any:`openfisca-run-test` options doc
    ======================  ==========  =========================================
...
def _run_test(period_str, test, verbose = False, options = {}):
    ...
    if absolute_error_margin is None and relative_error_margin is None:
        absolute_error_margin = options.get('absolute_error_margin')
        relative_error_margin = options.get('relative_error_margin')
