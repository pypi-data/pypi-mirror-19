...
class salaire_net_hors_revenus_exceptionnels(Variable):
    ...
    def function(individu, period):
        ...
        return period, (
            ...
            individu('indemnites_fin_de_contrat_net', period)
            )
...
class rsa_revenu_activite_individu(DatedVariable):
    ...
    def function_2017(individu, mois_demande, legislation, mois_courant):
        ...
        revenus_non_moyennes = (
            ...
            individu('indemnites_fin_de_contrat_net', mois_courant)
            )
...
class rsa_fictif(Variable):
    ...
    def function(famille, mois_courant, legislation, mois_demande):
        ...
        rsa_forfait_logement = famille('rsa_forfait_logement', mois_demande, extra_params = [mois_courant])
...
class rsa_forfait_logement(Variable):
    ...
    def function(famille, mois_demande, legislation, mois_courant = None):
        ...
        statut_occupation_logement = famille.demandeur.menage('statut_occupation_logement', mois_courant)
        participation_frais = famille.demandeur.menage('participation_frais', mois_courant)
        loyer = famille.demandeur.menage('loyer', mois_courant)
        ...
        if mois_demande.start.date >= date(2009, 6, 01):
            params = legislation(mois_demande).prestations.minima_sociaux.rsa
            ...
            params = legislation(mois_demande).prestations.minima_sociaux.rmi
        ...
        return mois_demande, max_(montant_al, montant_nature)
