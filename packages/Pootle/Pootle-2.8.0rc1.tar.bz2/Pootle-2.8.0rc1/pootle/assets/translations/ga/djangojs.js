...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(tascanna cl\u00e1raithe)", 
    "Accept": "Glac Leis", 
    ...
    "Entire Project": "An Tionscadal Ar Fad", 
    ...
    "Total (%(currency)s)": "Ioml\u00e1n (%(currency)s)", 
    "Translated": "Aistrithe", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Aistrithe ag %(fullname)s i dtionscadal &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo;", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Aistrithe ag %(fullname)s i dtionscadal &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; %(time_ago)s", 
