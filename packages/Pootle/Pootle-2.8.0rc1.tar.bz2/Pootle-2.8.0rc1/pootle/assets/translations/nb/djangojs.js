...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "%(count)s language matches your query.": [
      "%(counts)s spr\u00e5k samsvarer med din sp\u00f8rring.", 
      "%(counts)s spr\u00e5k samsvarer med din sp\u00f8rring."
    ], 
    ...
    "%(timeSince)s via file upload": "%s(timeSince)s via filopplasting", 
    "%s hour": [
      "%s time", 
      "%s timer"
    ], 
    ...
    "(registered tasks)": "(registrerte oppgaver)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "Godta", 
    ...
    "Didn't receive an email? Check if it was accidentally filtered out as spam, or try requesting another copy of the email.": "Fikk du ikke e-posten? Sjekk at den ikke feilaktig ble filtrert ut som spam, eller ved \u00e5 foresp\u00f8rre ny kopi av e-posten.", 
    "Disabled": "Avskrudd", 
    ...
    "There is %(count)s language.": [
      "Det finnes %(cont)s spr\u00e5k.", 
      "Det finnes %(cont)s spr\u00e5k. Nedenfor finner du de nyligst tillagte."
    ], 
    ...
    "To set or change your avatar for your email address (%(email)s), please go to gravatar.com.": "For \u00e5 sette eller endre avatar for din e-postadresse (%(emails)s), g\u00e5 til gravatar.com.", 
    "Translated": "Oversatt", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Oversatt av %(fullname)s i &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo;-prosjektet", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Oversatt av %(fullname)s i &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo;-prosjektet %(time_ago)s", 
