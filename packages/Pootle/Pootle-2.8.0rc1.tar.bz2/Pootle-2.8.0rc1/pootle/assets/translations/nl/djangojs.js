...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(geregistreerde taken)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "Accepteren", 
    ...
    "Comment": "Opmerking", 
    "Comment on it": "Opmerking plaatsen", 
    ...
    "Total (%(currency)s)": "Totaal (%(currency)s)", 
    "Translated": "Vertaald", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Vertaald door %(fullname)s in project &lsquo;<span title=\"%(path)s\">%(project)s</span>&rsquo;", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Vertaald door %(fullname)s in project &lsquo;<span title=\"%(path)s\">%(project)s</span>&rsquo;, %(time_ago)s", 
    ...
    "We have sent an email containing the special link to <span>%s</span>. Please check your spam folder if you do not see the email.": "We hebben een e-mailbericht dat de speciale koppeling bevat naar <span>%s</span> verzonden. Controleer uw spammap als u het e-mailbericht niet ziet.", 
    "We have sent an email containing the special link to the address used to register this account. Please check your spam folder if you do not see the email.": "We hebben een e-mailbericht dat de speciale koppeling bevat verzonden naar het adres dat voor registratie van deze account is gebruikt. Controleer uw spammap als u het e-mailbericht niet ziet.", 
    "Website": "Website", 
