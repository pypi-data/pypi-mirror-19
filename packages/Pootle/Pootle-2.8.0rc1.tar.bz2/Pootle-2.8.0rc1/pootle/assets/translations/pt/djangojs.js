...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "%(count)s language matches your query.": [
      "%(count)s idioma corresponde com a sua consulta.", 
      "%(count)s idiomas corresponde com a sua consulta."
    ], 
    ...
    "%(count)s user matches your query.": [
      "%(count)s utilizador corresponde com a sua consulta.", 
      "%(count)s utilizadores correspondem com a sua consulta."
    ], 
    ...
    "(registered tasks)": "(tarefas registadas)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "Aceitar", 
    ...
    "Didn't receive an email? Check if it was accidentally filtered out as spam, or try requesting another copy of the email.": "N\u00e3o recebeu uma mensagem? Verifique se esta est\u00e1 na pasta de spam, ou tente solicitar uma outra c\u00f3pia da mensagem.", 
    "Disabled": "Desativado", 
    ...
    "Enter your email address, and we will send you a message with the special link to reset your password.": "Insira o seu endere\u00e7o de e-mail, e n\u00f3s iremos enviar-lhe uma mensagem com uma hiperliga\u00e7\u00e3o especial para redefinir a sua palavra-passe.", 
    "Entire Project": "Projeto completo", 
    ...
    "Note: when deleting a user their contributions to the site, e.g. comments, suggestions and translations, are attributed to the anonymous user (nobody).": "Nota: quando elimina um utilizador, as suas contribui\u00e7\u00f5es para o site, por exemplo, coment\u00e1rios, sugest\u00f5es e tradu\u00e7\u00f5es, ser\u00e3o atribu\u00eddos ao utilizador an\u00f3nimo (ningu\u00e9m).", 
    "Number of Plurals": "N\u00famero de plurais", 
    "Oops...": "Ups...", 
    "Overview": "Sinopse", 
    "Password": "Palavra-passe", 
    "Password changed, signing in...": "Palavra-passe alterada, a iniciar a sess\u00e3o...", 
    "Period": "Per\u00edodo", 
    "Permissions": "Permiss\u00f5es", 
    "Personal description": "Descri\u00e7\u00e3o pessoal", 
    "Personal website URL": "URL do site pessoal", 
    "Please follow that link to continue the account creation.": "Por favor, siga essa hiperliga\u00e7\u00e3o para continuar com a cria\u00e7\u00e3o da conta.", 
    "Please follow that link to continue the password reset procedure.": "Por favor, siga essa hiperliga\u00e7\u00e3o para continuar com a reposi\u00e7\u00e3o da palavra-passe.", 
    ...
    "Preview will be displayed here.": "A pr\u00e9-visualiza\u00e7\u00e3o ser\u00e1 exibida aqui.", 
    ...
    "Sending email to %s...": "A enviar mensagem para %s...", 
    ...
    "Sign In With %s": "Iniciar a sess\u00e3o com %s", 
    "Sign In With...": "Iniciar a sess\u00e3o com...", 
    "Sign Up": "Registar", 
    "Sign in as an existing user": "Iniciar a sess\u00e3o como utilizador existente", 
    ...
    "Summary": "Resumo", 
    "Team": "Equipa", 
    "The password reset link was invalid, possibly because it has already been used. Please request a new password reset.": "A hiperliga\u00e7\u00e3o de reposi\u00e7\u00e3o de palavra-passe era inv\u00e1lida, possivelmente porque esta j\u00e1 foi utilizada. Por favor, solicite uma nova reposi\u00e7\u00e3o de palavra-passe.", 
    ...
    "This email confirmation link expired or is invalid.": "Esta hiperliga\u00e7\u00e3o de confirma\u00e7\u00e3o de e-mail expirou ou \u00e9 inv\u00e1lida.", 
    ...
    "Translated": "Traduziu", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Traduzido por %(fullname)s no &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo;", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Traduzido por %(fullname)s no &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo;projeto %(time_ago)s", 
    "Try again": "Tentar novamente", 
    "Twitter": "Twitter", 
    "Twitter username": "Nome de utilizador do Twitter", 
    "Type to search": "Digite para procurar", 
    "Updating data": "A atualizar dados", 
    "Use the search form to find the language, then click on a language to edit.": "Utilize o campo de procura para encontrar o idioma, e depois clique no idioma para o editar.", 
    "Use the search form to find the project, then click on a project to edit.": "Utilize o campo de procura para encontrar o projeto, e depois clique no projeto para o editar.", 
    "Use the search form to find the user, then click on a user to edit.": "Utilize o campo de procura para encontrar o utilizador, e depois clique num utilizador para o editar.", 
    ...
    "We have sent an email containing the special link to <span>%s</span>": "N\u00f3s envi\u00e1mos uma mensagem com uma hiperliga\u00e7\u00e3o especial para <span>%s</span>", 
