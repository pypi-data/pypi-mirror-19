...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(kay\u0131tl\u0131 g\u00f6revler)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "Kabul Et", 
    ...
    "Total (%(currency)s)": "Toplam (%(currency)s)", 
    "Translated": "\u00c7evrilmi\u015f", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "&ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; projesinde %(fullname)s taraf\u0131ndan \u00e7evrilmi\u015f", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "&ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; projesinde %(time_ago)s %(fullname)s taraf\u0131ndan \u00e7evrilmi\u015f", 
