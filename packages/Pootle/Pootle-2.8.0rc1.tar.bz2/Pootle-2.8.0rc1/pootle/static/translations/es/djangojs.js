...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(tareas registradas)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "Aceptar", 
    ...
    "Comment": "Comentario", 
    "Comment on it": "A\u00f1adir un comentario al respecto", 
    ...
    "Edit the suggestion before accepting, if necessary": "Si fuera necesario, editar la sugerencia antes de aceptar", 
    ...
    "Entire Project": "Todo el proyecto", 
    ...
    "Provide optional comment (will be publicly visible)": "Proponer un comentario opcional (visible para el p\u00fablico)", 
    ...
    "Translated": "Tradujo", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Traducido por %(fullname)s en el proyecto &laquo;<span title=\"%(path)s\">%(project)s</span>&raquo;", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Traducido por %(fullname)s en el proyecto &laquo;<span title=\"%(path)s\">%(project)s</span>&raquo; &(time_ago)s", 
    ...
    "We have sent an email containing the special link to <span>%s</span>. Please check your spam folder if you do not see the email.": "Le hemos enviado un mensaje que contiene el enlace especial a <span>%s</span>. Por favor chequee su carpeta de spam si no recibe el mensaje.", 
    "We have sent an email containing the special link to the address used to register this account. Please check your spam folder if you do not see the email.": "Le hemos enviado un mensaje que contiene el enlace especial a la direcci\u00f3n usada para registrar esta cuenta. Por favor chequee su carpeta de spam si no recibe el mensaje.", 
    "Website": "Sitio web", 
