...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(tasgau cofrestredig)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "Derbyn", 
    ...
    "Comment": "Sylw", 
    "Comment on it": "Rhowch sylwadau arno", 
    ...
    "Entire Project": "Y Project Cyfan", 
    ...
    "Rate": "Cyfradd", 
    "Registered Tasks": "Tasgau wedi eu Cofrestru", 
    "Reject": "Gwrthod", 
    "Reload page": "Ail lwytho tudalen", 
    "Remove task": "Tynnu tasg", 
    ...
    "To set or change your avatar for your email address (%(email)s), please go to gravatar.com.": "I osod neu newid avatar eich cyfeiriad e-bost (%(email)s), ewch i gravatar.com.", 
    "Total (%(currency)s)": "Cyfanswm (%(currency)s)", 
    "Translated": "Cyfieithu", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Cyfieithiwyd gan %(fullname)s yn &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Cyfieithiwyd gan %(fullname)s yn &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s", 
