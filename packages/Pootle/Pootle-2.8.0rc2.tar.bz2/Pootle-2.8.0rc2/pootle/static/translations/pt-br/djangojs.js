...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(tarefas registradas)", 
    "Accept": "Aceitar", 
    ...
    "Enter your email address, and we will send you a message with the special link to reset your password.": "Digite seu endere\u00e7o de e-mail, e n\u00f3s vamos enviar uma mensagem para voc\u00ea com o link especial para redefinir sua senha.", 
    "Entire Project": "Projeto inteiro", 
    ...
    "Please follow that link to continue the account creation.": "Por favor, siga o link para continuar a cria\u00e7\u00e3o da conta.", 
    "Please follow that link to continue the password reset procedure.": "Por favor, siga o link para continuar o processo de redefini\u00e7\u00e3o de senha.", 
    "Please select a valid user.": "Por favor, selecione um usu\u00e1rio v\u00e1lido.", 
    ...
    "Suggested": "Sugerido", 
    "Summary": "Sum\u00e1rio", 
    "The password reset link was invalid, possibly because it has already been used. Please request a new password reset.": "O link de redefini\u00e7\u00e3o de senha era inv\u00e1lido, possivelmente porque ele j\u00e1 foi usado. Por favor, solicite uma nova redefini\u00e7\u00e3o de senha.", 
    ...
    "To set or change your avatar for your email address (%(email)s), please go to gravatar.com.": "Para definir ou alterar o seu avatar para seu endere\u00e7o de e-mail (%(email)s), por favor, v\u00e1 para gravatar.com.", 
    "Total (%(currency)s)": "Total (%(currency)s)", 
    "Translated": "Traduzido", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Traduzido por %(fullname)s no projeto &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo;", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Traduzido por %(fullname)s no projeto &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; %(time_ago)s", 
    ...
    "We have sent an email containing the special link to <span>%s</span>": "N\u00f3s enviamos um e-mail contendo o link especial para <span>%s</span>", 
    "Website": "Site", 
