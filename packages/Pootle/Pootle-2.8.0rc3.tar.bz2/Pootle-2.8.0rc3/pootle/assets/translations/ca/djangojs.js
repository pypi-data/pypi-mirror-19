...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Comment": "Comentari", 
    "Comment on it": "Afegeix un comentari", 
    ...
    "Note: when deleting a user their contributions to the site, e.g. comments, suggestions and translations, are attributed to the anonymous user (nobody).": "Nota: si suprimiu un usuari un usuari, les seves aportacions al lloc, p. e. comentaris, suggeriments i traduccions, s'atribueixen a l'usuari an\u00f2nim (\u00abnobody\u00bb).", 
