...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(Registrierte Aufgaben)", 
    ...
    "Entire Project": "Gesamtes Projekt", 
    ...
    "Total (%(currency)s)": "Gesamt (%(currency)s)", 
    "Translated": "\u00dcbersetzt", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "\u00dcbersetzt von %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; Projekt", 
