...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(registrovan\u00e9 \u00falohy)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "P\u0159ijmout", 
    ...
    "Rate": "Sazba", 
    "Registered Tasks": "Zaregistrovan\u00e9 \u00falohy", 
    "Reject": "Zam\u00edtnout", 
    ...
    "Total (%(currency)s)": "Celkem (%(currency)s)", 
    "Translated": "P\u0159elo\u017eeno", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "P\u0159elo\u017eil %(fullname)s v projektu &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo;", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "P\u0159elo\u017eil %(fullname)s v projektu &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; %(time_ago)s", 
