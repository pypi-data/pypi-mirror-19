...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(tarefas rexistradas)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "Aceptar", 
    ...
    "Entire Project": "Todo o proxecto", 
    ...
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Traducido por %(fullname)s no proxecto &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo;", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Traducido por %(fullname)s no proxecto &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; hai %(time_ago)s", 
