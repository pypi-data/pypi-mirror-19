...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(registrerade uppgifter)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "Godk\u00e4nn", 
    ...
    "Total (%(currency)s)": "Totalt (%(currency)s)", 
    "Translated": "\u00d6versatt", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "\u00d6versatt av %(fullname)s ii &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; projekt", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "\u00d6versatt av %(fullname)s i &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; projekt %(time_ago)s", 
