...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(tasques registrades)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "Accepta", 
    ...
    "Action": "Acci\u00f3", 
    "Active": "Actiu", 
    "Add Language": "Afig una llengua", 
    "Add Project": "Afig un projecte", 
    "Add User": "Afig un usuari", 
    ...
    "Comment": "Comentari", 
    "Comment on it": "Afig un comentari", 
    "Congratulations! You have completed this task!": "Enhorabona! Heu finalitzat esta tasca!", 
    ...
    "Didn't receive an email? Check if it was accidentally filtered out as spam, or try requesting another copy of the email.": "No heu rebut cap correu? Comproveu que no s'haja classificat com a correu brossa, o proveu a sol\u00b7licitar una altra c\u00f2pia del correu.", 
    ...
    "Enter your email address, and we will send you a message with the special link to reset your password.": "Introdu\u00efu la vostra adre\u00e7a electr\u00f2nica de correu i vos enviarem un missatge amb l'enlla\u00e7 especial que vos permetr\u00e0 canviar la contrasenya.", 
    "Entire Project": "Projecte sencer", 
    ...
    "Find language by name, code": "Busca una llengua per nom o codi", 
    "Find project by name, code": "Busca un projecte per nom o codi", 
    "Find user by name, email, properties": "Busca un usuari per nom, adre\u00e7a electr\u00f2nica o propietats", 
    "Full Name": "Nom complet", 
    "Go back to browsing": "Torna arrere a la navegaci\u00f3", 
    ...
    "No": "No", 
    "No activity recorded in a given period": "No s'ha gravat cap activitat en el per\u00edode determinat", 
    ...
    "Note: when deleting a user their contributions to the site, e.g. comments, suggestions and translations, are attributed to the anonymous user (nobody).": "Nota: si suprimiu un usuari, les seues aportacions al lloc, p. e. comentaris, suggeriments i traduccions, s'atribueixen a l'usuari an\u00f2nim (\u00abnobody\u00bb).", 
    ...
    "Please follow that link to continue the password reset procedure.": "Visiteu este enlla\u00e7 per a continuar amb el proc\u00e9s de canvi de contrasenya.", 
    ...
    "Preview will be displayed here.": "La vista preliminar es mostrar\u00e0 ac\u00ed.", 
    ...
    "Remove task": "Suprimeix la tasca", 
    ...
    "Reviewed": "Revisat", 
    "Save": "Guarda", 
    "Saved successfully.": "S'ha guardat correctament.", 
    "Score Change": "Canvi de puntuaci\u00f3", 
    "Screenshot Search Prefix": "Prefix de busca de captures de pantalla", 
    "Search Languages": "Busca les lleng\u00fces", 
    "Search Projects": "Busca projectes", 
    "Search Users": "Busca usuaris", 
    "Select...": "Seleccioneu...", 
    ...
    "Sign up as a new user": "Grava'm com a un usuari nou", 
    "Signed in. Redirecting...": "S'ha iniciat la sessi\u00f3. S'est\u00e0 redirigint...", 
    "Signing in with an external service for the first time will automatically create an account for you.": "En iniciar sessi\u00f3 per primera vegada amb un servei extern se vos crear\u00e0 un compte autom\u00e0ticament.", 
    ...
    "The server seems down. Try again later.": "Pareix que el servidor no funciona. Proveu-ho m\u00e9s tard.", 
    "There are unsaved changes. Do you want to discard them?": "Hi ha canvis sense guardar. Voleu descartar-los?", 
    ...
    "This email confirmation link expired or is invalid.": "Este enlla\u00e7 de confirmaci\u00f3 d'adre\u00e7a electr\u00f2nica ha caducat o no \u00e9s v\u00e0lid.", 
    "This string no longer exists.": "Esta cadena ja no existeix.", 
    ...
    "Total (%(currency)s)": "Total (%(currency)s)", 
    "Translated": "Tradu\u00eft", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Tradu\u00eft per %(fullname)s al projecte \u00ab<span title=\"%(path)s\">%(project)s</span>\u00bb", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Tradu\u00eft per %(fullname)s al projecte \u00ab<span title=\"%(path)s\">%(project)s</span>\u00bb fa %(time_ago)s", 
    "Try again": "Torneu-hi", 
    "Twitter": "Twitter", 
    "Twitter username": "Nom d'usuari del Twitter", 
    "Type to search": "Escriviu per a buscar", 
    "Updating data": "S'estan actualitzant les dades", 
    "Use the search form to find the language, then click on a language to edit.": "Useu el formulari de busca per a troba la llengua, aleshores feu clic a la llegua per a editar-la.", 
    "Use the search form to find the project, then click on a project to edit.": "Usa el formulari de busca per a trobar el projectes, aleshores feu clic al projecte per a editar-lo.", 
    "Use the search form to find the user, then click on a user to edit.": "Usue el formulari de busca per a trobar l'usuari, aleshores feu clic a l'usuari per a editar-lo.", 
    "Username": "Nom d'usuari", 
    "We found a user with <span>%(email)s</span> email in our system. Please provide the password to finish the sign in procedure. This is a one-off procedure, which will establish a link between your Pootle and %(provider)s accounts.": "Hem trobat un usuari al nostre sistema amb l'adre\u00e7a de correu <span>%(email)s</span>. Indiqueu la contrasenya per a finalitzar el proc\u00e9s d'inici de sessi\u00f3. Este procediment nom\u00e9s es realitza un cop, i enlla\u00e7ar\u00e0 els vostres comptes de Pootle i %(provider)s.", 
    "We have sent an email containing the special link to <span>%s</span>": "Vos hem enviat un correu electr\u00f2nic amb l'enlla\u00e7 especial a <span>%s</span>", 
    "We have sent an email containing the special link to <span>%s</span>. Please check your spam folder if you do not see the email.": "Vos hem enviat un correu electr\u00f2nic amb l'enlla\u00e7 especial a <span>%s</span>. Reviseu la carpeta de correu brossa si no veieu el correu.", 
    "We have sent an email containing the special link to the address used to register this account. Please check your spam folder if you do not see the email.": "Vos hem enviat un correu electr\u00f2nic amb l'enlla\u00e7 a l'adre\u00e7a usada en gravar este compte. Reviseu la carpeta de correu brossa si no veieu el correu.", 
    "Website": "Lloc web", 
    ...
    "Yes": "S\u00ed", 
    "You have unsaved changes in this string. Navigating away will discard those changes.": "Teniu canvis sense guardar en esta cadena Si abandoneu la navegaci\u00f3 es descartaran tots els canvis.", 
