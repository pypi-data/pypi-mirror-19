...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Cyfieithwyd gan %(fullname)s yn &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Cyfieithwyd gan %(fullname)s yn &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s", 
