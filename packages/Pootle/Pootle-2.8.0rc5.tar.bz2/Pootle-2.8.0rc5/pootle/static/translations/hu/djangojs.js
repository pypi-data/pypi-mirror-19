...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "(registered tasks)": "(regisztr\u00e1lt feladatok)", 
    "+%(score)s": "+%(score)s", 
    "Accept": "Elfogad\u00e1s", 
    ...
    "Comment": "Megjegyz\u00e9s", 
    "Comment on it": "Megjegyz\u00e9s \u00edr\u00e1sa", 
    ...
    "Total (%(currency)s)": "\u00d6sszesen (%(currency)s)", 
    "Translated": "Leford\u00edtott", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project": "Ford\u00edtotta: %(fullname)s, itt: &bdquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; projekt", 
    "Translated by %(fullname)s in &ldquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; project %(time_ago)s": "Ford\u00edtotta: %(fullname)s, itt: &bdquo;<span title=\"%(path)s\">%(project)s</span>&rdquo; projekt, %(time_ago)s", 
