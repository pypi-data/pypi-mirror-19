...
class StationsApi(object):
    ...
    def delete_station_id_associateduser(self, station_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_station_id_associateduser(station_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_station_id_associateduser" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('station_id' not in params) or (params['station_id'] is None):
            raise ValueError("Missing the required parameter `station_id` when calling `delete_station_id_associateduser`")
    ...
    def get_station_id(self, station_id, **kwargs):
        """
        Get station.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_station_id(station_id, callback=callback_function)
        ...
        # verify the required parameter 'station_id' is set
        if ('station_id' not in params) or (params['station_id'] is None):
            raise ValueError("Missing the required parameter `station_id` when calling `get_station_id`")
    ...
    def get_stations(self, **kwargs):
        ...
        all_params = ['page_size', 'page_number', 'sort_by', 'name', 'line_appearance_id']
        all_params.append('callback')
