...
class TestWorkforceManagementApi(unittest.TestCase):
    ...
    def test_get_decisions_downloads_download_id(self):
        """
        Test case for get_decisions_downloads_download_id
    ...
    def test_post_decisions_downloads_search(self):
        """
        Test case for post_decisions_downloads_search
