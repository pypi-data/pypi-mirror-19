...
class JsonNode(object):
    ...
    def __init__(self):
        ...
        self._number = False
        self._float = False
        self._container_node = False
        self._missing_node = False
        self._binary = False
        self._pojo = False
        self._value_node = False
        self._integral_number = False
        self._floating_point_number = False
        self._short = False
        self._int = False
        self._long = False
        self._double = False
        self._big_decimal = False
        self._big_integer = False
        self._textual = False
        self._array = False
        self._null = False
