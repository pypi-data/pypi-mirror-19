...
class LocationsApi(object):
    ...
    def get(self, **kwargs):
        ...
        resource_path = '/api/v2/locations'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_location_id(self, location_id, **kwargs):
        """
        Get Location by ID.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_location_id(location_id, callback=callback_function)
        ...
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `get_location_id`")


        resource_path = '/api/v2/locations/{locationId}'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='LocationDefinition',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
