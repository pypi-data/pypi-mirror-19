...
class RecordingApi(object):
    ...
    def get_localkeys_settings(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_localkeys_settings(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_localkeys_settings" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_localkeys_settings_settings_id(self, settings_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_localkeys_settings_settings_id(settings_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_localkeys_settings_settings_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('settings_id' not in params) or (params['settings_id'] is None):
            raise ValueError("Missing the required parameter `settings_id` when calling `get_localkeys_settings_settings_id`")
    ...
    def get_orphan_id_media(self, orphan_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_orphan_id_media(orphan_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_orphan_id_media" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'orphan_id' is set
        if ('orphan_id' not in params) or (params['orphan_id'] is None):
            raise ValueError("Missing the required parameter `orphan_id` when calling `get_orphan_id_media`")
    ...
    def get_recordingkeys(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_recordingkeys(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_recordingkeys" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_recordingkeys_rotationschedule(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_recordingkeys_rotationschedule(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_recordingkeys_rotationschedule" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def gets_screensessions(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.gets_screensessions(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method gets_screensessions" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def patch_mediaretentionpolicies_policy_id(self, policy_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_mediaretentionpolicies_policy_id(policy_id, body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_mediaretentionpolicies_policy_id`")
    ...
    def patchs_screensessions_recordingsession_id(self, recording_session_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patchs_screensessions_recordingsession_id(recording_session_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patchs_screensessions_recordingsession_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('recording_session_id' not in params) or (params['recording_session_id'] is None):
            raise ValueError("Missing the required parameter `recording_session_id` when calling `patchs_screensessions_recordingsession_id`")
    ...
    def post_conversation_id_recordings_recording_id_annotations(self, conversation_id, recording_id, body, **kwargs):
        """
        Create annotation
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversation_id_recordings_recording_id_annotations(conversation_id, recording_id, body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_conversation_id_recordings_recording_id_annotations`")
    ...
    def post_localkeys(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_localkeys(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_localkeys`")
    ...
    def post_localkeys_settings(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_localkeys_settings(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_localkeys_settings" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_localkeys_settings`")
    ...
    def post_mediaretentionpolicies(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_mediaretentionpolicies(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_mediaretentionpolicies`")
    ...
    def post_recordingkeys(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_recordingkeys(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_recordingkeys" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def put_conversation_id_recordings_recording_id_annotations_annotation_id(self, conversation_id, recording_id, annotation_id, body, **kwargs):
        """
        Update annotation
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_conversation_id_recordings_recording_id_annotations_annotation_id(conversation_id, recording_id, annotation_id, body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_conversation_id_recordings_recording_id_annotations_annotation_id`")
    ...
    def put_localkeys_settings_settings_id(self, settings_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_localkeys_settings_settings_id(settings_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_localkeys_settings_settings_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'settings_id' is set
        if ('settings_id' not in params) or (params['settings_id'] is None):
            raise ValueError("Missing the required parameter `settings_id` when calling `put_localkeys_settings_settings_id`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_localkeys_settings_settings_id`")
    ...
    def put_mediaretentionpolicies_policy_id(self, policy_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_mediaretentionpolicies_policy_id(policy_id, body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_mediaretentionpolicies_policy_id`")
    ...
    def put_orphan_id(self, orphan_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_orphan_id(orphan_id, callback=callback_function)
        ...
        # verify the required parameter 'orphan_id' is set
        if ('orphan_id' not in params) or (params['orphan_id'] is None):
            raise ValueError("Missing the required parameter `orphan_id` when calling `put_orphan_id`")
    ...
    def put_recordingkeys_rotationschedule(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_recordingkeys_rotationschedule(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_recordingkeys_rotationschedule" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_recordingkeys_rotationschedule`")
    ...
    def put_settings(self, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_settings(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_settings`")
