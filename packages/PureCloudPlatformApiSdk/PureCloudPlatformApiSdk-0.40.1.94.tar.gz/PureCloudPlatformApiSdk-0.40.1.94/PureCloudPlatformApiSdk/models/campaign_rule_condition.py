...
class CampaignRuleCondition(object):
    ...
    def __init__(self):
        """
        CampaignRuleCondition - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this CampaignRuleCondition.


        :return: The id of this CampaignRuleCondition.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this CampaignRuleCondition.


        :param id: The id of this CampaignRuleCondition.
        :type: str
        """
