...
class QualityApi(object):
    ...
    def get_keywordsets(self, **kwargs):
        ...
        all_params = ['page_size', 'page_number', 'sort_by', 'expand', 'next_page', 'previous_page', 'name', 'queue_id', 'agent_id']
        all_params.append('callback')
    ...
    def post_calibrations(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_calibrations(body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_calibrations`")
    ...
    def post_conversations_conversation_id_evaluations(self, conversation_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversations_conversation_id_evaluations(conversation_id, body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_conversations_conversation_id_evaluations`")
    ...
    def post_evaluations_aggregates_query(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_evaluations_aggregates_query(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_evaluations_aggregates_query`")
    ...
    def post_evaluations_scoring(self, body, **kwargs):
        """
        Score evaluation
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_evaluations_scoring(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_evaluations_scoring`")
    ...
    def post_forms(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_forms(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_forms`")
    ...
    def post_keywordsets(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_keywordsets(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_keywordsets`")
    ...
    def post_publishedforms(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_publishedforms(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_publishedforms`")
    ...
    def post_spotability(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_spotability(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_spotability" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def put_calibrations_calibration_id(self, calibration_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_calibrations_calibration_id(calibration_id, body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_calibrations_calibration_id`")
    ...
    def put_conversations_conversation_id_evaluations_evaluation_id(self, conversation_id, evaluation_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_conversations_conversation_id_evaluations_evaluation_id(conversation_id, evaluation_id, body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_conversations_conversation_id_evaluations_evaluation_id`")
    ...
    def put_forms_form_id(self, form_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_forms_form_id(form_id, body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_forms_form_id`")
    ...
    def put_keywordsets_keywordset_id(self, keyword_set_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_keywordsets_keywordset_id(keyword_set_id, body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_keywordsets_keywordset_id`")
