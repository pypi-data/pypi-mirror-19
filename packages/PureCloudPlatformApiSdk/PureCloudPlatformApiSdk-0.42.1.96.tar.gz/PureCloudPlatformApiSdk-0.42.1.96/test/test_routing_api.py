...
class TestRoutingApi(unittest.TestCase):
    ...
    def test_get_queues_queue_id_conversations(self):
        """
        Test case for get_queues_queue_id_conversations

        Get recent conversations that are still active
        """
        pass

    def test_get_queues_queue_id_conversations_callbacks(self):
        """
        Test case for get_queues_queue_id_conversations_callbacks

        Get recent callback conversations that are still active
        """
        pass

    def test_get_queues_queue_id_conversations_calls(self):
        """
        Test case for get_queues_queue_id_conversations_calls

        Get recent call conversations that are still active
        """
        pass

    def test_get_queues_queue_id_conversations_chats(self):
        """
        Test case for get_queues_queue_id_conversations_chats

        Get recent chat conversations that are still active
        """
        pass

    def test_get_queues_queue_id_conversations_emails(self):
        """
        Test case for get_queues_queue_id_conversations_emails
