...
class TestTelephonyProvidersEdgeApi(unittest.TestCase):
    ...
    def test_get_providers_edges_edge_id_metrics(self):
        """
        Test case for get_providers_edges_edge_id_metrics
    ...
    def test_get_providers_edges_metrics(self):
        """
        Test case for get_providers_edges_metrics
    ...
    def test_post_providers_edges_offlineconfiguration(self):
        """
        Test case for post_providers_edges_offlineconfiguration
