...
class OrganizationApi(object):
    ...
    def patch_features(self, **kwargs):
        """
        Update organization
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_features(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param EntryFeatureBoolean body: Feature to update.
        :return: dict(str, str)
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        resource_path = '/api/v2/organizations/features'.replace('{format}', 'json')
        path_params = {}
