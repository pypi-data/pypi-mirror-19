...
from peewee import (BareField, BigIntegerField, BlobField, BooleanField,
                    CharField, Check, Clause, CompositeKey, DatabaseError,
                    DataError, DateField, DateTimeField, DecimalField,
                    ...
                    PrimaryKeyField, ProgrammingError, Proxy, R,
                    SmallIntegerField, SqliteDatabase, SQL, TextField,
                    TimeField, TimestampField, Using, UUIDField, Window)
...
try:
    ...
    peewee += (ppe.cast, ppe.ArrayField, ppe.DateTimeTZField,
               ppe.HStoreField, ppe.JSONField, ppe.BinaryJSONField,
               ppe.TSVectorField, ppe.Match, ppe.PostgresqlExtDatabase,
               ppe.ServerSideSelectQuery, ppe.ServerSide,
               ppe.LateralJoin)
...
class Topology(object):
    def __init__(self, connection, models):
        ...
        for db_table, model in models.items():
            ...
            for n, f in model._meta.fields.items():
