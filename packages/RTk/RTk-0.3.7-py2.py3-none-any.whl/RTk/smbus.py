...
class SMBus:
    ...
    def write_i2c_block_data(self,i2caddress,command,data):
        ...
        self._write(chr(int(hex(command),16))) # Write the command char
    ...
    def write_byte_data(self,i2caddress,command,data):
        ...
        self._write(chr(int(hex(command),16))) # Write the command char
        self._write(chr(int(hex(data),16))) #Data
        sleep(i)
    ...
    def read_word_data(self,i2caddress,command) :
        ...
        self._write(chr(int(hex(command),16)))
        ...
        print("read")
        #return(wordDat2)
        wordDat = int(hex((wordDat2<<8)+wordDat1),16)
        sleep(i)
    ...
    def read_i2c_block_data(self,i2caddress,command):
        ...
        while(ii<16):
             ...
             blockData.append(int(hex((byteDat)),16))
             ii = ii+1
        sleep(i)
