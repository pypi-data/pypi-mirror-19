...
__all__ = [
            ...
            # For convenience when importing from shaft, but can use
            # the flask one
            "flash",
            "session",
            "request",
...
# By default shaft will load all the application/models.py models
models = type('', (), {})
...
# Setup the DB
# Shaft upon initialization will use the right URI for it
db = _ShaftAlchemy()
...
class Shaft(object):
    ...
    def __call__(cls,
        ...
        if app.config.get("COMPRESS_HTML"):
            app.jinja_env.add_extension('shaft.htmlcompress.HTMLCompress')
        ...
        # Implicit import.
        # Shaft can load models and view files according to the convention:
        # application.models,
