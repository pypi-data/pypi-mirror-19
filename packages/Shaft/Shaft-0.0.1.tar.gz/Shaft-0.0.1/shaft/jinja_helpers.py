...
import humanize
import arrow
from shaft import init_app, get_config
...
FILTERS = {
    ...
    "markdown": lambda text: Markup(markdown_ext.html(text)), # Return a markdown to HTML
    "markdown_toc": markdown_ext.toc, # Create a Table of Content of the Markdown
    "nl2br": nl2br,
    "format_datetime": format_datetime, # Require the format to be passed
    "date": format_date,
