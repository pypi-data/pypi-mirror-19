...
class Feed_19Endpoint:
    ...
    def options(self, accept_type=None):
        ...
        return fill(Feed_19, response.json())
    
    def get(self, feedscope, feedidentity, size, offset, badgeUnreadVersion=None, returnChatAsCard=None, returnForwardedCopyPosts=None, accept_type=None):
        """
    ...
    def get_2(self, feedscope, feedidentity, sinceId, size, offset, sortDirection=None, badgeUnreadVersion=None, returnChatAsCard=None, returnForwardedCopyPosts=None, accept_type=None):
        """
