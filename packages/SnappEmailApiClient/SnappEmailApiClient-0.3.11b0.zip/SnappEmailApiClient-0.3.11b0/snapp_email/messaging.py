...
def post(client, content, existing_card_id, attachment_ids=None):
    """
    ...
    :param client:
    :type client: api_client.ApiClient
    :param content:
    ...
    created_post = client.post.Post_22.create(post_obj)
    if attachment_ids and len(attachment_ids) > 0:
        pass
    return created_post


def post_create_card(client, content, recipients=None, attachment_ids=None):
    """
    Post a message to a new card.

    :param client:
    :rtype client: api_client.ApiClient
    :param content: str
...
def get_user_chat_card(client, user_email):
    """
    :param client:
    :type client: api_client.ApiClient
    :param user_email:
    ...
    feed = client.stream.StreamUser_22.create(data)
    return feed


def get_user_chat_id(client, user_email):
    """
    :param client:
    :type client: api_client.ApiClient
    :param user_email:
    :return:
    """
    feed = get_user_chat_card(client, user_email)
    return feed.Id
