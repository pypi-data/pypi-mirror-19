...
class DiscussionCard_20Endpoint:
    ...
    def options(self, accept_type=None):
        ...
        return fill(DiscussionCard_20, response.json())
    
    def get(self, cardId, size, offset, htmlFormat=None, returnForwardedCopyPosts=None, sinceId=None, sortDirection=None, accept_type=None):
        """
