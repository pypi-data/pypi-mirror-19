...
class DiscussionCard_22Endpoint:
    ...
    def options(self, accept_type=None):
        ...
        return fill(DiscussionCard_22, response.json())
    
    def get(self, cardId, size, offset, htmlFormat=None, returnForwardedCopyPosts=None, sinceId=None, sortDirection=None, loadPartial=None, accept_type=None):
        """
