...
class Feed_22Endpoint:
    ...
    def options(self, accept_type=None):
        ...
        return fill(Feed_22, response.json())
    
    def get(self, feedscope, feedidentity, size, offset, htmlFormat=None, unreadFirst=None, unreadOnly=None, loadUnread=None, loadPartial=None, postPageSize=None, returnForwardedCopyPosts=None, accept_type=None):
        """
    ...
    def get_2(self, feedscope, feedidentity, loadUnread, sinceId, size, offset, htmlFormat=None, unreadFirst=None, unreadOnly=None, sortDirection=None, returnForwardedCopyPosts=None, accept_type=None):
        """
