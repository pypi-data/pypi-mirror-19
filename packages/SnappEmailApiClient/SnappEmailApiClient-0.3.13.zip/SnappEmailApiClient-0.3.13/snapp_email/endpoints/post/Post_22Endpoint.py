...
class Post_22Endpoint:
    ...
    def options(self, accept_type=None):
        ...
        return fill(Post_22, response.json())
    
    def get(self, postId, htmlFormat=None, accept_type=None):
        """
    ...
    def create(self, obj, clientResourceId=None, customDateTime=None, signatureId=None, returnFullResource=None, accept_type=None):
        """
        Create new post.
    ...
    def create_2(self, obj, sourceResourceId, sourceResourceModified, isForward=None, returnFullResource=None, accept_type=None):
        """
        Copy existing post.
