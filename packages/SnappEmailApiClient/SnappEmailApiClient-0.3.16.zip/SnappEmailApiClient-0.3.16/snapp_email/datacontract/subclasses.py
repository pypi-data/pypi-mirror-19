...
#
# Generated Fri Jan 13 15:29:42 2017 by generateDS.py version 2.23a.
#
...
class SearchResource_22Sub(supermod.SearchResource_22):
    def __init__(self, Resource=None, Highlights=None, SearchHit=None, BadgeCount=None, Weight=None):
        super(SearchResource_22Sub, self).__init__(Resource, Highlights, SearchHit, BadgeCount, Weight, )
...
class UserSettings_14Sub(supermod.UserSettings_14):
    def __init__(self, FirstName=None, LastName=None, CultureCode=None, RegionCode=None, TimeZoneId=None):
        super(UserSettings_14Sub, self).__init__(FirstName, LastName, CultureCode, RegionCode, TimeZoneId, )
...
class UserSettingsGMailSync_16Sub(supermod.UserSettingsGMailSync_16):
    def __init__(self, SyncApplicationId=None, IsEnabled=None, AuthorizationCode=None, RefreshToken=None, Account=None, MarkAsRead=None, ImportDayRange=None):
        super(UserSettingsGMailSync_16Sub, self).__init__(SyncApplicationId, IsEnabled, AuthorizationCode, RefreshToken, Account, MarkAsRead, ImportDayRange, )
...
class UserSettingsMicrosoftExchangeSync_16Sub(supermod.UserSettingsMicrosoftExchangeSync_16):
    def __init__(self, SyncApplicationId=None, IsEnabled=None, Email=None, Secret=None, Domain=None, MarkAsRead=None, ImportDayRange=None):
        super(UserSettingsMicrosoftExchangeSync_16Sub, self).__init__(SyncApplicationId, IsEnabled, Email, Secret, Domain, MarkAsRead, ImportDayRange, )
...
class Feed_19Sub(supermod.Feed_19):
    def __init__(self, DiscussionListPage=None):
        super(Feed_19Sub, self).__init__(DiscussionListPage, )
supermod.Feed_19.subclass = Feed_19Sub
# end class Feed_19Sub
...
class AgendaSummary_22Sub(supermod.AgendaSummary_22):
    def __init__(self, ListOfFirstItems=None, ListOfUpcomingItems=None):
        super(AgendaSummary_22Sub, self).__init__(ListOfFirstItems, ListOfUpcomingItems, )
...
class AppointmentRecurrence_20Sub(supermod.AppointmentRecurrence_20):
    def __init__(self, RecurrenceInterval=None, RecurrenceType=None, RecurrenceStopTime=None, RecurrenceDayOfWeek=None, RecurrenceMonth=None):
        super(AppointmentRecurrence_20Sub, self).__init__(RecurrenceInterval, RecurrenceType, RecurrenceStopTime, RecurrenceDayOfWeek, RecurrenceMonth, )
...
class Menu_21Sub(supermod.Menu_21):
    def __init__(self, MenuItemList=None, Paging=None, BadgeCountTotal=None, HasUnreadItems=None):
        super(Menu_21Sub, self).__init__(MenuItemList, Paging, BadgeCountTotal, HasUnreadItems, )
supermod.Menu_21.subclass = Menu_21Sub
# end class Menu_21Sub


class ListOfMenutItems_21Sub(supermod.ListOfMenutItems_21):
    def __init__(self, MenuItem=None):
        super(ListOfMenutItems_21Sub, self).__init__(MenuItem, )
supermod.ListOfMenutItems_21.subclass = ListOfMenutItems_21Sub
# end class ListOfMenutItems_21Sub


class MenuItem_21Sub(supermod.MenuItem_21):
    def __init__(self, Resource=None, LastPost=None, LastUnreadPost=None, OldestUnreadPost=None, BadgeCount=None, BadgeCountCardStream=None, BadgeCountChatStream=None, Modified=None, SortModified=None):
        super(MenuItem_21Sub, self).__init__(Resource, LastPost, LastUnreadPost, OldestUnreadPost, BadgeCount, BadgeCountCardStream, BadgeCountChatStream, Modified, SortModified, )
supermod.MenuItem_21.subclass = MenuItem_21Sub
# end class MenuItem_21Sub


class Menu_20Sub(supermod.Menu_20):
    def __init__(self, MenuItemList=None, Paging=None, BadgeCountTotal=None, HasUnreadItems=None):
        super(Menu_20Sub, self).__init__(MenuItemList, Paging, BadgeCountTotal, HasUnreadItems, )
supermod.Menu_20.subclass = Menu_20Sub
# end class Menu_20Sub


class ListOfMenutItems_20Sub(supermod.ListOfMenutItems_20):
    def __init__(self, MenuItem=None):
        super(ListOfMenutItems_20Sub, self).__init__(MenuItem, )
supermod.ListOfMenutItems_20.subclass = ListOfMenutItems_20Sub
# end class ListOfMenutItems_20Sub


class MenuItem_20Sub(supermod.MenuItem_20):
    def __init__(self, Resource=None, LastPost=None, LastUnreadPost=None, OldestUnreadPost=None, BadgeCount=None, BadgeCountCardStream=None, BadgeCountChatStream=None, Modified=None, SortModified=None):
        super(MenuItem_20Sub, self).__init__(Resource, LastPost, LastUnreadPost, OldestUnreadPost, BadgeCount, BadgeCountCardStream, BadgeCountChatStream, Modified, SortModified, )
supermod.MenuItem_20.subclass = MenuItem_20Sub
# end class MenuItem_20Sub
...
class AnalysisPost_22Sub(supermod.AnalysisPost_22):
    def __init__(self, PostId=None, Mentions=None, Questions=None):
        super(AnalysisPost_22Sub, self).__init__(PostId, Mentions, Questions, )
supermod.AnalysisPost_22.subclass = AnalysisPost_22Sub
# end class AnalysisPost_22Sub
...
class StreamBase_22Sub(supermod.StreamBase_22):
    def __init__(self, IsVisible=None, LastPost=None, LastUnreadPost=None, BadgeCount=None, BadgeCountCardStream=None, BadgeCountChatStream=None, SortModified=None, Parent=None):
        super(StreamBase_22Sub, self).__init__(IsVisible, LastPost, LastUnreadPost, BadgeCount, BadgeCountCardStream, BadgeCountChatStream, SortModified, Parent, )
...
class PostUnread_22Sub(supermod.PostUnread_22):
    def __init__(self, Unread=None, Parent=None, ParentStream=None):
        super(PostUnread_22Sub, self).__init__(Unread, Parent, ParentStream, )
...
class Group_17Sub(supermod.Group_17):
    def __init__(self, Description=None, Email=None, ShareOnlyMembers=None, ShareOnlyMembersCount=None, Members=None, MemberCount=None, Administrators=None, AdministratorCount=None, Boards=None):
        super(Group_17Sub, self).__init__(Description, Email, ShareOnlyMembers, ShareOnlyMembersCount, Members, MemberCount, Administrators, AdministratorCount, Boards, )
...
class Appointment_22Sub(supermod.Appointment_22):
    def __init__(self, CalendarUId=None, AppointmentTime=None, Location=None, LocationImage=None, LocationLat=None, LocationLng=None, Attendees=None, Recurrence=None, Reminder=None, IsCanceled=None, Response=None):
        super(Appointment_22Sub, self).__init__(CalendarUId, AppointmentTime, Location, LocationImage, LocationLat, LocationLng, Attendees, Recurrence, Reminder, IsCanceled, Response, )
...
class DiscussionCard_22Sub(supermod.DiscussionCard_22):
    def __init__(self, PostListPage=None, MoreUnreadCount=None, TotalUnreadCount=None, FirstPost=None, PreviousPost=None, ShareList=None, VisibilityListCount=None, PinnedToList=None, Files=None, Author=None, ManagedByAssistant=None, RelatedCardCount=None, IsForward=None, CombinedCardId=None):
        super(DiscussionCard_22Sub, self).__init__(PostListPage, MoreUnreadCount, TotalUnreadCount, FirstPost, PreviousPost, ShareList, VisibilityListCount, PinnedToList, Files, Author, ManagedByAssistant, RelatedCardCount, IsForward, CombinedCardId, )
