...
class ApiClient(endpoints.ApiEndpoints):
    ...
    def __init__(self, username, password, auth_type, certificate=DEFAULT_CERTIFICATE,
                 impersonate_user_id=None, impersonate_only_once=False,
