...
class ListOfBoardsPage_22Endpoint:
    ...
    def options(self, impersonate_user_id=None, accept_type=None):
        ...
        return fill(ListOfBoardsPage_22, response.json(), content_type=response.headers['Content-Type'])
    
    def get(self, boardId, size, offset, boardType=None, impersonate_user_id=None, accept_type=None):
        """
