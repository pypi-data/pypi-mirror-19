...
class ListOfNotificationsPage_15Endpoint:
    ...
    def options(self, impersonate_user_id=None, accept_type=None):
        ...
        return fill(ListOfNotificationsPage_15, response.json(), content_type=response.headers['Content-Type'])
    
    def get(self, size, offset, longPolling, sinceId=None, impersonate_user_id=None, accept_type=None):
        """
