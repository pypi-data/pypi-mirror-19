...
class SearchGroup_18Endpoint:
    ...
    def options(self, impersonate_user_id=None, accept_type=None):
        ...
        return fill(SearchGroup_18, response.json(), content_type=response.headers['Content-Type'])
    
    def get(self, searchGroupId, size, offset, searchQuery=None, searchScope=None, sort=None, sortDirection=None, impersonate_user_id=None, accept_type=None):
        """
