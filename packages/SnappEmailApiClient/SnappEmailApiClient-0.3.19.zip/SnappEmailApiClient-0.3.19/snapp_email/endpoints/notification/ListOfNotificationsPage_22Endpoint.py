...
class ListOfNotificationsPage_22Endpoint:
    ...
    def options(self, impersonate_user_id=None, accept_type=None):
        ...
        return fill(ListOfNotificationsPage_22, response.json(), content_type=response.headers['Content-Type'])
    
    def get(self, size, offset, sinceId=None, notificationType=None, sortDirection=None, returnFullResource=None, skipOlderThan=None, skipMuted=None, impersonate_user_id=None, accept_type=None):
        """
    ...
    def get_2(self, size, offset, sinceId=None, skipNotificationType=None, sortDirection=None, returnFullResource=None, skipOlderThan=None, skipMuted=None, impersonate_user_id=None, accept_type=None):
        """
        Get notification list.
    ...
    def get_3(self, sinceId, size, offset, longPolling, returnFullResource=None, skipOlderThan=None, skipMuted=None, impersonate_user_id=None, accept_type=None):
        """
