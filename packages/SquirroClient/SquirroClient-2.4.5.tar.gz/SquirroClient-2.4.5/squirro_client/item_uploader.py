...
class ItemUploader(object):
    ...
    def __init__(self, token=None, project_id=None, project_title=None,
        ...
        # include 500 in the status codes for retry handling, this makes the
        # actual data loading more robust for transient failures (e.g. topic
        # proxy outages) which are reported as 500
        self._create_squirro_client(
            client_cls, retry_status_forcelist=frozenset([500, 502, 503, 504]),
