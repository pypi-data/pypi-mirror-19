...
"""
# Package name
__pkg_name__ = u"alignak_module_nrpe_booster"

# Module type for PyPI keywords
# Used for:
# - PyPI keywords
__module_types__ = u"checks"
...
__git_url__ = u"https://github.com/Alignak-monitoring-contrib/alignak-modules-nrpe-booster"
__doc_url__ = u"http://alignak-doc.readthedocs.io/en/latest"
__description__ = u"Alignak - Poller module to boost NRPE checks"
