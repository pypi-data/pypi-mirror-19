...
class RenewInstanceRequest(RpcRequest):
	...
	def get_CovertDiskPortable1DiskId(self):
		return self.get_query_params().get('CovertDiskPortable.1.DiskId')

	def set_CovertDiskPortable1DiskId(self,CovertDiskPortable1DiskId):
		self.add_query_param('CovertDiskPortable.1.DiskId',CovertDiskPortable1DiskId)

	def get_CovertDiskPortable2DiskId(self):
		return self.get_query_params().get('CovertDiskPortable.2.DiskId')

	def set_CovertDiskPortable2DiskId(self,CovertDiskPortable2DiskId):
		self.add_query_param('CovertDiskPortable.2.DiskId',CovertDiskPortable2DiskId)

	def get_CovertDiskPortable3DiskId(self):
		return self.get_query_params().get('CovertDiskPortable.3.DiskId')

	def set_CovertDiskPortable3DiskId(self,CovertDiskPortable3DiskId):
		self.add_query_param('CovertDiskPortable.3.DiskId',CovertDiskPortable3DiskId)

	def get_CovertDiskPortable4DiskId(self):
		return self.get_query_params().get('CovertDiskPortable.4.DiskId')

	def set_CovertDiskPortable4DiskId(self,CovertDiskPortable4DiskId):
		self.add_query_param('CovertDiskPortable.4.DiskId',CovertDiskPortable4DiskId)