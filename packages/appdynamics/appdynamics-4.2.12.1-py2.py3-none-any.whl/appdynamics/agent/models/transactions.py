...
class Transaction(object):
    ...
    def start_exit_call(self, caller, backend, operation=None, params=None, category=None):
        ...
        try:
            ...
            caller_info = callgraph.FrameInfo(caller)
            ...
            exit_call = exitcalls.ExitCall(sequence_info, timer, backend, category, params, caller_info,
                                           operation=operation)
    ...
    def end_exit_call(self, exit_call, end_frame, exc_info=None):
        ...
        if exit_call in self._active_exit_calls:
            end_frame_info = callgraph.FrameInfo(end_frame)
