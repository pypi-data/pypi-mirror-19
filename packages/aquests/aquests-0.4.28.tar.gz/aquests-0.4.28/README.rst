...
- url: request url string, should start with 'ws://' or 'wss://'
- params: string or tuple. if messages is not string you specify message type code like (ws.OPCODE_BINARY, b"binary"), you can find OPCODE list, 'from aquests.protocols import ws'
