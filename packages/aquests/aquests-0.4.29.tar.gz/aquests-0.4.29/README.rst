...
- params: string or tuple. if messages is not string you specify message type code using tuple like (ws.OPCODE_BINARY, b"binary"), you can find OPCODE list, 'from aquests.protocols import ws'. (as you guess, default opcode is OPCODE_TEXT).
