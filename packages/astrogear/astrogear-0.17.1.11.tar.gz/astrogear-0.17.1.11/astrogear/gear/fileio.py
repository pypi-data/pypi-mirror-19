...
__all__ = [
    ...
    "load_with_classes", "slugify", "write_lf", "int_vector", "overwrite_fits", "float_vector",
...
def load_with_classes(filename, classes):
    ...
    for class_ in classes:
        ...
        #     raise
            ...
            if ag.logging_level == logging.DEBUG:
                get_python_logger().exception("Error trying with class \"{0!s}\"".format( \
                                              class_.__name__))
            pass
        if ok:
            break
