...
def __get_vega_spectrum():
    ...
    if __vega_spectrum is None:
        __vega_spectrum = pa.load_spectrum(pa.get_data_path("pysynphot-vega-fnu.xy"), module=ag)
    return __vega_spectrum

def get_vega_spectrum():
    """Returns Spectrum of Vega"""
    return pa.load_spectrum(pa.get_data_path("pysynphot-vega-fnu.xy"))
...
class Bandpass(object):
    ...
    def __rmul__(self, other):
        ...
        if isinstance(other, pa.Spectrum):
