...
class WDBRegistry(WBase):
    ...
    def __init__(self, *args):
        ...
        # ## Actions
        action = self.action_insert = QAction(ag.get_icon("list-add"), "&Insert...", self)
        action.triggered.connect(self.on_insert)
        action.setShortcut("Ins")

        action = self.action_edit = QAction(ag.get_icon("gtk-edit"), "&Edit...", self)
        action.triggered.connect(self.on_edit)
        action.setShortcut("Enter")

        action = self.action_delete = QAction(ag.get_icon("trash"), "&Delete", self)
