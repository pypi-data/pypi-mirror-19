...
__all__ = [
    ...
    "format_title1", "format_title2", "style_widget_valid"
]
...
def enc_name_descr(name, descr, color=ag.COLOR_DESCR):
    """Encodes html given name and description."""
    return enc_name(name, color)+"<br>"+descr


def enc_name(name, color=ag.COLOR_DESCR):
...
def get_icon(keyword):
    ...
    filename = ag.get_path("data", "icons", keyword + ".png")
    ret = QIcon(filename)
    return ret
