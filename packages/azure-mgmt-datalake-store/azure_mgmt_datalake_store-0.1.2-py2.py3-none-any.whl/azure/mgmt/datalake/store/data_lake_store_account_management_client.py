...
class DataLakeStoreAccountManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        super(DataLakeStoreAccountManagementClientConfiguration, self).__init__(base_url, filepath)
...
class DataLakeStoreAccountManagementClient(object):
    ...
    def __init__(
        ...
        self.config = DataLakeStoreAccountManagementClientConfiguration(credentials, subscription_id, api_version, accept_language, long_running_operation_retry_timeout, generate_client_request_id, base_url, filepath)
