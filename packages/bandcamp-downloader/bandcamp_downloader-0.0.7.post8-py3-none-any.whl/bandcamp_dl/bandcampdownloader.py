...
class BandcampDownloader:
    def __init__(self, urls=None, template=None, directory=None, overwrite=False, lyrics=False):
        ...
        """
        self.headers = {'user_agent': 'bandcamp-dl/0.0.7-08 (https://github.com/iheanyi/bandcamp-dl)'}
    ...
    def write_id3_tags(self, filepath: str, meta: dict):
        ...
        if self.lyrics is not False:
            audio["USLT::'eng'"] = (USLT(encoding=3, lang='eng', desc='', text=meta['lyrics']))
