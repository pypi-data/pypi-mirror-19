...
#. (\ *Optional*\ ) **Test the installation of this release.** If installation
   ...
   #. **Test this release on** `Test PyPI`_ by following `these instructions
      <Test PyPI instructions_>`__, omitted here to avoid desynchronization with
      upstream's moving target.
