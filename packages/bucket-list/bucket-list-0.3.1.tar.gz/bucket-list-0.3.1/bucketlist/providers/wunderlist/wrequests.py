...
def raise_if_error(resp):
    if resp is None:
        raise BucketlistError("Failed to get a valid response from Wunderlist."
    ...
    if 'error' in resp:
        ...
        raise BucketlistError(resp['error']['message'], error_code=resp['error'].get('type'))
...
class WRequests:
    ...
    def delete(*args, **kwargs):
        ...
        resp = requests.delete(*args, **kwargs, headers=headers)
