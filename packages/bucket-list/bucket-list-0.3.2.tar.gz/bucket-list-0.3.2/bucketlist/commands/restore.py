...
class RestoreCommand:
    ...
    def execute(self, argv):
        ...
        try:
            ...
            speedyio.error("Data restored failed from {}. Please try again.".format(optmap['file']))
            speedyio.error(e.description)
        except Exception as e:
            logger.exception(e)
            speedyio.error("Data restored failed from {}. Please check logs.".format(optmap['file']))
        else:
