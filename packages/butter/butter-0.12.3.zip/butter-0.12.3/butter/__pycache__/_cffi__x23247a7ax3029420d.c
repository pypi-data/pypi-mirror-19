...
PyMODINIT_FUNC
PyInit__cffi__x23247a7ax3029420d(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x23247a7ax3029420d(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x23247a7ax3029420d", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
