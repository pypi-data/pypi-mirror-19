...
static PyObject *
_cffi_f_getpid(PyObject *self, PyObject *no_arg)
{
  int32_t result;
...
static PyObject *
_cffi_f_getppid(PyObject *self, PyObject *no_arg)
{
  int32_t result;
...
PyMODINIT_FUNC
PyInit__cffi__x2dd3f2f8xba290b23(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x2dd3f2f8xba290b23(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x2dd3f2f8xba290b23", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
