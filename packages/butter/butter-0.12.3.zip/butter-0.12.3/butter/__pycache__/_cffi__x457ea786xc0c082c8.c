...
PyMODINIT_FUNC
PyInit__cffi__x457ea786xc0c082c8(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x457ea786xc0c082c8(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x457ea786xc0c082c8", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
