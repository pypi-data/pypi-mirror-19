...
_CGAL_Polygon_mesh_processing.CGAL_VERSION_swigconstant(_CGAL_Polygon_mesh_processing)
CGAL_VERSION = _CGAL_Polygon_mesh_processing.CGAL_VERSION

_CGAL_Polygon_mesh_processing.CGAL_VERSION_NR_swigconstant(_CGAL_Polygon_mesh_processing)
CGAL_VERSION_NR = _CGAL_Polygon_mesh_processing.CGAL_VERSION_NR

_CGAL_Polygon_mesh_processing.CGAL_SVN_REVISION_swigconstant(_CGAL_Polygon_mesh_processing)
CGAL_SVN_REVISION = _CGAL_Polygon_mesh_processing.CGAL_SVN_REVISION

_CGAL_Polygon_mesh_processing.CGAL_VERSION_STR_swigconstant(_CGAL_Polygon_mesh_processing)
...
def bbox_3(P):
    return _CGAL_Polygon_mesh_processing.bbox_3(P)
bbox_3 = _CGAL_Polygon_mesh_processing.bbox_3
