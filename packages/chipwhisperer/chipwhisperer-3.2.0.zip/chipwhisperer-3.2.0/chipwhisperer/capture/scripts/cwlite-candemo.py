...
class UserScript(UserScriptBase):
    _name = "VOLPE Demo #1: CAN-XOR on MPC"
    ...
    def run(self):
        ...
        self.api.setParameter(['Generic Settings', 'Target Module', 'Peak CAN with Simple Interface'])
        ...
        lstexample = [['OpenADC', 'Clock Setup', 'CLKGEN Settings', 'Multiply', 2],
        ...
        self.api.setParameter(['Generic Settings', 'Acquisition Settings', 'Number of Traces', 2000])
