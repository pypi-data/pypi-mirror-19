...
def name():
    return "ChipWhisperer-Rev2: AtMega48A VCC Glitch Target"
...
class userScript(QObject):
    ...
    def run(self):
        ...
        lstexample = [['CW Extra', 'CW Extra Settings', 'Target HS IO-Out', 'Disabled'],
                      ...
                      ['OpenADC', 'Trigger Setup', 'Pre-Trigger Samples', 400],
                      ...
                      ['Glitch Module', 'Clock Source', 'Target IO-IN'],
                      ['Glitch Module', 'Glitch Trigger', 'Manual'],
                      ['Glitch Module', 'Glitch Width (as % of period)', 45],
                      ['Glitch Module', 'Glitch Offset (as % of period)', 46],
                      ['Glitch Module', 'Repeat', 49],
                      ['Glitch Module', 'Output Mode', 'Glitch Only'],
                      ['CW Extra', 'CW Extra Settings', 'Target HS IO-Out', 'Glitch Module'],
                      ['Glitch Module', 'Glitch Trigger', 'External Trigger'],
                      ['Target Connection', 'Output Format', u'$GLITCH$'],
                      ['Generic Settings', 'Auxiliary Module', 'Reset AVR via ISP-MKII'],
                      ['Glitch Explorer', 'Successful Response', u's.endswith("A1234")'],
                      ['Glitch Explorer', 'Normal Response', u's.endswith("A")']
                      ]
