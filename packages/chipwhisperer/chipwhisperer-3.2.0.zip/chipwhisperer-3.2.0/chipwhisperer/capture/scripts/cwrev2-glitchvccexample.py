...
def name():
    return "ChipWhisperer-Rev2: VCC Glitch Target"
...
class userScript(QObject):
    ...
    def run(self):
        ...
        lstexample = [['CW Extra', 'CW Extra Settings', 'Target HS IO-Out', 'Disabled'],
                      ...
                      ['Glitch Module', 'Glitch Width (as % of period)', 40],
                      ['Glitch Module', 'Glitch Offset (as % of period)', 45],
                      ['Glitch Module', 'Repeat', 11],
