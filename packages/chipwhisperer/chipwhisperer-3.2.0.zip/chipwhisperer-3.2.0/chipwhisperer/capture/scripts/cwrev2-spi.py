...
def name():
    return "ChipWhisperer-Rev2: SPI Test Board"

def tip():
    return "SimpleSerial with SPI Test Board"
...
class userScript(QObject):
    ...
    def run(self):
        ...
        cap.setParameter(['Generic Settings', 'Target Module', 'ChipWhisperer SPI'])
        ...
        lstexample = [['CW Extra', 'CW Extra Settings', 'Trigger Pins', 'Front Panel A', False],
                      ...
                      ['OpenADC', 'Clock Setup', 'CLKGEN Settings', 'Divide', 90],
                      ['OpenADC', 'Clock Setup', 'ADC Clock', 'Source', 'CLKGEN x4 via DCM'],
                      ['OpenADC', 'Trigger Setup', 'Total Samples', 1800],
        ...
        cap.setParameter(['Generic Settings', 'Acquisition Settings', 'Number of Traces', 5000])
