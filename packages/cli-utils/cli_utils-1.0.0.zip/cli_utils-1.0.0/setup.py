...
setup(
    ...
    url=u'https://bitbucket.org/daycoder/cli_utils.git',  # Use the url to the git repo
    download_url=(u'https://bitbucket.org/daycoder/'
                  u'cli_utils.git/get/{version}.tar'
    ...
    description=u"Utilities for Command Line Interfaces",
