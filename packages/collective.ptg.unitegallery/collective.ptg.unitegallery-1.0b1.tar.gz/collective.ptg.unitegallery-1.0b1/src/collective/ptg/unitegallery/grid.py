...
class IUniteGalleryGridSettings(IBaseSettings):
    ...
    grid_theme_hide_panel_under_width = schema.Int(
    ...
    grid_gallery_debug_errors = schema.Bool(
        ...
        default=True)
    grid_gallery_background_color = schema.TextLine(
