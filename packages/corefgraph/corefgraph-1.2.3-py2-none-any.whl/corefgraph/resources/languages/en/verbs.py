...
# As stanford
copulative = list_checker(("is","are","were", "was","be", "been","become","became","becomes","seem","seemed","seems","remain","remains","remained"))
...
pleonastic_verbs_full = list_checker(("is", "was", "be", "becomes", "become", "became"))
