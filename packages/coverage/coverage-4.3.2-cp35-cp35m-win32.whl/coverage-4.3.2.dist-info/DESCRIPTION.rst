...
.. |codecov| image:: http://codecov.io/github/nedbat/coveragepy/coverage.svg?branch=master
    ...
    :alt: Coverage!
.. |commits-since| image:: https://img.shields.io/github/commits-since/nedbat/coveragepy/coverage-4.3.2.svg
    :target: https://github.com/nedbat/coveragepy/compare/coverage-4.3.2...master
    :alt: See latest work
