...
from crysp.utils.operators import rol,ror,concat
...
class AES(object):
    ...
    def enc(self,M):
        Nb=4
        state = Poly(Bits(M).split(8),size=8)
        w = self.keyschedule()
...
def Sbox(state):
    ...
    [0x63, 0x7c, 0x77, 0x7b, 0xf2, 0x6b, 0x6f, 0xc5, 0x30, 0x01, 0x67,
     ...
     0x54, 0xbb, 0x16],size=8)
    return sboxtable[state.ival]
...
def Sbox_inv(state):
    ...
    [0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38, 0xbf, 0x40, 0xa3,
     ...
     0x21, 0x0c, 0x7d],size=8)
    return sboxinvtable[state.ival]
