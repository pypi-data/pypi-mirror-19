...
from cubicweb.predicates import (adaptable, has_related_entities, is_instance,
                                 match_user_groups, one_line_rset, score_entity)
from cubicweb.uilib import js
from cubicweb.utils import json_dumps
from cubicweb.web import Redirect, action, component, facet as cwfacet, formwidgets as fw
...
class CkanJsonLicensesAction(action.Action):
    ...
    __select__ = (one_line_rset() & is_instance('ConceptScheme')
...
pvdc.tag_subject_of(('DataCatalog', 'license', '*'), {'vid': 'incontext'})
...
pvdc.tag_subject_of(('Distribution', 'license', '*'), {'vid': 'incontext'})
...
affk.set_fields_order('ResourceFeed',
                      ('title', 'url', 'media_type', 'validation_script',
