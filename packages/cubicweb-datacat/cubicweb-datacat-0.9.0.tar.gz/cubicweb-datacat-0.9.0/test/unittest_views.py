    ...
    def setup_database(self):
        ...
        with patch('cubes.datacat.hooks.datetime') as mock_dt:
            ...
            with self.admin_access.repo_cnx() as cnx:
                ...
                # Patch download_url to have Distribution's access_url
                # predictable.
                with patch('cubes.file.entities.FileIDownloadableAdapter.download_url',
                           return_value=u'http://example.org/abc/download'):
