...
import cubicweb.devtools  # noqa (needed to set PYTHONPATH)

from cubes.datacat.vocabularies import capitalized_eurovoc_domain, eurovoc_domains, simplify_eurovoc
from cubes.skos import rdfio


class EurovocTC(TestCase):
