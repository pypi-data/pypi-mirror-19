...
class Coopy(object):
    ...
    def runDiff(self,parent,a,b,flags,output):
        ...
        self.saveTables(output,os,self.useColor(flags,output),True)
            ...
            while (_g3 < w):
                ...
                if (sizes is not None):
                    ...
                    while (_g5 < spaces):
                        ...
                        at = (at + 1)
                if (x > 0):
                    txt = (("null" if txt is None else txt) + HxOverrides.stringOrNull((((HxOverrides.stringOrNull(self.codes.h.get("minor",None)) + HxOverrides.stringOrNull(self.delim)) + HxOverrides.stringOrNull(self.codes.h.get("done",None))))))
