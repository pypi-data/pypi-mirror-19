...
import datetime
import logging
from typing import AnyStr, Any, Dict, Iterable, Sequence, Optional

# Non-standard library imports
import requests

# Package imports
from datacore.types import Header, Query, Payload, EndpointDefinition, Endpoints
...
class Access(object):
    ...
    def number_of_entries(self, url: AnyStr, query: Query=None) \
            -> int:
        """
    ...
    def get(self, url: AnyStr, query: Query=None, fields: Optional[Iterable[str]]=None, sort: AnyStr='', sync: bool=False, agg: bool=False, limit: int=1000) \
            -> Payload:
    ...
    def chunk(data: Payload, chunk_size=500) \
        ...
        try:
            ...
            message = "Failed to prepare data for posting. Data: {d}; Data type {t}".format(d=data, t=type(data))
            raise DatacoreException(
