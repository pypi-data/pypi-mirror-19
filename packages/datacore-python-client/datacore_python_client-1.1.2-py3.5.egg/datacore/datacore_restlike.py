...
class Endpoints(collections.UserDict):
    ...
    """
    def __init__(self, read: AnyStr, write: AnyStr, bulk: AnyStr, agg: AnyStr, version: SupportsInt):
        """

        :param read: Read endpoint
    ...
    def get(self, url: AnyStr, query: Union[AggregationQuery, Query]=None, fields: Optional[Iterable[str]]=None, sort: AnyStr='', sync: bool=False, agg: bool=False, limit: int=1000) \
        ...
        while page < max_page:
            ...
            if not agg:
                ...
                qurl = base + "?limit={l}&page={p}".format(l=limit, p=page)
            else:
