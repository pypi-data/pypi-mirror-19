...
setup(
  name = 'dataflowkit',
  packages = ['dataflowkit'], # this must be the same as the name above
  version = '0.1.1',
  ...
  download_url = 'https://github.com/IcarusSO/dataflowkit/tarball/0.1.1', # I'll explain this in a second
