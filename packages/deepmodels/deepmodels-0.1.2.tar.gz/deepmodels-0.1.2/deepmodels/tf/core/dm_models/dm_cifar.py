...
class CIFARDM(model_zoo.NetworkDM):
  """DeepModels version of CIFAR.
  """
  cifar10_params = commons.ModelParams(
      model_name=commons.ModelTypes.model_names[commons.ModelTypes.CIFAR10],
      model_type=commons.ModelTypes.CIFAR10,
      input_img_width=32,
      input_img_height=32,
      cls_num=10)
  cifar100_params = commons.ModelParams(
      model_name=commons.ModelTypes.model_names[commons.ModelTypes.CIFAR100],
      model_type=commons.ModelTypes.CIFAR100,
      input_img_width=32,
      input_img_height=32,
      cls_num=100)

  def __init__(self, net_type=commons.ModelTypes.CIFAR10):
    if net_type == commons.ModelTypes.CIFAR10:
      self.net_params = self.cifar10_params
    elif net_type == commons.ModelTypes.CIFAR100:
  ...
  def get_label_names(self):
    ...
    if self.net_params.model_type == commons.ModelTypes.CIFAR10:
