...
class setup_window:
    ...
    def on_load_session_button_call(self):
        ...
        self.demog_main.app_output_box_window.output_box.insert(INSERT,'   edit its numerical value. WARNING: there is a known\n')
        self.demog_main.app_output_box_window.output_box.insert(INSERT,'   bug with "v" (being resolved). If your window freezes,\n')
        self.demog_main.app_output_box_window.output_box.insert(INSERT,'   close it and click "Draw History" again.\n')
