...
def ticker_Bitcoin(
    ...
    # example:
    #     {
    #         'volume':    '10353.98005387',
    #         'last':      '882.01',
    #         'timestamp': '1484667579',
    #         'bid':       '882.01',
    #         'vwap':      '860.38',
    #         'high':      '896.23',
    #         'low':       '827.00',
    ...
    # Convert currency USD to requested currency.
    ...
    for key in data_dictionary:
        if key == "timestamp":
            ...
            data_dictionary_currency[key] = converter_currency.convert(
