...
class CommandV(Extensible):
    ...
    def create_db_demo(self, without_db=False, without_demo=False):
        """This method creates a default database with demonstration data.

        :param without_db: Database is not created.
        :type without_db: bool
        :param without_demo: Demo data is not loaded.
        :type without_demo: bool
