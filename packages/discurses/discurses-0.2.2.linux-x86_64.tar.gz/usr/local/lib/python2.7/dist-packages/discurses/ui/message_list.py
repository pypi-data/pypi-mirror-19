...
class Sidebar(urwid.WidgetWrap):
    def __init__(self, chat_widget):
        ...
        self.chat_widget.discord.event_handlers["on_member_join"] += self.update_list
        self.chat_widget.discord.event_handlers["on_member_remove"] += self.update_list
        self.chat_widget.discord.event_handlers["on_member_update"] += self.update_list
