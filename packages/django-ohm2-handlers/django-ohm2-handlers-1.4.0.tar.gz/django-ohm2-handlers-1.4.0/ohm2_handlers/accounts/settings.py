...
SIGNUP_PIPELINE = getattr(settings, APP + 'SIGNUP_PIPELINE', (
	'ohm2_handlers.accounts.pipelines.user_settings',
	'ohm2_handlers.accounts.pipelines.user_keys',
	'ohm2_handlers.accounts.pipelines.user_avatars',
	'ohm2_handlers.accounts.pipelines.user_referalcode',
	'ohm2_handlers.accounts.pipelines.user_authtoken',
	'ohm2_handlers.accounts.pipelines.user_crypto',
))
