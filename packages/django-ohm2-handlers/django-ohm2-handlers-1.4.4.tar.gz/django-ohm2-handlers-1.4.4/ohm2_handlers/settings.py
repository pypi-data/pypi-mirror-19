...
GOOGLE_RECAPTCHA_SECRET = getattr(settings, APP + 'GOOGLE_RECAPTCHA_SECRET', "")
GOOGLE_RECAPTCHA_VERIFY_URL = getattr(settings, APP + 'GOOGLE_RECAPTCHA_VERIFY_URL', "https://www.google.com/recaptcha/api/siteverify")
