...
_PARAMETERS = _descriptor.Descriptor(
  name='Parameters',
  full_name='dstore.engine.om_GetGroupSurcharges_Ad.Parameters',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='group_id', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Parameters.group_id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='group_id_null', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Parameters.group_id_null', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tree_node_id', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Parameters.tree_node_id', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tree_node_id_null', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Parameters.tree_node_id_null', index=3,
...
_RESPONSE_ROW = _descriptor.Descriptor(
  name='Row',
  full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='row_id', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.row_id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='relative', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.relative', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unit_symbol', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.unit_symbol', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='surcharge_value', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.surcharge_value', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='group_id', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.group_id', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='group_description', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.group_description', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='node_description', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.node_description', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='active', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.active', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unit_id', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.unit_id', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='brutto', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.brutto', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tree_node_id', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.tree_node_id', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='node_id', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.node_id', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='surcharge_type_description', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.surcharge_type_description', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='surcharge_type_id', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.surcharge_type_id', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='level_id', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.Row.level_id', index=14,
...
_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='meta_information', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.meta_information', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.message', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='row', full_name='dstore.engine.om_GetGroupSurcharges_Ad.Response.row', index=2,
...
Parameters = _reflection.GeneratedProtocolMessageType('Parameters', (_message.Message,), dict(
  ...
  __module__ = 'dstore.engine.procedures.om_GetGroupSurcharges_Ad_pb2'
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\033io.dstore.engine.proceduresZ:gosdk.dstore.de/engine/procedures/om_GetGroupSurcharges_Ad'))
import grpc
