...
_PARAMETERS = _descriptor.Descriptor(
  name='Parameters',
  full_name='dstore.engine.om_GetTaxes.Parameters',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tax_type_id', full_name='dstore.engine.om_GetTaxes.Parameters.tax_type_id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tax_type_id_null', full_name='dstore.engine.om_GetTaxes.Parameters.tax_type_id_null', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='date', full_name='dstore.engine.om_GetTaxes.Parameters.date', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='date_null', full_name='dstore.engine.om_GetTaxes.Parameters.date_null', index=3,
...
_RESPONSE_ROW = _descriptor.Descriptor(
  name='Row',
  full_name='dstore.engine.om_GetTaxes.Response.Row',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='row_id', full_name='dstore.engine.om_GetTaxes.Response.Row.row_id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tax_type', full_name='dstore.engine.om_GetTaxes.Response.Row.tax_type', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tax_type_id', full_name='dstore.engine.om_GetTaxes.Response.Row.tax_type_id', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='valid_to', full_name='dstore.engine.om_GetTaxes.Response.Row.valid_to', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tax_rate', full_name='dstore.engine.om_GetTaxes.Response.Row.tax_rate', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='valid_from', full_name='dstore.engine.om_GetTaxes.Response.Row.valid_from', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='surcharge_type_id', full_name='dstore.engine.om_GetTaxes.Response.Row.surcharge_type_id', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='surcharge_type_category_id', full_name='dstore.engine.om_GetTaxes.Response.Row.surcharge_type_category_id', index=7,
...
_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='dstore.engine.om_GetTaxes.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='meta_information', full_name='dstore.engine.om_GetTaxes.Response.meta_information', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='dstore.engine.om_GetTaxes.Response.message', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='row', full_name='dstore.engine.om_GetTaxes.Response.row', index=2,
...
_RESPONSE_ROW.fields_by_name['tax_type'].message_type = dstore_dot_values__pb2._STRINGVALUE
_RESPONSE_ROW.fields_by_name['tax_type_id'].message_type = dstore_dot_values__pb2._INTEGERVALUE
...
Parameters = _reflection.GeneratedProtocolMessageType('Parameters', (_message.Message,), dict(
  ...
  __module__ = 'dstore.engine.procedures.om_GetTaxes_pb2'
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\033io.dstore.engine.proceduresZ-gosdk.dstore.de/engine/procedures/om_GetTaxes'))
import grpc
