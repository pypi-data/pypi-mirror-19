...
def create_2016_01_09a(silent=False):
    sys.argv = ["", "bucket", "create", "-name", "conerjbucket_2016_01_09a", "-fs", "false", "-ht", "S3", "-stale_allowed",
        "false", "-ns", "conerj", "-ts", "tag1^val1", "tag2^val2"]
    result = runCmd()
    printit(result, silent)

def update_tags_2016_01_09a(silent=False):
    sys.argv = ["", "bucket", "update-tags", "-name", "conerjbucket_2016_01_09a", "-ts", "tag3^val3"]
    result = runCmd()
    printit(result, silent)
