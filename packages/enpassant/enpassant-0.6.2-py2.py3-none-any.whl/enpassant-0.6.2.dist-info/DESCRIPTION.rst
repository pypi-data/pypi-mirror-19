...
.. |br-coverage| image:: https://img.shields.io/badge/test_coverage-98%25-blue.svg
...
* Version 0.6.2 updates testing for early 2017 Python
  ...
  2.7.12) and PyPy3 5.5.0 (based on 3.3.5). Python 3.2 is removed
  from support given it age and growin issues with testing frameworks.

* Version 0.6.1 bumps test coverage to 99%.
