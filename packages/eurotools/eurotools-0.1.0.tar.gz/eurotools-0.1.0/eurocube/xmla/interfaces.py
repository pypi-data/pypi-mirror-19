...
If not given, a default is made from the location URL's host called: HTTP@host"""),
    ...
    sslverify = zope.schema.TextLine(
        title=u("sslverify"),
        description=u("""Verify ssl certificate on ssl connections. Leave empty to accept any certifacte or point to a file on this server containing a certicate bundle"""),
        required=False
    )
