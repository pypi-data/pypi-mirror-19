...
from . import interfaces as oxi
import stoneCube.scripts.olap.interfaces as ooi
from .utils import u
from django.conf import settings
defaultwsdl = "file://" + settings.ROOT_DIR.root + "/stoneCube/scripts/xmla/vs.wsdl"
...
class XMLAClass(object):
    ...
    def getSchemaElements(self, schemaElementName, unique_name,
        ...
        if generate_instance:
            result = self.objectfactory(et["ELEMENT_CLASS"], et["PROPERTY_NAME"], schemaElementName, props)
        else:
            result = props
...
class XMLASource(XMLAConnection, XMLAClass):
    ...
    def __init__(self, urlwsdl=defaultwsdl,
        ...
        XMLAConnection.__init__(self, urlwsdl, location, username, password, spn, sslverify, **kwargs)
    ...
    def getCatalog(self, unique_name):
        return self.getSchemaElements("CATALOG", unique_name, aslist=unique_name is None)
...
class XMLACatalog(XMLAClass):
    ...
    def getDimension(self, unique_name):
        return self.getSchemaElements("CATALOG_DIMENSION", unique_name, aslist=unique_name is None)
    ...
    def getHierarchy(self, unique_name=None):
        return self.getSchemaElements("CATALOG_HIERARCHY", unique_name, aslist=unique_name is None)
    ...
    def getSet(self, unique_name=None):
        return self.getSchemaElements("CATALOG_SET", unique_name, aslist=unique_name is None)
    ...
    def getMeasure(self, unique_name):
        return self.getSchemaElements("CATALOG_MEASURE", unique_name, aslist=unique_name is None)
...
class XMLACube(XMLAClass):
    ...
    def getHierarchy(self, unique_name):
        return self.getSchemaElements("HIERARCHY", unique_name, aslist=unique_name is None)

    def getMeasures(self):
        return self.getMeasure(None)

    def getMeasure(self, unique_name):
        return self.getSchemaElements("MEASURE", unique_name, aslist=unique_name is None)

    def getSets(self):
        return self.getSet(None)

    def getSet(self, unique_name):
        return self.getSchemaElements("SET", unique_name, aslist=unique_name is None)

    def getDimensions(self):
        return self.getDimension(None)

    def getDimension(self, unique_name):
        return self.getSchemaElements("DIMENSION", unique_name, aslist=unique_name is None)
...
class XMLAHierarchy(XMLAClass):
    ...
    def getLevel(self, unique_name):
        return self.getSchemaElements("LEVEL", unique_name, aslist=unique_name is None)

    def getMembers(self):
        return self.getMember(None)

    def getMember(self, unique_name):
        return self.getSchemaElements("HIERARCHY_MEMBER", unique_name, aslist=unique_name is None)
