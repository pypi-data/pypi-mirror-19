    ...
    d.widget("ech.multiselect", {
        ...
        _create: function() {
            ...
            (this.headerLinkContainer = d("<ul />")).addClass("ui-helper-reset").html(function() {
                return !0 === b.header ? '<li><a class="ui-multiselect-all" href="#"><span class="ui-icon ui-icon-check" title="CkecKAll"></span><span>' + b.checkAllText + '</span></a></li><li><a class="ui-multiselect-none" href="#"><span class="ui-icon ui-icon-closethick" title="UncheckAll"></span><span>' + b.uncheckAllText + "</span></a></li>" : "string" === typeof b.header ? "<li>" + b.header + "</li>" : ""
            }).append('<li class="ui-multiselect-close"><a href="#" class="ui-multiselect-close"><span class="ui-icon ui-icon-circle-close" title="Close"></span></a></li>').appendTo(c);
        ...
        _bindEvents: function() {
            function a() {
                ...
                // $('.ui-multiselect-checkboxes.ui-helper-reset label[for="ui-multiselect-3-option-0"]')[0].focus()
                // $('.ui-multiselect-checkboxes.ui-helper-reset label[for="ui-multiselect-3-option-0"]').addClass('ui-state-hover')
                return !1
            }
            var b = this,
                c = this.button;
        ...
        _focusInput: function(keyevent, element){
            if((keyevent.keyCode >= 48) &&(keyevent.keyCode <= 90)){
                $(element).parent().parent().prev().find('input').val($(element).parent().parent().prev().find('input').val() + keyevent.key)
                $(element).parent().parent().prev().find('input').focus()
            }
