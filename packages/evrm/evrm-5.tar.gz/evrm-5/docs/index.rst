...
| Het toedienen van gif is een misdrijf tegen het leven gericht. 
...
Antipsychotica is een neurotoxine. Niet schadelijk, maar dodelijk.

.. raw: html

    <br>

| https://nl.wikipedia.org/wiki/Neurotoxine

| http://www.geneesmiddeleninformatiebank.nl/ords/f?p=111
| http://vergiftingen.info
...
De 6 weken test van Clozapine toont vergiftigings :ref:`symptomen <symptomen>`. Men weet dat men aan het vergiftigen is.
...
Aan de :ref:`(F)ACT <fact>` methodiek kan men zien dat men een opzet tot vergiftigen heeft, men zegt het toedienen van gif “verantwoord” te kunnen doen.
...
| Het OM moet vervolging instellen voor slachtoffers die dat zelf niet kunnen.
