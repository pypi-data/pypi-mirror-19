...
| De (F)ACT methodiek is levensbedreigend.
| Met toediening van antipsychotica pleegt men een :ref:`misdrijf tegen het leven gericht <wet>`.
| Het Openbaar Ministerie dient te vervolgen voor slachtoffers die dat zelf niet kunnen.
