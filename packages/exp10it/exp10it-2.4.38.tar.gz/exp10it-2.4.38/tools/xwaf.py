...
class Program(object):
    ...
    def __init__(self,url=None,useProxy=None):
        ...
        if has_entries == 1:
            self.returnValue="成功获取数据的命令是:\n%s" % eval(get_key_value_from_config_file(self.log_config_file, 'default', 'bypassed_command'))
            self.output.good_print(self.returnValue,'red')
