...
def execute_bearer_authentication(
        self, kind, token, settings, client_model, headers):
    ...
    client_id_from_payload = get_client_attribute_from_payload(
        payload, "ClientId", client_fields)
