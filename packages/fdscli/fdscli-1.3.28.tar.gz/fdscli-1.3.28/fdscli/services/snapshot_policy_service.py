...
class SnapshotPolicyService( AbstractService ):
    ...
    def edit_snapshot_policy(self, volume_id, policy ):
        ...
        url = "{}{}{}{}{}".format( self.get_url_preamble(), "/volumes/", volume_id, "/snapshot_policies/", policy.id )
        data = SnapshotPolicyConverter.to_json(policy)
    ...
    def get_snapshot_policy(self, volume_id, policy_id):
        '''
        just get a specific policy
        '''
        
        list_of_policies = self.list_snapshot_policies(volume_id)
