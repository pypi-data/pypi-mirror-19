...
from model.volume.recurrence_rule import Frequency
...
class TestSnapshotPolicyEdit(BaseCliTest):
    ...
    @patch( "services.snapshot_policy_service.SnapshotPolicyService.get_snapshot_policy", side_effect=mock_functions.getSnapshotPolicy)
