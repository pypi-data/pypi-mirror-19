...
from utils.converters.volume.safeguard_settings_converter import SafeGuardSettingsConverter
...
class VolumeConverter( object ):
    ...
    def build_volume_from_json( j_str ):
        ...
        if "safeguard" in j_str:
            volume.safeguard_settings = SafeGuardSettingsConverter.build_settings_from_json( j_str.pop("safeguard"))
    ...
    def to_json( volume ):
        ...
        d["safeguard"] = json.loads(j_safeguard)
