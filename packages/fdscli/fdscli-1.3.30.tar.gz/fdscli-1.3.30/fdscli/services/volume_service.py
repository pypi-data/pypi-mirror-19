...
class VolumeService( AbstractService ):
    ...
    def export_volume(self, volume, repository, snapshot_id=0, safeguard_preset=None, from_last_export=False):
        '''
    ...
    def clone_remote(self, remote_volume, snapshot_id=0, from_last_clone_remote=False):
    ...
    def replicate_snapshot(self, remote_volume, credential_digest, snapshot_id=0, from_last_clone_remote=True):
        ...
        url = "{}{}{}{}{}".format( self.get_url_preamble(), "/volumes/", remote_volume.volume.id,
            "/replicate/snapshot/", snapshot_id)
