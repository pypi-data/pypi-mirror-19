...
def exportVolume(volume, repository, snapshot_id, safeguard_policy, from_last_export):
    return "{code: 202, description: \'accepted\'}"

def importVolume(volume_name, repository):
...
def cloneRemote( remote_volume, snapshot_id, from_last_clone_remote ):
    return "{code: 202, description: \'accepted\'}"
...
def checkVolume( volumeId ):
    return

def fixVolume( volumeId ):
    return
