...
class VolumeSafeGuardTest( BaseCliTest ):
    ...
    @patch("services.subscription.named_credential_client.NamedCredentialClient.get_named_credential_by_key", side_effect=mock_functions.getNamedCredentialByKey)
    @patch("services.volume_service.VolumeService.get_safeguard_presets", side_effect=mock_functions.listSafeGuardPresets)
    @patch("services.subscription.subscription_client.SubscriptionClient.create_subscription", side_effect=mock_create_subscription)
    ...
    @patch("services.subscription.named_credential_client.NamedCredentialClient.get_named_credentials", side_effect=mock_functions.empty)
