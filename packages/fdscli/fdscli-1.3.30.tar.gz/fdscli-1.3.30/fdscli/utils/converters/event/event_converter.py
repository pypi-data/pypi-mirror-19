...
from utils.converters.event.event_source_info_converter import EventSourceInfoConverter
...
class EventConverter(object):
    ...
    def to_json(event):
        ...
        json_d["sourceInfo"] = EventSourceInfoConverter.to_json(event.source_info)
    ...
    def build_from_json(j_str):
        ...
        if "sourceInfo" in j_str:
            event.source_info = EventSourceInfoConverter.build_from_json(j_str.pop("sourceInfo", event.source_info))
