...
#         self.refresh()
    ...
    def isset_username(self):
        '''Returns without prompting for username
        '''
    ...
    def isset_hostname(self):
        '''Returns without prompting for hostname
        '''
    ...
    def login(self):
        ...
        url = "{}://{}:{}/fds/config/v09/token".format( self.get_protocol(), self.get_hostname(), self.get_port())
        response = None
