...
class testLogin( TestCase ):
    ...
    '''
    @patch( "services.fds_auth.FdsAuth.is_authenticated", side_effect=mock_false )
    @patch( "services.fds_auth.FdsAuth.isset_username", side_effect=mock_true )
    ...
    @patch( "services.fds_auth.FdsAuth.is_authenticated", side_effect=mock_false )
    @patch( "services.fds_auth.FdsAuth.isset_username", side_effect=mock_false )
    @patch( "services.fds_auth.FdsAuth.login", side_effect=failedLogin )
