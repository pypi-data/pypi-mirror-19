...
# -*- coding: utf-8 -*-
#
# footylib documentation build configuration file, created by
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'), 
                   os.path.join(project_root, '''footylib''')])
...
copyright = u'''2016, Oracle (Author : Oriol Fabregas)'''
...
version = footylib.__version__
# The full version, including alpha/beta/rc tags.
release = footylib.__version__
