    ...
    def do_run(self, options, args):
        ...
        try:
            ...
            if options.type == 'http':
                ...
                if port is None:
                    port = 22
                server = BaseSFTPServer((options.addr, port), fs1)
                try:
