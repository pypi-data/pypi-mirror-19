...
from fs1.path import normpath
from fs1.errors import ResourceNotFoundError, UnsupportedError
...
class HTTPFS(FS):
    ...
    If you do need filesystem like functionality over HTTP, see :mod:`~fs1.contrib.davfs`.
