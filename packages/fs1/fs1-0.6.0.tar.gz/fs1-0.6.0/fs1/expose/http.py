...
import SocketServer
from fs1.path import pathjoin, dirname
...
class FSHTTPRequestHandler(SimpleHTTPServer.SimpleHTTPRequestHandler):
    ...
    def __init__(self, fs1, request, client_address, server):
        self._fs = fs1
...
def serve_fs(fs1, address='', port=8000):
    ...
    def Handler(request, client_address, server):
        return FSHTTPRequestHandler(fs1, request, client_address, server)
