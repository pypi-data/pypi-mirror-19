"""
  ...
  fs1.tests.test_expose:  testcases for fs1.expose and associated FS classes
...
from fs1.tests.test_rpcfs import TestRPCFS

try:
    from fs1 import sftpfs
    from fs1.expose.sftp import BaseSFTPServer
except ImportError:
    if not PY3:
        raise
...
class TestSFTPFS(TestRPCFS):
    ...
    def makeServer(self,fs1,addr):
        return BaseSFTPServer(addr,fs1)

    def setUp(self):
        self.startServer()
        self.fs1 = sftpfs.SFTPFS(self.server_addr, no_auth=True)
...
try:
    ...
    class TestFUSE(unittest.TestCase, FSTestCases, ThreadingTestCases):
        ...
        def setUp(self):
            ...
            self.fs1 = OSFS(self.temp_fs.getsyspath("mount"))
...
if dokan.is_available:
    ...
    class DokanTestCases(FSTestCases):
        ...
        def test_remove(self):
            ...
            self.fs1.createfile("/dir1/a.txt")
    ...
    class TestDokan(unittest.TestCase,DokanTestCases,ThreadingTestCases):
        ...
        def setUp(self):
            ...
            self.fs1 = OSFS(self.mount_proc.path)
