...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PlainmapModel = exports.MarkerLayerModel = exports.MarkerModel = exports.SymbolModel = exports.WeightedHeatmapLayerModel = exports.SimpleHeatmapLayerModel = exports.DirectionsLayerModel = exports.GMapsLayerModel = exports.PlainmapView = exports.MarkerLayerView = exports.MarkerView = exports.SymbolView = exports.BaseMarkerView = exports.WeightedHeatmapLayerView = exports.SimpleHeatmapLayerView = exports.DirectionsLayerView = undefined;
	...
	var DirectionsLayerView = exports.DirectionsLayerView = GMapsLayerView.extend({
	    ...
	    getOrigin: function getOrigin(modelData) {
	        ...
	        var _$first2 = _slicedToArray(_$first, 2);
	...
	var HeatmapLayerBaseView = GMapsLayerView.extend({
	    ...
	    modelEvents: function modelEvents() {
	        ...
	        properties.forEach(function (_ref3) {
	            ...
	            var nameInView = _ref4[0];
	            var nameInModel = _ref4[1];
	...
	var BaseMarkerView = exports.BaseMarkerView = _jupyterJsWidgets2.default.WidgetView.extend({
	    render: function render() {
	        ...
	        var _model$get2 = _slicedToArray(_model$get, 2);
	
	        var lat = _model$get2[0];
	        var lng = _model$get2[1];
	    ...
	    modelEvents: function modelEvents() {
	        ...
	        properties.forEach(function (_ref9) {
	            ...
	            var nameInView = _ref10[0];
	            var nameInModel = _ref10[1];
	        ...
	        infoBoxProperties.forEach(function (_ref11) {
	            ...
	            var nameInView = _ref12[0];
	            var nameInModel = _ref12[1];
	...
	var SymbolView = exports.SymbolView = BaseMarkerView.extend({
	    ...
	    setStyleEvents: function setStyleEvents() {
	        ...
	        iconProperties.forEach(function (_ref13) {
	            ...
	            var nameInView = _ref14[0];
	            var nameInModel = _ref14[1];
	...
	var MarkerView = exports.MarkerView = BaseMarkerView.extend({
	    ...
	    setStyleEvents: function setStyleEvents() {
	        ...
	        properties.forEach(function (_ref15) {
	            ...
	            var nameInView = _ref16[0];
	            var nameInModel = _ref16[1];
	...
	var PlainmapView = exports.PlainmapView = _jupyterJsWidgets2.default.DOMWidgetView.extend({
	    render: function render() {
	        ...
	        this.on("displayed", function () {
	            _googleMaps2.default.load(function (google) {
	                _this9.map = new google.maps.Map(_this9.el);
	                _this9.updateBounds(initialBounds);
	
	                _this9.layerViews.update(_this9.model.get("layers"));
	
	                // hack to force the map to redraw
	                setTimeout(function () {
	                    google.maps.event.trigger(_this9.map, 'resize');
	                    _this9.updateBounds(initialBounds);
	                }, 500);
	            });
	        });
	    ...
	    updateBounds: function updateBounds() {
	        ...
	        var _model$get4 = _slicedToArray(_model$get3, 2);
	
	        var _model$get4$ = _slicedToArray(_model$get4[0], 2);
	
	        var latBL = _model$get4$[0];
	        var lngBL = _model$get4$[1];
	
	        var _model$get4$2 = _slicedToArray(_model$get4[1], 2);
	
	        var latTR = _model$get4$2[0];
	        var lngTR = _model$get4$2[1];
	    ...
	    addLayerModel: function addLayerModel(childModel) {
	        ...
	        return this.create_child_view(childModel, { mapView: this }).then(function (childView) {
	            childView.addToMapView(_this10);
	            return childView;
	        });
	    }
	});
