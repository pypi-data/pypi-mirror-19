...
class DatasetForm(QWidget):
    ...
    def addDefaultAttributes(self):
        ...
        # self.addAttribFunc_fixed(Attribute(GetTypeNameString(AttributeType.Double),"ConversionFactor",AttributeKeyword_ConversionFactor,True,True))
        # self.addAttribFunc_fixed(Attribute(GetTypeNameString(AttributeType.Double),"Offset"          ,AttributeKeyword_ChannelOffset,True,True))
