...
GNU/Linux-compatible DRM-free games purchased on the `GOG.com`_ online
...
* Version 0.1.0: http://chadok.info/gog-install/gog-install-0.1.1.tar.gz
* Version 0.1.0: http://chadok.info/gog-install/gog-install-0.1.0.tar.gz
...
.. _issues tracker: http://hub.darcs.net/oschwand/gog-install/issues
