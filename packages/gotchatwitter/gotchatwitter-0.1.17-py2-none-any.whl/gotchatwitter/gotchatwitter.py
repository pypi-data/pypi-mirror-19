...
with open('/Users/cchen/GoogleDrive/porkspace/packages/gotchatwitter/brandlist.txt', 'r') as i:
    brands = [re.sub('@|#', '', line.strip()) for line in i]

with GotchaTwitter('timeline', 'test', output_fp='test.csv', output_mode='w',
                   words_any=brands) as gt:
    #with GotchaTwitter('timeline', file, '/Users/cchen/Downloads/test.csv') as gt:
    gt = gt.set_output(save_mode='w', has_header=False)
