...
class Camera(object):
    ...
    def get_single_config(self, name, context):
        """
    ...
    def set_single_config(self, name, widget, context):
        """
...
def gp_camera_list_config(camera, context):
    """
...
def gp_camera_get_single_config(camera, name, context):
    """
...
def gp_camera_set_single_config(camera, name, widget, context):
    """
