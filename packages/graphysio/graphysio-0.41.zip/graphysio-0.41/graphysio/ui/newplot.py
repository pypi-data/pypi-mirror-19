...
class Ui_NewPlot(object):
    def setupUi(self, NewPlot):
        ...
        self.chkLoadAll = QtGui.QCheckBox(NewPlot)
        self.chkLoadAll.setObjectName(_fromUtf8("chkLoadAll"))
        self.formLayout_2.setWidget(4, QtGui.QFormLayout.FieldRole, self.chkLoadAll)
    ...
    def retranslateUi(self, NewPlot):
        ...
        self.chkUnixTime.setText(_translate("NewPlot", "Unix Timestamp in milliseconds", None))
        self.chkLoadAll.setText(_translate("NewPlot", "Load all Series", None))
        ...
        self.groupBox_3.setTitle(_translate("NewPlot", "Series on Y axis", None))
        self.groupBox_4.setTitle(_translate("NewPlot", "Series on X axis", None))
