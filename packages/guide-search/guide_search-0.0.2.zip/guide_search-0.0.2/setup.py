...
def run_setup(with_binary):
    ...
    setup(
        name='guide_search',
        version=guide_search.esearch.__version__,
        url='https://github.com/JohnPickerill/guide-search',
        author='John Pickerill',
        author_email='me@curiouscrab.com',
        description='LR guidance ElasticSearch interface',
        long_description=fread('README.rst'),
        license='BSD',
        py_modules=['guide_search.esearch', 'guide_search.exceptions'],
        install_requires=[],
        cmdclass=cmdclass,
