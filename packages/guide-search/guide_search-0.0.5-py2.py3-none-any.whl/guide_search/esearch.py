...
# query functions
    ...
    def getArticles(self, **kwargs):
        r = self.getDocuments(kwargs["index"], "article", **kwargs)
        return r["hits"]

    def getItems(self, **kwargs):
        r = self.getDocuments(kwargs["index"], "item", **kwargs)
        return r["hits"]

    def getSnippets(self, **kwargs):
        r = self.getDocuments(kwargs["index"], "snippet", **kwargs)
        return r["hits"]
    ...
    def getClusterList(self, index, **kwargs):
        ...
        url = self.makeUrl(kwargs["index"], "articles", "_search")
        res = self.request("get", url, data=dsl)
