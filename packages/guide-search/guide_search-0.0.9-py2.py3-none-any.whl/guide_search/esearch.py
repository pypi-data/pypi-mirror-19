...
# query functions
    ...
    def get_articles(self, index, **kwargs):
        r = self.get_documents("article", index, **kwargs)
        try:
            return r["hits"]
        except:
            raise ResultParseError
    ...
    def get_items(self, index, **kwargs):
        r = self.get_documents("item", index, **kwargs)
        try:
            return r["hits"]
        except:
            raise ResultParseError
    ...
    def get_snippets(self, **kwargs):
        r = self.get_documents("snippet", **kwargs)
        try:
            return r["hits"]
        except:
            raise ResultParseError
    ...
    def get_clusterList(self, index, **kwargs):
        dsl = {"size": "0",
               "aggs": {
                         "clusters": {
