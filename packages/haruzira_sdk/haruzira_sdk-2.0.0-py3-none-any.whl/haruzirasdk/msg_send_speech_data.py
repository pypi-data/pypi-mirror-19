    ...
    def make_send_data(self):
        ...
        try:
            ...
            if self.__name is not None:
                mdata = [self.id] + [self.enc_flg] + [self.data_type] + [self.priority] + list(bLangCode) + [self.gender] + [self.age] + [self.repeat] + list(self.time_stamp) + [self.padding] + list(bNameLen) + list(bSize) + list(self.name) + list(self.data)
            else:
                mdata = [self.id] + [self.enc_flg] + [self.data_type] + [self.priority] + list(bLangCode) + [self.gender] + [self.age] + [self.repeat] + list(self.time_stamp) + [self.padding] + list(bNameLen) + list(bSize) + list(self.data)
