...
class HfstBasicStates(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, HfstBasicStates, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, HfstBasicStates, name)
    __repr__ = _swig_repr

    def iterator(self):
        return _libhfst.HfstBasicStates_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _libhfst.HfstBasicStates___nonzero__(self)

    def __bool__(self):
        return _libhfst.HfstBasicStates___bool__(self)

    def __len__(self):
        return _libhfst.HfstBasicStates___len__(self)

    def pop(self):
        return _libhfst.HfstBasicStates_pop(self)

    def __getslice__(self, i, j):
        return _libhfst.HfstBasicStates___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _libhfst.HfstBasicStates___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _libhfst.HfstBasicStates___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _libhfst.HfstBasicStates___delitem__(self, *args)

    def __getitem__(self, *args):
        return _libhfst.HfstBasicStates___getitem__(self, *args)

    def __setitem__(self, *args):
        return _libhfst.HfstBasicStates___setitem__(self, *args)

    def append(self, x):
        return _libhfst.HfstBasicStates_append(self, x)

    def empty(self):
        return _libhfst.HfstBasicStates_empty(self)

    def size(self):
        return _libhfst.HfstBasicStates_size(self)

    def clear(self):
        return _libhfst.HfstBasicStates_clear(self)

    def swap(self, v):
        return _libhfst.HfstBasicStates_swap(self, v)

    def get_allocator(self):
        return _libhfst.HfstBasicStates_get_allocator(self)

    def begin(self):
        return _libhfst.HfstBasicStates_begin(self)

    def end(self):
        return _libhfst.HfstBasicStates_end(self)

    def rbegin(self):
        return _libhfst.HfstBasicStates_rbegin(self)

    def rend(self):
        return _libhfst.HfstBasicStates_rend(self)

    def pop_back(self):
        return _libhfst.HfstBasicStates_pop_back(self)

    def erase(self, *args):
        return _libhfst.HfstBasicStates_erase(self, *args)

    def __init__(self, *args):
        this = _libhfst.new_HfstBasicStates(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def push_back(self, x):
        return _libhfst.HfstBasicStates_push_back(self, x)

    def front(self):
        return _libhfst.HfstBasicStates_front(self)

    def back(self):
        return _libhfst.HfstBasicStates_back(self)

    def assign(self, n, x):
        return _libhfst.HfstBasicStates_assign(self, n, x)

    def resize(self, *args):
        return _libhfst.HfstBasicStates_resize(self, *args)

    def insert(self, *args):
        return _libhfst.HfstBasicStates_insert(self, *args)

    def reserve(self, n):
        return _libhfst.HfstBasicStates_reserve(self, n)

    def capacity(self):
        return _libhfst.HfstBasicStates_capacity(self)
    __swig_destroy__ = _libhfst.delete_HfstBasicStates
    __del__ = lambda self: None
HfstBasicStates_swigregister = _libhfst.HfstBasicStates_swigregister
HfstBasicStates_swigregister(HfstBasicStates)
...
_libhfst.SFST_TYPE_swigconstant(_libhfst)
SFST_TYPE = _libhfst.SFST_TYPE

_libhfst.TROPICAL_OPENFST_TYPE_swigconstant(_libhfst)
TROPICAL_OPENFST_TYPE = _libhfst.TROPICAL_OPENFST_TYPE

_libhfst.LOG_OPENFST_TYPE_swigconstant(_libhfst)
LOG_OPENFST_TYPE = _libhfst.LOG_OPENFST_TYPE

_libhfst.FOMA_TYPE_swigconstant(_libhfst)
FOMA_TYPE = _libhfst.FOMA_TYPE

_libhfst.XFSM_TYPE_swigconstant(_libhfst)
XFSM_TYPE = _libhfst.XFSM_TYPE

_libhfst.HFST_OL_TYPE_swigconstant(_libhfst)
HFST_OL_TYPE = _libhfst.HFST_OL_TYPE

_libhfst.HFST_OLW_TYPE_swigconstant(_libhfst)
HFST_OLW_TYPE = _libhfst.HFST_OLW_TYPE

_libhfst.HFST2_TYPE_swigconstant(_libhfst)
HFST2_TYPE = _libhfst.HFST2_TYPE

_libhfst.UNSPECIFIED_TYPE_swigconstant(_libhfst)
UNSPECIFIED_TYPE = _libhfst.UNSPECIFIED_TYPE

_libhfst.ERROR_TYPE_swigconstant(_libhfst)
ERROR_TYPE = _libhfst.ERROR_TYPE

_libhfst.REPL_UP_swigconstant(_libhfst)
REPL_UP = _libhfst.REPL_UP

_libhfst.REPL_DOWN_swigconstant(_libhfst)
REPL_DOWN = _libhfst.REPL_DOWN

_libhfst.REPL_RIGHT_swigconstant(_libhfst)
REPL_RIGHT = _libhfst.REPL_RIGHT

_libhfst.REPL_LEFT_swigconstant(_libhfst)
...
class HfstTokenizer(_object):
    ...
    __swig_getmethods__["tokenize_space_separated"] = lambda x: _libhfst.HfstTokenizer_tokenize_space_separated
    if _newclass:
    ...
    __swig_getmethods__["check_utf8_correctness"] = lambda x: _libhfst.HfstTokenizer_check_utf8_correctness
    if _newclass:
...
class HfstBasicTransducer(_object):
    ...
    def transitions(self, s):
        return _libhfst.HfstBasicTransducer_transitions(self, s)
    ...
    def states_and_transitions(self):
        return _libhfst.HfstBasicTransducer_states_and_transitions(self)
