...
def main():
    ...
    parser.add_argument("--host", help="Automation server host of field agent.", type=str, default='localhost')
    parser.add_argument("--visa", help="PyVISA visa backend.", type=str, default='@py')
    parser.add_argument("--exchange", help="RabbitMQ exchange for RPC.", type=str, default='')
