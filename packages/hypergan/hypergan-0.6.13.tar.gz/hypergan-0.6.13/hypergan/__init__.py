...
hc.set('encoder', random_combo_encoder.encode_periodic_gaussian) # how to encode z
...
categories = [[2,2,2,2,3,4,4,4,4,4,4,4,2,2,2,2,2,3,3,3,3,3,3,3,3]]#[[2]+[2]+build_categories_config(30)]
hc.set('categories', [[]])
