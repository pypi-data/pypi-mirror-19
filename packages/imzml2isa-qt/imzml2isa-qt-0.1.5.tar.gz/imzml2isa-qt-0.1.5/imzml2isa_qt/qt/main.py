...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cBox_merge = QtWidgets.QCheckBox(self.centralwidget)
        self.cBox_merge.setGeometry(QtCore.QRect(10, 380, 291, 22))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cBox_merge.sizePolicy().hasHeightForWidth())
        self.cBox_merge.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily(":/fonts/assets/fonts/Verdana.ttf")
        font.setPointSize(10)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.cBox_merge.setFont(font)
        self.cBox_merge.setStyleSheet("font: 10pt url(:/fonts/assets/fonts/Verdana.ttf);")
...
"")
        ...
        self.title.setGeometry(QtCore.QRect(349, 1, 281, 62))
        font = QtGui.QFont()
...
"font: 24pt url(:/fonts/assets/fonts/HelveticaNeue.ttf);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "imzML to ISA-Tab"))
        ...
        self.cBox_merge.setText(_translate("MainWindow", "Merge profile and centroid scans"))
        ...
        self.title.setText(_translate("MainWindow", "imzML to ISA-Tab "))
