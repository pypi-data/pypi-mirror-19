...
setup(
  ...
  packages = ['ipapi'], 
  version = '0.5.1',
  description = 'Python bindings for ipapi (IP address to location mapping service. Free & paid API for a secure, fast & reliable IP lookup (city, country, latitude, longitude, timezone &amp; hostname) - https://ipapi.co)',
  author = 'ipapi',
  license="MIT License",
