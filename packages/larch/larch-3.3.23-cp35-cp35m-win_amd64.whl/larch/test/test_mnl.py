...
from ..core import LarchError, SQLiteError, LarchCacheError
...
class TestMTC(ELM_TestCase):
	...
	def test_parameter_math(self):
		...
		self.assertEqual( '1.2', P1x.strf(m) )
		self.assertEqual( '2.5', (P1x*P2).strf(m) )
		self.assertEqual( '2.5', (P2*P1x).strf(m) )
		self.assertEqual( '3.2', (P1x+P2).strf(m) )
		self.assertEqual( '3.2', (P2+P1x).strf(m) )
		self.assertEqual( '0.6', (P1x/P2).strf(m) )
		self.assertEqual( '1.6', (P2/P1x).strf(m) )
		self.assertEqual( '-0.8',(P1x-P2).strf(m) )
		self.assertEqual( '0.8', (P2-P1x).strf(m) )
		self.assertEqual( '-1.2',(-P1x).strf(m) )
