...
%description
libnk2 is a library to access the Nickfile (NK2) format
...
Group: System Environment/Libraries
Requires: libnk2 = %{version}-%{release} python
...
%defattr(644,root,root,755)
%doc AUTHORS COPYING NEWS README
%attr(755,root,root) %{_bindir}/nk2export
%attr(755,root,root) %{_bindir}/nk2info
%{_mandir}/man1/*
...
%changelog
* Fri Jan 27 2017 Joachim Metz <joachim.metz@gmail.com> 20170127-1
- Auto-generated
