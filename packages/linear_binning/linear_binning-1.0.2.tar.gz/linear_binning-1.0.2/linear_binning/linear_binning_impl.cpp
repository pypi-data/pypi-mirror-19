...
#include "linear_binning_impl.hpp"
                          ...
                          double *result_weights)  // grid points
{
  ...
  if (prod > std::numeric_limits<FiniteNum_t>::max()) {
...
//   else {
//     // cout << "static" << endl;
//     // linear_binning<D>(&X[0], &weights[0], n_samples,
