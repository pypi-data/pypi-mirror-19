...
setup(
    name=u"logging_helper",  # The module name must match this!
    ...
    url=u'https://bitbucket.org/davisowb/logging-helper.git',  # Use the url to the git repo
    download_url=u'https://bitbucket.org/davisowb/logging-helper.git/get/{version}.tar'.format(version=VERSION),

    #packages=find_packages(),

    # If you want to distribute just a my_module.py, uncomment
    # this and comment out packages:
    py_modules=[u'logging_helper'],

    description=u"A python helper to make setting up more informative logging a little easier.",
