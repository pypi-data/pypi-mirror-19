...
class SimplePlugin(object):
    def __init__(self, package_info, config, **kwargs):
        ...
        try:
            assert "artifact_location" in package_info
            self.path = "{0}/{1}/{2}".format(package_info["artifact_location"],
                                             package_info["artifact_dir"],
                                             package_info["artifact_name"]) \
                        if "artifact_dir" in package_info else \
                        "{0}/{1}".format(package_info["artifact_location"],
                                         package_info["artifact_name"])
