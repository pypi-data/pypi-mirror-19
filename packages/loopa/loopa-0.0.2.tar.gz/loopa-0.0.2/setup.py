...
long_description = '''Loopa has various utilities for Python asynchronous event
...
setup(
    ...
    description='Arduino-esque event loop app framework.',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/Muterra/py_loopa',
