...
from release import __author__ , __doc__ , __version__
...
class Generator:
    ...
    def generate(self):
        ...
        tmp_file_prefix = '-{0}-{1:%y%m%d%H%M%S}'.format(self.__version, datetime.now())
        ...
        ret = os.system('SUFDesign /BUILD "%s" "/STDOUT" >> "%s"' % (conf_file, log_file))
