"""
Mambo: Global Configuration

Global config shared by all applications

"""

from . import DATA_DIR, get_app_data_path, AVAILABLE_APPS
...
# ------------------------------------------------------------------------------
#: APPLICATION_*
    # Your own application variable that will not affect Mambo at all
...
#: DATE AND TIME FORMAT
    ...
    # The date format. Will be used in the jinja `date` extension -> {{ my_date_time | date }}
    DATE_FORMAT = "MM/DD/YYYY"

    # The Date and time format. Will be used in the jinja `date_time` extension -> {{yy_ date_time | date_time }}
...
#: DATABASES
    ...
    DB_URI = "sqlite:////%s/db.db" % DATA_DIR
...
#: STORAGE
    ...
    STORAGE_CONTAINER = get_app_data_path("uploads")
...
#: MAIL
    ...
    MAIL_TEMPLATE = get_app_data_path("mail-templates")
