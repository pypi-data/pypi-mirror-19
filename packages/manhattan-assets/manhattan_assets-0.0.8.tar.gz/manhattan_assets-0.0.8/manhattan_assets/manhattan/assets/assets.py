...
class Asset(SubFrame):
    ...
    _fields = {
        ...
        # An unique key (at least within the scope of the application) for the
        # asset.
        'key',
...
# defining projectsion for classes with assets fields. For example:
#
#    _default_projection = {
