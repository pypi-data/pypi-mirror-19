...
class SlugField(StringField):
    ...
    def __init__(self, label=None, validators=None, template=None, **kwargs):
    ...
    def build_slug(self):
        ...
        if callable(self.template):
            return slugify(self.template(self._form.data))
        else:
            return slugify(self.template.format(**self._form.data))
