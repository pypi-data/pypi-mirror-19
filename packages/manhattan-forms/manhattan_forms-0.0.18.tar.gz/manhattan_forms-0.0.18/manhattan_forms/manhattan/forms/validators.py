...
class ErrorMessage:
    ...
    def __init__(self, raised_by, message, **kwargs):
        # The object that raised the error
        self.raised_by = raised_by

        # The error message to relay to the user
...
class UniqueDocument:
    ...
    def __init__(self, frame_cls, filter=None, case_sensitive=True,
            endpoint=None, endpoint_args=None, alternative=None, message=None):
