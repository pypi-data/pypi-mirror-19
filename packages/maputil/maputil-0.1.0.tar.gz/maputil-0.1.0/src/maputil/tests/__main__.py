...
from maputil import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('maputil')
...
def main(args=None):
    """
    Called with ``python -m maputil.tests``: run main test suite.
    """
    ...
    import maputil.tests as test_module
