...
from .compat.managers import check_access, filter_by_access
...
class APICabinetDocumentView(generics.RetrieveDestroyAPIView):
    ...
    def get_cabinet(self):
        return get_object_or_404(Cabinet, pk=self.kwargs['cabinet_pk'])
