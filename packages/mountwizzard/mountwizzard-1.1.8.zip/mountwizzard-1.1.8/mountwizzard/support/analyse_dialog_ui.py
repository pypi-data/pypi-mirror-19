...
class Ui_AnalyseDialog(object):
    def setupUi(self, AnalyseDialog):
        ...
        self.btn_selectAnalyseFileName_9 = QtWidgets.QPushButton(AnalyseDialog)
        self.btn_selectAnalyseFileName_9.setGeometry(QtCore.QRect(140, 90, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_selectAnalyseFileName_9.setFont(font)
        self.btn_selectAnalyseFileName_9.setObjectName("btn_selectAnalyseFileName_9")
        ...
        self.scalePlotError.setSingleStep(1.0)
        self.scalePlotError.setProperty("value", 10.0)
        self.scalePlotError.setObjectName("scalePlotError")
        self.btn_selectAnalyseFileName_10 = QtWidgets.QPushButton(AnalyseDialog)
        self.btn_selectAnalyseFileName_10.setGeometry(QtCore.QRect(10, 90, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_selectAnalyseFileName_10.setFont(font)
        self.btn_selectAnalyseFileName_10.setObjectName("btn_selectAnalyseFileName_10")
    ...
    def retranslateUi(self, AnalyseDialog):
        ...
        self.btn_selectDecError.setToolTip(_translate("AnalyseDialog", "Sets dual tracking on / off"))
        self.btn_selectDecError.setText(_translate("AnalyseDialog", "Dec Error"))
        self.btn_selectRaError.setToolTip(_translate("AnalyseDialog", "Sets dual tracking on / off"))
        self.btn_selectRaError.setText(_translate("AnalyseDialog", "Ra Error"))
        self.btn_selectDecErrorAltitude.setToolTip(_translate("AnalyseDialog", "Sets dual tracking on / off"))
        self.btn_selectDecErrorAltitude.setText(_translate("AnalyseDialog", "Dec Error over Alt"))
        self.btn_selectRaErrorAltitude.setToolTip(_translate("AnalyseDialog", "Sets dual tracking on / off"))
        self.btn_selectRaErrorAltitude.setText(_translate("AnalyseDialog", "Ra Error over Alt"))
        self.btn_selectModelPointPolar.setToolTip(_translate("AnalyseDialog", "Sets dual tracking on / off"))
        self.btn_selectModelPointPolar.setText(_translate("AnalyseDialog", "Model Points Polar"))
        self.btn_selectDecErrorAzimuth.setToolTip(_translate("AnalyseDialog", "Sets dual tracking on / off"))
        ...
        self.btn_selectModelPointErrorPolar.setToolTip(_translate("AnalyseDialog", "Sets dual tracking on / off"))
        self.btn_selectModelPointErrorPolar.setText(_translate("AnalyseDialog", "Model Error Polar"))
        self.btn_selectAnalyseFileName_9.setToolTip(_translate("AnalyseDialog", "Sets dual tracking on / off"))
        self.btn_selectAnalyseFileName_9.setText(_translate("AnalyseDialog", "..."))
        self.btn_selectRaErrorAzimuth.setToolTip(_translate("AnalyseDialog", "Sets dual tracking on / off"))
        ...
        self.btn_selectAnalyseFileName_10.setToolTip(_translate("AnalyseDialog", "Sets dual tracking on / off"))
        self.btn_selectAnalyseFileName_10.setText(_translate("AnalyseDialog", "..."))
