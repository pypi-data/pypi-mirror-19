    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(help_text='A human-readable label for the contact detail', max_length=128, verbose_name='label', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, verbose_name='creation time', editable=False)),
                ('updated_at', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, verbose_name='last modification time', editable=False)),
                ('label', models.CharField(help_text='A label describing the membership', max_length=128, verbose_name='label', blank=True)),
                ('role', models.CharField(help_text='The role that the person fulfills in the organization', max_length=128, verbose_name='role', blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.CharField(help_text="A one-line account of a person's life", max_length=512, verbose_name='summary', blank=True)),
