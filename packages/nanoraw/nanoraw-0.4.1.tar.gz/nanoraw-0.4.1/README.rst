...
Description: Summary
        ...
        -   :code:`plot_motif_with_stats`: Plot signal from several regions and test statistics centered on a k-mer of interst.
        ...
        -  :code:`write_wiggles` : Write wiggle files for various attribute of reads.
