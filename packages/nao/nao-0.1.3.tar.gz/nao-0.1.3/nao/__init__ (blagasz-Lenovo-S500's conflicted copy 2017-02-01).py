...
# don't use any actual handler in library code
...
# TODO clear this mess up - this is not the way to go!
def logger(name,
        level='debug',
        dict_config=None,
    ):
    ...
    # not necessary after Python 2.7
    levels = {
        'error': logging.ERROR,
...
# TODO create log_setup helper function ?
# TODO create log_db helper - return dblogger
# TODO create log_file helper - return rotatingfilelogger

# check existing logging best practices
# fill everything with debug messages
# use INFO level in loader (or filter those?)
