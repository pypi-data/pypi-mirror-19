...
::
    ...
    --duedate=<Unicode> (DbAssignmentAddApp.duedate)
        Default: None
    ...
    DbAssignmentAddApp options
    --------------------------
    --DbAssignmentAddApp.answer_yes=<Bool>
        Default: False
        Answer yes to any prompts.
    --DbAssignmentAddApp.assignment_id=<Unicode>
        Default: ''
        The assignment name. This MUST be specified, either by setting the config
        option, passing an argument on the command line, or using the --assignment
        option on the command line.
    --DbAssignmentAddApp.autograded_directory=<Unicode>
        Default: 'autograded'
    ...
    --DbAssignmentAddApp.course_directory=<Unicode>
        Default: ''
        The root directory for the course files (that includes the `source`,
        `release`, `submitted`, `autograded`, etc. directories). Defaults to the
        current working directory.
    --DbAssignmentAddApp.course_id=<Unicode>
        Default: ''
        A key that is unique per instructor and course. This MUST be specified,
        either by setting the config option, or using the --course option on the
        command line.
    --DbAssignmentAddApp.db_assignments=<List>
        Default: []
    ...
    --DbAssignmentAddApp.db_students=<List>
        Default: []
    ...
    --DbAssignmentAddApp.db_url=<Unicode>
        Default: ''
        URL to the database. Defaults to sqlite:///<course_directory>/gradebook.db,
        where <course_directory> is another configurable variable.
    --DbAssignmentAddApp.directory_structure=<Unicode>
    ...
    --DbAssignmentAddApp.duedate=<Unicode>
        Default: None
        The due date of the assignment
    --DbAssignmentAddApp.feedback_directory=<Unicode>
        Default: 'feedback'
    ...
    --DbAssignmentAddApp.ignore=<List>
    ...
    --DbAssignmentAddApp.notebook_id=<Unicode>
        Default: '*'
        File glob to match notebook names, excluding the '.ipynb' extension. This
        can be changed to filter by notebook.
    --DbAssignmentAddApp.release_directory=<Unicode>
        Default: 'release'
    ...
    --DbAssignmentAddApp.source_directory=<Unicode>
        Default: 'source'
