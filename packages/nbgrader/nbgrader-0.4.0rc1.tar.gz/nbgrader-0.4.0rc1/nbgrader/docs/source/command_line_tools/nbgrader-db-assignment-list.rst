...
::
    ...
    List assignments int the nbgrader database
    ...
    DbAssignmentListApp options
    ---------------------------
    --DbAssignmentListApp.answer_yes=<Bool>
        Default: False
        Answer yes to any prompts.
    --DbAssignmentListApp.assignment_id=<Unicode>
        Default: ''
        The assignment name. This MUST be specified, either by setting the config
        option, passing an argument on the command line, or using the --assignment
        option on the command line.
    --DbAssignmentListApp.autograded_directory=<Unicode>
        Default: 'autograded'
    ...
    --DbAssignmentListApp.course_directory=<Unicode>
        Default: ''
        The root directory for the course files (that includes the `source`,
        `release`, `submitted`, `autograded`, etc. directories). Defaults to the
        current working directory.
    --DbAssignmentListApp.course_id=<Unicode>
        Default: ''
        A key that is unique per instructor and course. This MUST be specified,
        either by setting the config option, or using the --course option on the
        command line.
    --DbAssignmentListApp.db_assignments=<List>
        Default: []
    ...
    --DbAssignmentListApp.db_students=<List>
        Default: []
    ...
    --DbAssignmentListApp.db_url=<Unicode>
        Default: ''
        URL to the database. Defaults to sqlite:///<course_directory>/gradebook.db,
        where <course_directory> is another configurable variable.
    --DbAssignmentListApp.directory_structure=<Unicode>
        ...
        path.
    --DbAssignmentListApp.feedback_directory=<Unicode>
        Default: 'feedback'
    ...
    --DbAssignmentListApp.ignore=<List>
    ...
    --DbAssignmentListApp.notebook_id=<Unicode>
        Default: '*'
        File glob to match notebook names, excluding the '.ipynb' extension. This
        can be changed to filter by notebook.
    --DbAssignmentListApp.release_directory=<Unicode>
        Default: 'release'
    ...
    --DbAssignmentListApp.source_directory=<Unicode>
        Default: 'source'
        ...
        `directory_structure` config option.
    --DbAssignmentListApp.student_id=<Unicode>
        Default: '*'
        File glob to match student IDs. This can be changed to filter by student.
        Note: this is always changed to '.' when running `nbgrader assign`, as the
        assign step doesn't have any student ID associated with it.
    --DbAssignmentListApp.submitted_directory=<Unicode>
        Default: 'submitted'
