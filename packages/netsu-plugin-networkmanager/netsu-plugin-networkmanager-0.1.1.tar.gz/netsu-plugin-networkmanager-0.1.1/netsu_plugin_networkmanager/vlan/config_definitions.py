...
def update(api_definitions):
    ...
    api_definitions.update(VLAN)
    api_definitions.update(VLANS)
    api_definitions['Config']['properties']['nm_vlan'] = {
        '$ref': '#/definitions/NMVlansConfig'
    }
