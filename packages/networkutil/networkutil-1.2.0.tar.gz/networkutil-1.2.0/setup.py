...
setup(
    name=u"networkutil",  # The module name must match this!
    ...
    url=u'https://bitbucket.org/davisowb/networkutil.git',  # Use the url to the git repo
    download_url=u'https://bitbucket.org/davisowb/networkutil.git/get/{version}.tar'.format(version=VERSION),
    ...
    description=u"A collection of networking utilities.",
    long_description=read(u'README.rst'),

    keywords=[u'networking'],
