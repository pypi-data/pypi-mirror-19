...
if '__version__' in pkg_data:
    assert version_str == pkg_data['__version__'].replace('dev', 'dev0')
...
# def install_nim(fp):
#     print('installing nim', os.getcwd(), file=fp)
#     nim_version = '0.16.0'
#     nim_download = 'http://nim-lang.org/download/nim-{}.tar.xz'.format(nim_version)
