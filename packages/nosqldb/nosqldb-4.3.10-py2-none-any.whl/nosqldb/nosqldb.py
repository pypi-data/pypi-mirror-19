...
class ResultIterator:
    ...
    def close(self):
        ...
        if (self._has_more is not False):
...
class Consistency(RestrictedDict):
    ...
    * ONDB_VERSION_CONSISTENCY
    ...
    """
    _consistency_allowed_keys = {ONDB_SIMPLE_CONSISTENCY,
        ONDB_TIME_CONSISTENCY, ONDB_VERSION_CONSISTENCY}
...
class MultiRowOptions(RestrictedDict):
    ...
    * ONDB_INCLUDED_TABLES
    ...
    """
    _multirow_opts_allowed_keys = {
        ONDB_FIELD_RANGE, ONDB_INCLUDED_TABLES}
...
class TableIteratorOptions(RestrictedDict):
    ...
    * ONDB_READ_OPTIONS
        ...
        class instance.
    """
    _table_iterator_opts_allowed_keys = {
        ONDB_DIRECTION, ONDB_MAX_RESULTS, ONDB_READ_OPTIONS}
...
class Operation(RestrictedDict):
    ...
    * ONDB_VERSION
    ...
    _operation_allowed_keys = {
        ONDB_TABLE_NAME, ONDB_OPERATION, ONDB_ABORT_IF_UNSUCCESSFUL,
        ONDB_ROW, ONDB_RETURN_CHOICE, ONDB_VERSION}
    ...
    def _validate_data(self, data, option):
        if (type(data) is dict):
            if (option == 'WO' and not isinstance(data, WriteOptions)):
                ...
                # nothing to do here if it is already a dict
                pass
            else:
    ...
    def delete(self, table, primary_key, write_opts=None):
        ...
        try:
            ...
            if (t_write_result.wasDeleted):
                ...
                if (r_row.get_version() is not None or r_row):
