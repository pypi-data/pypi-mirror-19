...
atlas_3_10_blas_threads_info={'libraries': ['numpy-atlas'], 'library_dirs': ['C:\\projects\\numpy-wheels\\windows-wheel-builder\\atlas-builds\\atlas-3.11.38-sse2-64\\lib'], 'language': 'c', 'define_macros': [('HAVE_CBLAS', None), ('ATLAS_INFO', '"\\"None\\""')]}
lapack_opt_info={'libraries': ['numpy-atlas', 'numpy-atlas'], 'library_dirs': ['C:\\projects\\numpy-wheels\\windows-wheel-builder\\atlas-builds\\atlas-3.11.38-sse2-64\\lib'], 'language': 'f77', 'define_macros': [('ATLAS_INFO', '"\\"None\\""')]}
