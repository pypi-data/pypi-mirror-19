...
class UInt32Set(object):
    ...
    def __len__(self):
        """__len__(self) -> std::set< unsigned long >::size_type"""
    ...
    def __getitem__(self, i):
        """__getitem__(self, i) -> std::set< unsigned long >::value_type"""
    ...
    def size(self):
        """size(self) -> std::set< unsigned long >::size_type"""
    ...
    def count(self, x):
        """count(self, x) -> std::set< unsigned long >::size_type"""
        return _engine_internal.UInt32Set_count(self, x)


    def begin(self):
        """begin(self) -> std::set< unsigned long >::iterator"""
        return _engine_internal.UInt32Set_begin(self)


    def end(self):
        """end(self) -> std::set< unsigned long >::iterator"""
        return _engine_internal.UInt32Set_end(self)


    def rbegin(self):
        """rbegin(self) -> std::set< unsigned long >::reverse_iterator"""
        return _engine_internal.UInt32Set_rbegin(self)


    def rend(self):
        """rend(self) -> std::set< unsigned long >::reverse_iterator"""
        return _engine_internal.UInt32Set_rend(self)


    def erase(self, *args):
        """
        erase(self, x) -> std::set< unsigned long >::size_type
        erase(self, pos)
    ...
    def find(self, x):
        """find(self, x) -> std::set< unsigned long >::iterator"""
        return _engine_internal.UInt32Set_find(self, x)


    def lower_bound(self, x):
        """lower_bound(self, x) -> std::set< unsigned long >::iterator"""
        return _engine_internal.UInt32Set_lower_bound(self, x)


    def upper_bound(self, x):
        """upper_bound(self, x) -> std::set< unsigned long >::iterator"""
        return _engine_internal.UInt32Set_upper_bound(self, x)


    def equal_range(self, x):
        """equal_range(self, x) -> std::pair< std::set< unsigned long >::iterator,std::set< unsigned long >::iterator >"""
        return _engine_internal.UInt32Set_equal_range(self, x)


    def insert(self, __x):
        """insert(self, __x) -> std::pair< std::set< unsigned long >::iterator,bool >"""
...
class Network(object):
    ...
    def convertedRead(self, pyReader):
        ...
        return _engine_internal.Network_convertedRead(self, pyReader)
...
class Region(object):
    ...
    def purgeInputLinkBufferHeads(self):
        """purgeInputLinkBufferHeads(self)"""
        return _engine_internal.Region_purgeInputLinkBufferHeads(self)
