...
def active():
    ...
    if '--help' in sys.argv or '-h' in sys.argv:
        ...
        print ""
        print "   --reset           Reset record data listing from Google server."
        print ""
        print "-------------------------------------------------------------------------"
        print ""
        quit()
    ...
    o = open('text_%i-%02i.dat'%(y0,m0),'w')
    ...
    plt.savefig('plot_%i-%02i.pdf'%(y0,m0),dpi=80)
    #os.system('rm data')
