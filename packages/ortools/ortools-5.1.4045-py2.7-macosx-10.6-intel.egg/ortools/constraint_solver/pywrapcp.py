...
class RoutingModel(_object):
    ...
    def AddDimensionWithVehicleCapacity(self, evaluator, slack_max, vehicle_capacities, fix_start_cumul_to_zero, name):
    ...
    def AddDimensionWithVehicleTransitAndCapacity(self, evaluators, slack_max, vehicle_capacities, fix_start_cumul_to_zero, name):
    ...
    def GetDisjunctionIndicesFromNode(self, node):
        return _pywrapcp.RoutingModel_GetDisjunctionIndicesFromNode(self, node)

    def GetDisjunctionIndicesFromVariableIndex(self, index):
    ...
    def AddSoftSameVehicleConstraint(self, nodes, cost):
    ...
    def SolveFromAssignmentWithParameters(self, assignment, search_parameters):
...
def RoutingModel_InitializeBuilders(solver):
...
class RoutingDimension(_object):
    ...
    def SetBreakIntervalsOfVehicle(self, breaks, vehicle):
