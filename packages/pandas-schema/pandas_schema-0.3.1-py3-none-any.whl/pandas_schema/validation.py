...
class SeriesValidation(_BaseValidation):
    ...
    def __or__(self, other: 'SeriesValidation'):
        """
    ...
    def __and__(self, other: 'SeriesValidation'):
        """
        Returns a validation which is true if either this or the other validation is true
        """
...
class InverseValidation(SeriesValidation):
    ...
    def __init__(self, validation: SeriesValidation, **kwargs):
...
class _CombinedValidation(SeriesValidation):
    ...
    def __init__(self, validation_a: SeriesValidation, validation_b: SeriesValidation, operator):
