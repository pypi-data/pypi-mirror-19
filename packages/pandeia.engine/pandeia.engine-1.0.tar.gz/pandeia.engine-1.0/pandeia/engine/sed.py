    ...
    def create_flux(self):
        ...
        if self.unit == 'flam':
            ...
            try:
                ...
                msg = "Error converting flam units to Pandeia flux units via Pysynphot for Power Law spectrum. "
                if self.webapp:
                    msg += "(%s)" % type(e)
                else:
                    msg += repr(e)
    ...
    def create_flux(self):
        ...
        if self.unit == 'flam':
            ...
            try:
                ...
                msg = "Error converting flam units to Pandeia flux units via Pysynphot for Flat spectrum. "
                if self.webapp:
                    msg += "(%s)" % type(e)
                else:
                    msg += repr(e)
...
class Phoenix(Parameterized):
    ...
    def get_spectrum(self):
        ...
        try:
            ...
            msg = "Error creating Phoenix spectrum via Pysynphot. "
            if self.webapp:
                msg += "(%s)" % type(e)
            else:
                msg += repr(e)
