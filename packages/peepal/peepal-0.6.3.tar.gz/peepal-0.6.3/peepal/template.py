...
class _File(_Node):
    ...
    def generate(self, writer):
        ...
        with writer.indent():
            ...
            writer.write_line("return ''.join(_tt_buffer)", self.line)
...
class _ApplyBlock(_Node):
    ...
    def generate(self, writer):
        ...
        with writer.indent():
            ...
            self.body.generate(writer)
            writer.write_line("return ''.join(_tt_buffer)", self.line)
        writer.write_line("_tt_append(%s(%s()))" % (
...
class _Expression(_Node):
    ...
    def generate(self, writer):
        ...
        if not self.raw and writer.current_template.autoescape is not None:
            tmp = writer.current_template.autoescape + '(str(_tt_tmp))'
        else:
            tmp = 'str(_tt_tmp)'
        writer.write_line("if _tt_tmp is not None: _tt_append(%s)" %
                          tmp, self.line)
...
class _Text(_Node):
    ...
    def generate(self, writer):
        ...
        if value:
            writer.write_line('_tt_append(%r)' % value, self.line)
