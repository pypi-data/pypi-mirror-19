...
LOWERCASE_REGEX_CONTAIN_T = re.compile(r'[_a-zT][_a-z0-9T]*$')
...
class VariablesInFunctionCheckPI(BaseASTCheck):
    ...
    Local variables in functions should be lowercase
    """
    check = LOWERCASE_REGEX_CONTAIN_T.match
    N810 = "variable in function should be lowercase(except T, pi)"
