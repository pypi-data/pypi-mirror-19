...
releases_release_uri = "https://github.com/SethMichaelLarson/picklepipe/tree/%s"
releases_issue_uri = "https://github.com/SethMichaelLarson/picklepipe/issues/%s"
...
version = picklepipe.__version__
