...
def pipeline_launchpad(job, fastqs, univ_options, tool_options):
    ...
    star_fusion = job.wrapJobFn(run_star_fusion, cutadapt.rv(), univ_options,
                               tool_options['star_fusion'], memory='100M',
                               cores=tool_options['star_fusion']['n'],
    ...
    # B. cutadapt will be followed by star and star_fusion
    cutadapt.addChild(star)  # Edge 2->9
    cutadapt.addChild(star_fusion)
