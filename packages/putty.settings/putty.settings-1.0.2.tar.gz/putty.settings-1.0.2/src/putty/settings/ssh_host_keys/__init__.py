...
def load_from_putty(host_keys: paramiko.HostKeys):
    ssh_host_keys = SshHostKeys()
    ssh_host_keys.load()
    ssh_host_keys.add_to_paramiko_host_keys(host_keys)


def save_to_putty(host_keys: paramiko.HostKeys):
    ssh_host_keys = SshHostKeys()
    ssh_host_keys.add_from_paramiko_host_keys(host_keys)
    ssh_host_keys.save()
