...
def Fl_RGB_Image_max_size(*args):
  """
    max_size(size_t size)
...
class Fl_Widget(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """__init__(Fl_Widget self, int x, int y, int w, int h, char const * label=0L) -> Fl_Widget"""
...
def Fl_api_version(*args):
  """Fl_api_version() -> int"""
  return _fltk.Fl_api_version(*args)

def Fl_abi_version(*args):
  """Fl_abi_version() -> int"""
  return _fltk.Fl_abi_version(*args)

def Fl_abi_check(*args):
...
def Fl_event_clipboard(*args):
  """Fl_event_clipboard() -> void *"""
  return _fltk.Fl_event_clipboard(*args)

def Fl_event_clipboard_type(*args):
...
def Fl_enable_im(*args):
  """Fl_enable_im()"""
  return _fltk.Fl_enable_im(*args)

def Fl_disable_im(*args):
  """Fl_disable_im()"""
  return _fltk.Fl_disable_im(*args)
...
def Fl_screen_dpi(*args):
  """Fl_screen_dpi(float & h, float & v, int n=0)"""
  return _fltk.Fl_screen_dpi(*args)

def Fl_screen_work_area(*args):
  """
    screen_work_area(int & X, int & Y, int & W, int & H, int mx, int my)
    screen_work_area(int & X, int & Y, int & W, int & H, int n)
...
def Fl_box_color(*args):
  """Fl_box_color(Fl_Color arg1) -> Fl_Color"""
  return _fltk.Fl_box_color(*args)

def Fl_set_box_color(*args):
...
class Fl_Menu_(Fl_Widget):
    ...
    def insert(self, *args):
        """
        insert(Fl_Menu_ self, int index, char const * arg3, int shortcut, Fl_Callback * arg5, void * arg6=None, 
            int arg7=0) -> int
...
def Fl_Window_default_xclass(*args):
  """
    default_xclass(char const * arg1)
...
def Fl_Window_default_icon(*args):
  """Fl_Window_default_icon(Fl_RGB_Image arg1)"""
  return _fltk.Fl_Window_default_icon(*args)

def Fl_Window_default_icons(*args):
...
def fl_draw(*args):
  """
    ...
    fl_draw(char const * str, int x, int y, int w, int h, Fl_Align align, Fl_Image img=None, 
        int draw_symbols=1)
    fl_draw(char const * str, int x, int y, int w, int h, Fl_Align align, void (*)(char const *,int,int,int) callthis, 
...
def fl_scroll(*args):
  """
    fl_scroll(int X, int Y, int W, int H, int dx, int dy, void (*)(void *,int,int,int,int) draw_area, 
        void * data)
    """
...
def fl_expand_text(*args):
  """
    fl_expand_text(char const * _from, char * buf, int maxbuf, double maxw, double & width, int wrap, 
        int draw_symbols=0) -> char const *
    """
...
class Fl_Menu_Item(object):
    ...
    def pulldown(self, *args):
        """
        pulldown(Fl_Menu_Item self, int X, int Y, int W, int H, Fl_Menu_Item picked=None, Fl_Menu_ arg7=None, Fl_Menu_Item title=None, 
...
def Fl_Shared_Image_scaling_algorithm(*args):
...
class Fl_Text_Display(Fl_Group):
    ...
    def highlight_data(self, *args):
        """
        highlight_data(Fl_Text_Display self, Fl_Text_Buffer styleBuffer, Fl_Text_Display::Style_Table_Entry const * styleTable, 
            int nStyles, char unfinishedStyle, PyObject * func, PyObject * cbArg)
        """
...
def Fl_Text_Editor_kf_meta_move(*args):
  """Fl_Text_Editor_kf_meta_move(int c, Fl_Text_Editor e) -> int"""
  return _fltk.Fl_Text_Editor_kf_meta_move(*args)

def Fl_Text_Editor_kf_m_s_move(*args):
...
def Fl_Tooltip_margin_width(*args):
  """Fl_Tooltip_margin_width() -> int"""
  return _fltk.Fl_Tooltip_margin_width(*args)

def Fl_Tooltip_margin_height(*args):
  """Fl_Tooltip_margin_height() -> int"""
  return _fltk.Fl_Tooltip_margin_height(*args)

def Fl_Tooltip_wrap_width(*args):
...
def fl_utf8toa(*args):
  """fl_utf8toa(char const * src, unsigned int srclen, unsigned int OUTPUT) -> unsigned int"""
