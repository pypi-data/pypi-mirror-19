...
#define PyUnicode_1BYTE_DATA(a)             PyString_AsString(a)
#define PyUnicode_FromKindAndData(a, b, c)  PyString_FromStringAndSize(b, c)
#endif
...
PyObject* listReaders(PyObject* self, PyObject* args)
{
    ...
    //ARGS_GetCardContext(0);
    PyObject *pobjCardContext = PyTuple_GetItem(args, 0);
    if (pobjCardContext == Py_None) {
            _RaiseError(PyExc_Exception, __FUNCTION__, _T("Card context can not be None!"));
            return NULL; 
    }
