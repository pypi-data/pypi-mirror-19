...
extern "C" PYIMAPI_API  void *fcreateIMAPI2FS(char *filename, char *mode)
{
	//printf("about to new\n");
	...
	void *object = (void *)new CpyIMAPIObject(filename, mode);
	//printf("after new\n");
	return object;
}
...
extern "C" PYIMAPI_API void fremove(void *obj, char *filename) 
{
	//reinterpret_cast
	CpyIMAPIObject *fs_obj = (CpyIMAPIObject *)obj;

	fs_obj->remove(filename);
