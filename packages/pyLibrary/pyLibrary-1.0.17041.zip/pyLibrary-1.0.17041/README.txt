...
makes. Only, instead of being utilities that are specific to the task,
these utilities are for programming in general: They assume logs should
be structured, all data should be JSONizable, and OO is preferred, and
more.
