...
class ElasticJsonDataSource(object):
    ...
    # TODO: Query specified fields instead of post-filtering
...
class YSProdElasticSource(ElasticJsonDataSource):
    ...
    URL = 'ys-es-prod-10.yscan.local'
    PORT = 9200

    def __init__(self, index, query, keys=None, fill_na_map=None, authentication=None):
        super().__init__(YSProdElasticSource.URL, YSProdElasticSource.PORT, index, query, keys, fill_na_map, authentication)
