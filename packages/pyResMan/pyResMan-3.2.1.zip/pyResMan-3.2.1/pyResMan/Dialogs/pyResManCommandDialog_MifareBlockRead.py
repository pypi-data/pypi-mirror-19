...
from pyResMan.BaseDialogs.pyResManCommandDialogBase_MifareBlockRead import CommandDialogBase_MifareBlockRead
from pyResMan.Util import IDOK, IDCANCEL
from pyResMan.Util import HexValidator, Util

###########################################################################
## Class CommandDialog_MifareBlockRead
###########################################################################
...
class CommandDialog_MifareBlockRead ( CommandDialogBase_MifareBlockRead ):
    def __init__( self, parent, bytesCount = 1 ):
        CommandDialogBase_MifareBlockRead.__init__ ( self, parent )
