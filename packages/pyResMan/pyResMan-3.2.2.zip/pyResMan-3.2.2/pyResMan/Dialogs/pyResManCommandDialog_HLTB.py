...
from pyResMan.BaseDialogs.pyResManCommandDialogBase_HLTB import CommandDialogBase_HLTB
...
class CommandDialog_HLTB ( CommandDialogBase_HLTB ):
    
    def __init__( self, parent ):
        CommandDialogBase_HLTB.__init__ ( self, parent )
        self.__mode = MODE_IDLE
        self._textctrlCommandHeader.SetMaxLength(1 * 2)
        self._textctrlCommandValue.SetMaxLength(5 * 2)
        # Set validator;
