...
from pySMS.utils.excepetions import ProductChooserAddError, DataRetreivalError
...
class Webpage:
    ...
    class Logic:
        ...
        def __init__(self):
            self.exp = Export()
            self.item_library = self.exp.convert_to_dict(self.exp.unzip_from_gzip(self.exp.data_files_list['ci_data_library.json.gz'])['content'].decode())
