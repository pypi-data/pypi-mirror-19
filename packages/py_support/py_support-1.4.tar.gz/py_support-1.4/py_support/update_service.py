...
class UpdateBuilder(DefaultBuilder):
    ...
    def get_inline_query(self, json_obj):
        try:
            json_obj['inline_query']['from_user'] = json_obj['message']['from']
    ...
    def get_chosen_inline_result(self, json_obj):
        try:
            json_obj['chosen_inline_result']['from_user'] = json_obj['message']['from']
    ...
    def get_callback_query(self, json_obj):
        try:
            json_obj['callback_query']['from_user'] = json_obj['message']['from']
