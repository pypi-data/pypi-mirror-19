...
class UpdateBuilder(DefaultBuilder):
    ...
    @staticmethod
    def _replace_from(json_obj):
        """ replace from to from_user """
        return json_obj

    def _get_object(self, json_obj, model, key_index):
        json_obj = self._replace_from(json_obj)
    ...
    def get_inline_query(self, json_obj):
        try:
            json_obj['inline_query']['from_user'] = json_obj['inline_query']['from']
            del json_obj['inline_query']['from']
        except KeyError:
            pass
        return self._get_object(
    ...
    def get_chosen_inline_result(self, json_obj):
        try:
            json_obj['chosen_inline_result']['from_user'] = json_obj['chosen_inline_result']['from']
            del json_obj['chosen_inline_result']['from']
        except KeyError:
            pass
        return self._get_object(
    ...
    def get_callback_query(self, json_obj):
        try:
            json_obj['callback_query']['from_user'] = json_obj['callback_query']['from']
            del json_obj['callback_query']['from']
        except KeyError:
            pass
        return self._get_object(
