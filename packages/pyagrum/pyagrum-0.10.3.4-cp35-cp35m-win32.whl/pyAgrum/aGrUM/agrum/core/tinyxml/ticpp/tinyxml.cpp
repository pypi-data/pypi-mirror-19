...
bool TiXmlDocument::LoadFile( FILE* file, TiXmlEncoding encoding ) {
  ...
  // external
  // parsed entities (including the document entity) on input, before parsing,
  // by
  // translating
  ...
  // platform.
  // Generally, you expect fgets to translate from the convention of the OS to
  // the
  // c/unix
...
TiXmlStylesheetReference::TiXmlStylesheetReference(
    const TiXmlStylesheetReference& copy )
    : TiXmlNode( TiXmlNode::STYLESHEETREFERENCE ) {
  copy.CopyTo( this );
}
