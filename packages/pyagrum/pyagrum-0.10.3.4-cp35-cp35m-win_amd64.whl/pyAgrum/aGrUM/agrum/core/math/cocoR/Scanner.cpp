...
// ensure binary read on windows
    ...
    int Buffer::GetPercent() { return (int)( ( 100.0 * GetPos() ) / fileLen ); }
    ...
    int Buffer::GetPos() { return bufPos + bufStart; }
    ...
    void Buffer::SetPos( int value ) {
      ...
      if ( ( value >= bufStart ) &&
           ( value < ( bufStart + bufLen ) ) ) {  // already in buffer
    ...
    void Scanner::CreateHeapBlock() {
      ...
      while ( ( (char*)tokens < cur ) ||
              ( (char*)tokens > ( cur + HEAP_BLOCK_SIZE ) ) ) {
        cur = *( (char**)( cur + HEAP_BLOCK_SIZE ) );
        free( firstHeap );
        firstHeap = cur;
      }
    ...
    void Scanner::ResetPeek() { pt = tokens; }
