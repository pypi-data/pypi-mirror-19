...
namespace gum {
  ...
  namespace learning {
    ...
    class BasicDBRowTranslatorSetStatic<OUTPUT_SIZE,
      ...
      /** @brief indicates whether one of the translators needs an initial
       * parsing
     ...
     * identical, translator's methods are also inlined, otherwise, methods'
     *calls
     * induce virtual function overheads.
     *
     * This class enables efficient packing of cell translators into row
     *filters.
     * To make it easy to use, you should prefer using its helper creation
     *function
     ...
     *   Create<Translate, Col<5>, 4> (), // use Translate to translate cols 5
     *to 8
     ...
     * to 8
     *   Create<Translate2, Col<6,7> > (), // translate cols 6 and 7 and get the
     *                                     // result into 1 col of the output
     * row
     *   Create<Translate2, Col<10,11>, 4, Incr<1,2> > ()
     * );
     * @endcode
