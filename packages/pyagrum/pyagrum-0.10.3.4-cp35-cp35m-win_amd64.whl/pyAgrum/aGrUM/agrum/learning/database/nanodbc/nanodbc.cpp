...
#define NANODBC_SNPRINTF( buffer, count, format, ... ) \
...
// 888     888 888    888 8888888K.  888             888Y88888P888  8888b.
// .d8888b 888d888 .d88b.  .d8888b
// 888     888 888    888 888  "Y88b 888             888 Y888P 888     "88b
// d88P"    888P"  d88""88b 88K
// 888     888 888    888 888    888 888    888      888  Y8P  888 .d888888 888
// 888    888  888 "Y8888b.
// Y88b. .d88P 888  .d88P 888   d88P Y88b  d88P      888   "   888 888  888
// Y88b.    888    Y88..88P      X88
//  "Y88888P"  8888888P"  8888888P"   "Y8888P"       888       888 "Y888888
//  "Y8888P 888     "Y88P"   88888P'
// MARK: ODBC Macros -
...
#define NANODBC_CALL_RC( FUNC, RC, ... )                                       \
  do {                                                                         \
    std::cerr << __FILE__ ":" NANODBC_STRINGIZE(                               \
                     __LINE__ ) " " NANODBC_STRINGIZE( FUNC ) "(" #__VA_ARGS__ \
                                                              ")"              \
              << std::endl;                                                    \
    RC = FUNC( __VA_ARGS__ );                                                  \
  } while ( false ) /**/
...
// 888        888P"   888P"  d88""88b 888P"        888    888     "88b 888 "88b
// d88" 888 888 888 888 "88b d88P"88b
// 888        888     888    888  888 888          888    888 .d888888 888  888
// 888  888 888 888 888  888 888  888
// 888        888     888    Y88..88P 888          888    888 888  888 888  888
// Y88b 888 888 888 888  888 Y88b 888
// 8888888888 888     888     "Y88P"  888          888    888 "Y888888 888  888
// "Y88888 888 888 888  888  "Y88888
//                                                                                                             888
//                                                                                                        Y8b d88P
//                                                                                                         "Y88P"
// MARK: Error Handling -
...
namespace {
  ...
  inline nanodbc::string_type return_code( RETCODE rc ) {
    switch ( rc ) {
      case SQL_SUCCESS:
        return NANODBC_UNICODE( "SQL_SUCCESS" );
      case SQL_SUCCESS_WITH_INFO:
        return NANODBC_UNICODE( "SQL_SUCCESS_WITH_INFO" );
      case SQL_ERROR:
        return NANODBC_UNICODE( "SQL_ERROR" );
      case SQL_INVALID_HANDLE:
        return NANODBC_UNICODE( "SQL_INVALID_HANDLE" );
      case SQL_NO_DATA:
        return NANODBC_UNICODE( "SQL_NO_DATA" );
      case SQL_NEED_DATA:
        return NANODBC_UNICODE( "SQL_NEED_DATA" );
      case SQL_STILL_EXECUTING:
        return NANODBC_UNICODE( "SQL_STILL_EXECUTING" );
    }
    NANODBC_ASSERT( 0 );
  ...
  inline void convert( const std::wstring& in, std::wstring& out ) { out = in; }
#else
  inline void convert( const std::string& in, std::string& out ) { out = in; }
#endif
...
// 88888b.              888   88888b.d88b.  88888b.  888
// 888        d88""88b 888 "88b 888 "88b d8P  Y8b d88P"    888    888 d88""88b
// 888 "88b             888   888 "888 "88b 888 "88b 888
...
//  888  888           8888888 888  888  888 88888P"  888
//                                                                                                                      888
//                                                                                                                      888
//                                                                                                                      888
...
namespace nanodbc {
  ...
  class connection::connection_impl {
    ...
    void connect( const string_type& dsn,
      ...
      NANODBC_CALL_RC( NANODBC_UNICODE( SQLConnect ),
                       rc,
                       conn_,
                       ...
                       SQL_NTS );
      if ( !success( rc ) &&
           ( event_handle == NULL || rc != SQL_STILL_EXECUTING ) )
        NANODBC_THROW_DATABASE_ERROR( conn_, SQL_HANDLE_DBC );
    ...
    string_type database_name() const {
      // FIXME: Allocate buffer of dynamic size as drivers do not agree on
      // universal size
    ...
    std::size_t unref_transaction() { return ++transactions_; }
    ...
    transaction_impl( const class connection& conn )
      ...
      if ( conn_.transactions() == 0 && conn_.connected() ) {
        ...
        NANODBC_CALL_RC( SQLSetConnectAttr,
                         ...
                         SQL_IS_UINTEGER );
        if ( !success( rc ) )
          NANODBC_THROW_DATABASE_ERROR( conn_.native_dbc_handle(),
                                        SQL_HANDLE_DBC );
      }
...
//  888888             888   88888b.d88b.  88888b.  888
...
// Y88b.              888   888  888  888 888 d88P 888
//  "Y8888P"   "Y888 "Y888888  "Y888 "Y8888  888  888  888  "Y8888  888  888
//  "Y888           8888888 888  888  888 88888P"  888
//                                                                                                                  888
//                                                                                                                  888
//                                                                                                                  888
// MARK: Statement Impl -
...
namespace nanodbc {
  ...
  class statement::statement_impl {
    ...
    void
    prepare( class connection& conn, const string_type& query, long timeout ) {
      open( conn );
    ...
    RETCODE just_execute_direct( class connection&  conn,
      ...
      NANODBC_CALL_RC( NANODBC_UNICODE( SQLExecDirect ),
                       rc,
                       stmt_,
                       (NANODBC_SQLCHAR*)query.c_str(),
                       SQL_NTS );
    ...
    just_execute( long batch_operations, long timeout, statement& /*statement*/ ) {
      ...
      if ( open() ) {
        // The ODBC cursor must be closed before subsequent executions, as
        // described
        // here
        // http://msdn.microsoft.com/en-us/library/windows/desktop/ms713584%28v=vs.85%29.aspx
        //
        // However, we don't necessarily want to call SQLCloseCursor() because
        // that
        // will cause an invalid cursor state in the case that no cursor is
        // currently open.
        // A better solution is to use SQLFreeStmt() with the SQL_CLOSE option,
        // which has
    ...
    result procedure_columns( const string_type& catalog,
    ...
    void bind_parameter( short    param,
      ...
      NANODBC_CALL_RC( SQLBindParameter,
                       ...
                       ,
                       parameter_size  // column size ignored for many types,
                                       // but needed for strings
                       ,
  ...
  // In this case, we need to pass NULL to the final parameter of
  // SQLBindParameter().
  template <>
  void statement::statement_impl::bind_parameter<string_type::value_type>(
    ...
    NANODBC_CALL_RC(
        ...
        data_type  // parameter type
        ,
        parameter_size  // column size ignored for many types, but needed for
                        // strings
        ,
        scale  // decimal digits
        ,
  ...
  void statement::statement_impl::bind( short           param,
    ...
    bind_parameter(
        param, values, elements, data_type, param_type, parameter_size, scale );
  }
...
// 888   d88P .d88b.  .d8888b  888  888 888 888888             888
// 88888b.d88b.  88888b.  888
// 8888888P" d8P  Y8b 88K      888  888 888 888                888   888 "888
// "88b 888 "88b 888
// 888 T88b  88888888 "Y8888b. 888  888 888 888                888   888  888
// 888 888  888 888
// 888  T88b Y8b.          X88 Y88b 888 888 Y88b.              888   888  888
// 888 888 d88P 888
// 888   T88b "Y8888   88888P'  "Y88888 888  "Y888           8888888 888  888
// 888 88888P"  888
//                                                                                 888
//                                                                                 888
//                                                                                 888
...
namespace nanodbc {
  ...
  class result::result_impl {
    ...
    bool prior() {
      if ( rows() && --rowset_position_ >= 0 ) return true;
      rowset_position_ = 0;
    ...
    unsigned long position() const {
      ...
      RETCODE rc;
      NANODBC_CALL_RC( SQLGetStmtAttr,
                       rc,
                       stmt_.native_statement_handle(),
                       SQL_ATTR_ROW_NUMBER,
                       &pos,
      ...
      //
      // NOTE: We try to address incorrect implementation in some drivers (e.g.
      // SQLite ODBC)
      // which instead of 0 return SQL_ROW_NUMBER_UNKNOWN(-2) .
      if ( pos == 0 || pos == static_cast<SQLULEN>( SQL_ROW_NUMBER_UNKNOWN ) )
        return 0;

      NANODBC_ASSERT( pos <= static_cast<SQLULEN>(
    ...
    bool end() const NANODBC_NOEXCEPT {
      ...
      NANODBC_CALL_RC( SQLGetStmtAttr,
                       ...
                       SQL_IS_UINTEGER,
                       0 );
      return ( !success( rc ) || rows() < 0 ||
               pos - 1 > static_cast<unsigned long>( rows() ) );
    }

    bool is_null( short column ) const {
      if ( column >= bound_columns_size_ ) throw index_range_error();
      bound_column& col = bound_columns_[column];
      if ( rowset_position_ >= rows() ) throw index_range_error();
    ...
    short column( const string_type& column_name ) const {
      ...
      if ( i == bound_columns_by_name_.end() ) throw index_range_error();
    ...
    void get_ref( short column, T& result ) const {
      if ( column >= bound_columns_size_ ) throw index_range_error();
      if ( is_null( column ) ) throw null_access_error();
    ...
    void auto_bind() {
      ...
      for ( SQLSMALLINT i = 0; i < n_columns; ++i ) {
        ...
        // Adjust the sqlsize parameter in case of "unlimited" data
        ...
        if ( sqlsize == 0 ) {
          switch ( sqltype ) {
            case SQL_VARCHAR:
            case SQL_WVARCHAR: {
              // Divide in half, due to sqlsize being 32-bit in Win32 (and
              // 64-bit in x64)
  ...
  template <>
  inline void result::result_impl::get_ref_impl<date>( short column,
                                                       date& result ) const {
    bound_column& col = bound_columns_[column];
    switch ( col.ctype_ ) {
      case SQL_C_DATE:
  ...
  result::result_impl::get_ref_impl<string_type>( short        column,
    ...
    switch ( col.ctype_ ) {
      ...
      case SQL_C_WCHAR: {
        if ( col.blob_ ) {
          // Input is always std::wstring, output might be std::string or
          // std::wstring.
      ...
      case SQL_C_GUID:
      case SQL_C_BINARY: {
        if ( col.blob_ ) throw std::runtime_error( "blob not implemented yet" );
        const char* s = col.pdata_ + rowset_position_ * col.clen_;
...
// 888     888P"  d8P  Y8b d8P  Y8b      888     888  888 888 "88b d88P"    888
...
// 888                        888
// 888         .d88b.  88888b.  88888b.   .d88b.   .d8888b 888888 888  .d88b.
// 88888b.            8888888 888  888  888  .d88888
// 888        d88""88b 888 "88b 888 "88b d8P  Y8b d88P"    888    888 d88""88b
// 888 "88b           888     888  888  888 d88" 888
// 888    888 888  888 888  888 888  888 88888888 888      888    888 888  888
// 888  888           888     888  888  888 888  888
// Y88b  d88P Y88..88P 888  888 888  888 Y8b.     Y88b.    Y88b.  888 Y88..88P
// 888  888           888     Y88b 888 d88P Y88b 888
//  "Y8888P"   "Y88P"  888  888 888  888  "Y8888   "Y8888P  "Y888 888  "Y88P"
//  888  888           888      "Y8888888P"   "Y88888
// MARK: Connection Fwd -
...
namespace nanodbc {
  ...
  void connection::async_complete() { impl_->async_complete(); }
#endif  // SQL_ATTR_ASYNC_DBC_EVENT

  bool connection::connected() const { return impl_->connected(); }

  void connection::disconnect() { impl_->disconnect(); }

  std::size_t connection::transactions() const { return impl_->transactions(); }
  ...
  std::size_t connection::ref_transaction() { return impl_->ref_transaction(); }

  std::size_t connection::unref_transaction() {
    return impl_->unref_transaction();
  }

  bool connection::rollback() const { return impl_->rollback(); }

  void connection::rollback( bool onoff ) { impl_->rollback( onoff ); }
...
//     888                        888
//     888  888d888 8888b.  88888b.  .d8888b   8888b.   .d8888b 888888 888
//     .d88b.  88888b.            8888888 888  888  888  .d88888 .d8888b
//     888  888P"      "88b 888 "88b 88K          "88b d88P"    888    888
//     d88""88b 888 "88b           888     888  888  888 d88" 888 88K
//     888  888    .d888888 888  888 "Y8888b. .d888888 888      888    888 888
//     888 888  888           888     888  888  888 888  888 "Y8888b.
//     888  888    888  888 888  888      X88 888  888 Y88b.    Y88b.  888
//     Y88..88P 888  888           888     Y88b 888 d88P Y88b 888      X88
//     888  888    "Y888888 888  888  88888P' "Y888888  "Y8888P  "Y888 888
//     "Y88P"  888  888           888      "Y8888888P"   "Y88888  88888P'
...
namespace nanodbc {
  ...
  void transaction::commit() { impl_->commit(); }

  void transaction::rollback() NANODBC_NOEXCEPT { impl_->rollback(); }
  ...
  transaction::operator class connection&() { return impl_->connection(); }
...
// 888                        888
//  "Y888b.   888888  8888b.  888888 .d88b.  88888b.d88b.   .d88b.  88888b.
//  888888           8888888 888  888  888  .d88888
//     "Y88b. 888        "88b 888   d8P  Y8b 888 "888 "88b d8P  Y8b 888 "88b 888
//     888     888  888  888 d88" 888
//       "888 888    .d888888 888   88888888 888  888  888 88888888 888  888 888
//       888     888  888  888 888  888
// Y88b  d88P Y88b.  888  888 Y88b. Y8b.     888  888  888 Y8b.     888  888
// Y88b.            888     Y88b 888 d88P Y88b 888
//  "Y8888P"   "Y888 "Y888888  "Y888 "Y8888  888  888  888  "Y8888  888  888
//  "Y888           888      "Y8888888P"   "Y88888
// MARK: Statement Fwd -
...
namespace nanodbc {
  ...
  void statement::open( class connection& conn ) { impl_->open( conn ); }

  bool statement::open() const { return impl_->open(); }

  bool statement::connected() const { return impl_->connected(); }
  ...
  void statement::close() { impl_->close(); }
  ...
  result statement::procedure_columns( const string_type& catalog,
                                       const string_type& schema,
                                       const string_type& procedure,
                                       const string_type& column ) {
  ...
  short statement::columns() const { return impl_->columns(); }
...
// We need to instantiate each form of bind() for each of our supported data
// types.
#define NANODBC_INSTANTIATE_BINDS( type )                               \
  template void statement::bind(                                        \
      short, const type*, param_direction ); /* 1-ary */                \
  template void statement::bind(                                        \
      short, const type*, std::size_t, param_direction ); /* n-ary */   \
  template void statement::bind( short,                                 \
                                 const type*,                           \
                                 std::size_t,                           \
                                 const type*,                           \
                                 param_direction ); /* n-ary, sentry */ \
  template void statement::bind( short,                                 \
                                 const type*,                           \
                                 std::size_t,                           \
                                 const bool*,                           \
                                 param_direction ) /* n-ary, flags */ /**/
...
namespace nanodbc {
  ...
  bool catalog::tables::next() { return result_.next(); }
  ...
  bool catalog::primary_keys::next() { return result_.next(); }
  ...
  bool catalog::columns::next() { return result_.next(); }
  ...
  catalog::tables catalog::find_tables( const string_type& table,
    ...
    if ( !success( rc ) )
      NANODBC_THROW_DATABASE_ERROR( stmt.native_statement_handle(),
                                    SQL_HANDLE_STMT );
  ...
  catalog::columns catalog::find_columns( const string_type& column,
...
// 888   Y88b                           888 888              888 888
// 888    888                           888 888              888 888
// 888   d88P .d88b.  .d8888b  888  888 888 888888           8888888 888  888
// 888  .d88888
// 8888888P" d8P  Y8b 88K      888  888 888 888              888     888  888
// 888 d88" 888
// 888 T88b  88888888 "Y8888b. 888  888 888 888              888     888  888
// 888 888  888
// 888  T88b Y8b.          X88 Y88b 888 888 Y88b.            888     Y88b 888
// d88P Y88b 888
// 888   T88b "Y8888   88888P'  "Y88888 888  "Y888           888
// "Y8888888P"   "Y88888
// MARK: Result Fwd -
...
namespace nanodbc {
  ...
  long result::affected_rows() const { return impl_->affected_rows(); }

  long result::rows() const NANODBC_NOEXCEPT { return impl_->rows(); }

  short result::columns() const { return impl_->columns(); }

  bool result::first() { return impl_->first(); }

  bool result::last() { return impl_->last(); }

  bool result::next() { return impl_->next(); }

  bool result::prior() { return impl_->prior(); }

  bool result::move( long row ) { return impl_->move( row ); }

  bool result::skip( long rows ) { return impl_->skip( rows ); }

  unsigned long result::position() const { return impl_->position(); }
  ...
  bool result::next_result() { return impl_->next_result(); }
  ...
  result::operator bool() const { return static_cast<bool>( impl_ ); }
  ...
  // The following are the only supported instantiations of result::get_ref()
  // with fallback.
  template void result::get_ref( short,
  ...
  template void
  result::get_ref( const string_type&, const int32_t&, int32_t& ) const;
  template void
  result::get_ref( const string_type&, const uint32_t&, uint32_t& ) const;
  template void
