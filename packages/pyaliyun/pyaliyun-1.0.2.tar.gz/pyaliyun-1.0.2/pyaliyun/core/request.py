...
from .utils import buiild_canonicalized_headers, sign, get_date, build_header_authorization, dict_to_xml
...
class AliRequest:
    ...
    def _build(self):
        ...
        md5_hash = ""
        if self.method == "POST":
            md5_hash = base64.b64encode(hashlib.md5(self.request_body).hexdigest())
        self.headers.update(
            {
