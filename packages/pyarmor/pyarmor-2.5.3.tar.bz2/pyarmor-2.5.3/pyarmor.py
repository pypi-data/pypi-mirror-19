...
#############################################################
#                                                           #
#      Copyright @ 2013 - 2016 Dashingsoft corp.            #
#      All rights reserved.                                 #
#                                                           #
#      Pyshield                                             #
#                                                           #
...
__versioninfo__ = '''
Pyarmor {0}
Copyright (c) 2009 - 2016 Dashingsoft Corp. All rights reserved.
...
Usage: pyarmor encrypt [OPTIONS] [File Patterns or @Filename]
  ...
  name plus 'y'. By default, the encrypted scripts and all the
...
def encrypt_files(files, kv, output=None):
    ...
    a suffix 'y', for example, hello.py -> hello.pyx
