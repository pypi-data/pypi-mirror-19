...
along with the operational characteristics.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__interface_type','__interface_name','__mode','__fcoe_port_enabled','__ingress_filter_enabled','__acceptable_frame_type','__default_vlan','__active_vlans','__inactive_vlans',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__fcoe_port_enabled = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="fcoe-port-enabled", rest_name="fcoe-port-enabled", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-interface-ext', defining_module='brocade-interface-ext', yang_type='boolean', is_config=True)
...
'interface-type' must fail with an error.
  ...
  def _get_fcoe_port_enabled(self):
    """
    Getter method for fcoe_port_enabled, mapped from YANG variable /brocade_interface_ext_rpc/get_interface_switchport/output/switchport/fcoe_port_enabled (boolean)

    YANG Description: This indicates if the FCoE capability is 
...
FCoE.
    """
    return self.__fcoe_port_enabled
      
  def _set_fcoe_port_enabled(self, v, load=False):
    """
    Setter method for fcoe_port_enabled, mapped from YANG variable /brocade_interface_ext_rpc/get_interface_switchport/output/switchport/fcoe_port_enabled (boolean)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_fcoe_port_enabled is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_fcoe_port_enabled() directly.
...
FCoE.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """fcoe_port_enabled must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="fcoe-port-enabled", rest_name="fcoe-port-enabled", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-interface-ext', defining_module='brocade-interface-ext', yang_type='boolean', is_config=True)""",
        })

    self.__fcoe_port_enabled = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_fcoe_port_enabled(self):
    self.__fcoe_port_enabled = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="fcoe-port-enabled", rest_name="fcoe-port-enabled", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-interface-ext', defining_module='brocade-interface-ext', yang_type='boolean', is_config=True)
...
vlans for this switch-port interface.
  ...
  fcoe_port_enabled = __builtin__.property(_get_fcoe_port_enabled, _set_fcoe_port_enabled)
  ...
  _pyangbind_elements = {'interface_type': interface_type, 'interface_name': interface_name, 'mode': mode, 'fcoe_port_enabled': fcoe_port_enabled, 'ingress_filter_enabled': ingress_filter_enabled, 'acceptable_frame_type': acceptable_frame_type, 'default_vlan': default_vlan, 'active_vlans': active_vlans, 'inactive_vlans': inactive_vlans, }
