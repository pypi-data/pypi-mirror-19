...
interface.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__interface_type','__interface_name','__sfp','__on_board','__gbc','__xfp','__xff','__xfpe','__unknown','__qsfp','__qsfpp','__cfp','__cfp2',)
...
'interface-type' must fail with an error.
  ...
  __choices__ = {u'interface-identifier': {u'cfp2': [u'cfp2'], u'gbic': [u'gbc'], u'on-board': [u'on_board'], u'qsfp': [u'qsfp'], u'unknown': [u'unknown'], u'sfp': [u'sfp'], u'xfpe': [u'xfpe'], u'qsfpp': [u'qsfpp'], u'xfp': [u'xfp'], u'xff': [u'xff'], u'cfp': [u'cfp']}}
  _pyangbind_elements = {'interface_type': interface_type, 'interface_name': interface_name, 'sfp': sfp, 'on_board': on_board, 'gbc': gbc, 'xfp': xfp, 'xff': xff, 'xfpe': xfpe, 'unknown': unknown, 'qsfp': qsfp, 'qsfpp': qsfpp, 'cfp': cfp, 'cfp2': cfp2, }
