...
class ip_pbr_interface(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/ip-pbr-interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'ip-pbr-interface']
  ...
  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /interface/fortygigabitethernet/ip_pbr_interface/ip (container)
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /interface/fortygigabitethernet/ip_pbr_interface/ip (container)
