...
class arp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/vrrp/arp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'vrrp', u'arp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'FortyGigabitEthernet', u'vrrp-group', u'arp']

  def _get_unicast_request(self):
    """
    Getter method for unicast_request, mapped from YANG variable /interface/fortygigabitethernet/vrrp/arp/unicast_request (container)
  ...
  def _set_unicast_request(self, v, load=False):
    """
    Setter method for unicast_request, mapped from YANG variable /interface/fortygigabitethernet/vrrp/arp/unicast_request (container)
