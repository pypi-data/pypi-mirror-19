...
class interface(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/vrrp/track/interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'vrrp', u'track', u'interface']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'FortyGigabitEthernet', u'vrrp-group', u'track']

  def _get_interface_type(self):
    """
    Getter method for interface_type, mapped from YANG variable /interface/fortygigabitethernet/vrrp/track/interface/interface_type (track-iftype)
    """
    return self.__interface_type
      
  def _set_interface_type(self, v, load=False):
    """
    Setter method for interface_type, mapped from YANG variable /interface/fortygigabitethernet/vrrp/track/interface/interface_type (track-iftype)
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /interface/fortygigabitethernet/vrrp/track/interface/interface_name (track-ifname)
    """
    return self.__interface_name
      
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /interface/fortygigabitethernet/vrrp/track/interface/interface_name (track-ifname)
    If this variable is read-only (config: false) in the
  ...
  def _get_track_priority(self):
    """
    Getter method for track_priority, mapped from YANG variable /interface/fortygigabitethernet/vrrp/track/interface/track_priority (uint8)
  ...
  def _set_track_priority(self, v, load=False):
    """
    Setter method for track_priority, mapped from YANG variable /interface/fortygigabitethernet/vrrp/track/interface/track_priority (uint8)
    If this variable is read-only (config: false) in the
