...
import __builtin__
import dhcp
class interface_gi_dhcp_conf(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/ip/interface-gi-dhcp-conf. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__dhcp',)

  _yang_name = 'interface-gi-dhcp-conf'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'ip', u'interface-gi-dhcp-conf']
  ...
  def _get_dhcp(self):
    """
    Getter method for dhcp, mapped from YANG variable /interface/gigabitethernet/ip/interface_gi_dhcp_conf/dhcp (container)
    """
    return self.__dhcp
      
  def _set_dhcp(self, v, load=False):
    """
    Setter method for dhcp, mapped from YANG variable /interface/gigabitethernet/ip/interface_gi_dhcp_conf/dhcp (container)
