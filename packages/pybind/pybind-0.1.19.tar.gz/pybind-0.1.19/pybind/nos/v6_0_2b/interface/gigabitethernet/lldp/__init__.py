...
class lldp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/lldp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'lldp']
  ...
  def _get_cee(self):
    """
    Getter method for cee, mapped from YANG variable /interface/gigabitethernet/lldp/cee (container)
  ...
  def _set_cee(self, v, load=False):
    """
    Setter method for cee, mapped from YANG variable /interface/gigabitethernet/lldp/cee (container)
  ...
  def _get_dcbx_version(self):
    """
    Getter method for dcbx_version, mapped from YANG variable /interface/gigabitethernet/lldp/dcbx_version (enumeration)
    """
    return self.__dcbx_version
      
  def _set_dcbx_version(self, v, load=False):
    """
    Setter method for dcbx_version, mapped from YANG variable /interface/gigabitethernet/lldp/dcbx_version (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_disable(self):
    """
    Getter method for disable, mapped from YANG variable /interface/gigabitethernet/lldp/disable (empty)
    """
    return self.__disable
      
  def _set_disable(self, v, load=False):
    """
    Setter method for disable, mapped from YANG variable /interface/gigabitethernet/lldp/disable (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_iscsi_priority(self):
    """
    Getter method for iscsi_priority, mapped from YANG variable /interface/gigabitethernet/lldp/iscsi_priority (uint32)
    """
    return self.__iscsi_priority
      
  def _set_iscsi_priority(self, v, load=False):
    """
    Setter method for iscsi_priority, mapped from YANG variable /interface/gigabitethernet/lldp/iscsi_priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_profile(self):
    """
    Getter method for profile, mapped from YANG variable /interface/gigabitethernet/lldp/profile (string)
    """
    return self.__profile
      
  def _set_profile(self, v, load=False):
    """
    Setter method for profile, mapped from YANG variable /interface/gigabitethernet/lldp/profile (string)
    If this variable is read-only (config: false) in the
