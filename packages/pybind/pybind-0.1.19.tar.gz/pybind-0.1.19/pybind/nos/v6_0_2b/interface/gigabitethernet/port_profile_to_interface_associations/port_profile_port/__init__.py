...
class port_profile_port(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/port-profile-to-interface-associations/port-profile-port. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'port-profile-to-interface-associations', u'port-profile-port']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'GigabitEthernet', u'port-profile-port']

  def _get_port_to_port_profile_domain_association(self):
    """
    Getter method for port_to_port_profile_domain_association, mapped from YANG variable /interface/gigabitethernet/port_profile_to_interface_associations/port_profile_port/port_to_port_profile_domain_association (container)
  ...
  def _set_port_to_port_profile_domain_association(self, v, load=False):
    """
    Setter method for port_to_port_profile_domain_association, mapped from YANG variable /interface/gigabitethernet/port_profile_to_interface_associations/port_profile_port/port_to_port_profile_domain_association (container)
  ...
  def _get_port_to_port_profile_associations(self):
    """
    Getter method for port_to_port_profile_associations, mapped from YANG variable /interface/gigabitethernet/port_profile_to_interface_associations/port_profile_port/port_to_port_profile_associations (list)
...
with an interface.
  ...
  def _set_port_to_port_profile_associations(self, v, load=False):
    """
    Setter method for port_to_port_profile_associations, mapped from YANG variable /interface/gigabitethernet/port_profile_to_interface_associations/port_profile_port/port_to_port_profile_associations (list)
    If this variable is read-only (config: false) in the
