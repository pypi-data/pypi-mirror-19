...
class spanning_tree(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/spanning-tree. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'spanning-tree']
  ...
  def _get_autoedge(self):
    """
    Getter method for autoedge, mapped from YANG variable /interface/gigabitethernet/spanning_tree/autoedge (empty)
    """
    return self.__autoedge
      
  def _set_autoedge(self, v, load=False):
    """
    Setter method for autoedge, mapped from YANG variable /interface/gigabitethernet/spanning_tree/autoedge (empty)
  ...
  def _get_cost(self):
    """
    Getter method for cost, mapped from YANG variable /interface/gigabitethernet/spanning_tree/cost (uint32)
    """
    return self.__cost
      
  def _set_cost(self, v, load=False):
    """
    Setter method for cost, mapped from YANG variable /interface/gigabitethernet/spanning_tree/cost (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_portfast(self):
    """
    Getter method for portfast, mapped from YANG variable /interface/gigabitethernet/spanning_tree/portfast (container)
    """
    return self.__portfast
      
  def _set_portfast(self, v, load=False):
    """
    Setter method for portfast, mapped from YANG variable /interface/gigabitethernet/spanning_tree/portfast (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_edgeport(self):
    """
    Getter method for edgeport, mapped from YANG variable /interface/gigabitethernet/spanning_tree/edgeport (container)
    """
    return self.__edgeport
      
  def _set_edgeport(self, v, load=False):
    """
    Setter method for edgeport, mapped from YANG variable /interface/gigabitethernet/spanning_tree/edgeport (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_guard(self):
    """
    Getter method for guard, mapped from YANG variable /interface/gigabitethernet/spanning_tree/guard (container)
    """
    return self.__guard
      
  def _set_guard(self, v, load=False):
    """
    Setter method for guard, mapped from YANG variable /interface/gigabitethernet/spanning_tree/guard (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_hello_time(self):
    """
    Getter method for hello_time, mapped from YANG variable /interface/gigabitethernet/spanning_tree/hello_time (uint32)
    """
    return self.__hello_time
      
  def _set_hello_time(self, v, load=False):
    """
    Setter method for hello_time, mapped from YANG variable /interface/gigabitethernet/spanning_tree/hello_time (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_bpdu_mac(self):
    """
    Getter method for bpdu_mac, mapped from YANG variable /interface/gigabitethernet/spanning_tree/bpdu_mac (enumeration)
    """
    return self.__bpdu_mac
      
  def _set_bpdu_mac(self, v, load=False):
    """
    Setter method for bpdu_mac, mapped from YANG variable /interface/gigabitethernet/spanning_tree/bpdu_mac (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_link_type(self):
    """
    Getter method for link_type, mapped from YANG variable /interface/gigabitethernet/spanning_tree/link_type (enumeration)
    """
    return self.__link_type
      
  def _set_link_type(self, v, load=False):
    """
    Setter method for link_type, mapped from YANG variable /interface/gigabitethernet/spanning_tree/link_type (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_priority(self):
    """
    Getter method for priority, mapped from YANG variable /interface/gigabitethernet/spanning_tree/priority (uint32)
    """
    return self.__priority
      
  def _set_priority(self, v, load=False):
    """
    Setter method for priority, mapped from YANG variable /interface/gigabitethernet/spanning_tree/priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_restricted_role(self):
    """
    Getter method for restricted_role, mapped from YANG variable /interface/gigabitethernet/spanning_tree/restricted_role (empty)
    """
    return self.__restricted_role
      
  def _set_restricted_role(self, v, load=False):
    """
    Setter method for restricted_role, mapped from YANG variable /interface/gigabitethernet/spanning_tree/restricted_role (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_restricted_tcn(self):
    """
    Getter method for restricted_tcn, mapped from YANG variable /interface/gigabitethernet/spanning_tree/restricted_tcn (empty)
    """
    return self.__restricted_tcn
      
  def _set_restricted_tcn(self, v, load=False):
    """
    Setter method for restricted_tcn, mapped from YANG variable /interface/gigabitethernet/spanning_tree/restricted_tcn (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_shutdown(self):
    """
    Getter method for shutdown, mapped from YANG variable /interface/gigabitethernet/spanning_tree/shutdown (empty)
    """
    return self.__shutdown
      
  def _set_shutdown(self, v, load=False):
    """
    Setter method for shutdown, mapped from YANG variable /interface/gigabitethernet/spanning_tree/shutdown (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/gigabitethernet/spanning_tree/vlan (list)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/gigabitethernet/spanning_tree/vlan (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_instance(self):
    """
    Getter method for instance, mapped from YANG variable /interface/gigabitethernet/spanning_tree/instance (list)
    """
    return self.__instance
      
  def _set_instance(self, v, load=False):
    """
    Setter method for instance, mapped from YANG variable /interface/gigabitethernet/spanning_tree/instance (list)
    If this variable is read-only (config: false) in the
