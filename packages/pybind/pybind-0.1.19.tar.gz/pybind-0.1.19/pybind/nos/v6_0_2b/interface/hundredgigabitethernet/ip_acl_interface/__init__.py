...
class ip_acl_interface(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/ip-acl-interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'ip-acl-interface']
  ...
  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /interface/hundredgigabitethernet/ip_acl_interface/ip (container)
    """
    return self.__ip
      
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /interface/hundredgigabitethernet/ip_acl_interface/ip (container)
