...
class relay(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/ipv6/interface-phy-dhcp-conf/dhcp/relay. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__servers',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'ipv6', u'interface-phy-dhcp-conf', u'dhcp', u'relay']
  ...
  def _get_servers(self):
    """
    Getter method for servers, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay/servers (list)
    """
    return self.__servers
      
  def _set_servers(self, v, load=False):
    """
    Setter method for servers, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay/servers (list)
  ...
  _pyangbind_elements = {'servers': servers, }
