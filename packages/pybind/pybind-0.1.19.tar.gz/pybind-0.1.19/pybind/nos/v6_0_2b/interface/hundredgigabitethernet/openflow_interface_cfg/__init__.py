...
class openflow_interface_cfg(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/openflow-interface-cfg. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'openflow-interface-cfg']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'HundredGigabitEthernet', u'openflow']

  def _get_logical_instance_id(self):
    """
    Getter method for logical_instance_id, mapped from YANG variable /interface/hundredgigabitethernet/openflow_interface_cfg/logical_instance_id (instance-id-type)
...
logical instances under a physical switch.
  ...
  def _set_logical_instance_id(self, v, load=False):
    """
    Setter method for logical_instance_id, mapped from YANG variable /interface/hundredgigabitethernet/openflow_interface_cfg/logical_instance_id (instance-id-type)
...
logical instances under a physical switch.
  ...
  def _get_openflow_enable(self):
    """
    Getter method for openflow_enable, mapped from YANG variable /interface/hundredgigabitethernet/openflow_interface_cfg/openflow_enable (container)
    """
    return self.__openflow_enable
      
  def _set_openflow_enable(self, v, load=False):
    """
    Setter method for openflow_enable, mapped from YANG variable /interface/hundredgigabitethernet/openflow_interface_cfg/openflow_enable (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=openflow_enable.openflow_enable, is_container='container', yang_name="openflow-enable", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-openflow', defining_module='brocade-openflow', yang_type='container', is_config=True)""",
        })
