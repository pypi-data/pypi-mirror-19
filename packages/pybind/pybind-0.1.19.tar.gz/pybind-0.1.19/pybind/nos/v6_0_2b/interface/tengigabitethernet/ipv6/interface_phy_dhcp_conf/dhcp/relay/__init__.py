...
class relay(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ipv6/interface-phy-dhcp-conf/dhcp/relay. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ipv6', u'interface-phy-dhcp-conf', u'dhcp', u'relay']
  ...
  def _get_servers(self):
    """
    Getter method for servers, mapped from YANG variable /interface/tengigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay/servers (list)
    """
    return self.__servers
      
  def _set_servers(self, v, load=False):
    """
    Setter method for servers, mapped from YANG variable /interface/tengigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay/servers (list)
