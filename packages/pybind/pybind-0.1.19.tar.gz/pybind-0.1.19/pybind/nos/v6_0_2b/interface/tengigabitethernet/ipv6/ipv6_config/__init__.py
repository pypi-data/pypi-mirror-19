...
class ipv6_config(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ipv6/ipv6-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ipv6', u'ipv6-config']
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_config/address (container)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_config/address (container)
  ...
  def _get_mtu(self):
    """
    Getter method for mtu, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_config/mtu (uint32)
    """
    return self.__mtu
      
  def _set_mtu(self, v, load=False):
    """
    Setter method for mtu, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_config/mtu (uint32)
    If this variable is read-only (config: false) in the
