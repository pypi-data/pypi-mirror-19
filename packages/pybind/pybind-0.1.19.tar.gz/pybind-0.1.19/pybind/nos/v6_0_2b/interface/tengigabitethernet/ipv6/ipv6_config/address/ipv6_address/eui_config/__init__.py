...
class eui_config(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ipv6/ipv6-config/address/ipv6-address/eui-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ipv6', u'ipv6-config', u'address', u'ipv6-address', u'eui-config']
  ...
  def _get_eui64(self):
    """
    Getter method for eui64, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_config/address/ipv6_address/eui_config/eui64 (empty)
    """
    return self.__eui64
      
  def _set_eui64(self, v, load=False):
    """
    Setter method for eui64, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_config/address/ipv6_address/eui_config/eui64 (empty)
  ...
  def _get_eui_secondary(self):
    """
    Getter method for eui_secondary, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_config/address/ipv6_address/eui_config/eui_secondary (empty)
    """
    return self.__eui_secondary
      
  def _set_eui_secondary(self, v, load=False):
    """
    Setter method for eui_secondary, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_config/address/ipv6_address/eui_config/eui_secondary (empty)
    If this variable is read-only (config: false) in the
