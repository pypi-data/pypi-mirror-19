...
class rcv_queue(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/qos/rcv-queue. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Configure Queue Parameters
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__cos_threshold',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'qos', u'rcv-queue']
  ...
  def _get_cos_threshold(self):
    """
    Getter method for cos_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold (container)
  ...
  def _set_cos_threshold(self, v, load=False):
    """
    Setter method for cos_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold (container)
  ...
  _pyangbind_elements = {'cos_threshold': cos_threshold, }
