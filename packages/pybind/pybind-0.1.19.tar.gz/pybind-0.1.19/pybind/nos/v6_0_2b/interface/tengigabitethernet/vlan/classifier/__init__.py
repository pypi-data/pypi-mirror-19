...
class classifier(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/vlan/classifier. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'vlan', u'classifier']
  ...
  def _get_activate(self):
    """
    Getter method for activate, mapped from YANG variable /interface/tengigabitethernet/vlan/classifier/activate (container)
    """
    return self.__activate
      
  def _set_activate(self, v, load=False):
    """
    Setter method for activate, mapped from YANG variable /interface/tengigabitethernet/vlan/classifier/activate (container)
