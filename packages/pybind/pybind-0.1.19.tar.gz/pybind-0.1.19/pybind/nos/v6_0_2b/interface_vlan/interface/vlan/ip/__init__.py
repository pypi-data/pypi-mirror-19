...
class ip(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__arp','__igmp',)
  ...
  _pyangbind_elements = {'arp': arp, 'igmp': igmp, }
