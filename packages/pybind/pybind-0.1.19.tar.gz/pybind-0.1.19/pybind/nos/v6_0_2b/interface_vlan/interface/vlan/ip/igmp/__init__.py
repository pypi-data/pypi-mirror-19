...
class igmp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__last_member_query_interval','__query_interval','__query_max_response_time','__snooping','__static_group',)
  ...
  _pyangbind_elements = {'last_member_query_interval': last_member_query_interval, 'query_interval': query_interval, 'query_max_response_time': query_max_response_time, 'snooping': snooping, 'static_group': static_group, }
