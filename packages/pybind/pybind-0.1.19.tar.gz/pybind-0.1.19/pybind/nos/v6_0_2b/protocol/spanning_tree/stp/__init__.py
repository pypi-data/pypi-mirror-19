...
class stp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__description','__bridge_priority','__error_disable_timeout','__forward_delay','__max_age','__port_channel','__shutdown','__hello_time',)
  ...
  _pyangbind_elements = {'description': description, 'bridge_priority': bridge_priority, 'error_disable_timeout': error_disable_timeout, 'forward_delay': forward_delay, 'max_age': max_age, 'port_channel': port_channel, 'shutdown': shutdown, 'hello_time': hello_time, }
