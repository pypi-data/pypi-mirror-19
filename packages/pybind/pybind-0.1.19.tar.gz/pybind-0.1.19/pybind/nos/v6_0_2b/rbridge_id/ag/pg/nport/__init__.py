...
import __builtin__
import pg_nport_interface
class nport(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/ag/pg/nport. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__pg_nport_interface',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ag', u'pg', u'nport']
  ...
  def _get_pg_nport_interface(self):
    """
    Getter method for pg_nport_interface, mapped from YANG variable /rbridge_id/ag/pg/nport/pg_nport_interface (container)
    """
    return self.__pg_nport_interface
      
  def _set_pg_nport_interface(self, v, load=False):
    """
    Setter method for pg_nport_interface, mapped from YANG variable /rbridge_id/ag/pg/nport/pg_nport_interface (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_pg_nport_interface is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_pg_nport_interface() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'pg_nport_interface': pg_nport_interface, }
