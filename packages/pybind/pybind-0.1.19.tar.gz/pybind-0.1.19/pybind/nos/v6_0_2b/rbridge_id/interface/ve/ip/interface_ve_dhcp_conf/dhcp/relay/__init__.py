...
class relay(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ip/interface-ve-dhcp-conf/dhcp/relay. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ip', u'interface-ve-dhcp-conf', u'dhcp', u'relay']
  ...
  def _get_servers(self):
    """
    Getter method for servers, mapped from YANG variable /rbridge_id/interface/ve/ip/interface_ve_dhcp_conf/dhcp/relay/servers (list)
    """
    return self.__servers
      
  def _set_servers(self, v, load=False):
    """
    Setter method for servers, mapped from YANG variable /rbridge_id/interface/ve/ip/interface_ve_dhcp_conf/dhcp/relay/servers (list)
  ...
  def _get_gateway(self):
    """
    Getter method for gateway, mapped from YANG variable /rbridge_id/interface/ve/ip/interface_ve_dhcp_conf/dhcp/relay/gateway (dhcp-ipv4-address)
  ...
  def _set_gateway(self, v, load=False):
    """
    Setter method for gateway, mapped from YANG variable /rbridge_id/interface/ve/ip/interface_ve_dhcp_conf/dhcp/relay/gateway (dhcp-ipv4-address)
    If this variable is read-only (config: false) in the
