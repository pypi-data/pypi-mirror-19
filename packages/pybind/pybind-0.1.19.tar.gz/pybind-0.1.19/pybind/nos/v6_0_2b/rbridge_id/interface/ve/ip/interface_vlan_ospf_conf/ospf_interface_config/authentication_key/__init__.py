...
class authentication_key(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ip/interface-vlan-ospf-conf/ospf-interface-config/authentication-key. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ip', u'interface-vlan-ospf-conf', u'ospf-interface-config', u'authentication-key']
  ...
  def _get_no_encrypt_auth_key_table(self):
    """
    Getter method for no_encrypt_auth_key_table, mapped from YANG variable /rbridge_id/interface/ve/ip/interface_vlan_ospf_conf/ospf_interface_config/authentication_key/no_encrypt_auth_key_table (container)
    """
    return self.__no_encrypt_auth_key_table
      
  def _set_no_encrypt_auth_key_table(self, v, load=False):
    """
    Setter method for no_encrypt_auth_key_table, mapped from YANG variable /rbridge_id/interface/ve/ip/interface_vlan_ospf_conf/ospf_interface_config/authentication_key/no_encrypt_auth_key_table (container)
  ...
  def _get_auth_key_table(self):
    """
    Getter method for auth_key_table, mapped from YANG variable /rbridge_id/interface/ve/ip/interface_vlan_ospf_conf/ospf_interface_config/authentication_key/auth_key_table (container)
    """
    return self.__auth_key_table
      
  def _set_auth_key_table(self, v, load=False):
    """
    Setter method for auth_key_table, mapped from YANG variable /rbridge_id/interface/ve/ip/interface_vlan_ospf_conf/ospf_interface_config/authentication_key/auth_key_table (container)
    If this variable is read-only (config: false) in the
