...
class ip_local_anycast_gateway(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ip/ip-local-anycast-gateway. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ip', u'ip-local-anycast-gateway']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Ve', u'ip', u'fabric-virtual-gateway']

  def _get_local_ip_gw_id(self):
    """
    Getter method for local_ip_gw_id, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/local_ip_gw_id (uint32)
    """
    return self.__local_ip_gw_id
      
  def _set_local_ip_gw_id(self, v, load=False):
    """
    Setter method for local_ip_gw_id, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/local_ip_gw_id (uint32)
  ...
  def _get_enable_local(self):
    """
    Getter method for enable_local, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/enable_local (empty)
    """
    return self.__enable_local
      
  def _set_enable_local(self, v, load=False):
    """
    Setter method for enable_local, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/enable_local (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_disable_local(self):
    """
    Getter method for disable_local, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/disable_local (empty)
    """
    return self.__disable_local
      
  def _set_disable_local(self, v, load=False):
    """
    Setter method for disable_local, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/disable_local (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_load_balancing(self):
    """
    Getter method for load_balancing, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/load_balancing (container)
    """
    return self.__load_balancing
      
  def _set_load_balancing(self, v, load=False):
    """
    Setter method for load_balancing, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/load_balancing (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_track(self):
    """
    Getter method for track, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/track (container)
    """
    return self.__track
      
  def _set_track(self, v, load=False):
    """
    Setter method for track, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/track (container)
    If this variable is read-only (config: false) in the
