...
class interface_ve_dhcp_conf(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ipv6/interface-ve-dhcp-conf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ipv6', u'interface-ve-dhcp-conf']
  ...
  def _get_dhcp(self):
    """
    Getter method for dhcp, mapped from YANG variable /rbridge_id/interface/ve/ipv6/interface_ve_dhcp_conf/dhcp (container)
    """
    return self.__dhcp
      
  def _set_dhcp(self, v, load=False):
    """
    Setter method for dhcp, mapped from YANG variable /rbridge_id/interface/ve/ipv6/interface_ve_dhcp_conf/dhcp (container)
