...
class link_local_config(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ipv6/ipv6-config/address/link-local-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ipv6', u'ipv6-config', u'address', u'link-local-config']
  ...
  def _get_link_local_address(self):
    """
    Getter method for link_local_address, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_config/address/link_local_config/link_local_address (inet:ipv6-address)
    """
    return self.__link_local_address
      
  def _set_link_local_address(self, v, load=False):
    """
    Setter method for link_local_address, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_config/address/link_local_config/link_local_address (inet:ipv6-address)
  ...
  def _get_link_local(self):
    """
    Getter method for link_local, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_config/address/link_local_config/link_local (empty)
    """
    return self.__link_local
      
  def _set_link_local(self, v, load=False):
    """
    Setter method for link_local, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_config/address/link_local_config/link_local (empty)
    If this variable is read-only (config: false) in the
