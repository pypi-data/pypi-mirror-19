...
class prefix(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ipv6/ipv6-nd-ra/ipv6-intf-cmds/nd/prefix. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ipv6', u'ipv6-nd-ra', u'ipv6-intf-cmds', u'nd', u'prefix']
  ...
  def _get_prefix_ipv6_address(self):
    """
    Getter method for prefix_ipv6_address, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/prefix_ipv6_address (inet:ipv6-prefix)
    """
    return self.__prefix_ipv6_address
      
  def _set_prefix_ipv6_address(self, v, load=False):
    """
    Setter method for prefix_ipv6_address, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/prefix_ipv6_address (inet:ipv6-prefix)
  ...
  def _get_lifetime(self):
    """
    Getter method for lifetime, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime (container)
    """
    return self.__lifetime
      
  def _set_lifetime(self, v, load=False):
    """
    Setter method for lifetime, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime (container)
    If this variable is read-only (config: false) in the
