...
class track(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/vrrpe/track. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'vrrpe', u'track']
  ...
  def _get_network(self):
    """
    Getter method for network, mapped from YANG variable /rbridge_id/interface/ve/vrrpe/track/network (list)
    """
    return self.__network
      
  def _set_network(self, v, load=False):
    """
    Setter method for network, mapped from YANG variable /rbridge_id/interface/ve/vrrpe/track/network (list)
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /rbridge_id/interface/ve/vrrpe/track/interface (list)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /rbridge_id/interface/ve/vrrpe/track/interface (list)
    If this variable is read-only (config: false) in the
