...
class extended(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ip/community-list/extended. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ip_community_reg_expr = YANGDynClass(base=unicode, is_leaf=True, yang_name="ip-community-reg-expr", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='ip-community-reg-expr-t', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ip', u'community-list', u'extended']
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /rbridge_id/ip/community_list/extended/name (ip-community-list-name-t)
    """
    return self.__name
      
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /rbridge_id/ip/community_list/extended/name (ip-community-list-name-t)
  ...
  def _get_seq_keyword(self):
    """
    Getter method for seq_keyword, mapped from YANG variable /rbridge_id/ip/community_list/extended/seq_keyword (enumeration)
    """
    return self.__seq_keyword
      
  def _set_seq_keyword(self, v, load=False):
    """
    Setter method for seq_keyword, mapped from YANG variable /rbridge_id/ip/community_list/extended/seq_keyword (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_instance(self):
    """
    Getter method for instance, mapped from YANG variable /rbridge_id/ip/community_list/extended/instance (instance-id-t)
    """
    return self.__instance
      
  def _set_instance(self, v, load=False):
    """
    Setter method for instance, mapped from YANG variable /rbridge_id/ip/community_list/extended/instance (instance-id-t)
    If this variable is read-only (config: false) in the
  ...
  def _get_ip_action(self):
    """
    Getter method for ip_action, mapped from YANG variable /rbridge_id/ip/community_list/extended/ip_action (action-t)
    """
    return self.__ip_action
      
  def _set_ip_action(self, v, load=False):
    """
    Setter method for ip_action, mapped from YANG variable /rbridge_id/ip/community_list/extended/ip_action (action-t)
    If this variable is read-only (config: false) in the
  ...
  def _get_ip_community_reg_expr(self):
    """
    Getter method for ip_community_reg_expr, mapped from YANG variable /rbridge_id/ip/community_list/extended/ip_community_reg_expr (ip-community-reg-expr-t)
    """
    return self.__ip_community_reg_expr
      
  def _set_ip_community_reg_expr(self, v, load=False):
    """
    Setter method for ip_community_reg_expr, mapped from YANG variable /rbridge_id/ip/community_list/extended/ip_community_reg_expr (ip-community-reg-expr-t)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="ip-community-reg-expr", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='ip-community-reg-expr-t', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="ip-community-reg-expr", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='ip-community-reg-expr-t', is_config=True)""",
        })
