...
class dhcp(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ip/dhcp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ip', u'dhcp']
  ...
  def _get_relay(self):
    """
    Getter method for relay, mapped from YANG variable /rbridge_id/ip/dhcp/relay (container)
    """
    return self.__relay
      
  def _set_relay(self, v, load=False):
    """
    Setter method for relay, mapped from YANG variable /rbridge_id/ip/dhcp/relay (container)
