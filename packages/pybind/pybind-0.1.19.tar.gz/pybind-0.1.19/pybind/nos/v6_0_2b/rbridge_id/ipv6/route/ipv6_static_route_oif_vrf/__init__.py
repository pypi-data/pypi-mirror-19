...
class ipv6_static_route_oif_vrf(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/route/ipv6-static-route-oif-vrf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'route', u'ipv6-static-route-oif-vrf']
  ...
  def _get_static_route_next_vrf_dest(self):
    """
    Getter method for static_route_next_vrf_dest, mapped from YANG variable /rbridge_id/ipv6/route/ipv6_static_route_oif_vrf/static_route_next_vrf_dest (inet:ipv6-prefix)
    """
    return self.__static_route_next_vrf_dest
      
  def _set_static_route_next_vrf_dest(self, v, load=False):
    """
    Setter method for static_route_next_vrf_dest, mapped from YANG variable /rbridge_id/ipv6/route/ipv6_static_route_oif_vrf/static_route_next_vrf_dest (inet:ipv6-prefix)
  ...
  def _get_next_hop_vrf(self):
    """
    Getter method for next_hop_vrf, mapped from YANG variable /rbridge_id/ipv6/route/ipv6_static_route_oif_vrf/next_hop_vrf (string)
    """
    return self.__next_hop_vrf
      
  def _set_next_hop_vrf(self, v, load=False):
    """
    Setter method for next_hop_vrf, mapped from YANG variable /rbridge_id/ipv6/route/ipv6_static_route_oif_vrf/next_hop_vrf (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_route_oif_type(self):
    """
    Getter method for static_route_oif_type, mapped from YANG variable /rbridge_id/ipv6/route/ipv6_static_route_oif_vrf/static_route_oif_type (enumeration)
    """
    return self.__static_route_oif_type
      
  def _set_static_route_oif_type(self, v, load=False):
    """
    Setter method for static_route_oif_type, mapped from YANG variable /rbridge_id/ipv6/route/ipv6_static_route_oif_vrf/static_route_oif_type (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_route_oif_name(self):
    """
    Getter method for static_route_oif_name, mapped from YANG variable /rbridge_id/ipv6/route/ipv6_static_route_oif_vrf/static_route_oif_name (string)
    """
    return self.__static_route_oif_name
      
  def _set_static_route_oif_name(self, v, load=False):
    """
    Setter method for static_route_oif_name, mapped from YANG variable /rbridge_id/ipv6/route/ipv6_static_route_oif_vrf/static_route_oif_name (string)
    If this variable is read-only (config: false) in the
