...
class bfd(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/route/static/bfd. Each member element of
  ...
  def _get_bfd_ipv6_static_route(self):
    """
    Getter method for bfd_ipv6_static_route, mapped from YANG variable /rbridge_id/ipv6/route/static/bfd/bfd_ipv6_static_route (list)
    """
    return self.__bfd_ipv6_static_route
      
  def _set_bfd_ipv6_static_route(self, v, load=False):
    """
    Setter method for bfd_ipv6_static_route, mapped from YANG variable /rbridge_id/ipv6/route/static/bfd/bfd_ipv6_static_route (list)
  ...
  def _get_bfd_ipv6_link_local_static_route(self):
    """
    Getter method for bfd_ipv6_link_local_static_route, mapped from YANG variable /rbridge_id/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route (list)
    """
    return self.__bfd_ipv6_link_local_static_route
      
  def _set_bfd_ipv6_link_local_static_route(self, v, load=False):
    """
    Setter method for bfd_ipv6_link_local_static_route, mapped from YANG variable /rbridge_id/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv6_holdover_interval(self):
    """
    Getter method for ipv6_holdover_interval, mapped from YANG variable /rbridge_id/ipv6/route/static/bfd/ipv6_holdover_interval (uint8)
    """
    return self.__ipv6_holdover_interval
      
  def _set_ipv6_holdover_interval(self, v, load=False):
    """
    Setter method for ipv6_holdover_interval, mapped from YANG variable /rbridge_id/ipv6/route/static/bfd/ipv6_holdover_interval (uint8)
    If this variable is read-only (config: false) in the
