...
class area_range(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/area/area-range. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'area', u'area-range']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'area', u'range']

  def _get_range_address(self):
    """
    Getter method for range_address, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/area_range/range_address (common-def:ipv6-address-prefix)
  ...
  def _set_range_address(self, v, load=False):
    """
    Setter method for range_address, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/area_range/range_address (common-def:ipv6-address-prefix)
  ...
  def _get_range_effect(self):
    """
    Getter method for range_effect, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/area_range/range_effect (enumeration)
  ...
  def _set_range_effect(self, v, load=False):
    """
    Setter method for range_effect, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/area_range/range_effect (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_range_cost(self):
    """
    Getter method for range_cost, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/area_range/range_cost (ospf:range-metric)
  ...
  def _set_range_cost(self, v, load=False):
    """
    Setter method for range_cost, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/area_range/range_cost (ospf:range-metric)
    If this variable is read-only (config: false) in the
