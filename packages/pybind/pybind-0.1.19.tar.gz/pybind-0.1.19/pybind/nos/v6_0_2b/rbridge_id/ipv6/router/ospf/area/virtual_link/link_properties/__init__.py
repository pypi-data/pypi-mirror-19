...
class link_properties(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/area/virtual-link/link-properties. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__link_interval_properties','__authentication',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'area', u'virtual-link', u'link-properties']
  ...
  def _get_link_interval_properties(self):
    """
    Getter method for link_interval_properties, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties (container)
    """
    return self.__link_interval_properties
      
  def _set_link_interval_properties(self, v, load=False):
    """
    Setter method for link_interval_properties, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties (container)
  ...
  def _get_authentication(self):
    """
    Getter method for authentication, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/authentication (container)
  ...
  def _set_authentication(self, v, load=False):
    """
    Setter method for authentication, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/authentication (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'link_interval_properties': link_interval_properties, 'authentication': authentication, }
