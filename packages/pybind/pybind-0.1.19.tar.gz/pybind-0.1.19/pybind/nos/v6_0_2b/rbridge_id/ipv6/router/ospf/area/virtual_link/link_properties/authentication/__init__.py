...
class authentication(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/area/virtual-link/link-properties/authentication. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Authentication of OSPF messages
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ipsec_auth_key_config',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'area', u'virtual-link', u'link-properties', u'authentication']
  ...
  def _get_ipsec_auth_key_config(self):
    """
    Getter method for ipsec_auth_key_config, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/authentication/ipsec_auth_key_config (container)
    """
    return self.__ipsec_auth_key_config
      
  def _set_ipsec_auth_key_config(self, v, load=False):
    """
    Setter method for ipsec_auth_key_config, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/authentication/ipsec_auth_key_config (container)
  ...
  _pyangbind_elements = {'ipsec_auth_key_config': ipsec_auth_key_config, }
