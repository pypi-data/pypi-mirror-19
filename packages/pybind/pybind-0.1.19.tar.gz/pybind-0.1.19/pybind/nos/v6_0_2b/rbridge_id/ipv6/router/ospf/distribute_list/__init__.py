...
class distribute_list(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/distribute-list. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'distribute-list']
  ...
  def _get_route_map(self):
    """
    Getter method for route_map, mapped from YANG variable /rbridge_id/ipv6/router/ospf/distribute_list/route_map (container)
  ...
  def _set_route_map(self, v, load=False):
    """
    Setter method for route_map, mapped from YANG variable /rbridge_id/ipv6/router/ospf/distribute_list/route_map (container)
  ...
  def _get_prefix_list(self):
    """
    Getter method for prefix_list, mapped from YANG variable /rbridge_id/ipv6/router/ospf/distribute_list/prefix_list (container)
  ...
  def _set_prefix_list(self, v, load=False):
    """
    Setter method for prefix_list, mapped from YANG variable /rbridge_id/ipv6/router/ospf/distribute_list/prefix_list (container)
    If this variable is read-only (config: false) in the
