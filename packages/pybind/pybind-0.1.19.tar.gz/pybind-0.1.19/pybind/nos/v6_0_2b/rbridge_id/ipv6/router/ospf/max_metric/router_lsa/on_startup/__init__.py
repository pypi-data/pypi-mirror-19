...
class on_startup(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/max-metric/router-lsa/on-startup. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__on_startup_time = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'5 ..86400']}), is_leaf=True, yang_name="on-startup-time", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'DECIMAL Amount of time to advertise maximum metric,range 5 to 86400 seconds', u'cli-drop-node-name': None, u'cli-full-no': None, u'cli-full-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospfv3', defining_module='brocade-ospfv3', yang_type='uint32', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'max-metric', u'router-lsa', u'on-startup']
  ...
  def _get_on_startup_time(self):
    """
    Getter method for on_startup_time, mapped from YANG variable /rbridge_id/ipv6/router/ospf/max_metric/router_lsa/on_startup/on_startup_time (uint32)
    """
    return self.__on_startup_time
      
  def _set_on_startup_time(self, v, load=False):
    """
    Setter method for on_startup_time, mapped from YANG variable /rbridge_id/ipv6/router/ospf/max_metric/router_lsa/on_startup/on_startup_time (uint32)
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'5 ..86400']}), is_leaf=True, yang_name="on-startup-time", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'DECIMAL Amount of time to advertise maximum metric,range 5 to 86400 seconds', u'cli-drop-node-name': None, u'cli-full-no': None, u'cli-full-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospfv3', defining_module='brocade-ospfv3', yang_type='uint32', is_config=True)""",
        })
  ...
  def _get_wait_for_bgp(self):
    """
    Getter method for wait_for_bgp, mapped from YANG variable /rbridge_id/ipv6/router/ospf/max_metric/router_lsa/on_startup/wait_for_bgp (empty)
  ...
  def _set_wait_for_bgp(self, v, load=False):
    """
    Setter method for wait_for_bgp, mapped from YANG variable /rbridge_id/ipv6/router/ospf/max_metric/router_lsa/on_startup/wait_for_bgp (empty)
    If this variable is read-only (config: false) in the
