...
class passive(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/openflow/logical-instance/passive. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Passive controller connection
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__no_ssl',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'openflow', u'logical-instance', u'passive']
  ...
  def _get_no_ssl(self):
    """
    Getter method for no_ssl, mapped from YANG variable /rbridge_id/openflow/logical_instance/passive/no_ssl (container)

    YANG Description: No ssl connection
    """
    return self.__no_ssl
      
  def _set_no_ssl(self, v, load=False):
    """
    Setter method for no_ssl, mapped from YANG variable /rbridge_id/openflow/logical_instance/passive/no_ssl (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_no_ssl is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_no_ssl() directly.
  ...
  _pyangbind_elements = {'no_ssl': no_ssl, }
