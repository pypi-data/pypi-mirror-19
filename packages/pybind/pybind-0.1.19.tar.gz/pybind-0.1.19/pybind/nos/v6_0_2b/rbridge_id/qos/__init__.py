...
class qos(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/qos. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__tx_queue','__rcv_queue',)
  ...
  def _get_tx_queue(self):
    """
    Getter method for tx_queue, mapped from YANG variable /rbridge_id/qos/tx_queue (container)
    """
    return self.__tx_queue
      
  def _set_tx_queue(self, v, load=False):
    """
    Setter method for tx_queue, mapped from YANG variable /rbridge_id/qos/tx_queue (container)
  ...
  def _get_rcv_queue(self):
    """
    Getter method for rcv_queue, mapped from YANG variable /rbridge_id/qos/rcv_queue (container)
    """
  ...
  _pyangbind_elements = {'tx_queue': tx_queue, 'rcv_queue': rcv_queue, }
