...
class content(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content']
  ...
  def _get_match(self):
    """
    Getter method for match, mapped from YANG variable /rbridge_id/route_map/content/match (container)
  ...
  def _set_match(self, v, load=False):
    """
    Setter method for match, mapped from YANG variable /rbridge_id/route_map/content/match (container)
  ...
  def _get_set_(self):
    """
    Getter method for set_, mapped from YANG variable /rbridge_id/route_map/content/set (container)
  ...
  def _set_set_(self, v, load=False):
    """
    Setter method for set_, mapped from YANG variable /rbridge_id/route_map/content/set (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_continue_holder(self):
    """
    Getter method for continue_holder, mapped from YANG variable /rbridge_id/route_map/content/continue_holder (container)
    """
    return self.__continue_holder
      
  def _set_continue_holder(self, v, load=False):
    """
    Setter method for continue_holder, mapped from YANG variable /rbridge_id/route_map/content/continue_holder (container)
    If this variable is read-only (config: false) in the
