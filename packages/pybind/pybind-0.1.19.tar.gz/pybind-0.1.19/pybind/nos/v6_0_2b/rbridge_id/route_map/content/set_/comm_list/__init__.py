...
class comm_list(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/comm-list. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'comm-list']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'set', u'comm-list']

  def _get_comm_list_name(self):
    """
    Getter method for comm_list_name, mapped from YANG variable /rbridge_id/route_map/content/set/comm_list/comm_list_name (ip-community-list-name-t)
    """
    return self.__comm_list_name
      
  def _set_comm_list_name(self, v, load=False):
    """
    Setter method for comm_list_name, mapped from YANG variable /rbridge_id/route_map/content/set/comm_list/comm_list_name (ip-community-list-name-t)
  ...
  def _get_match_comm_delete(self):
    """
    Getter method for match_comm_delete, mapped from YANG variable /rbridge_id/route_map/content/set/comm_list/match_comm_delete (empty)
    """
    return self.__match_comm_delete
      
  def _set_match_comm_delete(self, v, load=False):
    """
    Setter method for match_comm_delete, mapped from YANG variable /rbridge_id/route_map/content/set/comm_list/match_comm_delete (empty)
    If this variable is read-only (config: false) in the
