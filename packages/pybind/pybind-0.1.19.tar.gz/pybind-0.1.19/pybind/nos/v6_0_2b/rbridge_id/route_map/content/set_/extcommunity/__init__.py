...
class extcommunity(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/extcommunity. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'extcommunity']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'set', u'extcommunity']

  def _get_rt(self):
    """
    Getter method for rt, mapped from YANG variable /rbridge_id/route_map/content/set/extcommunity/rt (container)
  ...
  def _get_soo(self):
    """
    Getter method for soo, mapped from YANG variable /rbridge_id/route_map/content/set/extcommunity/soo (container)
