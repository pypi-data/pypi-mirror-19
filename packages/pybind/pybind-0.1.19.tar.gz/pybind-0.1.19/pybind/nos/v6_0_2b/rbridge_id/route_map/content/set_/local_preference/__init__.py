...
class local_preference(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/local-preference. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'local-preference']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'set', u'local-preference']

  def _get_local_preference_value(self):
    """
    Getter method for local_preference_value, mapped from YANG variable /rbridge_id/route_map/content/set/local_preference/local_preference_value (uint32)
    """
    return self.__local_preference_value
      
  def _set_local_preference_value(self, v, load=False):
    """
    Setter method for local_preference_value, mapped from YANG variable /rbridge_id/route_map/content/set/local_preference/local_preference_value (uint32)
