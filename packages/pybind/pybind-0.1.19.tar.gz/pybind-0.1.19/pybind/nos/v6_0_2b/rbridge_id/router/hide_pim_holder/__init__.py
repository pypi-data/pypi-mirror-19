...
class hide_pim_holder(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/hide-pim-holder. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'hide-pim-holder']
  ...
  def _get_pim(self):
    """
    Getter method for pim, mapped from YANG variable /rbridge_id/router/hide_pim_holder/pim (container)
    """
    return self.__pim
