...
class stub(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/area/stub. Each member element of
  ...
  def _get_metric(self):
    """
    Getter method for metric, mapped from YANG variable /rbridge_id/router/ospf/area/stub/metric (container)
    """
    return self.__metric
      
  def _set_metric(self, v, load=False):
    """
    Setter method for metric, mapped from YANG variable /rbridge_id/router/ospf/area/stub/metric (container)
