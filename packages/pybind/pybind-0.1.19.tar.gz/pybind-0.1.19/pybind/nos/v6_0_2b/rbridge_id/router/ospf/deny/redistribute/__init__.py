...
class redistribute(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/deny/redistribute. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__mask = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="mask", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Subnet Mask', u'cli-drop-node-name': None, u'display-when': u'(../address)', u'cli-break-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='inet:ipv4-address', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'deny', u'redistribute']
  ...
  def _get_redist_value(self):
    """
    Getter method for redist_value, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/redist_value (uint32)
    """
    return self.__redist_value
      
  def _set_redist_value(self, v, load=False):
    """
    Setter method for redist_value, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/redist_value (uint32)
  ...
  def _get_route_option(self):
    """
    Getter method for route_option, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/route_option (route-option-type)
    """
    return self.__route_option
      
  def _set_route_option(self, v, load=False):
    """
    Setter method for route_option, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/route_option (route-option-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/address (inet:ipv4-address)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/address (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_mask(self):
    """
    Getter method for mask, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/mask (inet:ipv4-address)
    """
    return self.__mask
      
  def _set_mask(self, v, load=False):
    """
    Setter method for mask, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/mask (inet:ipv4-address)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="mask", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Subnet Mask', u'cli-drop-node-name': None, u'display-when': u'(../address)', u'cli-break-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='inet:ipv4-address', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mask must be of a type compatible with inet:ipv4-address""",
          'defined-type': "inet:ipv4-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="mask", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Subnet Mask', u'cli-drop-node-name': None, u'display-when': u'(../address)', u'cli-break-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='inet:ipv4-address', is_config=True)""",
        })
  ...
  def _get_set_metric_val(self):
    """
    Getter method for set_metric_val, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/set_metric_val (uint32)
    """
    return self.__set_metric_val
      
  def _set_set_metric_val(self, v, load=False):
    """
    Setter method for set_metric_val, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/set_metric_val (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_match_metric_val(self):
    """
    Getter method for match_metric_val, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/match_metric_val (uint32)
    """
    return self.__match_metric_val
      
  def _set_match_metric_val(self, v, load=False):
    """
    Setter method for match_metric_val, mapped from YANG variable /rbridge_id/router/ospf/deny/redistribute/match_metric_val (uint32)
    If this variable is read-only (config: false) in the
