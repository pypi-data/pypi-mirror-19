...
class throttle(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/timers/throttle. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'timers', u'throttle']
  ...
  def _get_spf(self):
    """
    Getter method for spf, mapped from YANG variable /rbridge_id/router/ospf/timers/throttle/spf (container)
    """
    return self.__spf
      
  def _set_spf(self, v, load=False):
    """
    Setter method for spf, mapped from YANG variable /rbridge_id/router/ospf/timers/throttle/spf (container)
