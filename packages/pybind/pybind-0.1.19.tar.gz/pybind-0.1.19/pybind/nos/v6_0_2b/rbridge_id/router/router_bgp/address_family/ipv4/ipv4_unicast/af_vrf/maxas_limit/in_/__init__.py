...
class in_(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv4/ipv4-unicast/af-vrf/maxas-limit/in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'af-vrf', u'maxas-limit', u'in']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'ipv4', u'unicast', u'vrf', u'maxas-limit', u'in']

  def _get_num_as_in_path(self):
    """
    Getter method for num_as_in_path, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/maxas_limit/in/num_as_in_path (num-as-in-path)
    """
    return self.__num_as_in_path
      
  def _set_num_as_in_path(self, v, load=False):
    """
    Setter method for num_as_in_path, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/maxas_limit/in/num_as_in_path (num-as-in-path)
