...
class static_network(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv4/ipv4-unicast/default-vrf/static-network. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'default-vrf', u'static-network']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'ipv4', u'unicast', u'static-network']

  def _get_static_network_address(self):
    """
    Getter method for static_network_address, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/static_network/static_network_address (inet:ipv4-prefix)
    """
    return self.__static_network_address
      
  def _set_static_network_address(self, v, load=False):
    """
    Setter method for static_network_address, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/static_network/static_network_address (inet:ipv4-prefix)
  ...
  def _get_static_network_distance(self):
    """
    Getter method for static_network_distance, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/static_network/static_network_distance (sdistance)
    """
    return self.__static_network_distance
      
  def _set_static_network_distance(self, v, load=False):
    """
    Setter method for static_network_distance, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/static_network/static_network_distance (sdistance)
    If this variable is read-only (config: false) in the
