...
class ipv6_unicast(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv6/ipv6-unicast. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast']
  ...
  def _get_default_vrf(self):
    """
    Getter method for default_vrf, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf (container)
    """
  ...
  def _get_af_ipv6_vrf(self):
    """
    Getter method for af_ipv6_vrf, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf (list)
    """
    return self.__af_ipv6_vrf
      
  def _set_af_ipv6_vrf(self, v, load=False):
    """
    Setter method for af_ipv6_vrf, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf (list)
    If this variable is read-only (config: false) in the
