...
class as4(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv6/ipv6-unicast/af-ipv6-vrf/neighbor/af-ipv6-vrf-neighbor-address-holder/af-ipv6-neighbor-addr/af-vrf-neighbor-capability/as4. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'af-ipv6-vrf', u'neighbor', u'af-ipv6-vrf-neighbor-address-holder', u'af-ipv6-neighbor-addr', u'af-vrf-neighbor-capability', u'as4']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'ipv6', u'unicast', u'vrf', u'neighbor', u'capability', u'as4']

  def _get_neighbor_as4_enable(self):
    """
    Getter method for neighbor_as4_enable, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/af_vrf_neighbor_capability/as4/neighbor_as4_enable (empty)
    """
    return self.__neighbor_as4_enable
      
  def _set_neighbor_as4_enable(self, v, load=False):
    """
    Setter method for neighbor_as4_enable, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/af_vrf_neighbor_capability/as4/neighbor_as4_enable (empty)
  ...
  def _get_neighbor_as4_disable(self):
    """
    Getter method for neighbor_as4_disable, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/af_vrf_neighbor_capability/as4/neighbor_as4_disable (empty)
    """
    return self.__neighbor_as4_disable
      
  def _set_neighbor_as4_disable(self, v, load=False):
    """
    Setter method for neighbor_as4_disable, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/af_vrf_neighbor_capability/as4/neighbor_as4_disable (empty)
    If this variable is read-only (config: false) in the
