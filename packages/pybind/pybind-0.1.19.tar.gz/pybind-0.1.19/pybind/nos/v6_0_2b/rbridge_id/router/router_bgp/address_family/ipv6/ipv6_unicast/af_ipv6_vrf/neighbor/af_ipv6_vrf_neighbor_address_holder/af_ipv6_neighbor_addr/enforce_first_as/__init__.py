...
class enforce_first_as(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv6/ipv6-unicast/af-ipv6-vrf/neighbor/af-ipv6-vrf-neighbor-address-holder/af-ipv6-neighbor-addr/enforce-first-as. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'af-ipv6-vrf', u'neighbor', u'af-ipv6-vrf-neighbor-address-holder', u'af-ipv6-neighbor-addr', u'enforce-first-as']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'ipv6', u'unicast', u'vrf', u'neighbor', u'enforce-first-as']

  def _get_nei_enforce_first_as(self):
    """
    Getter method for nei_enforce_first_as, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/enforce_first_as/nei_enforce_first_as (empty)
    """
    return self.__nei_enforce_first_as
      
  def _set_nei_enforce_first_as(self, v, load=False):
    """
    Setter method for nei_enforce_first_as, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/enforce_first_as/nei_enforce_first_as (empty)
  ...
  def _get_nei_enforce_first_as_disable(self):
    """
    Getter method for nei_enforce_first_as_disable, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/enforce_first_as/nei_enforce_first_as_disable (empty)
    """
    return self.__nei_enforce_first_as_disable
      
  def _set_nei_enforce_first_as_disable(self, v, load=False):
    """
    Setter method for nei_enforce_first_as_disable, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/enforce_first_as/nei_enforce_first_as_disable (empty)
    If this variable is read-only (config: false) in the
