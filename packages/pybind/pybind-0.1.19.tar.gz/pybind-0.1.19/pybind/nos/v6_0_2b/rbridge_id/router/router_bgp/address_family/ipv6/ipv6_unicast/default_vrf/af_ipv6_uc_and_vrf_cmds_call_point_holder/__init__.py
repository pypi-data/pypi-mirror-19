...
class af_ipv6_uc_and_vrf_cmds_call_point_holder(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv6/ipv6-unicast/default-vrf/af-ipv6-uc-and-vrf-cmds-call-point-holder. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'default-vrf', u'af-ipv6-uc-and-vrf-cmds-call-point-holder']
  ...
  def _get_bgp_redistribute_internal(self):
    """
    Getter method for bgp_redistribute_internal, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/af_ipv6_uc_and_vrf_cmds_call_point_holder/bgp_redistribute_internal (empty)
    """
    return self.__bgp_redistribute_internal
      
  def _set_bgp_redistribute_internal(self, v, load=False):
    """
    Setter method for bgp_redistribute_internal, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/af_ipv6_uc_and_vrf_cmds_call_point_holder/bgp_redistribute_internal (empty)
  ...
  def _get_redistribute(self):
    """
    Getter method for redistribute, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/af_ipv6_uc_and_vrf_cmds_call_point_holder/redistribute (container)
    """
    return self.__redistribute
      
  def _set_redistribute(self, v, load=False):
    """
    Setter method for redistribute, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/af_ipv6_uc_and_vrf_cmds_call_point_holder/redistribute (container)
    If this variable is read-only (config: false) in the
