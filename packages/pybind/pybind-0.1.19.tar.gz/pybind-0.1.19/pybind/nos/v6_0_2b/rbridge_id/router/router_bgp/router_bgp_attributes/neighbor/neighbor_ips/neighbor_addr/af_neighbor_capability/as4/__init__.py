...
class as4(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ips/neighbor-addr/af-neighbor-capability/as4. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'neighbor-ips', u'neighbor-addr', u'af-neighbor-capability', u'as4']
  ...
  def _get_neighbor_as4_enable(self):
    """
    Getter method for neighbor_as4_enable, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/af_neighbor_capability/as4/neighbor_as4_enable (empty)
    """
    return self.__neighbor_as4_enable
      
  def _set_neighbor_as4_enable(self, v, load=False):
    """
    Setter method for neighbor_as4_enable, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/af_neighbor_capability/as4/neighbor_as4_enable (empty)
  ...
  def _get_neighbor_as4_disable(self):
    """
    Getter method for neighbor_as4_disable, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/af_neighbor_capability/as4/neighbor_as4_disable (empty)
    """
    return self.__neighbor_as4_disable
      
  def _set_neighbor_as4_disable(self, v, load=False):
    """
    Setter method for neighbor_as4_disable, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/af_neighbor_capability/as4/neighbor_as4_disable (empty)
    If this variable is read-only (config: false) in the
