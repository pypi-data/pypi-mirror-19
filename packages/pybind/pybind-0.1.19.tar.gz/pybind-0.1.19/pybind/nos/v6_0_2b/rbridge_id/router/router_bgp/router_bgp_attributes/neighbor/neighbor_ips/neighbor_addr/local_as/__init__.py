...
class local_as(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ips/neighbor-addr/local-as. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'neighbor-ips', u'neighbor-addr', u'local-as']
  ...
  def _get_local_as_value(self):
    """
    Getter method for local_as_value, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/local_as/local_as_value (local-as-num)
    """
    return self.__local_as_value
      
  def _set_local_as_value(self, v, load=False):
    """
    Setter method for local_as_value, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/local_as/local_as_value (local-as-num)
  ...
  def _get_no_prepend(self):
    """
    Getter method for no_prepend, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/local_as/no_prepend (empty)
    """
    return self.__no_prepend
      
  def _set_no_prepend(self, v, load=False):
    """
    Setter method for no_prepend, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/local_as/no_prepend (empty)
    If this variable is read-only (config: false) in the
