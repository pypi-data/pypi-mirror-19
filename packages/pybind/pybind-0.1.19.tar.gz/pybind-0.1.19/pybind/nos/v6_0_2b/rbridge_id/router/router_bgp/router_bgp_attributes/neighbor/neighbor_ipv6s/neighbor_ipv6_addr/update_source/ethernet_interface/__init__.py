...
class ethernet_interface(PybindBase):
  ...
  def _get_ethernet(self):
    """
    Getter method for ethernet, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ipv6s/neighbor_ipv6_addr/update_source/ethernet_interface/ethernet (update-source-ethernet-type)
    """
    return self.__ethernet
      
  def _set_ethernet(self, v, load=False):
    """
    Setter method for ethernet, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ipv6s/neighbor_ipv6_addr/update_source/ethernet_interface/ethernet (update-source-ethernet-type)
    If this variable is read-only (config: false) in the
