...
class spanning_tree(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/spanning-tree. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ieee_bpdu',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'spanning-tree']
  ...
  def _get_ieee_bpdu(self):
    """
    Getter method for ieee_bpdu, mapped from YANG variable /rbridge_id/spanning_tree/ieee_bpdu (container)
    """
    return self.__ieee_bpdu
      
  def _set_ieee_bpdu(self, v, load=False):
    """
    Setter method for ieee_bpdu, mapped from YANG variable /rbridge_id/spanning_tree/ieee_bpdu (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ieee_bpdu is considered as a private
  ...
  _pyangbind_elements = {'ieee_bpdu': ieee_bpdu, }
