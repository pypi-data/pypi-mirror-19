...
class policy(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/threshold-monitor/sfp/policy. Each member element of
  ...
  def _get_policy_name(self):
    """
    Getter method for policy_name, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/policy_name (string)
    """
    return self.__policy_name
      
  def _set_policy_name(self, v, load=False):
    """
    Setter method for policy_name, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/policy_name (string)
  ...
  def _get_area(self):
    """
    Getter method for area, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/area (list)
    """
    return self.__area
      
  def _set_area(self, v, load=False):
    """
    Setter method for area, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/area (list)
    If this variable is read-only (config: false) in the
