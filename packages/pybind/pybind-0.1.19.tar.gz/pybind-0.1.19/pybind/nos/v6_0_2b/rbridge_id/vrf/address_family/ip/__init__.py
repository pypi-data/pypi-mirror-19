...
class ip(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ip']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ipv4']

  def _get_unicast(self):
    """
    Getter method for unicast, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast (container)
    """
    return self.__unicast
      
  def _set_unicast(self, v, load=False):
    """
    Setter method for unicast, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast (container)
