...
class ipv6(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ipv6/unicast/ipv6. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ipv6', u'unicast', u'ipv6']
  ...
  def _get_route(self):
    """
    Getter method for route, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route (container)
    """
    return self.__route
      
  def _set_route(self, v, load=False):
    """
    Setter method for route, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route (container)
  ...
  def _get_import_(self):
    """
    Getter method for import_, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/import (container)
    """
    return self.__import_
      
  def _set_import_(self, v, load=False):
    """
    Setter method for import_, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/import (container)
    If this variable is read-only (config: false) in the
