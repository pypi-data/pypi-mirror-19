...
class bfd(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ipv6/unicast/ipv6/route/static/bfd. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__bfd_ipv6_static_route','__bfd_ipv6_link_local_static_route',)
  ...
  def _get_bfd_ipv6_static_route(self):
    """
    Getter method for bfd_ipv6_static_route, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route (list)
    """
    return self.__bfd_ipv6_static_route
      
  def _set_bfd_ipv6_static_route(self, v, load=False):
    """
    Setter method for bfd_ipv6_static_route, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route (list)
  ...
  def _get_bfd_ipv6_link_local_static_route(self):
    """
    Getter method for bfd_ipv6_link_local_static_route, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route (list)
    """
    return self.__bfd_ipv6_link_local_static_route
      
  def _set_bfd_ipv6_link_local_static_route(self, v, load=False):
    """
    Setter method for bfd_ipv6_link_local_static_route, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'bfd_ipv6_static_route': bfd_ipv6_static_route, 'bfd_ipv6_link_local_static_route': bfd_ipv6_link_local_static_route, }
