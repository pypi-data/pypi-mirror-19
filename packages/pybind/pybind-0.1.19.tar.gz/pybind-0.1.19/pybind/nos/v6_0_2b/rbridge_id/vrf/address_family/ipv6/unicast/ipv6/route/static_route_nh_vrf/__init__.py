...
class static_route_nh_vrf(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ipv6/unicast/ipv6/route/static-route-nh-vrf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ipv6', u'unicast', u'ipv6', u'route', u'static-route-nh-vrf']
  ...
  def _get_static_route_next_vrf_dest(self):
    """
    Getter method for static_route_next_vrf_dest, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static_route_nh_vrf/static_route_next_vrf_dest (inet:ipv6-prefix)
    """
    return self.__static_route_next_vrf_dest
      
  def _set_static_route_next_vrf_dest(self, v, load=False):
    """
    Setter method for static_route_next_vrf_dest, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static_route_nh_vrf/static_route_next_vrf_dest (inet:ipv6-prefix)
  ...
  def _get_next_hop_vrf(self):
    """
    Getter method for next_hop_vrf, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static_route_nh_vrf/next_hop_vrf (string)
    """
    return self.__next_hop_vrf
      
  def _set_next_hop_vrf(self, v, load=False):
    """
    Setter method for next_hop_vrf, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static_route_nh_vrf/next_hop_vrf (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_route_next_hop(self):
    """
    Getter method for static_route_next_hop, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static_route_nh_vrf/static_route_next_hop (inet:ipv6-address)
    """
    return self.__static_route_next_hop
      
  def _set_static_route_next_hop(self, v, load=False):
    """
    Setter method for static_route_next_hop, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static_route_nh_vrf/static_route_next_hop (inet:ipv6-address)
    If this variable is read-only (config: false) in the
