...
class link_local_config(PybindBase):
  ...
  from YANG module brocade-intf-loopback - based on the path /hide-intf-loopback-holder/interface/loopback/ipv6/ipv6-config/address/link-local-config. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__link_local_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="link-local-address", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ipv6-config', defining_module='brocade-ipv6-config', yang_type='inet:ipv6-address', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-intf-loopback-holder', u'interface', u'loopback', u'ipv6', u'ipv6-config', u'address', u'link-local-config']
  ...
  def _get_link_local_address(self):
    """
    Getter method for link_local_address, mapped from YANG variable /hide_intf_loopback_holder/interface/loopback/ipv6/ipv6_config/address/link_local_config/link_local_address (inet:ipv6-address)
    """
    return self.__link_local_address
      
  def _set_link_local_address(self, v, load=False):
    """
    Setter method for link_local_address, mapped from YANG variable /hide_intf_loopback_holder/interface/loopback/ipv6/ipv6_config/address/link_local_config/link_local_address (inet:ipv6-address)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="link-local-address", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ipv6-config', defining_module='brocade-ipv6-config', yang_type='inet:ipv6-address', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """link_local_address must be of a type compatible with inet:ipv6-address""",
          'defined-type': "inet:ipv6-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="link-local-address", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ipv6-config', defining_module='brocade-ipv6-config', yang_type='inet:ipv6-address', is_config=True)""",
        })
  ...
  def _get_link_local(self):
    """
    Getter method for link_local, mapped from YANG variable /hide_intf_loopback_holder/interface/loopback/ipv6/ipv6_config/address/link_local_config/link_local (empty)
    """
    return self.__link_local
      
  def _set_link_local(self, v, load=False):
    """
    Setter method for link_local, mapped from YANG variable /hide_intf_loopback_holder/interface/loopback/ipv6/ipv6_config/address/link_local_config/link_local (empty)
    If this variable is read-only (config: false) in the
