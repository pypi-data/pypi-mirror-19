...
class fabric(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/fabric. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'fabric']
  ...
  def _get_fabric_isl(self):
    """
    Getter method for fabric_isl, mapped from YANG variable /interface/fortygigabitethernet/fabric/fabric_isl (container)
  ...
  def _get_fabric_trunk(self):
    """
    Getter method for fabric_trunk, mapped from YANG variable /interface/fortygigabitethernet/fabric/fabric_trunk (container)
  ...
  def _get_neighbor_discovery(self):
    """
    Getter method for neighbor_discovery, mapped from YANG variable /interface/fortygigabitethernet/fabric/neighbor_discovery (container)
  ...
  def _set_neighbor_discovery(self, v, load=False):
    """
    Setter method for neighbor_discovery, mapped from YANG variable /interface/fortygigabitethernet/fabric/neighbor_discovery (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_fabric_dport(self):
    """
    Getter method for fabric_dport, mapped from YANG variable /interface/fortygigabitethernet/fabric/fabric_dport (container)

    YANG Description: Configure the Interface D-port mode
    """
