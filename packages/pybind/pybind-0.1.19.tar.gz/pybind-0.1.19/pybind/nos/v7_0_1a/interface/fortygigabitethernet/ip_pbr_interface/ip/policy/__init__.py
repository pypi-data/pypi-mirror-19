...
class policy(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/ip-pbr-interface/ip/policy. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'ip-pbr-interface', u'ip', u'policy']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'FortyGigabitEthernet', u'ip', u'policy']

  def _get_route_map(self):
    """
    Getter method for route_map, mapped from YANG variable /interface/fortygigabitethernet/ip_pbr_interface/ip/policy/route_map (container)
  ...
  def _set_route_map(self, v, load=False):
    """
    Setter method for route_map, mapped from YANG variable /interface/fortygigabitethernet/ip_pbr_interface/ip/policy/route_map (container)
