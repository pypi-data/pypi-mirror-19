...
class neighbor(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/ipv6/ipv6-nd-ra/ipv6-intf-cmds/neighbor. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'ipv6', u'ipv6-nd-ra', u'ipv6-intf-cmds', u'neighbor']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'FortyGigabitEthernet', u'ipv6', u'neighbor']

  def _get_ipv6_address(self):
    """
    Getter method for ipv6_address, mapped from YANG variable /interface/fortygigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/neighbor/ipv6_address (neighbor-ipv6-address)
    """
    return self.__ipv6_address
      
  def _set_ipv6_address(self, v, load=False):
    """
    Setter method for ipv6_address, mapped from YANG variable /interface/fortygigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/neighbor/ipv6_address (neighbor-ipv6-address)
  ...
  def _get_hardware_address(self):
    """
    Getter method for hardware_address, mapped from YANG variable /interface/fortygigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/neighbor/hardware_address (macAddr)
    """
    return self.__hardware_address
      
  def _set_hardware_address(self, v, load=False):
    """
    Setter method for hardware_address, mapped from YANG variable /interface/fortygigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/neighbor/hardware_address (macAddr)
    If this variable is read-only (config: false) in the
