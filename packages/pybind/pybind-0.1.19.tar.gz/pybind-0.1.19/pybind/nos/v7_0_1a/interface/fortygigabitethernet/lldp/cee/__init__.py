...
class cee(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/lldp/cee. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'lldp', u'cee']
  ...
  def _get_lldp_cee_on_off(self):
    """
    Getter method for lldp_cee_on_off, mapped from YANG variable /interface/fortygigabitethernet/lldp/cee/lldp_cee_on_off (enumeration)
    """
    return self.__lldp_cee_on_off
      
  def _set_lldp_cee_on_off(self, v, load=False):
    """
    Setter method for lldp_cee_on_off, mapped from YANG variable /interface/fortygigabitethernet/lldp/cee/lldp_cee_on_off (enumeration)
