...
class fabric(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/fabric. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__neighbor_discovery',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'fabric']
  ...
  def _get_neighbor_discovery(self):
    """
    Getter method for neighbor_discovery, mapped from YANG variable /interface/gigabitethernet/fabric/neighbor_discovery (container)
  ...
  def _set_neighbor_discovery(self, v, load=False):
    """
    Setter method for neighbor_discovery, mapped from YANG variable /interface/gigabitethernet/fabric/neighbor_discovery (container)
  ...
  _pyangbind_elements = {'neighbor_discovery': neighbor_discovery, }
