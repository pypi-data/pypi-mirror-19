...
class servers(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/ip/interface-gi-dhcp-conf/dhcp/relay/servers. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'ip', u'interface-gi-dhcp-conf', u'dhcp', u'relay', u'servers']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'GigabitEthernet', u'ip', u'dhcp', u'relay']

  def _get_relay_ip_addr(self):
    """
    Getter method for relay_ip_addr, mapped from YANG variable /interface/gigabitethernet/ip/interface_gi_dhcp_conf/dhcp/relay/servers/relay_ip_addr (dhcp-ipv4-address)
  ...
  def _set_relay_ip_addr(self, v, load=False):
    """
    Setter method for relay_ip_addr, mapped from YANG variable /interface/gigabitethernet/ip/interface_gi_dhcp_conf/dhcp/relay/servers/relay_ip_addr (dhcp-ipv4-address)
  ...
  def _get_server_vrf_name(self):
    """
    Getter method for server_vrf_name, mapped from YANG variable /interface/gigabitethernet/ip/interface_gi_dhcp_conf/dhcp/relay/servers/server_vrf_name (common-def:vrf-name)
  ...
  def _set_server_vrf_name(self, v, load=False):
    """
    Setter method for server_vrf_name, mapped from YANG variable /interface/gigabitethernet/ip/interface_gi_dhcp_conf/dhcp/relay/servers/server_vrf_name (common-def:vrf-name)
    If this variable is read-only (config: false) in the
