...
class interface_phy_dhcp_conf(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/ipv6/interface-phy-dhcp-conf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'ipv6', u'interface-phy-dhcp-conf']
  ...
  def _get_dhcp(self):
    """
    Getter method for dhcp, mapped from YANG variable /interface/gigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp (container)
    """
    return self.__dhcp
      
  def _set_dhcp(self, v, load=False):
    """
    Setter method for dhcp, mapped from YANG variable /interface/gigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp (container)
