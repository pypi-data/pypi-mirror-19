...
class rcv_queue(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/qos/rcv-queue. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'qos', u'rcv-queue']
  ...
  def _get_cos_threshold(self):
    """
    Getter method for cos_threshold, mapped from YANG variable /interface/gigabitethernet/qos/rcv_queue/cos_threshold (container)
  ...
  def _set_cos_threshold(self, v, load=False):
    """
    Setter method for cos_threshold, mapped from YANG variable /interface/gigabitethernet/qos/rcv_queue/cos_threshold (container)
