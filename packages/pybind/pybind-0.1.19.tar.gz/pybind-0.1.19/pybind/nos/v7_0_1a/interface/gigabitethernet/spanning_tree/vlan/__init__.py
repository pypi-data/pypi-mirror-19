...
class vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/spanning-tree/vlan. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__guard = YANGDynClass(base=guard.guard, is_container='container', yang_name="guard", rest_name="guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u"Change an interface's spanning tree \nguard mode", u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'spanning-tree', u'vlan']
  ...
  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /interface/gigabitethernet/spanning_tree/vlan/id (uint32)
    """
    return self.__id
      
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /interface/gigabitethernet/spanning_tree/vlan/id (uint32)
  ...
  def _get_cost(self):
    """
    Getter method for cost, mapped from YANG variable /interface/gigabitethernet/spanning_tree/vlan/cost (uint32)
    """
    return self.__cost
      
  def _set_cost(self, v, load=False):
    """
    Setter method for cost, mapped from YANG variable /interface/gigabitethernet/spanning_tree/vlan/cost (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_priority(self):
    """
    Getter method for priority, mapped from YANG variable /interface/gigabitethernet/spanning_tree/vlan/priority (uint32)
    """
    return self.__priority
      
  def _set_priority(self, v, load=False):
    """
    Setter method for priority, mapped from YANG variable /interface/gigabitethernet/spanning_tree/vlan/priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_guard(self):
    """
    Getter method for guard, mapped from YANG variable /interface/gigabitethernet/spanning_tree/vlan/guard (container)
    """
    return self.__guard
      
  def _set_guard(self, v, load=False):
    """
    Setter method for guard, mapped from YANG variable /interface/gigabitethernet/spanning_tree/vlan/guard (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=guard.guard, is_container='container', yang_name="guard", rest_name="guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u"Change an interface's spanning tree \nguard mode", u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """guard must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=guard.guard, is_container='container', yang_name="guard", rest_name="guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u"Change an interface's spanning tree \nguard mode", u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='container', is_config=True)""",
        })
