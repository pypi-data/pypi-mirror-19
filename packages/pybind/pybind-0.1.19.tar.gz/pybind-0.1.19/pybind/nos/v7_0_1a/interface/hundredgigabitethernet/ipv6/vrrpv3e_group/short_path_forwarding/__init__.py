...
class short_path_forwarding(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/ipv6/vrrpv3e-group/short-path-forwarding. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'ipv6', u'vrrpv3e-group', u'short-path-forwarding']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'HundredGigabitEthernet', u'ipv6', u'vrrp-extended-group', u'short-path-forwarding']

  def _get_basic(self):
    """
    Getter method for basic, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/vrrpv3e_group/short_path_forwarding/basic (empty)
    """
    return self.__basic
      
  def _set_basic(self, v, load=False):
    """
    Setter method for basic, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/vrrpv3e_group/short_path_forwarding/basic (empty)
  ...
  def _get_revert_priority(self):
    """
    Getter method for revert_priority, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/vrrpv3e_group/short_path_forwarding/revert_priority (uint8)
  ...
  def _set_revert_priority(self, v, load=False):
    """
    Setter method for revert_priority, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/vrrpv3e_group/short_path_forwarding/revert_priority (uint8)
    If this variable is read-only (config: false) in the
