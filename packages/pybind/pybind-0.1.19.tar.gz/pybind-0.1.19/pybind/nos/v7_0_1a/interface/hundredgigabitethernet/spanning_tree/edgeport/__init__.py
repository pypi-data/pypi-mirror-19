...
class edgeport(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/spanning-tree/edgeport. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__edgeportbasic = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="edgeportbasic", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Edgeport', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='empty', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'spanning-tree', u'edgeport']
  ...
  def _get_edgeportbasic(self):
    """
    Getter method for edgeportbasic, mapped from YANG variable /interface/hundredgigabitethernet/spanning_tree/edgeport/edgeportbasic (empty)
    """
    return self.__edgeportbasic
      
  def _set_edgeportbasic(self, v, load=False):
    """
    Setter method for edgeportbasic, mapped from YANG variable /interface/hundredgigabitethernet/spanning_tree/edgeport/edgeportbasic (empty)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="edgeportbasic", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Edgeport', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='empty', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """edgeportbasic must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="edgeportbasic", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Edgeport', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='empty', is_config=True)""",
        })
  ...
  def _get_bpdu_guard(self):
    """
    Getter method for bpdu_guard, mapped from YANG variable /interface/hundredgigabitethernet/spanning_tree/edgeport/bpdu_guard (empty)
    """
    return self.__bpdu_guard
      
  def _set_bpdu_guard(self, v, load=False):
    """
    Setter method for bpdu_guard, mapped from YANG variable /interface/hundredgigabitethernet/spanning_tree/edgeport/bpdu_guard (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_bpdu_filter(self):
    """
    Getter method for bpdu_filter, mapped from YANG variable /interface/hundredgigabitethernet/spanning_tree/edgeport/bpdu_filter (empty)
    """
    return self.__bpdu_filter
      
  def _set_bpdu_filter(self, v, load=False):
    """
    Setter method for bpdu_filter, mapped from YANG variable /interface/hundredgigabitethernet/spanning_tree/edgeport/bpdu_filter (empty)
    If this variable is read-only (config: false) in the
