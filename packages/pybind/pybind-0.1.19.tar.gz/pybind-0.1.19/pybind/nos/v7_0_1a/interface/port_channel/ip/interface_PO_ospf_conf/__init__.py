...
class interface_PO_ospf_conf(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/interface-PO-ospf-conf. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ospf_interface_config',)

  _yang_name = 'interface-PO-ospf-conf'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'interface-PO-ospf-conf']
  ...
  def _get_ospf_interface_config(self):
    """
    Getter method for ospf_interface_config, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config (container)
    """
    return self.__ospf_interface_config
      
  def _set_ospf_interface_config(self, v, load=False):
    """
    Setter method for ospf_interface_config, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config (container)
