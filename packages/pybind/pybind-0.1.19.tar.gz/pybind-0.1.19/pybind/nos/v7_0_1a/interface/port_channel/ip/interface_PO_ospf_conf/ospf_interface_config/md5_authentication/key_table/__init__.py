...
class key_table(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/interface-PO-ospf-conf/ospf-interface-config/md5-authentication/key-table. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'interface-PO-ospf-conf', u'ospf-interface-config', u'md5-authentication', u'key-table']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'ip', u'ospf', u'md5-authentication', u'key-id']

  def _get_key_id(self):
    """
    Getter method for key_id, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/md5_authentication/key_table/key_id (uint32)
    """
    return self.__key_id
      
  def _set_key_id(self, v, load=False):
    """
    Setter method for key_id, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/md5_authentication/key_table/key_id (uint32)
  ...
  def _get_key(self):
    """
    Getter method for key, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/md5_authentication/key_table/key (key-type)
  ...
  def _set_key(self, v, load=False):
    """
    Setter method for key, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/md5_authentication/key_table/key (key-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_md5_authentication_key(self):
    """
    Getter method for md5_authentication_key, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/md5_authentication/key_table/md5_authentication_key (ospf-auth-psswd-string)
    """
    return self.__md5_authentication_key
      
  def _set_md5_authentication_key(self, v, load=False):
    """
    Setter method for md5_authentication_key, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/md5_authentication/key_table/md5_authentication_key (ospf-auth-psswd-string)
    If this variable is read-only (config: false) in the
