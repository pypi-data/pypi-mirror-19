...
class interface_po_dhcp_conf(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/interface-po-dhcp-conf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'interface-po-dhcp-conf']
  ...
  def _get_dhcp(self):
    """
    Getter method for dhcp, mapped from YANG variable /interface/port_channel/ip/interface_po_dhcp_conf/dhcp (container)
    """
    return self.__dhcp
      
  def _set_dhcp(self, v, load=False):
    """
    Setter method for dhcp, mapped from YANG variable /interface/port_channel/ip/interface_po_dhcp_conf/dhcp (container)
