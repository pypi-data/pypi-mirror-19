...
class servers(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/interface-po-dhcp-conf/dhcp/relay/servers. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'interface-po-dhcp-conf', u'dhcp', u'relay', u'servers']
  ...
  def _get_relay_ip_addr(self):
    """
    Getter method for relay_ip_addr, mapped from YANG variable /interface/port_channel/ip/interface_po_dhcp_conf/dhcp/relay/servers/relay_ip_addr (dhcp-ipv4-address)
  ...
  def _set_relay_ip_addr(self, v, load=False):
    """
    Setter method for relay_ip_addr, mapped from YANG variable /interface/port_channel/ip/interface_po_dhcp_conf/dhcp/relay/servers/relay_ip_addr (dhcp-ipv4-address)
  ...
  def _get_server_vrf_name(self):
    """
    Getter method for server_vrf_name, mapped from YANG variable /interface/port_channel/ip/interface_po_dhcp_conf/dhcp/relay/servers/server_vrf_name (common-def:vrf-name)
  ...
  def _set_server_vrf_name(self, v, load=False):
    """
    Setter method for server_vrf_name, mapped from YANG variable /interface/port_channel/ip/interface_po_dhcp_conf/dhcp/relay/servers/server_vrf_name (common-def:vrf-name)
    If this variable is read-only (config: false) in the
