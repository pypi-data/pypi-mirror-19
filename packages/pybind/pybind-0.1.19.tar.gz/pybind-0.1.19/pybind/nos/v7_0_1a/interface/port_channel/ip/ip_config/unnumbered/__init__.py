...
class unnumbered(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/ip-config/unnumbered. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'ip-config', u'unnumbered']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'ip', u'unnumbered']

  def _get_ip_donor_interface_type(self):
    """
    Getter method for ip_donor_interface_type, mapped from YANG variable /interface/port_channel/ip/ip_config/unnumbered/ip_donor_interface_type (ip-unnumbered-donor-interface-type_t)
    """
    return self.__ip_donor_interface_type
      
  def _set_ip_donor_interface_type(self, v, load=False):
    """
    Setter method for ip_donor_interface_type, mapped from YANG variable /interface/port_channel/ip/ip_config/unnumbered/ip_donor_interface_type (ip-unnumbered-donor-interface-type_t)
  ...
  def _get_ip_donor_interface_name(self):
    """
    Getter method for ip_donor_interface_name, mapped from YANG variable /interface/port_channel/ip/ip_config/unnumbered/ip_donor_interface_name (ip-unnumbered-donor-interface-name_t)
    """
    return self.__ip_donor_interface_name
      
  def _set_ip_donor_interface_name(self, v, load=False):
    """
    Setter method for ip_donor_interface_name, mapped from YANG variable /interface/port_channel/ip/ip_config/unnumbered/ip_donor_interface_name (ip-unnumbered-donor-interface-name_t)
    If this variable is read-only (config: false) in the
