...
class vrrpv3(PybindBase):
  ...
  def _get_use_v2_checksum(self):
    """
    Getter method for use_v2_checksum, mapped from YANG variable /interface/port_channel/ipv6/hide_vrrpv3_holder/vrrpv3/use_v2_checksum (empty)
  ...
  def _set_use_v2_checksum(self, v, load=False):
    """
    Setter method for use_v2_checksum, mapped from YANG variable /interface/port_channel/ipv6/hide_vrrpv3_holder/vrrpv3/use_v2_checksum (empty)
    If this variable is read-only (config: false) in the
