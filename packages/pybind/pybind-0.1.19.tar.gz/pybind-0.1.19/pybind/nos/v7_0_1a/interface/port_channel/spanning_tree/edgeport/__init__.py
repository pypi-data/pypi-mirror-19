...
class edgeport(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/spanning-tree/edgeport. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'spanning-tree', u'edgeport']
  ...
  def _get_edgeportbasic(self):
    """
    Getter method for edgeportbasic, mapped from YANG variable /interface/port_channel/spanning_tree/edgeport/edgeportbasic (empty)
    """
    return self.__edgeportbasic
      
  def _set_edgeportbasic(self, v, load=False):
    """
    Setter method for edgeportbasic, mapped from YANG variable /interface/port_channel/spanning_tree/edgeport/edgeportbasic (empty)
  ...
  def _get_bpdu_guard(self):
    """
    Getter method for bpdu_guard, mapped from YANG variable /interface/port_channel/spanning_tree/edgeport/bpdu_guard (empty)
    """
    return self.__bpdu_guard
      
  def _set_bpdu_guard(self, v, load=False):
    """
    Setter method for bpdu_guard, mapped from YANG variable /interface/port_channel/spanning_tree/edgeport/bpdu_guard (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_bpdu_filter(self):
    """
    Getter method for bpdu_filter, mapped from YANG variable /interface/port_channel/spanning_tree/edgeport/bpdu_filter (empty)
    """
    return self.__bpdu_filter
      
  def _set_bpdu_filter(self, v, load=False):
    """
    Setter method for bpdu_filter, mapped from YANG variable /interface/port_channel/spanning_tree/edgeport/bpdu_filter (empty)
    If this variable is read-only (config: false) in the
