...
class vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'vlan']
  ...
  def _get_classifier(self):
    """
    Getter method for classifier, mapped from YANG variable /interface/port_channel/vlan/classifier (container)
    """
    return self.__classifier
      
  def _set_classifier(self, v, load=False):
    """
    Setter method for classifier, mapped from YANG variable /interface/port_channel/vlan/classifier (container)
