...
class arp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/vrrp/arp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'vrrp', u'arp']
  ...
  def _get_unicast_request(self):
    """
    Getter method for unicast_request, mapped from YANG variable /interface/port_channel/vrrp/arp/unicast_request (container)
  ...
  def _set_unicast_request(self, v, load=False):
    """
    Setter method for unicast_request, mapped from YANG variable /interface/port_channel/vrrp/arp/unicast_request (container)
