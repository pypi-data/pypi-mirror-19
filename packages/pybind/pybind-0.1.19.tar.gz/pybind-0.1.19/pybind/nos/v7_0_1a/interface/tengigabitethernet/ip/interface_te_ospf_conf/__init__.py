...
class interface_te_ospf_conf(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ip/interface-te-ospf-conf. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ospf_interface_config',)

  _yang_name = 'interface-te-ospf-conf'
  _rest_name = ''
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__ospf_interface_config = YANGDynClass(base=ospf_interface_config.ospf_interface_config, is_container='container', yang_name="ospf-interface-config", rest_name="ospf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Open Shortest Path First (OSPF).', u'cli-incomplete-no': None, u'display-when': u'/vcsmode/vcs-mode = "true"', u'sort-priority': u'119', u'alt-name': u'ospf'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ip', u'interface-te-ospf-conf']
  ...
  def _get_ospf_interface_config(self):
    """
    Getter method for ospf_interface_config, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config (container)
    """
    return self.__ospf_interface_config
      
  def _set_ospf_interface_config(self, v, load=False):
    """
    Setter method for ospf_interface_config, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config (container)
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=ospf_interface_config.ospf_interface_config, is_container='container', yang_name="ospf-interface-config", rest_name="ospf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Open Shortest Path First (OSPF).', u'cli-incomplete-no': None, u'display-when': u'/vcsmode/vcs-mode = "true"', u'sort-priority': u'119', u'alt-name': u'ospf'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
