...
class md5_authentication(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ip/interface-te-ospf-conf/ospf-interface-config/md5-authentication. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ip', u'interface-te-ospf-conf', u'ospf-interface-config', u'md5-authentication']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'TenGigabitEthernet', u'ip', u'ospf', u'md5-authentication']

  def _get_key_activation_wait_time(self):
    """
    Getter method for key_activation_wait_time, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/md5_authentication/key_activation_wait_time (common-def:time-interval-sec)
    """
    return self.__key_activation_wait_time
      
  def _set_key_activation_wait_time(self, v, load=False):
    """
    Setter method for key_activation_wait_time, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/md5_authentication/key_activation_wait_time (common-def:time-interval-sec)
  ...
  def _get_no_encrypt_key_table(self):
    """
    Getter method for no_encrypt_key_table, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/md5_authentication/no_encrypt_key_table (container)
    """
    return self.__no_encrypt_key_table
      
  def _set_no_encrypt_key_table(self, v, load=False):
    """
    Setter method for no_encrypt_key_table, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/md5_authentication/no_encrypt_key_table (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_key_table(self):
    """
    Getter method for key_table, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/md5_authentication/key_table (container)
    """
    return self.__key_table
      
  def _set_key_table(self, v, load=False):
    """
    Setter method for key_table, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/md5_authentication/key_table (container)
    If this variable is read-only (config: false) in the
