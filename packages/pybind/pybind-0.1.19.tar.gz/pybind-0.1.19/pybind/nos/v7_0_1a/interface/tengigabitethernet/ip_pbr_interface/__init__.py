...
class ip_pbr_interface(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ip-pbr-interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ip-pbr-interface']
  ...
  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /interface/tengigabitethernet/ip_pbr_interface/ip (container)
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /interface/tengigabitethernet/ip_pbr_interface/ip (container)
