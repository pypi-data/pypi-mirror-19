...
class qos(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/qos. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'qos']
  ...
  def _get_default_cos(self):
    """
    Getter method for default_cos, mapped from YANG variable /interface/tengigabitethernet/qos/default_cos (int32)
    """
    return self.__default_cos
      
  def _set_default_cos(self, v, load=False):
    """
    Setter method for default_cos, mapped from YANG variable /interface/tengigabitethernet/qos/default_cos (int32)
  ...
  def _get_trust(self):
    """
    Getter method for trust, mapped from YANG variable /interface/tengigabitethernet/qos/trust (container)
    """
    return self.__trust
      
  def _set_trust(self, v, load=False):
    """
    Setter method for trust, mapped from YANG variable /interface/tengigabitethernet/qos/trust (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_cos_mutation(self):
    """
    Getter method for cos_mutation, mapped from YANG variable /interface/tengigabitethernet/qos/cos_mutation (map-name-type)
    """
    return self.__cos_mutation
      
  def _set_cos_mutation(self, v, load=False):
    """
    Setter method for cos_mutation, mapped from YANG variable /interface/tengigabitethernet/qos/cos_mutation (map-name-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_cos_traffic_class(self):
    """
    Getter method for cos_traffic_class, mapped from YANG variable /interface/tengigabitethernet/qos/cos_traffic_class (map-name-type)
    """
    return self.__cos_traffic_class
      
  def _set_cos_traffic_class(self, v, load=False):
    """
    Setter method for cos_traffic_class, mapped from YANG variable /interface/tengigabitethernet/qos/cos_traffic_class (map-name-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_dscp_mutation(self):
    """
    Getter method for dscp_mutation, mapped from YANG variable /interface/tengigabitethernet/qos/dscp_mutation (map-name-type)
    """
    return self.__dscp_mutation
      
  def _set_dscp_mutation(self, v, load=False):
    """
    Setter method for dscp_mutation, mapped from YANG variable /interface/tengigabitethernet/qos/dscp_mutation (map-name-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_dscp_traffic_class(self):
    """
    Getter method for dscp_traffic_class, mapped from YANG variable /interface/tengigabitethernet/qos/dscp_traffic_class (map-name-type)
    """
    return self.__dscp_traffic_class
      
  def _set_dscp_traffic_class(self, v, load=False):
    """
    Setter method for dscp_traffic_class, mapped from YANG variable /interface/tengigabitethernet/qos/dscp_traffic_class (map-name-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_dscp_cos(self):
    """
    Getter method for dscp_cos, mapped from YANG variable /interface/tengigabitethernet/qos/dscp_cos (map-name-type)
    """
    return self.__dscp_cos
      
  def _set_dscp_cos(self, v, load=False):
    """
    Setter method for dscp_cos, mapped from YANG variable /interface/tengigabitethernet/qos/dscp_cos (map-name-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_random_detect(self):
    """
    Getter method for random_detect, mapped from YANG variable /interface/tengigabitethernet/qos/random_detect (container)
    """
    return self.__random_detect
      
  def _set_random_detect(self, v, load=False):
    """
    Setter method for random_detect, mapped from YANG variable /interface/tengigabitethernet/qos/random_detect (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_drop_monitor(self):
    """
    Getter method for drop_monitor, mapped from YANG variable /interface/tengigabitethernet/qos/drop_monitor (container)
    """
    return self.__drop_monitor
      
  def _set_drop_monitor(self, v, load=False):
    """
    Setter method for drop_monitor, mapped from YANG variable /interface/tengigabitethernet/qos/drop_monitor (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_rcv_queue(self):
    """
    Getter method for rcv_queue, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue (container)
  ...
  def _set_rcv_queue(self, v, load=False):
    """
    Setter method for rcv_queue, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_flowcontrol(self):
    """
    Getter method for flowcontrol, mapped from YANG variable /interface/tengigabitethernet/qos/flowcontrol (container)
    """
    return self.__flowcontrol
      
  def _set_flowcontrol(self, v, load=False):
    """
    Setter method for flowcontrol, mapped from YANG variable /interface/tengigabitethernet/qos/flowcontrol (container)
    If this variable is read-only (config: false) in the
