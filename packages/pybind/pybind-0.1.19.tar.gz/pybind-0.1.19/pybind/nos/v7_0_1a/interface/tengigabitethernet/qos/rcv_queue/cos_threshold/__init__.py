...
class cos_threshold(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/qos/rcv-queue/cos-threshold. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'qos', u'rcv-queue', u'cos-threshold']
  ...
  def _get_cos0_threshold(self):
    """
    Getter method for cos0_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos0_threshold (uint32)
  ...
  def _set_cos0_threshold(self, v, load=False):
    """
    Setter method for cos0_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos0_threshold (uint32)
  ...
  def _get_cos1_threshold(self):
    """
    Getter method for cos1_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos1_threshold (uint32)
  ...
  def _set_cos1_threshold(self, v, load=False):
    """
    Setter method for cos1_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos1_threshold (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_cos2_threshold(self):
    """
    Getter method for cos2_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos2_threshold (uint32)
  ...
  def _set_cos2_threshold(self, v, load=False):
    """
    Setter method for cos2_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos2_threshold (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_cos3_threshold(self):
    """
    Getter method for cos3_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos3_threshold (uint32)
  ...
  def _set_cos3_threshold(self, v, load=False):
    """
    Setter method for cos3_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos3_threshold (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_cos4_threshold(self):
    """
    Getter method for cos4_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos4_threshold (uint32)
  ...
  def _set_cos4_threshold(self, v, load=False):
    """
    Setter method for cos4_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos4_threshold (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_cos5_threshold(self):
    """
    Getter method for cos5_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos5_threshold (uint32)
  ...
  def _set_cos5_threshold(self, v, load=False):
    """
    Setter method for cos5_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos5_threshold (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_cos6_threshold(self):
    """
    Getter method for cos6_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos6_threshold (uint32)
  ...
  def _set_cos6_threshold(self, v, load=False):
    """
    Setter method for cos6_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos6_threshold (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_cos7_threshold(self):
    """
    Getter method for cos7_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos7_threshold (uint32)
  ...
  def _set_cos7_threshold(self, v, load=False):
    """
    Setter method for cos7_threshold, mapped from YANG variable /interface/tengigabitethernet/qos/rcv_queue/cos_threshold/cos7_threshold (uint32)
    If this variable is read-only (config: false) in the
