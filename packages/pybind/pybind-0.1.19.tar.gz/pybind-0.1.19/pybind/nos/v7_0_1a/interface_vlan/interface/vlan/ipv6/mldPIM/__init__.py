...
import __builtin__
import snooping
class mldPIM(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface-vlan/interface/vlan/ipv6/mldPIM. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface-vlan', u'interface', u'vlan', u'ipv6', u'mldPIM']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Vlan', u'ipv6', u'pim']

  def _get_snooping(self):
    """
    Getter method for snooping, mapped from YANG variable /interface_vlan/interface/vlan/ipv6/mldPIM/snooping (container)
    """
    return self.__snooping
      
  def _set_snooping(self, v, load=False):
    """
    Setter method for snooping, mapped from YANG variable /interface_vlan/interface/vlan/ipv6/mldPIM/snooping (container)
