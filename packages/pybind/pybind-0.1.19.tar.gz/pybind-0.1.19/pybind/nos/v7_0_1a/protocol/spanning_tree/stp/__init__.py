...
class stp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__system_id','__description','__bridge_priority','__error_disable_timeout','__forward_delay','__max_age','__port_channel','__shutdown','__hello_time',)
  ...
  def _get_system_id(self):
    """
    Getter method for system_id, mapped from YANG variable /protocol/spanning_tree/stp/system_id (container)
    """
    return self.__system_id
      
  def _set_system_id(self, v, load=False):
    """
    Setter method for system_id, mapped from YANG variable /protocol/spanning_tree/stp/system_id (container)
  ...
  def _get_forward_delay(self):
    """
    Getter method for forward_delay, mapped from YANG variable /protocol/spanning_tree/stp/forward_delay (uint32)
    """
    return self.__forward_delay
      
  def _set_forward_delay(self, v, load=False):
    """
    Setter method for forward_delay, mapped from YANG variable /protocol/spanning_tree/stp/forward_delay (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_max_age(self):
    """
    Getter method for max_age, mapped from YANG variable /protocol/spanning_tree/stp/max_age (uint32)
    """
    return self.__max_age
      
  def _set_max_age(self, v, load=False):
    """
    Setter method for max_age, mapped from YANG variable /protocol/spanning_tree/stp/max_age (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_hello_time(self):
    """
    Getter method for hello_time, mapped from YANG variable /protocol/spanning_tree/stp/hello_time (uint32)
    """
    return self.__hello_time
      
  def _set_hello_time(self, v, load=False):
    """
    Setter method for hello_time, mapped from YANG variable /protocol/spanning_tree/stp/hello_time (uint32)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'system_id': system_id, 'description': description, 'bridge_priority': bridge_priority, 'error_disable_timeout': error_disable_timeout, 'forward_delay': forward_delay, 'max_age': max_age, 'port_channel': port_channel, 'shutdown': shutdown, 'hello_time': hello_time, }
