...
class heavy(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/bp-rate-limit/heavy. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'bp-rate-limit', u'heavy']
  ...
  def _get_module(self):
    """
    Getter method for module, mapped from YANG variable /rbridge_id/bp_rate_limit/heavy/module (container)
    """
    return self.__module
      
  def _set_module(self, v, load=False):
    """
    Setter method for module, mapped from YANG variable /rbridge_id/bp_rate_limit/heavy/module (container)
