...
class global_lc_holder(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/global-lc-holder. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'global-lc-holder']
  ...
  def _get_linecard(self):
    """
    Getter method for linecard, mapped from YANG variable /rbridge_id/global_lc_holder/linecard (container)
    """
    return self.__linecard
      
  def _set_linecard(self, v, load=False):
    """
    Setter method for linecard, mapped from YANG variable /rbridge_id/global_lc_holder/linecard (container)
