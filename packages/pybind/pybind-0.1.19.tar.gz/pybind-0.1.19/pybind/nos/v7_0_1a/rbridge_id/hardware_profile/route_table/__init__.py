...
import __builtin__
import predefined
class route_table(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/hardware-profile/route-table. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__predefined',)

  _yang_name = 'route-table'
  _rest_name = 'route-table'
  ...
  def _get_predefined(self):
    """
    Getter method for predefined, mapped from YANG variable /rbridge_id/hardware_profile/route_table/predefined (container)
    """
    return self.__predefined
      
  def _set_predefined(self, v, load=False):
    """
    Setter method for predefined, mapped from YANG variable /rbridge_id/hardware_profile/route_table/predefined (container)
  ...
  _pyangbind_elements = {'predefined': predefined, }
