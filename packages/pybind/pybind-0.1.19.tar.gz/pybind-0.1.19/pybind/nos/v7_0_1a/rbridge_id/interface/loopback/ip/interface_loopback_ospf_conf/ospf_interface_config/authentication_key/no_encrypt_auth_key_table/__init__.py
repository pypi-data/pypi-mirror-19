...
class no_encrypt_auth_key_table(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/loopback/ip/interface-loopback-ospf-conf/ospf-interface-config/authentication-key/no-encrypt-auth-key-table. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'loopback', u'ip', u'interface-loopback-ospf-conf', u'ospf-interface-config', u'authentication-key', u'no-encrypt-auth-key-table']
  ...
  def _get_no_encrypt_auth_key(self):
    """
    Getter method for no_encrypt_auth_key, mapped from YANG variable /rbridge_id/interface/loopback/ip/interface_loopback_ospf_conf/ospf_interface_config/authentication_key/no_encrypt_auth_key_table/no_encrypt_auth_key (ospf-auth-psswd-string)
    """
    return self.__no_encrypt_auth_key
      
  def _set_no_encrypt_auth_key(self, v, load=False):
    """
    Setter method for no_encrypt_auth_key, mapped from YANG variable /rbridge_id/interface/loopback/ip/interface_loopback_ospf_conf/ospf_interface_config/authentication_key/no_encrypt_auth_key_table/no_encrypt_auth_key (ospf-auth-psswd-string)
