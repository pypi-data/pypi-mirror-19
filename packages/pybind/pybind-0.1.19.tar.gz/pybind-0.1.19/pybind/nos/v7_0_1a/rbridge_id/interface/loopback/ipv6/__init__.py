...
class ipv6(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/loopback/ipv6. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ipv6_config','__interface_ospfv3_conf',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'loopback', u'ipv6']
  ...
  def _get_ipv6_config(self):
    """
    Getter method for ipv6_config, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/ipv6_config (container)
    """
    return self.__ipv6_config
      
  def _set_ipv6_config(self, v, load=False):
    """
    Setter method for ipv6_config, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/ipv6_config (container)
  ...
  def _get_interface_ospfv3_conf(self):
    """
    Getter method for interface_ospfv3_conf, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/interface_ospfv3_conf (container)
  ...
  def _set_interface_ospfv3_conf(self, v, load=False):
    """
    Setter method for interface_ospfv3_conf, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/interface_ospfv3_conf (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'ipv6_config': ipv6_config, 'interface_ospfv3_conf': interface_ospfv3_conf, }
