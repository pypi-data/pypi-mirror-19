...
class ip(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ip_config','__ip_anycast_address','__ip_local_anycast_gateway','__interface_ve_dhcp_conf','__icmp','__igmp','__interface_vlan_ospf_conf','__pim_intf_vlan_cont',)
  ...
  def _get_ip_anycast_address(self):
    """
    Getter method for ip_anycast_address, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_anycast_address (list)
    """
    return self.__ip_anycast_address
      
  def _set_ip_anycast_address(self, v, load=False):
    """
    Setter method for ip_anycast_address, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_anycast_address (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'ip_config': ip_config, 'ip_anycast_address': ip_anycast_address, 'ip_local_anycast_gateway': ip_local_anycast_gateway, 'interface_ve_dhcp_conf': interface_ve_dhcp_conf, 'icmp': icmp, 'igmp': igmp, 'interface_vlan_ospf_conf': interface_vlan_ospf_conf, 'pim_intf_vlan_cont': pim_intf_vlan_cont, }
