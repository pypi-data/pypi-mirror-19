...
class interface_vlan_ospf_conf(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ip/interface-vlan-ospf-conf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ip', u'interface-vlan-ospf-conf']
  ...
  def _get_ospf_interface_config(self):
    """
    Getter method for ospf_interface_config, mapped from YANG variable /rbridge_id/interface/ve/ip/interface_vlan_ospf_conf/ospf_interface_config (container)
    """
    return self.__ospf_interface_config
      
  def _set_ospf_interface_config(self, v, load=False):
    """
    Setter method for ospf_interface_config, mapped from YANG variable /rbridge_id/interface/ve/ip/interface_vlan_ospf_conf/ospf_interface_config (container)
