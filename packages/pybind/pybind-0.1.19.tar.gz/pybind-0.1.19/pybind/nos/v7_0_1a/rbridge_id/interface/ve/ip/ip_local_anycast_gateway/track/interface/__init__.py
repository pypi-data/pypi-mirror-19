...
class interface(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ip/ip-local-anycast-gateway/track/interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ip', u'ip-local-anycast-gateway', u'track', u'interface']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Ve', u'ip', u'fabric-virtual-gateway', u'track', u'interface']

  def _get_interface_type(self):
    """
    Getter method for interface_type, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/track/interface/interface_type (vrrp:track-iftype)
    """
    return self.__interface_type
      
  def _set_interface_type(self, v, load=False):
    """
    Setter method for interface_type, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/track/interface/interface_type (vrrp:track-iftype)
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/track/interface/interface_name (vrrp:track-ifname)
    """
    return self.__interface_name
      
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/track/interface/interface_name (vrrp:track-ifname)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface_priority(self):
    """
    Getter method for interface_priority, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/track/interface/interface_priority (uint32)
  ...
  def _set_interface_priority(self, v, load=False):
    """
    Setter method for interface_priority, mapped from YANG variable /rbridge_id/interface/ve/ip/ip_local_anycast_gateway/track/interface/interface_priority (uint32)
    If this variable is read-only (config: false) in the
