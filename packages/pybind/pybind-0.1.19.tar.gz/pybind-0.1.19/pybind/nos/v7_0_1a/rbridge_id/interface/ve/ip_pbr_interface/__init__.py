...
class ip_pbr_interface(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ip-pbr-interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ip-pbr-interface']
  ...
  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /rbridge_id/interface/ve/ip_pbr_interface/ip (container)
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /rbridge_id/interface/ve/ip_pbr_interface/ip (container)
