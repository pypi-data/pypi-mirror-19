...
class dhcp(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ipv6/interface-ve-dhcp-conf/dhcp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ipv6', u'interface-ve-dhcp-conf', u'dhcp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Ve', u'ipv6', u'dhcp']

  def _get_relay(self):
    """
    Getter method for relay, mapped from YANG variable /rbridge_id/interface/ve/ipv6/interface_ve_dhcp_conf/dhcp/relay (container)
    """
    return self.__relay
      
  def _set_relay(self, v, load=False):
    """
    Setter method for relay, mapped from YANG variable /rbridge_id/interface/ve/ipv6/interface_ve_dhcp_conf/dhcp/relay (container)
