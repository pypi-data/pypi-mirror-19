...
class arp(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/vrrp/arp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'vrrp', u'arp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Ve', u'vrrp-group', u'arp']

  def _get_unicast_request(self):
    """
    Getter method for unicast_request, mapped from YANG variable /rbridge_id/interface/ve/vrrp/arp/unicast_request (container)
  ...
  def _set_unicast_request(self, v, load=False):
    """
    Setter method for unicast_request, mapped from YANG variable /rbridge_id/interface/ve/vrrp/arp/unicast_request (container)
