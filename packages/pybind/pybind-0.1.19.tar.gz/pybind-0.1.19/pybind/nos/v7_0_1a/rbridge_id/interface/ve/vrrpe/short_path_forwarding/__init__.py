...
class short_path_forwarding(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/vrrpe/short-path-forwarding. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'vrrpe', u'short-path-forwarding']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Ve', u'vrrp-extended-group', u'short-path-forwarding']

  def _get_basic(self):
    """
    Getter method for basic, mapped from YANG variable /rbridge_id/interface/ve/vrrpe/short_path_forwarding/basic (empty)
    """
    return self.__basic
      
  def _set_basic(self, v, load=False):
    """
    Setter method for basic, mapped from YANG variable /rbridge_id/interface/ve/vrrpe/short_path_forwarding/basic (empty)
  ...
  def _get_revert_priority(self):
    """
    Getter method for revert_priority, mapped from YANG variable /rbridge_id/interface/ve/vrrpe/short_path_forwarding/revert_priority (uint8)
  ...
  def _set_revert_priority(self, v, load=False):
    """
    Setter method for revert_priority, mapped from YANG variable /rbridge_id/interface/ve/vrrpe/short_path_forwarding/revert_priority (uint8)
    If this variable is read-only (config: false) in the
