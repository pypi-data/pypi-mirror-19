...
class relay(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ip/dhcp/relay. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__information',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ip', u'dhcp', u'relay']
  ...
  def _get_information(self):
    """
    Getter method for information, mapped from YANG variable /rbridge_id/ip/dhcp/relay/information (container)
    """
    return self.__information
      
  def _set_information(self, v, load=False):
    """
    Setter method for information, mapped from YANG variable /rbridge_id/ip/dhcp/relay/information (container)
  ...
  _pyangbind_elements = {'information': information, }
