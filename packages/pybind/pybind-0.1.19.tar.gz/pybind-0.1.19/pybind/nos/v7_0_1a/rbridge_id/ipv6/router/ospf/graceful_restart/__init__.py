...
class graceful_restart(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/graceful-restart. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'graceful-restart']
  ...
  def _get_helper(self):
    """
    Getter method for helper, mapped from YANG variable /rbridge_id/ipv6/router/ospf/graceful_restart/helper (container)
  ...
  def _set_helper(self, v, load=False):
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=helper.helper, is_container='container', yang_name="helper", rest_name="helper", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Set graceful restart helper options', u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospfv3', defining_module='brocade-ospfv3', yang_type='container', is_config=True)""",
        })
