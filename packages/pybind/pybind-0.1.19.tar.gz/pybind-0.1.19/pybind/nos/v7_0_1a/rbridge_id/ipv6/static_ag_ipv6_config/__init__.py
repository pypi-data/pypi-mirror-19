...
class static_ag_ipv6_config(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/static-ag-ipv6-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'static-ag-ipv6-config']
  ...
  def _get_anycast_gateway_mac(self):
    """
    Getter method for anycast_gateway_mac, mapped from YANG variable /rbridge_id/ipv6/static_ag_ipv6_config/anycast_gateway_mac (container)
