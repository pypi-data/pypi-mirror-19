...
class no_ssl(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__passive_controller_flag','__passive_controller_ip_address','__passive_controller_port','__passive_controller_vrf',)
...
is supported.
  ...
  def _get_passive_controller_vrf(self):
    """
    Getter method for passive_controller_vrf, mapped from YANG variable /rbridge_id/openflow/logical_instance/passive/no_ssl/passive_controller_vrf (common-def:vrf-name)
    """
    return self.__passive_controller_vrf
      
  def _set_passive_controller_vrf(self, v, load=False):
    """
    Setter method for passive_controller_vrf, mapped from YANG variable /rbridge_id/openflow/logical_instance/passive/no_ssl/passive_controller_vrf (common-def:vrf-name)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'passive_controller_flag': passive_controller_flag, 'passive_controller_ip_address': passive_controller_ip_address, 'passive_controller_port': passive_controller_port, 'passive_controller_vrf': passive_controller_vrf, }
