...
class continue_holder(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/continue-holder. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'continue-holder']
  ...
  def _get_continue_(self):
    """
    Getter method for continue_, mapped from YANG variable /rbridge_id/route_map/content/continue_holder/continue (empty)
    """
    return self.__continue_
      
  def _set_continue_(self, v, load=False):
    """
    Setter method for continue_, mapped from YANG variable /rbridge_id/route_map/content/continue_holder/continue (empty)
  ...
  def _get_continue_val(self):
    """
    Getter method for continue_val, mapped from YANG variable /rbridge_id/route_map/content/continue_holder/continue_val (uint32)
    """
    return self.__continue_val
      
  def _set_continue_val(self, v, load=False):
    """
    Setter method for continue_val, mapped from YANG variable /rbridge_id/route_map/content/continue_holder/continue_val (uint32)
    If this variable is read-only (config: false) in the
