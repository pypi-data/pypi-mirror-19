...
class community(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/community. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'community']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'set', u'community']

  def _get_set_community_expr(self):
    """
    Getter method for set_community_expr, mapped from YANG variable /rbridge_id/route_map/content/set/community/set_community_expr (set-community-expr-t)
    """
    return self.__set_community_expr
      
  def _set_set_community_expr(self, v, load=False):
    """
    Setter method for set_community_expr, mapped from YANG variable /rbridge_id/route_map/content/set/community/set_community_expr (set-community-expr-t)
