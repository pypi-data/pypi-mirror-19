...
class rt(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/extcommunity/rt. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'extcommunity', u'rt']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'set', u'extcommunity', u'rt']

  def _get_ASN_NN_rt(self):
    """
    Getter method for ASN_NN_rt, mapped from YANG variable /rbridge_id/route_map/content/set/extcommunity/rt/ASN_NN_rt (ext-community-rt-expr-t)
    """
    return self.__ASN_NN_rt
      
  def _set_ASN_NN_rt(self, v, load=False):
    """
    Setter method for ASN_NN_rt, mapped from YANG variable /rbridge_id/route_map/content/set/extcommunity/rt/ASN_NN_rt (ext-community-rt-expr-t)
