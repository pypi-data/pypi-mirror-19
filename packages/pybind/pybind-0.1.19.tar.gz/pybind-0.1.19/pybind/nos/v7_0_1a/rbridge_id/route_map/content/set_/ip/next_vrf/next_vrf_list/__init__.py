...
class next_vrf_list(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/ip/next-vrf/next-vrf-list. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'ip', u'next-vrf', u'next-vrf-list']
  ...
  def _get_vrf(self):
    """
    Getter method for vrf, mapped from YANG variable /rbridge_id/route_map/content/set/ip/next_vrf/next_vrf_list/vrf (string)
    """
    return self.__vrf
      
  def _set_vrf(self, v, load=False):
    """
    Setter method for vrf, mapped from YANG variable /rbridge_id/route_map/content/set/ip/next_vrf/next_vrf_list/vrf (string)
  ...
  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /rbridge_id/route_map/content/set/ip/next_vrf/next_vrf_list/next_hop (inet:ipv4-address)
    """
    return self.__next_hop
      
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /rbridge_id/route_map/content/set/ip/next_vrf/next_vrf_list/next_hop (inet:ipv4-address)
    If this variable is read-only (config: false) in the
