...
class pim(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__reset_tracking_bit','__max_mcache','__hello_interval','__nbr_timeout','__inactivity_timer','__message_interval','__bsr_msg_interval','__rp_adv_interval','__spt_threshold','__bsr_candidate','__rp_candidate','__rp_address',)
