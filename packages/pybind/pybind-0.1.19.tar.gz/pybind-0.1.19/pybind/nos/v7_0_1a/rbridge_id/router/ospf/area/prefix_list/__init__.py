...
class prefix_list(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/area/prefix-list. Each member element of
  ...
  def _get_direction_in(self):
    """
    Getter method for direction_in, mapped from YANG variable /rbridge_id/router/ospf/area/prefix_list/direction_in (container)
    """
    return self.__direction_in
      
  def _set_direction_in(self, v, load=False):
    """
    Setter method for direction_in, mapped from YANG variable /rbridge_id/router/ospf/area/prefix_list/direction_in (container)
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=direction_in.direction_in, is_container='container', yang_name="direction-in", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
  ...
  def _get_direction_out(self):
    """
    Getter method for direction_out, mapped from YANG variable /rbridge_id/router/ospf/area/prefix_list/direction_out (container)
    """
    return self.__direction_out
      
  def _set_direction_out(self, v, load=False):
    """
    Setter method for direction_out, mapped from YANG variable /rbridge_id/router/ospf/area/prefix_list/direction_out (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=direction_out.direction_out, is_container='container', yang_name="direction-out", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
