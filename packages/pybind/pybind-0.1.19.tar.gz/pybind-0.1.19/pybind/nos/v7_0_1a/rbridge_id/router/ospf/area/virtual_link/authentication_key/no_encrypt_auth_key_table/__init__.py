...
class no_encrypt_auth_key_table(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/area/virtual-link/authentication-key/no-encrypt-auth-key-table. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'area', u'virtual-link', u'authentication-key', u'no-encrypt-auth-key-table']
  ...
  def _get_no_encrypt_auth_key(self):
    """
    Getter method for no_encrypt_auth_key, mapped from YANG variable /rbridge_id/router/ospf/area/virtual_link/authentication_key/no_encrypt_auth_key_table/no_encrypt_auth_key (ospf-auth-psswd-string)
    """
    return self.__no_encrypt_auth_key
      
  def _set_no_encrypt_auth_key(self, v, load=False):
    """
    Setter method for no_encrypt_auth_key, mapped from YANG variable /rbridge_id/router/ospf/area/virtual_link/authentication_key/no_encrypt_auth_key_table/no_encrypt_auth_key (ospf-auth-psswd-string)
