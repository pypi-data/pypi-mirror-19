...
class graceful_restart(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__graceful_restart_enable','__helper_disable','__helper_strict_lsa_checking','__restart_time',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__helper_strict_lsa_checking = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="helper-strict-lsa-checking", rest_name="helper-strict-lsa-checking", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set strict LSA checking', u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='empty', is_config=True)
  ...
  def _get_helper_strict_lsa_checking(self):
    """
    Getter method for helper_strict_lsa_checking, mapped from YANG variable /rbridge_id/router/ospf/graceful_restart/helper_strict_lsa_checking (empty)
    ...
    """
    return self.__helper_strict_lsa_checking
      
  def _set_helper_strict_lsa_checking(self, v, load=False):
    """
    Setter method for helper_strict_lsa_checking, mapped from YANG variable /rbridge_id/router/ospf/graceful_restart/helper_strict_lsa_checking (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_helper_strict_lsa_checking is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_helper_strict_lsa_checking() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """helper_strict_lsa_checking must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="helper-strict-lsa-checking", rest_name="helper-strict-lsa-checking", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set strict LSA checking', u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='empty', is_config=True)""",
        })

    self.__helper_strict_lsa_checking = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_helper_strict_lsa_checking(self):
    self.__helper_strict_lsa_checking = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="helper-strict-lsa-checking", rest_name="helper-strict-lsa-checking", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set strict LSA checking', u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='empty', is_config=True)
  ...
  helper_strict_lsa_checking = __builtin__.property(_get_helper_strict_lsa_checking, _set_helper_strict_lsa_checking)
  restart_time = __builtin__.property(_get_restart_time, _set_restart_time)


  _pyangbind_elements = {'graceful_restart_enable': graceful_restart_enable, 'helper_disable': helper_disable, 'helper_strict_lsa_checking': helper_strict_lsa_checking, 'restart_time': restart_time, }
