...
class summary_lsa_onstartup(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/max-metric/router-lsa/on-startup/summary-lsa-onstartup. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'max-metric', u'router-lsa', u'on-startup', u'summary-lsa-onstartup']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'max-metric', u'router-lsa', u'on-startup', u'summary-lsa']

  def _get_summary_lsa_val_onstartup(self):
    """
    Getter method for summary_lsa_val_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/summary_lsa_onstartup/summary_lsa_val_onstartup (uint32)
    """
    return self.__summary_lsa_val_onstartup
      
  def _set_summary_lsa_val_onstartup(self, v, load=False):
    """
    Setter method for summary_lsa_val_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/summary_lsa_onstartup/summary_lsa_val_onstartup (uint32)
