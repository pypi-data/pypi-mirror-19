...
class rfc1583_compatibility(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/rfc1583-compatibility. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'rfc1583-compatibility']
  ...
  def _get_rfc1583_compatibility_flag(self):
    """
    Getter method for rfc1583_compatibility_flag, mapped from YANG variable /rbridge_id/router/ospf/rfc1583_compatibility/rfc1583_compatibility_flag (empty)
    """
    return self.__rfc1583_compatibility_flag
      
  def _set_rfc1583_compatibility_flag(self, v, load=False):
    """
    Setter method for rfc1583_compatibility_flag, mapped from YANG variable /rbridge_id/router/ospf/rfc1583_compatibility/rfc1583_compatibility_flag (empty)
