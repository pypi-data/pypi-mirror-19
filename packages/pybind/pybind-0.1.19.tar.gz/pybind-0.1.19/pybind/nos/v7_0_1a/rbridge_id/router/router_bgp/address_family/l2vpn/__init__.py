...
import __builtin__
import evpn
class l2vpn(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/l2vpn. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'l2vpn']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'l2vpn']

  def _get_evpn(self):
    """
    Getter method for evpn, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn (container)
    """
    return self.__evpn
      
  def _set_evpn(self, v, load=False):
    """
    Setter method for evpn, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn (container)
