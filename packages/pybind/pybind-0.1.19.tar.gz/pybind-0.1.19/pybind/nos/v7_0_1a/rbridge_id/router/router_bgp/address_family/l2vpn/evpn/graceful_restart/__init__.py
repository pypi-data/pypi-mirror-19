...
class graceful_restart(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/l2vpn/evpn/graceful-restart. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'l2vpn', u'evpn', u'graceful-restart']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'l2vpn', u'evpn', u'graceful-restart']

  def _get_graceful_restart_status(self):
    """
    Getter method for graceful_restart_status, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/graceful_restart/graceful_restart_status (empty)
    """
    return self.__graceful_restart_status
      
  def _set_graceful_restart_status(self, v, load=False):
    """
    Setter method for graceful_restart_status, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/graceful_restart/graceful_restart_status (empty)
  ...
  def _get_restart_time(self):
    """
    Getter method for restart_time, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/graceful_restart/restart_time (rtime-type)
    """
    return self.__restart_time
      
  def _set_restart_time(self, v, load=False):
    """
    Setter method for restart_time, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/graceful_restart/restart_time (rtime-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_purge_time(self):
    """
    Getter method for purge_time, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/graceful_restart/purge_time (ptime-type)
    """
    return self.__purge_time
      
  def _set_purge_time(self, v, load=False):
    """
    Setter method for purge_time, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/graceful_restart/purge_time (ptime-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_stale_routes_time(self):
    """
    Getter method for stale_routes_time, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/graceful_restart/stale_routes_time (st-time-type)
    """
    return self.__stale_routes_time
      
  def _set_stale_routes_time(self, v, load=False):
    """
    Setter method for stale_routes_time, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/graceful_restart/stale_routes_time (st-time-type)
    If this variable is read-only (config: false) in the
