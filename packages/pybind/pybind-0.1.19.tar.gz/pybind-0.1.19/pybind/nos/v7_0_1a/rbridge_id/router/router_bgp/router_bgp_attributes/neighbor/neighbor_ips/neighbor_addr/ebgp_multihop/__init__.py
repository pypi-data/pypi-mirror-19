...
class ebgp_multihop(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ips/neighbor-addr/ebgp-multihop. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'neighbor-ips', u'neighbor-addr', u'ebgp-multihop']
  ...
  def _get_ebgp_multihop_flag(self):
    """
    Getter method for ebgp_multihop_flag, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/ebgp_multihop/ebgp_multihop_flag (empty)
    """
    return self.__ebgp_multihop_flag
      
  def _set_ebgp_multihop_flag(self, v, load=False):
    """
    Setter method for ebgp_multihop_flag, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/ebgp_multihop/ebgp_multihop_flag (empty)
  ...
  def _get_ebgp_multihop_count(self):
    """
    Getter method for ebgp_multihop_count, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/ebgp_multihop/ebgp_multihop_count (uint32)
    """
    return self.__ebgp_multihop_count
      
  def _set_ebgp_multihop_count(self, v, load=False):
    """
    Setter method for ebgp_multihop_count, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/ebgp_multihop/ebgp_multihop_count (uint32)
    If this variable is read-only (config: false) in the
