...
class in_(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/neighbor/peer-grps/neighbor-peer-grp/maxas-limit/in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'peer-grps', u'neighbor-peer-grp', u'maxas-limit', u'in']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'neighbor', u'maxas-limit', u'in']

  def _get_num_as_in_as_path(self):
    """
    Getter method for num_as_in_as_path, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/maxas_limit/in/num_as_in_as_path (num-as-in-as-path)
    """
    return self.__num_as_in_as_path
      
  def _set_num_as_in_as_path(self, v, load=False):
    """
    Setter method for num_as_in_as_path, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/maxas_limit/in/num_as_in_as_path (num-as-in-as-path)
  ...
  def _get_maxas_limit_disable(self):
    """
    Getter method for maxas_limit_disable, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/maxas_limit/in/maxas_limit_disable (empty)
    """
    return self.__maxas_limit_disable
      
  def _set_maxas_limit_disable(self, v, load=False):
    """
    Setter method for maxas_limit_disable, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/maxas_limit/in/maxas_limit_disable (empty)
    If this variable is read-only (config: false) in the
