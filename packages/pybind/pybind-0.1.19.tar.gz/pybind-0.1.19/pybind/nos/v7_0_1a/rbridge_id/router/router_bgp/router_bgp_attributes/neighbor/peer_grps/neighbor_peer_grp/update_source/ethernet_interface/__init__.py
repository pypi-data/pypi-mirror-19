...
class ethernet_interface(PybindBase):
  ...
  def _get_ethernet(self):
    """
    Getter method for ethernet, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/update_source/ethernet_interface/ethernet (interface:interface-type)
    """
    return self.__ethernet
      
  def _set_ethernet(self, v, load=False):
    """
    Setter method for ethernet, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/update_source/ethernet_interface/ethernet (interface:interface-type)
    If this variable is read-only (config: false) in the
