...
class active_policy(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/secpolicy/active-policy. Each member element of
  ...
  def _get_policies(self):
    """
    Getter method for policies, mapped from YANG variable /rbridge_id/secpolicy/active_policy/policies (list)
    """
    return self.__policies
      
  def _set_policies(self, v, load=False):
    """
    Setter method for policies, mapped from YANG variable /rbridge_id/secpolicy/active_policy/policies (list)
