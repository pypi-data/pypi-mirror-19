...
class MM(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/system-monitor/MM. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'system-monitor', u'MM']
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /rbridge_id/system_monitor/MM/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /rbridge_id/system_monitor/MM/threshold (container)
