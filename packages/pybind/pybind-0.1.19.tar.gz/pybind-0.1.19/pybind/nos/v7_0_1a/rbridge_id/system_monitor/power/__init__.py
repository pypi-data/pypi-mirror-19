...
class power(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/system-monitor/power. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'system-monitor', u'power']
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /rbridge_id/system_monitor/power/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /rbridge_id/system_monitor/power/threshold (container)
  ...
  def _get_alert(self):
    """
    Getter method for alert, mapped from YANG variable /rbridge_id/system_monitor/power/alert (container)
    """
    return self.__alert
      
  def _set_alert(self, v, load=False):
    """
    Setter method for alert, mapped from YANG variable /rbridge_id/system_monitor/power/alert (container)
    If this variable is read-only (config: false) in the
