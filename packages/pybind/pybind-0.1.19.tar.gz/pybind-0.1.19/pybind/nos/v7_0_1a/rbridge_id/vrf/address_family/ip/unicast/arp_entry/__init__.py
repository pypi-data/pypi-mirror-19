...
class arp_entry(PybindBase):
  ...
  def _get_arp_ip_address(self):
    """
    Getter method for arp_ip_address, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/arp_entry/arp_ip_address (inet:ipv4-address)
  ...
  def _set_arp_ip_address(self, v, load=False):
    """
    Setter method for arp_ip_address, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/arp_entry/arp_ip_address (inet:ipv4-address)
