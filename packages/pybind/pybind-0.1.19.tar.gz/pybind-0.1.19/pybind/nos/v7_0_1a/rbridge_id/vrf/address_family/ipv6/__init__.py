...
class ipv6(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ipv6. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ipv6']
  ...
  def _get_unicast(self):
    """
    Getter method for unicast, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast (container)
    """
    return self.__unicast
      
  def _set_unicast(self, v, load=False):
    """
    Setter method for unicast, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast (container)
