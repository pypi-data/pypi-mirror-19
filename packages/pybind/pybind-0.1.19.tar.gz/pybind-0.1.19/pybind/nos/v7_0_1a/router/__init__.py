...
import __builtin__
import fabric_virtual_gateway
class router(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /router. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: The routing system.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__fabric_virtual_gateway',)
  ...
  def _get_fabric_virtual_gateway(self):
    """
    Getter method for fabric_virtual_gateway, mapped from YANG variable /router/fabric_virtual_gateway (container)

    YANG Description: Fabric virtual gateway
    """
    return self.__fabric_virtual_gateway
  ...
  _pyangbind_elements = {'fabric_virtual_gateway': fabric_virtual_gateway, }
