...
class ipv6(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /router/fabric-virtual-gateway/address-family/ipv6. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Anycast gateway ipv6
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__enable_global','__gratuitous_arp','__gateway_mac_address',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'fabric-virtual-gateway', u'address-family', u'ipv6']
  ...
  def _get_enable_global(self):
    """
    Getter method for enable_global, mapped from YANG variable /router/fabric_virtual_gateway/address_family/ipv6/enable_global (empty)
    """
    return self.__enable_global
      
  def _set_enable_global(self, v, load=False):
    """
    Setter method for enable_global, mapped from YANG variable /router/fabric_virtual_gateway/address_family/ipv6/enable_global (empty)
  ...
  def _get_gratuitous_arp(self):
    """
    Getter method for gratuitous_arp, mapped from YANG variable /router/fabric_virtual_gateway/address_family/ipv6/gratuitous_arp (container)
    """
    return self.__gratuitous_arp
      
  def _set_gratuitous_arp(self, v, load=False):
    """
    Setter method for gratuitous_arp, mapped from YANG variable /router/fabric_virtual_gateway/address_family/ipv6/gratuitous_arp (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_gateway_mac_address(self):
    """
    Getter method for gateway_mac_address, mapped from YANG variable /router/fabric_virtual_gateway/address_family/ipv6/gateway_mac_address (mac-access-list:mac-address-type)
    """
    return self.__gateway_mac_address
      
  def _set_gateway_mac_address(self, v, load=False):
    """
    Setter method for gateway_mac_address, mapped from YANG variable /router/fabric_virtual_gateway/address_family/ipv6/gateway_mac_address (mac-access-list:mac-address-type)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'enable_global': enable_global, 'gratuitous_arp': gratuitous_arp, 'gateway_mac_address': gateway_mac_address, }
