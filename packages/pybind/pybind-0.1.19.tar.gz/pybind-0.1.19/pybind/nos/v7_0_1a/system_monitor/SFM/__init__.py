...
class SFM(PybindBase):
  ...
  from YANG module brocade-system-monitor - based on the path /system-monitor/SFM. Each member element of
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /system_monitor/SFM/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /system_monitor/SFM/threshold (container)
