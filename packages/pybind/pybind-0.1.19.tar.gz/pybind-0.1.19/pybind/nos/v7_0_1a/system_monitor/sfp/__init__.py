...
class sfp(PybindBase):
  ...
  from YANG module brocade-system-monitor - based on the path /system-monitor/sfp. Each member element of
  ...
  def _get_alert(self):
    """
    Getter method for alert, mapped from YANG variable /system_monitor/sfp/alert (container)
    """
    return self.__alert
      
  def _set_alert(self, v, load=False):
    """
    Setter method for alert, mapped from YANG variable /system_monitor/sfp/alert (container)
