...
class interface(PybindBase):
  ...
  from YANG module brocade-system-monitor - based on the path /system-monitor-mail/interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system-monitor-mail', u'interface']
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /system_monitor_mail/interface/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /system_monitor_mail/interface/enable (empty)
  ...
  def _get_email_list(self):
    """
    Getter method for email_list, mapped from YANG variable /system_monitor_mail/interface/email_list (list)
    """
    return self.__email_list
      
  def _set_email_list(self, v, load=False):
    """
    Setter method for email_list, mapped from YANG variable /system_monitor_mail/interface/email_list (list)
    If this variable is read-only (config: false) in the
