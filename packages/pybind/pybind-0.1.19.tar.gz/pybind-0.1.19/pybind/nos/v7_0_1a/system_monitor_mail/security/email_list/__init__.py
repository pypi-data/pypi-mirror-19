...
class email_list(PybindBase):
  ...
  from YANG module brocade-system-monitor - based on the path /system-monitor-mail/security/email-list. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__email = YANGDynClass(base=unicode, is_leaf=True, yang_name="email", rest_name="email", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'<email:string>  e-mail address for Security alerts', u'cli-full-command': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-system-monitor', defining_module='brocade-system-monitor', yang_type='string', is_config=True)
  ...
  def _get_email(self):
    """
    Getter method for email, mapped from YANG variable /system_monitor_mail/security/email_list/email (string)
    """
    return self.__email
      
  def _set_email(self, v, load=False):
    """
    Setter method for email, mapped from YANG variable /system_monitor_mail/security/email_list/email (string)
