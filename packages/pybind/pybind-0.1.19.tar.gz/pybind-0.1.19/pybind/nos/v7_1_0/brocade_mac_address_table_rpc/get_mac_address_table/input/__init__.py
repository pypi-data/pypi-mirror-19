...
class input(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__forwarding_interface = YANGDynClass(base=forwarding_interface.forwarding_interface, is_container='container', yang_name="forwarding-interface", rest_name="forwarding-interface", parent=self, choice=(u'request-type', u'get-interface-based-request'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mac-address-table', defining_module='brocade-mac-address-table', yang_type='container', is_config=True)
...
MAC entries will be fetched.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=forwarding_interface.forwarding_interface, is_container='container', yang_name="forwarding-interface", rest_name="forwarding-interface", parent=self, choice=(u'request-type', u'get-interface-based-request'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mac-address-table', defining_module='brocade-mac-address-table', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """forwarding_interface must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=forwarding_interface.forwarding_interface, is_container='container', yang_name="forwarding-interface", rest_name="forwarding-interface", parent=self, choice=(u'request-type', u'get-interface-based-request'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mac-address-table', defining_module='brocade-mac-address-table', yang_type='container', is_config=True)""",
        })
