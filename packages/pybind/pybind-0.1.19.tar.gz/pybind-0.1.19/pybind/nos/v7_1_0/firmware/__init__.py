...
class firmware(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__download','__peripheral_update',)
  ...
  def _get_peripheral_update(self):
    """
    Getter method for peripheral_update, mapped from YANG variable /firmware/peripheral_update (container)
    """
    return self.__peripheral_update
      
  def _set_peripheral_update(self, v, load=False):
    """
    Setter method for peripheral_update, mapped from YANG variable /firmware/peripheral_update (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_peripheral_update is considered as a private
    method. Backends looking to populate this variable should
  ...
  _pyangbind_elements = {'download': download, 'peripheral_update': peripheral_update, }
