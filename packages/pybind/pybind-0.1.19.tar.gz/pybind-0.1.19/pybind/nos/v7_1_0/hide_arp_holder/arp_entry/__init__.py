...
class arp_entry(PybindBase):
  ...
  def _get_arp_ip_address(self):
    """
    Getter method for arp_ip_address, mapped from YANG variable /hide_arp_holder/arp_entry/arp_ip_address (arp-ip)
    """
    return self.__arp_ip_address
      
  def _set_arp_ip_address(self, v, load=False):
    """
    Setter method for arp_ip_address, mapped from YANG variable /hide_arp_holder/arp_entry/arp_ip_address (arp-ip)
