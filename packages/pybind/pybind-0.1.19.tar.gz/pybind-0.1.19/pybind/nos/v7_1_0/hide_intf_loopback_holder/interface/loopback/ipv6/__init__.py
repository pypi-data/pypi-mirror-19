...
class ipv6(PybindBase):
  ...
  from YANG module brocade-intf-loopback - based on the path /hide-intf-loopback-holder/interface/loopback/ipv6. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ipv6_config',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-intf-loopback-holder', u'interface', u'loopback', u'ipv6']
  ...
  def _get_ipv6_config(self):
    """
    Getter method for ipv6_config, mapped from YANG variable /hide_intf_loopback_holder/interface/loopback/ipv6/ipv6_config (container)
    """
    return self.__ipv6_config
      
  def _set_ipv6_config(self, v, load=False):
    """
    Setter method for ipv6_config, mapped from YANG variable /hide_intf_loopback_holder/interface/loopback/ipv6/ipv6_config (container)
  ...
  _pyangbind_elements = {'ipv6_config': ipv6_config, }
