...
class unnumbered(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/ip/ip-config/unnumbered. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'ip', u'ip-config', u'unnumbered']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'FortyGigabitEthernet', u'ip', u'unnumbered']

  def _get_ip_donor_interface_type(self):
    """
    Getter method for ip_donor_interface_type, mapped from YANG variable /interface/fortygigabitethernet/ip/ip_config/unnumbered/ip_donor_interface_type (ip-unnumbered-donor-interface-type_t)
    """
    return self.__ip_donor_interface_type
      
  def _set_ip_donor_interface_type(self, v, load=False):
    """
    Setter method for ip_donor_interface_type, mapped from YANG variable /interface/fortygigabitethernet/ip/ip_config/unnumbered/ip_donor_interface_type (ip-unnumbered-donor-interface-type_t)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u've': {'value': 5}, u'loopback': {'value': 9}, u'fortygigabitethernet': {'value': 2}, u'gigabitethernet': {'value': 0}, u'tengigabitethernet': {'value': 1}, u'hundredgigabitethernet': {'value': 10}},), is_leaf=True, yang_name="ip-donor-interface-type", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'The type of donor interface.', u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-config', defining_module='brocade-ip-config', yang_type='ip-unnumbered-donor-interface-type_t', is_config=True)
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u've': {'value': 5}, u'loopback': {'value': 9}, u'fortygigabitethernet': {'value': 2}, u'gigabitethernet': {'value': 0}, u'tengigabitethernet': {'value': 1}, u'hundredgigabitethernet': {'value': 10}},), is_leaf=True, yang_name="ip-donor-interface-type", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'The type of donor interface.', u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-config', defining_module='brocade-ip-config', yang_type='ip-unnumbered-donor-interface-type_t', is_config=True)""",
        })
  ...
  def _get_ip_donor_interface_name(self):
    """
    Getter method for ip_donor_interface_name, mapped from YANG variable /interface/fortygigabitethernet/ip/ip_config/unnumbered/ip_donor_interface_name (ip-unnumbered-donor-interface-name_t)
    """
    return self.__ip_donor_interface_name
      
  def _set_ip_donor_interface_name(self, v, load=False):
    """
    Setter method for ip_donor_interface_name, mapped from YANG variable /interface/fortygigabitethernet/ip/ip_config/unnumbered/ip_donor_interface_name (ip-unnumbered-donor-interface-name_t)
    If this variable is read-only (config: false) in the
