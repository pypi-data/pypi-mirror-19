...
class ip(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/ip-pbr-interface/ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'ip-pbr-interface', u'ip']
  ...
  def _get_policy(self):
    """
    Getter method for policy, mapped from YANG variable /interface/fortygigabitethernet/ip_pbr_interface/ip/policy (container)
  ...
  def _set_policy(self, v, load=False):
    """
    Setter method for policy, mapped from YANG variable /interface/fortygigabitethernet/ip_pbr_interface/ip/policy (container)
