...
class ra_interval(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/ipv6/ipv6-nd-ra/ipv6-intf-cmds/nd/ra-interval. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'ipv6', u'ipv6-nd-ra', u'ipv6-intf-cmds', u'nd', u'ra-interval']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'FortyGigabitEthernet', u'ipv6', u'nd', u'ra-interval']

  def _get_max_interval(self):
    """
    Getter method for max_interval, mapped from YANG variable /interface/fortygigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/ra_interval/max_interval (common-def:time-interval-sec)
    """
    return self.__max_interval
      
  def _set_max_interval(self, v, load=False):
    """
    Setter method for max_interval, mapped from YANG variable /interface/fortygigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/ra_interval/max_interval (common-def:time-interval-sec)
  ...
  def _get_min_(self):
    """
    Getter method for min_, mapped from YANG variable /interface/fortygigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/ra_interval/min (common-def:time-interval-sec)
    """
    return self.__min_
      
  def _set_min_(self, v, load=False):
    """
    Setter method for min_, mapped from YANG variable /interface/fortygigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/ra_interval/min (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
