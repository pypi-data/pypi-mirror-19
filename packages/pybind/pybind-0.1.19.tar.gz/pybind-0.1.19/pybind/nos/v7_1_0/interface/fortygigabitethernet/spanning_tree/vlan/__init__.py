...
class vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/spanning-tree/vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'spanning-tree', u'vlan']
  ...
  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /interface/fortygigabitethernet/spanning_tree/vlan/id (uint32)
    """
    return self.__id
      
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /interface/fortygigabitethernet/spanning_tree/vlan/id (uint32)
  ...
  def _get_cost(self):
    """
    Getter method for cost, mapped from YANG variable /interface/fortygigabitethernet/spanning_tree/vlan/cost (uint32)
    """
    return self.__cost
      
  def _set_cost(self, v, load=False):
    """
    Setter method for cost, mapped from YANG variable /interface/fortygigabitethernet/spanning_tree/vlan/cost (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_priority(self):
    """
    Getter method for priority, mapped from YANG variable /interface/fortygigabitethernet/spanning_tree/vlan/priority (uint32)
    """
    return self.__priority
      
  def _set_priority(self, v, load=False):
    """
    Setter method for priority, mapped from YANG variable /interface/fortygigabitethernet/spanning_tree/vlan/priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_guard(self):
    """
    Getter method for guard, mapped from YANG variable /interface/fortygigabitethernet/spanning_tree/vlan/guard (container)
    """
    return self.__guard
      
  def _set_guard(self, v, load=False):
    """
    Setter method for guard, mapped from YANG variable /interface/fortygigabitethernet/spanning_tree/vlan/guard (container)
    If this variable is read-only (config: false) in the
