...
import interface_gi_dhcp_conf
import icmp
import igmp_phy_intf_cfg
import interface_gi_ospf_conf
import pim_intf_phy_cont
class ip(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/ip. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: The IP configurations for an interface.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ip_config','__arp_node_config','__interface_gi_dhcp_conf','__icmp','__igmp_phy_intf_cfg','__interface_gi_ospf_conf','__pim_intf_phy_cont',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__pim_intf_phy_cont = YANGDynClass(base=pim_intf_phy_cont.pim_intf_phy_cont, is_container='container', yang_name="pim-intf-phy-cont", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'PimPhyIntfCallpoint', u'sort-priority': u'122'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)
    ...
    self.__arp_node_config = YANGDynClass(base=arp_node_config.arp_node_config, is_container='container', yang_name="arp-node-config", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'interface_onegigabit'}}, namespace='urn:brocade.com:mgmt:brocade-dai', defining_module='brocade-dai', yang_type='container', is_config=True)
    self.__interface_gi_ospf_conf = YANGDynClass(base=interface_gi_ospf_conf.interface_gi_ospf_conf, is_container='container', yang_name="interface-gi-ospf-conf", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'OSPFTeInterfaceCallPoint'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)
    self.__interface_gi_dhcp_conf = YANGDynClass(base=interface_gi_dhcp_conf.interface_gi_dhcp_conf, is_container='container', yang_name="interface-gi-dhcp-conf", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-dhcp', defining_module='brocade-dhcp', yang_type='container', is_config=True)
  ...
  def _get_ip_config(self):
    """
    Getter method for ip_config, mapped from YANG variable /interface/gigabitethernet/ip/ip_config (container)
    """
  ...
  def _get_arp_node_config(self):
    """
    Getter method for arp_node_config, mapped from YANG variable /interface/gigabitethernet/ip/arp_node_config (container)
    """
    return self.__arp_node_config
      
  def _set_arp_node_config(self, v, load=False):
    """
    Setter method for arp_node_config, mapped from YANG variable /interface/gigabitethernet/ip/arp_node_config (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface_gi_dhcp_conf(self):
    """
    Getter method for interface_gi_dhcp_conf, mapped from YANG variable /interface/gigabitethernet/ip/interface_gi_dhcp_conf (container)
    """
    return self.__interface_gi_dhcp_conf
      
  def _set_interface_gi_dhcp_conf(self, v, load=False):
    """
    Setter method for interface_gi_dhcp_conf, mapped from YANG variable /interface/gigabitethernet/ip/interface_gi_dhcp_conf (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_interface_gi_dhcp_conf is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_interface_gi_dhcp_conf() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=interface_gi_dhcp_conf.interface_gi_dhcp_conf, is_container='container', yang_name="interface-gi-dhcp-conf", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-dhcp', defining_module='brocade-dhcp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """interface_gi_dhcp_conf must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=interface_gi_dhcp_conf.interface_gi_dhcp_conf, is_container='container', yang_name="interface-gi-dhcp-conf", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-dhcp', defining_module='brocade-dhcp', yang_type='container', is_config=True)""",
        })

    self.__interface_gi_dhcp_conf = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_interface_gi_dhcp_conf(self):
    self.__interface_gi_dhcp_conf = YANGDynClass(base=interface_gi_dhcp_conf.interface_gi_dhcp_conf, is_container='container', yang_name="interface-gi-dhcp-conf", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-dhcp', defining_module='brocade-dhcp', yang_type='container', is_config=True)


  def _get_icmp(self):
    """
    Getter method for icmp, mapped from YANG variable /interface/gigabitethernet/ip/icmp (container)
    """
    return self.__icmp
      
  def _set_icmp(self, v, load=False):
    """
    Setter method for icmp, mapped from YANG variable /interface/gigabitethernet/ip/icmp (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_igmp_phy_intf_cfg(self):
    """
    Getter method for igmp_phy_intf_cfg, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg (container)
    """
    return self.__igmp_phy_intf_cfg
      
  def _set_igmp_phy_intf_cfg(self, v, load=False):
    """
    Setter method for igmp_phy_intf_cfg, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface_gi_ospf_conf(self):
    """
    Getter method for interface_gi_ospf_conf, mapped from YANG variable /interface/gigabitethernet/ip/interface_gi_ospf_conf (container)
    """
    return self.__interface_gi_ospf_conf
      
  def _set_interface_gi_ospf_conf(self, v, load=False):
    """
    Setter method for interface_gi_ospf_conf, mapped from YANG variable /interface/gigabitethernet/ip/interface_gi_ospf_conf (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_interface_gi_ospf_conf is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_interface_gi_ospf_conf() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=interface_gi_ospf_conf.interface_gi_ospf_conf, is_container='container', yang_name="interface-gi-ospf-conf", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'OSPFTeInterfaceCallPoint'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """interface_gi_ospf_conf must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=interface_gi_ospf_conf.interface_gi_ospf_conf, is_container='container', yang_name="interface-gi-ospf-conf", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'OSPFTeInterfaceCallPoint'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })

    self.__interface_gi_ospf_conf = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_interface_gi_ospf_conf(self):
    self.__interface_gi_ospf_conf = YANGDynClass(base=interface_gi_ospf_conf.interface_gi_ospf_conf, is_container='container', yang_name="interface-gi-ospf-conf", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'OSPFTeInterfaceCallPoint'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)


  def _get_pim_intf_phy_cont(self):
    """
    Getter method for pim_intf_phy_cont, mapped from YANG variable /interface/gigabitethernet/ip/pim_intf_phy_cont (container)
    """
    return self.__pim_intf_phy_cont
      
  def _set_pim_intf_phy_cont(self, v, load=False):
    """
    Setter method for pim_intf_phy_cont, mapped from YANG variable /interface/gigabitethernet/ip/pim_intf_phy_cont (container)
    If this variable is read-only (config: false) in the
  ...
  interface_gi_dhcp_conf = __builtin__.property(_get_interface_gi_dhcp_conf, _set_interface_gi_dhcp_conf)
  ...
  interface_gi_ospf_conf = __builtin__.property(_get_interface_gi_ospf_conf, _set_interface_gi_ospf_conf)
  pim_intf_phy_cont = __builtin__.property(_get_pim_intf_phy_cont, _set_pim_intf_phy_cont)


  _pyangbind_elements = {'ip_config': ip_config, 'arp_node_config': arp_node_config, 'interface_gi_dhcp_conf': interface_gi_dhcp_conf, 'icmp': icmp, 'igmp_phy_intf_cfg': igmp_phy_intf_cfg, 'interface_gi_ospf_conf': interface_gi_ospf_conf, 'pim_intf_phy_cont': pim_intf_phy_cont, }
