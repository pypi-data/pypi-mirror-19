...
class dhcp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/ipv6/interface-phy-dhcp-conf/dhcp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'ipv6', u'interface-phy-dhcp-conf', u'dhcp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'GigabitEthernet', u'ipv6', u'dhcp']

  def _get_relay(self):
    """
    Getter method for relay, mapped from YANG variable /interface/gigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay (container)
    """
    return self.__relay
      
  def _set_relay(self, v, load=False):
    """
    Setter method for relay, mapped from YANG variable /interface/gigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay (container)
