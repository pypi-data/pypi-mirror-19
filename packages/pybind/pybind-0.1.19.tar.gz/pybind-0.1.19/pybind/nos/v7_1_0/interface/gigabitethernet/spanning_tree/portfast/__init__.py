...
class portfast(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/spanning-tree/portfast. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'spanning-tree', u'portfast']
  ...
  def _get_portfastbasic(self):
    """
    Getter method for portfastbasic, mapped from YANG variable /interface/gigabitethernet/spanning_tree/portfast/portfastbasic (empty)
    """
    return self.__portfastbasic
      
  def _set_portfastbasic(self, v, load=False):
    """
    Setter method for portfastbasic, mapped from YANG variable /interface/gigabitethernet/spanning_tree/portfast/portfastbasic (empty)
  ...
  def _get_bpdu_guard(self):
    """
    Getter method for bpdu_guard, mapped from YANG variable /interface/gigabitethernet/spanning_tree/portfast/bpdu_guard (empty)
    """
    return self.__bpdu_guard
      
  def _set_bpdu_guard(self, v, load=False):
    """
    Setter method for bpdu_guard, mapped from YANG variable /interface/gigabitethernet/spanning_tree/portfast/bpdu_guard (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_bpdu_filter(self):
    """
    Getter method for bpdu_filter, mapped from YANG variable /interface/gigabitethernet/spanning_tree/portfast/bpdu_filter (empty)
    """
    return self.__bpdu_filter
      
  def _set_bpdu_filter(self, v, load=False):
    """
    Setter method for bpdu_filter, mapped from YANG variable /interface/gigabitethernet/spanning_tree/portfast/bpdu_filter (empty)
    If this variable is read-only (config: false) in the
