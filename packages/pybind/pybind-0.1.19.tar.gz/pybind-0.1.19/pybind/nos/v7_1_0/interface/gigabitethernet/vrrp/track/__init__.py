...
class track(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/vrrp/track. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'vrrp', u'track']
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /interface/gigabitethernet/vrrp/track/interface (list)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /interface/gigabitethernet/vrrp/track/interface (list)
