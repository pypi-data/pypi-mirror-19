...
class pim(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/ip/pim-intf-phy-cont/pim-int-cmd/pim. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__neighbor_filter','__dr_priority','__multinet',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__multinet = YANGDynClass(base=multinet.multinet, is_container='container', yang_name="multinet", rest_name="multinet", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure multinet', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'ip', u'pim-intf-phy-cont', u'pim-int-cmd', u'pim']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'HundredGigabitEthernet', u'ip', u'pim']

  def _get_neighbor_filter(self):
    """
    Getter method for neighbor_filter, mapped from YANG variable /interface/hundredgigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/neighbor_filter (ip-prefix-name-t)
    """
    return self.__neighbor_filter
      
  def _set_neighbor_filter(self, v, load=False):
    """
    Setter method for neighbor_filter, mapped from YANG variable /interface/hundredgigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/neighbor_filter (ip-prefix-name-t)
  ...
  def _get_dr_priority(self):
    """
    Getter method for dr_priority, mapped from YANG variable /interface/hundredgigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/dr_priority (uint32)
    """
    return self.__dr_priority
      
  def _set_dr_priority(self, v, load=False):
    """
    Setter method for dr_priority, mapped from YANG variable /interface/hundredgigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/dr_priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_multinet(self):
    """
    Getter method for multinet, mapped from YANG variable /interface/hundredgigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/multinet (container)
    """
    return self.__multinet
      
  def _set_multinet(self, v, load=False):
    """
    Setter method for multinet, mapped from YANG variable /interface/hundredgigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/multinet (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_multinet is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_multinet() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=multinet.multinet, is_container='container', yang_name="multinet", rest_name="multinet", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure multinet', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """multinet must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=multinet.multinet, is_container='container', yang_name="multinet", rest_name="multinet", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure multinet', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)""",
        })
  ...
  multinet = __builtin__.property(_get_multinet, _set_multinet)


  _pyangbind_elements = {'neighbor_filter': neighbor_filter, 'dr_priority': dr_priority, 'multinet': multinet, }
