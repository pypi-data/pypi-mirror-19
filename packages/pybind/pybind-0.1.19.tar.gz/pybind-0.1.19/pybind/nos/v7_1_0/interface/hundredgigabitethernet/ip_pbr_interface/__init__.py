...
import __builtin__
import ip
class ip_pbr_interface(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/ip-pbr-interface. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ip',)

  _yang_name = 'ip-pbr-interface'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'ip-pbr-interface']
  ...
  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /interface/hundredgigabitethernet/ip_pbr_interface/ip (container)
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /interface/hundredgigabitethernet/ip_pbr_interface/ip (container)
