...
class ip(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/ip-pbr-interface/ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'ip-pbr-interface', u'ip']
  ...
  def _get_policy(self):
    """
    Getter method for policy, mapped from YANG variable /interface/hundredgigabitethernet/ip_pbr_interface/ip/policy (container)
  ...
  def _set_policy(self, v, load=False):
    """
    Setter method for policy, mapped from YANG variable /interface/hundredgigabitethernet/ip_pbr_interface/ip/policy (container)
