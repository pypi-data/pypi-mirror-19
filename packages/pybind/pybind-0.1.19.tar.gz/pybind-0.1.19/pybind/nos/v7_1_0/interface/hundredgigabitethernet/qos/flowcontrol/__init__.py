...
class flowcontrol(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/qos/flowcontrol. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'qos', u'flowcontrol']
  ...
  def _get_link_level_flowcontrol(self):
    """
    Getter method for link_level_flowcontrol, mapped from YANG variable /interface/hundredgigabitethernet/qos/flowcontrol/link_level_flowcontrol (container)
    """
    return self.__link_level_flowcontrol
      
  def _set_link_level_flowcontrol(self, v, load=False):
    """
    Setter method for link_level_flowcontrol, mapped from YANG variable /interface/hundredgigabitethernet/qos/flowcontrol/link_level_flowcontrol (container)
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=link_level_flowcontrol.link_level_flowcontrol, is_container='container', yang_name="link-level-flowcontrol", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-qos', defining_module='brocade-qos', yang_type='container', is_config=True)""",
        })
  ...
  def _get_pfc(self):
    """
    Getter method for pfc, mapped from YANG variable /interface/hundredgigabitethernet/qos/flowcontrol/pfc (list)
    """
    return self.__pfc
      
  def _set_pfc(self, v, load=False):
    """
    Setter method for pfc, mapped from YANG variable /interface/hundredgigabitethernet/qos/flowcontrol/pfc (list)
    If this variable is read-only (config: false) in the
