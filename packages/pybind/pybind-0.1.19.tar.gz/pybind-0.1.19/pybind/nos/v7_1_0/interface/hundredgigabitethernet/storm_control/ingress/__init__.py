...
class ingress(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/storm-control/ingress. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__rate_percent = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'0 .. 100']}), is_leaf=True, yang_name="rate-percent", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'display-when': u"../rate-format = 'limit-percent'"}}, namespace='urn:brocade.com:mgmt:brocade-bum-storm-control', defining_module='brocade-bum-storm-control', yang_type='percentage-rate-limit', is_config=True)
    ...
    self.__rate_format = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'limit-bps': {'value': 1}, u'limit-percent': {'value': 2}},), is_leaf=True, yang_name="rate-format", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-bum-storm-control', defining_module='brocade-bum-storm-control', yang_type='enumeration', is_config=True)
    self.__rate_bps = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), restriction_dict={'range': [u'0 .. 100000000000']}), is_leaf=True, yang_name="rate-bps", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'display-when': u"../rate-format = 'limit-bps'", u'cli-completion-actionpoint': u'storm-control-show-action-point'}}, namespace='urn:brocade.com:mgmt:brocade-bum-storm-control', defining_module='brocade-bum-storm-control', yang_type='bps-rate-limit', is_config=True)
    self.__protocol_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'broadcast': {'value': 1}, u'unknown-unicast': {'value': 3}, u'multicast': {'value': 2}},), is_leaf=True, yang_name="protocol-type", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bum-storm-control', defining_module='brocade-bum-storm-control', yang_type='enumeration', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'storm-control', u'ingress']
  ...
  def _get_protocol_type(self):
    """
    Getter method for protocol_type, mapped from YANG variable /interface/hundredgigabitethernet/storm_control/ingress/protocol_type (enumeration)
    """
    return self.__protocol_type
      
  def _set_protocol_type(self, v, load=False):
    """
    Setter method for protocol_type, mapped from YANG variable /interface/hundredgigabitethernet/storm_control/ingress/protocol_type (enumeration)
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'broadcast': {'value': 1}, u'unknown-unicast': {'value': 3}, u'multicast': {'value': 2}},), is_leaf=True, yang_name="protocol-type", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bum-storm-control', defining_module='brocade-bum-storm-control', yang_type='enumeration', is_config=True)""",
        })
  ...
  def _get_rate_format(self):
    """
    Getter method for rate_format, mapped from YANG variable /interface/hundredgigabitethernet/storm_control/ingress/rate_format (enumeration)
    """
    return self.__rate_format
      
  def _set_rate_format(self, v, load=False):
    """
    Setter method for rate_format, mapped from YANG variable /interface/hundredgigabitethernet/storm_control/ingress/rate_format (enumeration)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "brocade-bum-storm-control:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'limit-bps': {'value': 1}, u'limit-percent': {'value': 2}},), is_leaf=True, yang_name="rate-format", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-bum-storm-control', defining_module='brocade-bum-storm-control', yang_type='enumeration', is_config=True)""",
        })
  ...
  def _get_rate_bps(self):
    """
    Getter method for rate_bps, mapped from YANG variable /interface/hundredgigabitethernet/storm_control/ingress/rate_bps (bps-rate-limit)
    """
    return self.__rate_bps
      
  def _set_rate_bps(self, v, load=False):
    """
    Setter method for rate_bps, mapped from YANG variable /interface/hundredgigabitethernet/storm_control/ingress/rate_bps (bps-rate-limit)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), restriction_dict={'range': [u'0 .. 100000000000']}), is_leaf=True, yang_name="rate-bps", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'display-when': u"../rate-format = 'limit-bps'", u'cli-completion-actionpoint': u'storm-control-show-action-point'}}, namespace='urn:brocade.com:mgmt:brocade-bum-storm-control', defining_module='brocade-bum-storm-control', yang_type='bps-rate-limit', is_config=True)""",
        })
  ...
  def _get_rate_percent(self):
    """
    Getter method for rate_percent, mapped from YANG variable /interface/hundredgigabitethernet/storm_control/ingress/rate_percent (percentage-rate-limit)
    """
    return self.__rate_percent
      
  def _set_rate_percent(self, v, load=False):
    """
    Setter method for rate_percent, mapped from YANG variable /interface/hundredgigabitethernet/storm_control/ingress/rate_percent (percentage-rate-limit)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'0 .. 100']}), is_leaf=True, yang_name="rate-percent", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'display-when': u"../rate-format = 'limit-percent'"}}, namespace='urn:brocade.com:mgmt:brocade-bum-storm-control', defining_module='brocade-bum-storm-control', yang_type='percentage-rate-limit', is_config=True)""",
        })
  ...
  def _get_bum_action(self):
    """
    Getter method for bum_action, mapped from YANG variable /interface/hundredgigabitethernet/storm_control/ingress/bum_action (enumeration)
    """
    return self.__bum_action
      
  def _set_bum_action(self, v, load=False):
    """
    Setter method for bum_action, mapped from YANG variable /interface/hundredgigabitethernet/storm_control/ingress/bum_action (enumeration)
    If this variable is read-only (config: false) in the
