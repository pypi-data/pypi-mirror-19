...
class vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'vlan']
  ...
  def _get_classifier(self):
    """
    Getter method for classifier, mapped from YANG variable /interface/hundredgigabitethernet/vlan/classifier (container)
    """
    return self.__classifier
      
  def _set_classifier(self, v, load=False):
    """
    Setter method for classifier, mapped from YANG variable /interface/hundredgigabitethernet/vlan/classifier (container)
