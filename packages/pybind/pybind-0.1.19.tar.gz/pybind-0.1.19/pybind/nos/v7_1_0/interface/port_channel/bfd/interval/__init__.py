...
class interval(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/bfd/interval. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'bfd', u'interval']
  ...
  def _get_min_tx(self):
    """
    Getter method for min_tx, mapped from YANG variable /interface/port_channel/bfd/interval/min_tx (bfd-tx-interval-type)
  ...
  def _set_min_tx(self, v, load=False):
    """
    Setter method for min_tx, mapped from YANG variable /interface/port_channel/bfd/interval/min_tx (bfd-tx-interval-type)
  ...
  def _get_min_rx(self):
    """
    Getter method for min_rx, mapped from YANG variable /interface/port_channel/bfd/interval/min_rx (bfd-rx-interval-type)
  ...
  def _set_min_rx(self, v, load=False):
    """
    Setter method for min_rx, mapped from YANG variable /interface/port_channel/bfd/interval/min_rx (bfd-rx-interval-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_multiplier(self):
    """
    Getter method for multiplier, mapped from YANG variable /interface/port_channel/bfd/interval/multiplier (bfd-multiplier-type)
  ...
  def _set_multiplier(self, v, load=False):
    """
    Setter method for multiplier, mapped from YANG variable /interface/port_channel/bfd/interval/multiplier (bfd-multiplier-type)
    If this variable is read-only (config: false) in the
