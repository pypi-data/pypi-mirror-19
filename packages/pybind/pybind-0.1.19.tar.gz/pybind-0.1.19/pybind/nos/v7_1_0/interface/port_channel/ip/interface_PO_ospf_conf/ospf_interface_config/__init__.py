...
class ospf_interface_config(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/interface-PO-ospf-conf/ospf-interface-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'interface-PO-ospf-conf', u'ospf-interface-config']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'ip', u'ospf']

  def _get_area(self):
    """
    Getter method for area, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/area (ospf-area-id)
    """
    return self.__area
      
  def _set_area(self, v, load=False):
    """
    Setter method for area, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/area (ospf-area-id)
  ...
  def _get_auth_change_wait_time(self):
    """
    Getter method for auth_change_wait_time, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/auth_change_wait_time (common-def:time-interval-sec)
    """
    return self.__auth_change_wait_time
      
  def _set_auth_change_wait_time(self, v, load=False):
    """
    Setter method for auth_change_wait_time, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/auth_change_wait_time (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
  ...
  def _get_authentication_key(self):
    """
    Getter method for authentication_key, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/authentication_key (container)
    """
    return self.__authentication_key
      
  def _set_authentication_key(self, v, load=False):
    """
    Setter method for authentication_key, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/authentication_key (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_dead_interval(self):
    """
    Getter method for dead_interval, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/dead_interval (common-def:time-interval-sec)
    """
    return self.__dead_interval
      
  def _set_dead_interval(self, v, load=False):
    """
    Setter method for dead_interval, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/dead_interval (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
  ...
  def _get_hello_interval(self):
    """
    Getter method for hello_interval, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/hello_interval (common-def:time-interval-sec)
    """
    return self.__hello_interval
      
  def _set_hello_interval(self, v, load=False):
    """
    Setter method for hello_interval, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/hello_interval (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
  ...
  def _get_retransmit_interval(self):
    """
    Getter method for retransmit_interval, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/retransmit_interval (common-def:time-interval-sec)
    """
    return self.__retransmit_interval
      
  def _set_retransmit_interval(self, v, load=False):
    """
    Setter method for retransmit_interval, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/retransmit_interval (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
  ...
  def _get_transmit_delay(self):
    """
    Getter method for transmit_delay, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/transmit_delay (common-def:time-interval-sec)
    """
    return self.__transmit_delay
      
  def _set_transmit_delay(self, v, load=False):
    """
    Setter method for transmit_delay, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/transmit_delay (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
  ...
  def _get_md5_authentication(self):
    """
    Getter method for md5_authentication, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/md5_authentication (container)
    """
    return self.__md5_authentication
      
  def _set_md5_authentication(self, v, load=False):
    """
    Setter method for md5_authentication, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/md5_authentication (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_cost(self):
    """
    Getter method for cost, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/cost (uint32)
    """
    return self.__cost
      
  def _set_cost(self, v, load=False):
    """
    Setter method for cost, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/cost (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_database_filter(self):
    """
    Getter method for database_filter, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/database_filter (container)
    """
    return self.__database_filter
      
  def _set_database_filter(self, v, load=False):
    """
    Setter method for database_filter, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/database_filter (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_mtu_ignore(self):
    """
    Getter method for mtu_ignore, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/mtu_ignore (empty)
    """
    return self.__mtu_ignore
      
  def _set_mtu_ignore(self, v, load=False):
    """
    Setter method for mtu_ignore, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/mtu_ignore (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_network(self):
    """
    Getter method for network, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/network (enumeration)
    """
    return self.__network
      
  def _set_network(self, v, load=False):
    """
    Setter method for network, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/network (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_active(self):
    """
    Getter method for active, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/active (empty)
    """
    return self.__active
      
  def _set_active(self, v, load=False):
    """
    Setter method for active, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/active (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_passive(self):
    """
    Getter method for passive, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/passive (empty)
    """
    return self.__passive
      
  def _set_passive(self, v, load=False):
    """
    Setter method for passive, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/passive (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_priority(self):
    """
    Getter method for priority, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/priority (uint32)
    """
    return self.__priority
      
  def _set_priority(self, v, load=False):
    """
    Setter method for priority, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_bfd(self):
    """
    Getter method for bfd, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/bfd (container)
  ...
  def _set_bfd(self, v, load=False):
    """
    Setter method for bfd, mapped from YANG variable /interface/port_channel/ip/interface_PO_ospf_conf/ospf_interface_config/bfd (container)
    If this variable is read-only (config: false) in the
