...
class relay(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/interface-po-dhcp-conf/dhcp/relay. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'interface-po-dhcp-conf', u'dhcp', u'relay']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'ip', u'dhcp', u'relay']

  def _get_servers(self):
    """
    Getter method for servers, mapped from YANG variable /interface/port_channel/ip/interface_po_dhcp_conf/dhcp/relay/servers (list)
    """
    return self.__servers
      
  def _set_servers(self, v, load=False):
    """
    Setter method for servers, mapped from YANG variable /interface/port_channel/ip/interface_po_dhcp_conf/dhcp/relay/servers (list)
  ...
  def _get_gateway(self):
    """
    Getter method for gateway, mapped from YANG variable /interface/port_channel/ip/interface_po_dhcp_conf/dhcp/relay/gateway (dhcp-ipv4-address)
  ...
  def _set_gateway(self, v, load=False):
    """
    Setter method for gateway, mapped from YANG variable /interface/port_channel/ip/interface_po_dhcp_conf/dhcp/relay/gateway (dhcp-ipv4-address)
    If this variable is read-only (config: false) in the
