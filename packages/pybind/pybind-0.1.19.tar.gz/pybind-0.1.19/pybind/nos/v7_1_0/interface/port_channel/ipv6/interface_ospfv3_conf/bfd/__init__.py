...
class bfd(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ipv6/interface-ospfv3-conf/bfd. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ipv6', u'interface-ospfv3-conf', u'bfd']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'ipv6', u'ospf', u'bfd']

  def _get_bfd_enable(self):
    """
    Getter method for bfd_enable, mapped from YANG variable /interface/port_channel/ipv6/interface_ospfv3_conf/bfd/bfd_enable (empty)
  ...
  def _set_bfd_enable(self, v, load=False):
    """
    Setter method for bfd_enable, mapped from YANG variable /interface/port_channel/ipv6/interface_ospfv3_conf/bfd/bfd_enable (empty)
