...
class retry(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ipv6/ipv6-nd-ra/ipv6-intf-cmds/nd/nud/retry. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ipv6', u'ipv6-nd-ra', u'ipv6-intf-cmds', u'nd', u'nud', u'retry']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'ipv6', u'nd', u'nud', u'retry']

  def _get_base(self):
    """
    Getter method for base, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/nud/retry/base (int32)
    """
    return self.__base
      
  def _set_base(self, v, load=False):
    """
    Setter method for base, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/nud/retry/base (int32)
  ...
  def _get_interval(self):
    """
    Getter method for interval, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/nud/retry/interval (common-def:time-interval-msec)
    """
    return self.__interval
      
  def _set_interval(self, v, load=False):
    """
    Setter method for interval, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/nud/retry/interval (common-def:time-interval-msec)
    If this variable is read-only (config: false) in the
  ...
  def _get_max_attempts(self):
    """
    Getter method for max_attempts, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/nud/retry/max_attempts (int32)
    """
    return self.__max_attempts
      
  def _set_max_attempts(self, v, load=False):
    """
    Setter method for max_attempts, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/nud/retry/max_attempts (int32)
    If this variable is read-only (config: false) in the
