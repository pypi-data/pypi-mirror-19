...
class spanning_tree(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/spanning-tree. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__autoedge','__cost','__portfast','__edgeport','__guard','__hello_time','__bpdu_mac','__link_type','__priority','__restricted_role','__restricted_tcn','__shutdown','__vlan','__instance','__peer_switch',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__peer_switch = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="peer-switch", rest_name="peer-switch", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Enable Peer-switch configuration', u'display-when': u'((/protocol/spanning-tree/stp) or(/protocol/spanning-tree/rstp) or (/protocol/spanning-tree/mstp) or (/protocol/spanning-tree/pvst) or (/protocol/spanning-tree/rpvst)) ', u'cli-full-no': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='empty', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'spanning-tree']
  ...
  def _get_autoedge(self):
    """
    Getter method for autoedge, mapped from YANG variable /interface/port_channel/spanning_tree/autoedge (empty)
    """
    return self.__autoedge
      
  def _set_autoedge(self, v, load=False):
    """
    Setter method for autoedge, mapped from YANG variable /interface/port_channel/spanning_tree/autoedge (empty)
  ...
  def _get_cost(self):
    """
    Getter method for cost, mapped from YANG variable /interface/port_channel/spanning_tree/cost (uint32)
    """
    return self.__cost
      
  def _set_cost(self, v, load=False):
    """
    Setter method for cost, mapped from YANG variable /interface/port_channel/spanning_tree/cost (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_portfast(self):
    """
    Getter method for portfast, mapped from YANG variable /interface/port_channel/spanning_tree/portfast (container)
    """
  ...
  def _set_portfast(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=portfast.portfast, is_container='container', yang_name="portfast", rest_name="portfast", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Enable an interface to move directly to forwarding on link up', u'display-when': u' ((/protocol/spanning-tree/stp) or (/protocol/spanning-tree/pvst))'}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """portfast must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=portfast.portfast, is_container='container', yang_name="portfast", rest_name="portfast", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Enable an interface to move directly to forwarding on link up', u'display-when': u' ((/protocol/spanning-tree/stp) or (/protocol/spanning-tree/pvst))'}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='container', is_config=True)""",
        })
  ...
  def _get_edgeport(self):
    """
    Getter method for edgeport, mapped from YANG variable /interface/port_channel/spanning_tree/edgeport (container)
    """
  ...
  def _set_edgeport(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=edgeport.edgeport, is_container='container', yang_name="edgeport", rest_name="edgeport", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Edgeport', u'display-when': u'((/protocol/spanning-tree/rstp) or (/protocol/spanning-tree/mstp) or (/protocol/spanning-tree/rpvst)) '}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """edgeport must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=edgeport.edgeport, is_container='container', yang_name="edgeport", rest_name="edgeport", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Edgeport', u'display-when': u'((/protocol/spanning-tree/rstp) or (/protocol/spanning-tree/mstp) or (/protocol/spanning-tree/rpvst)) '}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='container', is_config=True)""",
        })
  ...
  def _get_guard(self):
    """
    Getter method for guard, mapped from YANG variable /interface/port_channel/spanning_tree/guard (container)
    """
    return self.__guard
  ...
  def _set_guard(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=guard.guard, is_container='container', yang_name="guard", rest_name="guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u"Change an interface's spanning tree guard mode", u'display-when': u'((/protocol/spanning-tree/stp) or(/protocol/spanning-tree/rstp))', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """guard must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=guard.guard, is_container='container', yang_name="guard", rest_name="guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u"Change an interface's spanning tree guard mode", u'display-when': u'((/protocol/spanning-tree/stp) or(/protocol/spanning-tree/rstp))', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='container', is_config=True)""",
        })
  ...
  def _get_hello_time(self):
    """
    Getter method for hello_time, mapped from YANG variable /interface/port_channel/spanning_tree/hello_time (uint32)
    """
    return self.__hello_time
      
  def _set_hello_time(self, v, load=False):
    """
    Setter method for hello_time, mapped from YANG variable /interface/port_channel/spanning_tree/hello_time (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_bpdu_mac(self):
    """
    Getter method for bpdu_mac, mapped from YANG variable /interface/port_channel/spanning_tree/bpdu_mac (enumeration)
    """
    return self.__bpdu_mac
      
  def _set_bpdu_mac(self, v, load=False):
    """
    Setter method for bpdu_mac, mapped from YANG variable /interface/port_channel/spanning_tree/bpdu_mac (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_link_type(self):
    """
    Getter method for link_type, mapped from YANG variable /interface/port_channel/spanning_tree/link_type (enumeration)
    """
    return self.__link_type
      
  def _set_link_type(self, v, load=False):
    """
    Setter method for link_type, mapped from YANG variable /interface/port_channel/spanning_tree/link_type (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_priority(self):
    """
    Getter method for priority, mapped from YANG variable /interface/port_channel/spanning_tree/priority (uint32)
    """
    return self.__priority
      
  def _set_priority(self, v, load=False):
    """
    Setter method for priority, mapped from YANG variable /interface/port_channel/spanning_tree/priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_restricted_role(self):
    """
    Getter method for restricted_role, mapped from YANG variable /interface/port_channel/spanning_tree/restricted_role (empty)
    """
    return self.__restricted_role
      
  def _set_restricted_role(self, v, load=False):
    """
    Setter method for restricted_role, mapped from YANG variable /interface/port_channel/spanning_tree/restricted_role (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_restricted_tcn(self):
    """
    Getter method for restricted_tcn, mapped from YANG variable /interface/port_channel/spanning_tree/restricted_tcn (empty)
    """
    return self.__restricted_tcn
      
  def _set_restricted_tcn(self, v, load=False):
    """
    Setter method for restricted_tcn, mapped from YANG variable /interface/port_channel/spanning_tree/restricted_tcn (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_shutdown(self):
    """
    Getter method for shutdown, mapped from YANG variable /interface/port_channel/spanning_tree/shutdown (empty)
    """
    return self.__shutdown
      
  def _set_shutdown(self, v, load=False):
    """
    Setter method for shutdown, mapped from YANG variable /interface/port_channel/spanning_tree/shutdown (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/port_channel/spanning_tree/vlan (list)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/port_channel/spanning_tree/vlan (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_instance(self):
    """
    Getter method for instance, mapped from YANG variable /interface/port_channel/spanning_tree/instance (list)
    """
  ...
  def _get_peer_switch(self):
    """
    Getter method for peer_switch, mapped from YANG variable /interface/port_channel/spanning_tree/peer_switch (empty)
    """
    return self.__peer_switch
      
  def _set_peer_switch(self, v, load=False):
    """
    Setter method for peer_switch, mapped from YANG variable /interface/port_channel/spanning_tree/peer_switch (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_peer_switch is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_peer_switch() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="peer-switch", rest_name="peer-switch", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Enable Peer-switch configuration', u'display-when': u'((/protocol/spanning-tree/stp) or(/protocol/spanning-tree/rstp) or (/protocol/spanning-tree/mstp) or (/protocol/spanning-tree/pvst) or (/protocol/spanning-tree/rpvst)) ', u'cli-full-no': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='empty', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """peer_switch must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="peer-switch", rest_name="peer-switch", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Enable Peer-switch configuration', u'display-when': u'((/protocol/spanning-tree/stp) or(/protocol/spanning-tree/rstp) or (/protocol/spanning-tree/mstp) or (/protocol/spanning-tree/pvst) or (/protocol/spanning-tree/rpvst)) ', u'cli-full-no': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='empty', is_config=True)""",
        })

    self.__peer_switch = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_peer_switch(self):
    self.__peer_switch = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="peer-switch", rest_name="peer-switch", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Enable Peer-switch configuration', u'display-when': u'((/protocol/spanning-tree/stp) or(/protocol/spanning-tree/rstp) or (/protocol/spanning-tree/mstp) or (/protocol/spanning-tree/pvst) or (/protocol/spanning-tree/rpvst)) ', u'cli-full-no': None}}, namespace='urn:brocade.com:mgmt:brocade-xstp', defining_module='brocade-xstp', yang_type='empty', is_config=True)
  ...
  peer_switch = __builtin__.property(_get_peer_switch, _set_peer_switch)


  _pyangbind_elements = {'autoedge': autoedge, 'cost': cost, 'portfast': portfast, 'edgeport': edgeport, 'guard': guard, 'hello_time': hello_time, 'bpdu_mac': bpdu_mac, 'link_type': link_type, 'priority': priority, 'restricted_role': restricted_role, 'restricted_tcn': restricted_tcn, 'shutdown': shutdown, 'vlan': vlan, 'instance': instance, 'peer_switch': peer_switch, }
