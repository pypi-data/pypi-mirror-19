...
class bpdu_drop(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/bpdu-drop. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'bpdu-drop']
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /interface/tengigabitethernet/bpdu_drop/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /interface/tengigabitethernet/bpdu_drop/enable (empty)
  ...
  def _get_direction(self):
    """
    Getter method for direction, mapped from YANG variable /interface/tengigabitethernet/bpdu_drop/direction (enumeration)
    """
    return self.__direction
      
  def _set_direction(self, v, load=False):
    """
    Setter method for direction, mapped from YANG variable /interface/tengigabitethernet/bpdu_drop/direction (enumeration)
    If this variable is read-only (config: false) in the
