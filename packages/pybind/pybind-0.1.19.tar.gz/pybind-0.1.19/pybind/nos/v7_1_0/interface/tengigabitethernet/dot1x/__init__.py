...
class dot1x(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/dot1x. Each member element of
...
elements.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'dot1x']
  ...
  def _get_authentication(self):
    """
    Getter method for authentication, mapped from YANG variable /interface/tengigabitethernet/dot1x/authentication (empty)
...
is enabled on the port.
  ...
  def _set_authentication(self, v, load=False):
    """
    Setter method for authentication, mapped from YANG variable /interface/tengigabitethernet/dot1x/authentication (empty)
...
is enabled on the port.
  ...
  def _get_port_control(self):
    """
    Getter method for port_control, mapped from YANG variable /interface/tengigabitethernet/dot1x/port_control (enumeration)
...
authenticate.
  ...
  def _set_port_control(self, v, load=False):
    """
    Setter method for port_control, mapped from YANG variable /interface/tengigabitethernet/dot1x/port_control (enumeration)
    If this variable is read-only (config: false) in the
...
authenticate.
  ...
  def _get_protocol_version(self):
    """
    Getter method for protocol_version, mapped from YANG variable /interface/tengigabitethernet/dot1x/protocol_version (uint32)
...
Protocol version.
  ...
  def _set_protocol_version(self, v, load=False):
    """
    Setter method for protocol_version, mapped from YANG variable /interface/tengigabitethernet/dot1x/protocol_version (uint32)
    If this variable is read-only (config: false) in the
...
Protocol version.
  ...
  def _get_quiet_period(self):
    """
    Getter method for quiet_period, mapped from YANG variable /interface/tengigabitethernet/dot1x/quiet_period (uint32)
...
again. 
  ...
  def _set_quiet_period(self, v, load=False):
    """
    Setter method for quiet_period, mapped from YANG variable /interface/tengigabitethernet/dot1x/quiet_period (uint32)
    If this variable is read-only (config: false) in the
...
again. 
  ...
  def _get_reauthMax(self):
    """
    Getter method for reauthMax, mapped from YANG variable /interface/tengigabitethernet/dot1x/reauthMax (uint32)
...
attempts before becoming unauthorized.
  ...
  def _set_reauthMax(self, v, load=False):
    """
    Setter method for reauthMax, mapped from YANG variable /interface/tengigabitethernet/dot1x/reauthMax (uint32)
    If this variable is read-only (config: false) in the
...
attempts before becoming unauthorized.
  ...
  def _get_reauthentication(self):
    """
    Getter method for reauthentication, mapped from YANG variable /interface/tengigabitethernet/dot1x/reauthentication (empty)
...
re-authentication should be done.
  ...
  def _set_reauthentication(self, v, load=False):
    """
    Setter method for reauthentication, mapped from YANG variable /interface/tengigabitethernet/dot1x/reauthentication (empty)
    If this variable is read-only (config: false) in the
...
re-authentication should be done.
  ...
  def _get_mac_auth_bypass(self):
    """
    Getter method for mac_auth_bypass, mapped from YANG variable /interface/tengigabitethernet/dot1x/mac_auth_bypass (empty)
  ...
  def _set_mac_auth_bypass(self, v, load=False):
    """
    Setter method for mac_auth_bypass, mapped from YANG variable /interface/tengigabitethernet/dot1x/mac_auth_bypass (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_mac_auth_enable(self):
    """
    Getter method for mac_auth_enable, mapped from YANG variable /interface/tengigabitethernet/dot1x/mac_auth_enable (empty)
  ...
  def _set_mac_auth_enable(self, v, load=False):
    """
    Setter method for mac_auth_enable, mapped from YANG variable /interface/tengigabitethernet/dot1x/mac_auth_enable (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_timeout(self):
    """
    Getter method for timeout, mapped from YANG variable /interface/tengigabitethernet/dot1x/timeout (container)
...
configuration elements.
  ...
  def _set_timeout(self, v, load=False):
    """
    Setter method for timeout, mapped from YANG variable /interface/tengigabitethernet/dot1x/timeout (container)
    If this variable is read-only (config: false) in the
