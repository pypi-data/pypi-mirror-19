...
class authentication_key(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ip/interface-te-ospf-conf/ospf-interface-config/authentication-key. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ip', u'interface-te-ospf-conf', u'ospf-interface-config', u'authentication-key']
  ...
  def _get_no_encrypt_auth_key_table(self):
    """
    Getter method for no_encrypt_auth_key_table, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/authentication_key/no_encrypt_auth_key_table (container)
    """
    return self.__no_encrypt_auth_key_table
      
  def _set_no_encrypt_auth_key_table(self, v, load=False):
    """
    Setter method for no_encrypt_auth_key_table, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/authentication_key/no_encrypt_auth_key_table (container)
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=no_encrypt_auth_key_table.no_encrypt_auth_key_table, is_container='container', yang_name="no-encrypt-auth-key-table", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
  ...
  def _get_auth_key_table(self):
    """
    Getter method for auth_key_table, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/authentication_key/auth_key_table (container)
    """
    return self.__auth_key_table
      
  def _set_auth_key_table(self, v, load=False):
    """
    Setter method for auth_key_table, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/authentication_key/auth_key_table (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=auth_key_table.auth_key_table, is_container='container', yang_name="auth-key-table", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
