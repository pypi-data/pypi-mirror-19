...
class pim_int_cmd(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ip/pim-intf-phy-cont/pim-int-cmd. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ip', u'pim-intf-phy-cont', u'pim-int-cmd']
  ...
  def _get_pim_sparse(self):
    """
    Getter method for pim_sparse, mapped from YANG variable /interface/tengigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim_sparse (empty)
    """
    return self.__pim_sparse
      
  def _set_pim_sparse(self, v, load=False):
    """
    Setter method for pim_sparse, mapped from YANG variable /interface/tengigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim_sparse (empty)
  ...
  def _get_pim(self):
    """
    Getter method for pim, mapped from YANG variable /interface/tengigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim (container)
    """
    return self.__pim
      
  def _set_pim(self, v, load=False):
    """
    Setter method for pim, mapped from YANG variable /interface/tengigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_mcast_bdry_prefix_list(self):
    """
    Getter method for mcast_bdry_prefix_list, mapped from YANG variable /interface/tengigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/mcast_bdry_prefix_list (ip-prefix-name-t)
    """
    return self.__mcast_bdry_prefix_list
      
  def _set_mcast_bdry_prefix_list(self, v, load=False):
    """
    Setter method for mcast_bdry_prefix_list, mapped from YANG variable /interface/tengigabitethernet/ip/pim_intf_phy_cont/pim_int_cmd/mcast_bdry_prefix_list (ip-prefix-name-t)
    If this variable is read-only (config: false) in the
