...
class ipv6_intf_cmds(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ipv6/ipv6-nd-ra/ipv6-intf-cmds. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ipv6', u'ipv6-nd-ra', u'ipv6-intf-cmds']
  ...
  def _get_vrrp_suppress_interface_ra(self):
    """
    Getter method for vrrp_suppress_interface_ra, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/vrrp_suppress_interface_ra (empty)
    """
    return self.__vrrp_suppress_interface_ra
      
  def _set_vrrp_suppress_interface_ra(self, v, load=False):
    """
    Setter method for vrrp_suppress_interface_ra, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/vrrp_suppress_interface_ra (empty)
  ...
  def _get_nd(self):
    """
    Getter method for nd, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd (container)
    """
    return self.__nd
      
  def _set_nd(self, v, load=False):
    """
    Setter method for nd, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_neighbor(self):
    """
    Getter method for neighbor, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/neighbor (list)
    """
    return self.__neighbor
      
  def _set_neighbor(self, v, load=False):
    """
    Setter method for neighbor, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/neighbor (list)
    If this variable is read-only (config: false) in the
