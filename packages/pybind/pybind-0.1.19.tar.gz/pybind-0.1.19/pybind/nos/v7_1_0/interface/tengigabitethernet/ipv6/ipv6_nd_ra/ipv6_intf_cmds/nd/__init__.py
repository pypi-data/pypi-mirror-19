...
class nd(PybindBase):
  ...
  def _get_set_hoplimit(self):
    """
    Getter method for set_hoplimit, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/set_hoplimit (uint32)
    """
    return self.__set_hoplimit
      
  def _set_set_hoplimit(self, v, load=False):
    """
    Setter method for set_hoplimit, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/set_hoplimit (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_set_cache_expire_time(self):
    """
    Getter method for set_cache_expire_time, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/set_cache_expire_time (common-def:time-interval-sec)
    """
    return self.__set_cache_expire_time
      
  def _set_set_cache_expire_time(self, v, load=False):
    """
    Setter method for set_cache_expire_time, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/set_cache_expire_time (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
