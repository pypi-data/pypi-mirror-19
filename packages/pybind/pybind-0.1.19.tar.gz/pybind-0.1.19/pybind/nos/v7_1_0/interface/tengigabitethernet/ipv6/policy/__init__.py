...
class policy(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ipv6/policy. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ipv6', u'policy']
  ...
  def _get_route_map(self):
    """
    Getter method for route_map, mapped from YANG variable /interface/tengigabitethernet/ipv6/policy/route_map (container)
  ...
  def _set_route_map(self, v, load=False):
    """
    Setter method for route_map, mapped from YANG variable /interface/tengigabitethernet/ipv6/policy/route_map (container)
