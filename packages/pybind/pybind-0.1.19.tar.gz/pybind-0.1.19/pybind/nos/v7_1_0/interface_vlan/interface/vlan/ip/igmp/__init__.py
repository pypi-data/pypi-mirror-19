...
class igmp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__last_member_query_interval','__query_interval','__query_max_response_time','__last_member_query_count','__startup_query_count','__startup_query_interval','__robustness_variable','__snooping','__static_group',)
