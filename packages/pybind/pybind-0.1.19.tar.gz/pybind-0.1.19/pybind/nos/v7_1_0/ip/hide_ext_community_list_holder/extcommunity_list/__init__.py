...
class extcommunity_list(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__extcommunity_list_num','__ext_community_action','__ext_community_regex','__ext_community_expr',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__ext_community_regex = YANGDynClass(base=unicode, is_leaf=True, yang_name="ext-community-regex", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Filter regular expression.', u'cli-drop-node-name': None, u'display-when': u'../extcommunity-list-num > 99', u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='extcommunity-list-reg-expr-t', is_config=True)
  ...
  def _set_extcommunity_list_num(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={'range': [u'0..500']}), is_leaf=True, yang_name="extcommunity-list-num", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-full-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='extcommunitylist-instance', is_config=True)
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={'range': [u'0..500']}), is_leaf=True, yang_name="extcommunity-list-num", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-full-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='extcommunitylist-instance', is_config=True)""",
        })
  ...
  def _get_ext_community_regex(self):
    """
    Getter method for ext_community_regex, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list/ext_community_regex (extcommunity-list-reg-expr-t)
    """
    return self.__ext_community_regex
      
  def _set_ext_community_regex(self, v, load=False):
    """
    Setter method for ext_community_regex, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list/ext_community_regex (extcommunity-list-reg-expr-t)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'extcommunity_list_num': extcommunity_list_num, 'ext_community_action': ext_community_action, 'ext_community_regex': ext_community_regex, 'ext_community_expr': ext_community_expr, }
