...
class rstp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__system_id','__description','__bridge_priority','__error_disable_timeout','__forward_delay','__max_age','__port_channel','__shutdown','__hello_time','__transmit_holdcount',)
  ...
  def _get_system_id(self):
    """
    Getter method for system_id, mapped from YANG variable /protocol/spanning_tree/rstp/system_id (container)
    """
    return self.__system_id
      
  def _set_system_id(self, v, load=False):
    """
    Setter method for system_id, mapped from YANG variable /protocol/spanning_tree/rstp/system_id (container)
  ...
  _pyangbind_elements = {'system_id': system_id, 'description': description, 'bridge_priority': bridge_priority, 'error_disable_timeout': error_disable_timeout, 'forward_delay': forward_delay, 'max_age': max_age, 'port_channel': port_channel, 'shutdown': shutdown, 'hello_time': hello_time, 'transmit_holdcount': transmit_holdcount, }
