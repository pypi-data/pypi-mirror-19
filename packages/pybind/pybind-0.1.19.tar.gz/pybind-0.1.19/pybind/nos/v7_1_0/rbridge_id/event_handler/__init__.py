...
class event_handler(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/event-handler. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__activate = YANGDynClass(base=activate.activate, is_container='container', yang_name="activate", rest_name="activate", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-event-handler', defining_module='brocade-event-handler', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'event-handler']
  ...
  def _get_activate(self):
    """
    Getter method for activate, mapped from YANG variable /rbridge_id/event_handler/activate (container)
    """
    return self.__activate
      
  def _set_activate(self, v, load=False):
    """
    Setter method for activate, mapped from YANG variable /rbridge_id/event_handler/activate (container)
