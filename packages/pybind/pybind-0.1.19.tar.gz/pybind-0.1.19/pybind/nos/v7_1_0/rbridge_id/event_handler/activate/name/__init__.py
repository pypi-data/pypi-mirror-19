...
class name(PybindBase):
  ...
  def _set_trigger_function(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=trigger_function.trigger_function, is_container='container', yang_name="trigger-function", rest_name="trigger-function", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Trigger-function controls how multiple triggers are interpreted to launch the action (default = OR).', u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-event-handler', defining_module='brocade-event-handler', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """trigger_function must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=trigger_function.trigger_function, is_container='container', yang_name="trigger-function", rest_name="trigger-function", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Trigger-function controls how multiple triggers are interpreted to launch the action (default = OR).', u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-event-handler', defining_module='brocade-event-handler', yang_type='container', is_config=True)""",
        })
