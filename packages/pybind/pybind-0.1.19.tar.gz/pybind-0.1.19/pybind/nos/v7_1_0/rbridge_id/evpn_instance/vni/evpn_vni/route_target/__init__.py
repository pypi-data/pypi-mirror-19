...
class route_target(PybindBase):
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'evpn-instance', u'vni', u'route-target']
