...
class both(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/evpn-instance/vni/evpn-vni/route-target/both. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'evpn-instance', u'vni', u'evpn-vni', u'route-target', u'both']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'evpn-instance', u'vni', u'route-target', u'both']

  def _get_target_community(self):
    """
    Getter method for target_community, mapped from YANG variable /rbridge_id/evpn_instance/vni/evpn_vni/route_target/both/target_community (rd-rt-type)
  ...
  def _set_target_community(self, v, load=False):
    """
    Setter method for target_community, mapped from YANG variable /rbridge_id/evpn_instance/vni/evpn_vni/route_target/both/target_community (rd-rt-type)
