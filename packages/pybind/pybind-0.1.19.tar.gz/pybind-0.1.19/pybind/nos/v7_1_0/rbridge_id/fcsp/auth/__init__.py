...
class auth(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/fcsp/auth. Each member element of
  ...
  def _get_proto(self):
    """
    Getter method for proto, mapped from YANG variable /rbridge_id/fcsp/auth/proto (container)
    """
    return self.__proto
      
  def _set_proto(self, v, load=False):
    """
    Setter method for proto, mapped from YANG variable /rbridge_id/fcsp/auth/proto (container)
  ...
  def _get_policy(self):
    """
    Getter method for policy, mapped from YANG variable /rbridge_id/fcsp/auth/policy (container)
    """
    return self.__policy
      
  def _set_policy(self, v, load=False):
    """
    Setter method for policy, mapped from YANG variable /rbridge_id/fcsp/auth/policy (container)
    If this variable is read-only (config: false) in the
