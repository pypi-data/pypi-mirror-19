...
class filter_change_update_delay(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/filter-change-update-delay. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'filter-change-update-delay']
  ...
  def _get_filter_delay_value(self):
    """
    Getter method for filter_delay_value, mapped from YANG variable /rbridge_id/filter_change_update_delay/filter_delay_value (uint32)
    """
    return self.__filter_delay_value
      
  def _set_filter_delay_value(self, v, load=False):
    """
    Setter method for filter_delay_value, mapped from YANG variable /rbridge_id/filter_change_update_delay/filter_delay_value (uint32)
