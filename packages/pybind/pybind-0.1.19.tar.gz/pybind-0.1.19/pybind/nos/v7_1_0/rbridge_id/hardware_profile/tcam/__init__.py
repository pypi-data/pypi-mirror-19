...
class tcam(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/hardware-profile/tcam. Each member element of
  ...
  def _get_predefined(self):
    """
    Getter method for predefined, mapped from YANG variable /rbridge_id/hardware_profile/tcam/predefined (container)
    """
    return self.__predefined
      
  def _set_predefined(self, v, load=False):
    """
    Setter method for predefined, mapped from YANG variable /rbridge_id/hardware_profile/tcam/predefined (container)
