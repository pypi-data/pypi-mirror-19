...
class host_table(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/host-table. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'host-table']
  ...
  def _get_aging_mode(self):
    """
    Getter method for aging_mode, mapped from YANG variable /rbridge_id/host_table/aging_mode (container)
    """
    return self.__aging_mode
      
  def _set_aging_mode(self, v, load=False):
    """
    Setter method for aging_mode, mapped from YANG variable /rbridge_id/host_table/aging_mode (container)
  ...
  def _get_aging_time(self):
    """
    Getter method for aging_time, mapped from YANG variable /rbridge_id/host_table/aging_time (container)
    """
    return self.__aging_time
      
  def _set_aging_time(self, v, load=False):
    """
    Setter method for aging_time, mapped from YANG variable /rbridge_id/host_table/aging_time (container)
    If this variable is read-only (config: false) in the
