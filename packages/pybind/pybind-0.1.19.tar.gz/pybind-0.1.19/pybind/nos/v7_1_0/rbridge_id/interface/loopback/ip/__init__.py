...
class ip(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ip_config','__interface_loopback_ospf_conf','__pim_intf_lo_cont',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__pim_intf_lo_cont = YANGDynClass(base=pim_intf_lo_cont.pim_intf_lo_cont, is_container='container', yang_name="pim-intf-lo-cont", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'PimLoIntfCallpoint', u'sort-priority': u'122'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)
  ...
  def _get_pim_intf_lo_cont(self):
    """
    Getter method for pim_intf_lo_cont, mapped from YANG variable /rbridge_id/interface/loopback/ip/pim_intf_lo_cont (container)
    """
    return self.__pim_intf_lo_cont
      
  def _set_pim_intf_lo_cont(self, v, load=False):
    """
    Setter method for pim_intf_lo_cont, mapped from YANG variable /rbridge_id/interface/loopback/ip/pim_intf_lo_cont (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_pim_intf_lo_cont is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_pim_intf_lo_cont() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=pim_intf_lo_cont.pim_intf_lo_cont, is_container='container', yang_name="pim-intf-lo-cont", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'PimLoIntfCallpoint', u'sort-priority': u'122'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """pim_intf_lo_cont must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=pim_intf_lo_cont.pim_intf_lo_cont, is_container='container', yang_name="pim-intf-lo-cont", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'PimLoIntfCallpoint', u'sort-priority': u'122'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)""",
        })

    self.__pim_intf_lo_cont = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_pim_intf_lo_cont(self):
    self.__pim_intf_lo_cont = YANGDynClass(base=pim_intf_lo_cont.pim_intf_lo_cont, is_container='container', yang_name="pim-intf-lo-cont", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'PimLoIntfCallpoint', u'sort-priority': u'122'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)
  ...
  pim_intf_lo_cont = __builtin__.property(_get_pim_intf_lo_cont, _set_pim_intf_lo_cont)


  _pyangbind_elements = {'ip_config': ip_config, 'interface_loopback_ospf_conf': interface_loopback_ospf_conf, 'pim_intf_lo_cont': pim_intf_lo_cont, }
