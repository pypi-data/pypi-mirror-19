...
import __builtin__
import pim_int_cmd
class pim_intf_lo_cont(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/loopback/ip/pim-intf-lo-cont. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__pim_int_cmd',)

  _yang_name = 'pim-intf-lo-cont'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'loopback', u'ip', u'pim-intf-lo-cont']
  ...
  def _get_pim_int_cmd(self):
    """
    Getter method for pim_int_cmd, mapped from YANG variable /rbridge_id/interface/loopback/ip/pim_intf_lo_cont/pim_int_cmd (container)
    """
    return self.__pim_int_cmd
      
  def _set_pim_int_cmd(self, v, load=False):
    """
    Setter method for pim_int_cmd, mapped from YANG variable /rbridge_id/interface/loopback/ip/pim_intf_lo_cont/pim_int_cmd (container)
