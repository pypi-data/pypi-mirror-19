...
class pim(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/loopback/ip/pim-intf-lo-cont/pim-int-cmd/pim. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'loopback', u'ip', u'pim-intf-lo-cont', u'pim-int-cmd', u'pim']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Loopback', u'ip', u'pim']

  def _get_neighbor_filter(self):
    """
    Getter method for neighbor_filter, mapped from YANG variable /rbridge_id/interface/loopback/ip/pim_intf_lo_cont/pim_int_cmd/pim/neighbor_filter (ip-prefix-name-t)
    """
    return self.__neighbor_filter
      
  def _set_neighbor_filter(self, v, load=False):
    """
    Setter method for neighbor_filter, mapped from YANG variable /rbridge_id/interface/loopback/ip/pim_intf_lo_cont/pim_int_cmd/pim/neighbor_filter (ip-prefix-name-t)
  ...
  def _get_dr_priority(self):
    """
    Getter method for dr_priority, mapped from YANG variable /rbridge_id/interface/loopback/ip/pim_intf_lo_cont/pim_int_cmd/pim/dr_priority (uint32)
    """
    return self.__dr_priority
      
  def _set_dr_priority(self, v, load=False):
    """
    Setter method for dr_priority, mapped from YANG variable /rbridge_id/interface/loopback/ip/pim_intf_lo_cont/pim_int_cmd/pim/dr_priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_multinet(self):
    """
    Getter method for multinet, mapped from YANG variable /rbridge_id/interface/loopback/ip/pim_intf_lo_cont/pim_int_cmd/pim/multinet (container)
    """
    return self.__multinet
      
  def _set_multinet(self, v, load=False):
    """
    Setter method for multinet, mapped from YANG variable /rbridge_id/interface/loopback/ip/pim_intf_lo_cont/pim_int_cmd/pim/multinet (container)
    If this variable is read-only (config: false) in the
