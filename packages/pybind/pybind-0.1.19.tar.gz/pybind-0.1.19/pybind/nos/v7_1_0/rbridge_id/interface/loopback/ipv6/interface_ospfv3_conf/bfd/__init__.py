...
class bfd(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/loopback/ipv6/interface-ospfv3-conf/bfd. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'loopback', u'ipv6', u'interface-ospfv3-conf', u'bfd']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Loopback', u'ipv6', u'ospf', u'bfd']

  def _get_bfd_enable(self):
    """
    Getter method for bfd_enable, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/interface_ospfv3_conf/bfd/bfd_enable (empty)
  ...
  def _set_bfd_enable(self, v, load=False):
    """
    Setter method for bfd_enable, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/interface_ospfv3_conf/bfd/bfd_enable (empty)
