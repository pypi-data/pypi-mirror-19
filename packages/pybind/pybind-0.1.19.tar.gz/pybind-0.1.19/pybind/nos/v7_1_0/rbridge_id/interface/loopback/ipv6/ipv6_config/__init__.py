...
class ipv6_config(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/loopback/ipv6/ipv6-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'loopback', u'ipv6', u'ipv6-config']
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/ipv6_config/address (container)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/ipv6_config/address (container)
