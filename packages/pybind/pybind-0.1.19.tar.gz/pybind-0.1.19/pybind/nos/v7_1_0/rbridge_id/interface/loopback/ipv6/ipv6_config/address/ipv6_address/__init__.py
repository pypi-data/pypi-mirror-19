...
class ipv6_address(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/loopback/ipv6/ipv6-config/address/ipv6-address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'loopback', u'ipv6', u'ipv6-config', u'address', u'ipv6-address']
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/ipv6_config/address/ipv6_address/address (union)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/ipv6_config/address/ipv6_address/address (union)
  ...
  def _get_eui64(self):
    """
    Getter method for eui64, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/ipv6_config/address/ipv6_address/eui64 (empty)
    """
    return self.__eui64
      
  def _set_eui64(self, v, load=False):
    """
    Setter method for eui64, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/ipv6_config/address/ipv6_address/eui64 (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_anycast(self):
    """
    Getter method for anycast, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/ipv6_config/address/ipv6_address/anycast (empty)
    """
    return self.__anycast
      
  def _set_anycast(self, v, load=False):
    """
    Setter method for anycast, mapped from YANG variable /rbridge_id/interface/loopback/ipv6/ipv6_config/address/ipv6_address/anycast (empty)
    If this variable is read-only (config: false) in the
