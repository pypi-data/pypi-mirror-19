...
class bfd(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/bfd. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'bfd']
  ...
  def _get_interval(self):
    """
    Getter method for interval, mapped from YANG variable /rbridge_id/interface/ve/bfd/interval (container)
  ...
  def _set_interval(self, v, load=False):
    """
    Setter method for interval, mapped from YANG variable /rbridge_id/interface/ve/bfd/interval (container)
  ...
  def _get_bfd_shutdown(self):
    """
    Getter method for bfd_shutdown, mapped from YANG variable /rbridge_id/interface/ve/bfd/bfd_shutdown (empty)
  ...
  def _set_bfd_shutdown(self, v, load=False):
    """
    Setter method for bfd_shutdown, mapped from YANG variable /rbridge_id/interface/ve/bfd/bfd_shutdown (empty)
    If this variable is read-only (config: false) in the
