...
class pim(PybindBase):
  ...
  def _get_multinet(self):
    """
    Getter method for multinet, mapped from YANG variable /rbridge_id/interface/ve/ip/pim_intf_vlan_cont/pim_int_cmd/pim/multinet (container)
    """
    return self.__multinet
      
  def _set_multinet(self, v, load=False):
    """
    Setter method for multinet, mapped from YANG variable /rbridge_id/interface/ve/ip/pim_intf_vlan_cont/pim_int_cmd/pim/multinet (container)
    If this variable is read-only (config: false) in the
