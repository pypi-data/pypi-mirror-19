...
class authentication(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ipv6/interface-ospfv3-conf/authentication. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ipv6', u'interface-ospfv3-conf', u'authentication']
  ...
  def _get_ipsec_auth_key_config(self):
    """
    Getter method for ipsec_auth_key_config, mapped from YANG variable /rbridge_id/interface/ve/ipv6/interface_ospfv3_conf/authentication/ipsec_auth_key_config (container)
    """
    return self.__ipsec_auth_key_config
      
  def _set_ipsec_auth_key_config(self, v, load=False):
    """
    Setter method for ipsec_auth_key_config, mapped from YANG variable /rbridge_id/interface/ve/ipv6/interface_ospfv3_conf/authentication/ipsec_auth_key_config (container)
  ...
  def _get_ipsec(self):
    """
    Getter method for ipsec, mapped from YANG variable /rbridge_id/interface/ve/ipv6/interface_ospfv3_conf/authentication/ipsec (container)
  ...
  def _set_ipsec(self, v, load=False):
    """
    Setter method for ipsec, mapped from YANG variable /rbridge_id/interface/ve/ipv6/interface_ospfv3_conf/authentication/ipsec (container)
    If this variable is read-only (config: false) in the
