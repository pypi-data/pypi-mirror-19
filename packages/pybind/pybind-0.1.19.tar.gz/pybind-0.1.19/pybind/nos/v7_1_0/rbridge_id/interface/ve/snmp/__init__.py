...
class snmp(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/snmp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'snmp']
  ...
  def _get_trap(self):
    """
    Getter method for trap, mapped from YANG variable /rbridge_id/interface/ve/snmp/trap (container)
  ...
  def _set_trap(self, v, load=False):
    """
    Setter method for trap, mapped from YANG variable /rbridge_id/interface/ve/snmp/trap (container)
