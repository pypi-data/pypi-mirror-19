...
class extcommunity_list(PybindBase):
  ...
  def _get_ext_community_regex(self):
    """
    Getter method for ext_community_regex, mapped from YANG variable /rbridge_id/ip/extcommunity_list/ext_community_regex (extcommunity-list-reg-expr-t)
    """
    return self.__ext_community_regex
      
  def _set_ext_community_regex(self, v, load=False):
    """
    Setter method for ext_community_regex, mapped from YANG variable /rbridge_id/ip/extcommunity_list/ext_community_regex (extcommunity-list-reg-expr-t)
    If this variable is read-only (config: false) in the
