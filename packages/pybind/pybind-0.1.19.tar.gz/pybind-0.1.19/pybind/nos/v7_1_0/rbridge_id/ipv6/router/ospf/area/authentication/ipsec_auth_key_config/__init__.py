...
class ipsec_auth_key_config(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/area/authentication/ipsec-auth-key-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'area', u'authentication', u'ipsec-auth-key-config']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'area', u'authentication']

  def _get_spi(self):
    """
    Getter method for spi, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/spi (spi-value-type)
  ...
  def _set_spi(self, v, load=False):
    """
    Setter method for spi, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/spi (spi-value-type)
  ...
  def _get_ah(self):
    """
    Getter method for ah, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/ah (algorithm-type-ah)
  ...
  def _set_ah(self, v, load=False):
    """
    Setter method for ah, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/ah (algorithm-type-ah)
    If this variable is read-only (config: false) in the
  ...
  def _get_ah_no_encrypt(self):
    """
    Getter method for ah_no_encrypt, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/ah_no_encrypt (empty)
  ...
  def _set_ah_no_encrypt(self, v, load=False):
    """
    Setter method for ah_no_encrypt, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/ah_no_encrypt (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_ah_key(self):
    """
    Getter method for ah_key, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/ah_key (ipsec-authentication-hexkey-string)
  ...
  def _set_ah_key(self, v, load=False):
    """
    Setter method for ah_key, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/ah_key (ipsec-authentication-hexkey-string)
    If this variable is read-only (config: false) in the
  ...
  def _get_esp(self):
    """
    Getter method for esp, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp (algorithm-type-esp)
  ...
  def _set_esp(self, v, load=False):
    """
    Setter method for esp, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp (algorithm-type-esp)
    If this variable is read-only (config: false) in the
  ...
  def _get_esp_no_encrypt(self):
    """
    Getter method for esp_no_encrypt, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp_no_encrypt (empty)
  ...
  def _set_esp_no_encrypt(self, v, load=False):
    """
    Setter method for esp_no_encrypt, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp_no_encrypt (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_esp_key(self):
    """
    Getter method for esp_key, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp_key (ipsec-authentication-hexkey-string)
  ...
  def _set_esp_key(self, v, load=False):
    """
    Setter method for esp_key, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp_key (ipsec-authentication-hexkey-string)
    If this variable is read-only (config: false) in the
  ...
  def _get_esp_auth(self):
    """
    Getter method for esp_auth, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp_auth (algorithm-type-ah)
    """
    return self.__esp_auth
      
  def _set_esp_auth(self, v, load=False):
    """
    Setter method for esp_auth, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp_auth (algorithm-type-ah)
    If this variable is read-only (config: false) in the
  ...
  def _get_esp_auth_no_encrypt(self):
    """
    Getter method for esp_auth_no_encrypt, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp_auth_no_encrypt (empty)
  ...
  def _set_esp_auth_no_encrypt(self, v, load=False):
    """
    Setter method for esp_auth_no_encrypt, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp_auth_no_encrypt (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_esp_auth_key(self):
    """
    Getter method for esp_auth_key, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp_auth_key (ipsec-authentication-hexkey-string)
  ...
  def _set_esp_auth_key(self, v, load=False):
    """
    Setter method for esp_auth_key, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/authentication/ipsec_auth_key_config/esp_auth_key (ipsec-authentication-hexkey-string)
    If this variable is read-only (config: false) in the
