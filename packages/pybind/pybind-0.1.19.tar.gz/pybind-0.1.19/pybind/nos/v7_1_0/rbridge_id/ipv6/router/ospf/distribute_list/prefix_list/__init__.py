...
class prefix_list(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/distribute-list/prefix-list. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__distribute_list_prefix_list_name = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[a-zA-Z]{1}([-a-zA-Z0-9\\.\\\\\\\\@#\\+\\*\\(\\)=\\{~\\}%<>=$_\\[\\]\\|]{0,62})'}), is_leaf=True, yang_name="distribute-list-prefix-list-name", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Prefix list  name.', u'cli-drop-node-name': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospfv3', defining_module='brocade-ospfv3', yang_type='common-def:name-string63', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'distribute-list', u'prefix-list']
  ...
  def _get_distribute_list_prefix_list_name(self):
    """
    Getter method for distribute_list_prefix_list_name, mapped from YANG variable /rbridge_id/ipv6/router/ospf/distribute_list/prefix_list/distribute_list_prefix_list_name (common-def:name-string63)
  ...
  def _set_distribute_list_prefix_list_name(self, v, load=False):
    """
    Setter method for distribute_list_prefix_list_name, mapped from YANG variable /rbridge_id/ipv6/router/ospf/distribute_list/prefix_list/distribute_list_prefix_list_name (common-def:name-string63)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[a-zA-Z]{1}([-a-zA-Z0-9\\.\\\\\\\\@#\\+\\*\\(\\)=\\{~\\}%<>=$_\\[\\]\\|]{0,62})'}), is_leaf=True, yang_name="distribute-list-prefix-list-name", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Prefix list  name.', u'cli-drop-node-name': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospfv3', defining_module='brocade-ospfv3', yang_type='common-def:name-string63', is_config=True)
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[a-zA-Z]{1}([-a-zA-Z0-9\\.\\\\\\\\@#\\+\\*\\(\\)=\\{~\\}%<>=$_\\[\\]\\|]{0,62})'}), is_leaf=True, yang_name="distribute-list-prefix-list-name", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Prefix list  name.', u'cli-drop-node-name': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospfv3', defining_module='brocade-ospfv3', yang_type='common-def:name-string63', is_config=True)""",
        })
  ...
  def _get_distribute_list_prefix_list_in(self):
    """
    Getter method for distribute_list_prefix_list_in, mapped from YANG variable /rbridge_id/ipv6/router/ospf/distribute_list/prefix_list/distribute_list_prefix_list_in (empty)
  ...
  def _set_distribute_list_prefix_list_in(self, v, load=False):
    """
    Setter method for distribute_list_prefix_list_in, mapped from YANG variable /rbridge_id/ipv6/router/ospf/distribute_list/prefix_list/distribute_list_prefix_list_in (empty)
    If this variable is read-only (config: false) in the
