...
class max_metric(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/max-metric. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'max-metric']
  ...
  def _get_router_lsa(self):
    """
    Getter method for router_lsa, mapped from YANG variable /rbridge_id/ipv6/router/ospf/max_metric/router_lsa (container)
  ...
  def _set_router_lsa(self, v, load=False):
    """
    Setter method for router_lsa, mapped from YANG variable /rbridge_id/ipv6/router/ospf/max_metric/router_lsa (container)
