...
class resource_monitor(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/resource-monitor. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'resource-monitor']
  ...
  def _get_cpu(self):
    """
    Getter method for cpu, mapped from YANG variable /rbridge_id/resource_monitor/cpu (container)
    """
    return self.__cpu
      
  def _set_cpu(self, v, load=False):
    """
    Setter method for cpu, mapped from YANG variable /rbridge_id/resource_monitor/cpu (container)
  ...
  def _get_memory(self):
    """
    Getter method for memory, mapped from YANG variable /rbridge_id/resource_monitor/memory (container)
    """
    return self.__memory
      
  def _set_memory(self, v, load=False):
    """
    Setter method for memory, mapped from YANG variable /rbridge_id/resource_monitor/memory (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_process(self):
    """
    Getter method for process, mapped from YANG variable /rbridge_id/resource_monitor/process (container)
    """
  ...
  def _set_process(self, v, load=False):
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=process.process, is_container='container', yang_name="process", rest_name="process", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Process based resource monitor', u'callpoint': u'rmconfig', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-resource-monitor', defining_module='brocade-resource-monitor', yang_type='container', is_config=True)""",
        })
