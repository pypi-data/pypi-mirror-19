...
class ipv6(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/match/ipv6. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'match', u'ipv6']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'match', u'ipv6']

  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/address (container)
  ...
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/address (container)
  ...
  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/next_hop (container)
  ...
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/next_hop (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_route_source(self):
    """
    Getter method for route_source, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/route_source (container)
