...
class automatic_tag(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/automatic-tag. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'automatic-tag']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'set', u'automatic-tag']

  def _get_tag_empty(self):
    """
    Getter method for tag_empty, mapped from YANG variable /rbridge_id/route_map/content/set/automatic_tag/tag_empty (empty)
    """
    return self.__tag_empty
      
  def _set_tag_empty(self, v, load=False):
    """
    Setter method for tag_empty, mapped from YANG variable /rbridge_id/route_map/content/set/automatic_tag/tag_empty (empty)
