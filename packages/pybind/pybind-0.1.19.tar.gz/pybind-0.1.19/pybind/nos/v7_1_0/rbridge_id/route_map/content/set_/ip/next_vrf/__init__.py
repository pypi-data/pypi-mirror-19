...
class next_vrf(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/ip/next-vrf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'ip', u'next-vrf']
  ...
  def _get_next_vrf_list(self):
    """
    Getter method for next_vrf_list, mapped from YANG variable /rbridge_id/route_map/content/set/ip/next_vrf/next_vrf_list (list)
    """
    return self.__next_vrf_list
      
  def _set_next_vrf_list(self, v, load=False):
    """
    Setter method for next_vrf_list, mapped from YANG variable /rbridge_id/route_map/content/set/ip/next_vrf/next_vrf_list (list)
