...
class next_global_hop(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/ipv6/global/next-global-hop. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'ipv6', u'global', u'next-global-hop']
  ...
  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /rbridge_id/route_map/content/set/ipv6/global/next_global_hop/next_hop (inet:ipv6-address)
    """
    return self.__next_hop
      
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /rbridge_id/route_map/content/set/ipv6/global/next_global_hop/next_hop (inet:ipv6-address)
