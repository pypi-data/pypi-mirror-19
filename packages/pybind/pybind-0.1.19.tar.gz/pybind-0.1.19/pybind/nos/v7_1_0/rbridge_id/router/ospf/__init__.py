...
class ospf(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__auto_cost = YANGDynClass(base=auto_cost.auto_cost, is_container='container', yang_name="auto-cost", rest_name="auto-cost", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Calculate OSPF interface cost according to\nbandwidth'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf']
  ...
  def _get_vrf(self):
    """
    Getter method for vrf, mapped from YANG variable /rbridge_id/router/ospf/vrf (string)
    """
    return self.__vrf
      
  def _set_vrf(self, v, load=False):
    """
    Setter method for vrf, mapped from YANG variable /rbridge_id/router/ospf/vrf (string)
  ...
  def _get_database_overflow_interval(self):
    """
    Getter method for database_overflow_interval, mapped from YANG variable /rbridge_id/router/ospf/database_overflow_interval (common-def:time-interval-sec)
    """
    return self.__database_overflow_interval
      
  def _set_database_overflow_interval(self, v, load=False):
    """
    Setter method for database_overflow_interval, mapped from YANG variable /rbridge_id/router/ospf/database_overflow_interval (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
  ...
  def _get_default_information_originate(self):
    """
    Getter method for default_information_originate, mapped from YANG variable /rbridge_id/router/ospf/default_information_originate (container)
    """
    return self.__default_information_originate
      
  def _set_default_information_originate(self, v, load=False):
    """
    Setter method for default_information_originate, mapped from YANG variable /rbridge_id/router/ospf/default_information_originate (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_default_passive_interface(self):
    """
    Getter method for default_passive_interface, mapped from YANG variable /rbridge_id/router/ospf/default_passive_interface (empty)
    """
    return self.__default_passive_interface
      
  def _set_default_passive_interface(self, v, load=False):
    """
    Setter method for default_passive_interface, mapped from YANG variable /rbridge_id/router/ospf/default_passive_interface (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_default_metric(self):
    """
    Getter method for default_metric, mapped from YANG variable /rbridge_id/router/ospf/default_metric (uint32)
    """
    return self.__default_metric
      
  def _set_default_metric(self, v, load=False):
    """
    Setter method for default_metric, mapped from YANG variable /rbridge_id/router/ospf/default_metric (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_external_lsdb_limit(self):
    """
    Getter method for external_lsdb_limit, mapped from YANG variable /rbridge_id/router/ospf/external_lsdb_limit (uint32)
    """
    return self.__external_lsdb_limit
      
  def _set_external_lsdb_limit(self, v, load=False):
    """
    Setter method for external_lsdb_limit, mapped from YANG variable /rbridge_id/router/ospf/external_lsdb_limit (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_log(self):
    """
    Getter method for log, mapped from YANG variable /rbridge_id/router/ospf/log (container)
    """
    return self.__log
      
  def _set_log(self, v, load=False):
    """
    Setter method for log, mapped from YANG variable /rbridge_id/router/ospf/log (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=log.log, is_container='container', yang_name="log", rest_name="log", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Enable logging OSPF activities'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
  ...
  def _get_ospf_metric_type(self):
    """
    Getter method for ospf_metric_type, mapped from YANG variable /rbridge_id/router/ospf/ospf_metric_type (metric-type)
    """
    return self.__ospf_metric_type
      
  def _set_ospf_metric_type(self, v, load=False):
    """
    Setter method for ospf_metric_type, mapped from YANG variable /rbridge_id/router/ospf/ospf_metric_type (metric-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_neighbor(self):
    """
    Getter method for neighbor, mapped from YANG variable /rbridge_id/router/ospf/neighbor (list)
    """
    return self.__neighbor
      
  def _set_neighbor(self, v, load=False):
    """
    Setter method for neighbor, mapped from YANG variable /rbridge_id/router/ospf/neighbor (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_redistribute(self):
    """
    Getter method for redistribute, mapped from YANG variable /rbridge_id/router/ospf/redistribute (container)
    """
    return self.__redistribute
      
  def _set_redistribute(self, v, load=False):
    """
    Setter method for redistribute, mapped from YANG variable /rbridge_id/router/ospf/redistribute (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_rfc1583_compatibility(self):
    """
    Getter method for rfc1583_compatibility, mapped from YANG variable /rbridge_id/router/ospf/rfc1583_compatibility (container)
    """
    return self.__rfc1583_compatibility
      
  def _set_rfc1583_compatibility(self, v, load=False):
    """
    Setter method for rfc1583_compatibility, mapped from YANG variable /rbridge_id/router/ospf/rfc1583_compatibility (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=rfc1583_compatibility.rfc1583_compatibility, is_container='container', yang_name="rfc1583-compatibility", rest_name="rfc1583-compatibility", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Enable RFC 1583 OSPF v2 compatibility', u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
  ...
  def _get_area(self):
    """
    Getter method for area, mapped from YANG variable /rbridge_id/router/ospf/area (list)
    """
    return self.__area
      
  def _set_area(self, v, load=False):
    """
    Setter method for area, mapped from YANG variable /rbridge_id/router/ospf/area (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_auto_cost(self):
    """
    Getter method for auto_cost, mapped from YANG variable /rbridge_id/router/ospf/auto_cost (container)
    """
    return self.__auto_cost
      
  def _set_auto_cost(self, v, load=False):
    """
    Setter method for auto_cost, mapped from YANG variable /rbridge_id/router/ospf/auto_cost (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=auto_cost.auto_cost, is_container='container', yang_name="auto-cost", rest_name="auto-cost", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Calculate OSPF interface cost according to\nbandwidth'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
  ...
  def _get_distance(self):
    """
    Getter method for distance, mapped from YANG variable /rbridge_id/router/ospf/distance (list)
    """
    return self.__distance
      
  def _set_distance(self, v, load=False):
    """
    Setter method for distance, mapped from YANG variable /rbridge_id/router/ospf/distance (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_distribute_list(self):
    """
    Getter method for distribute_list, mapped from YANG variable /rbridge_id/router/ospf/distribute_list (container)
    """
    return self.__distribute_list
      
  def _set_distribute_list(self, v, load=False):
    """
    Setter method for distribute_list, mapped from YANG variable /rbridge_id/router/ospf/distribute_list (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_max_metric(self):
    """
    Getter method for max_metric, mapped from YANG variable /rbridge_id/router/ospf/max_metric (container)
    """
    return self.__max_metric
      
  def _set_max_metric(self, v, load=False):
    """
    Setter method for max_metric, mapped from YANG variable /rbridge_id/router/ospf/max_metric (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_summary_address(self):
    """
    Getter method for summary_address, mapped from YANG variable /rbridge_id/router/ospf/summary_address (list)
    """
    return self.__summary_address
      
  def _set_summary_address(self, v, load=False):
    """
    Setter method for summary_address, mapped from YANG variable /rbridge_id/router/ospf/summary_address (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_timers(self):
    """
    Getter method for timers, mapped from YANG variable /rbridge_id/router/ospf/timers (container)
    """
    return self.__timers
      
  def _set_timers(self, v, load=False):
    """
    Setter method for timers, mapped from YANG variable /rbridge_id/router/ospf/timers (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_permit(self):
    """
    Getter method for permit, mapped from YANG variable /rbridge_id/router/ospf/permit (container)
    """
    return self.__permit
      
  def _set_permit(self, v, load=False):
    """
    Setter method for permit, mapped from YANG variable /rbridge_id/router/ospf/permit (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_deny(self):
    """
    Getter method for deny, mapped from YANG variable /rbridge_id/router/ospf/deny (container)
    """
    return self.__deny
      
  def _set_deny(self, v, load=False):
    """
    Setter method for deny, mapped from YANG variable /rbridge_id/router/ospf/deny (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_vrf_lite_capability(self):
    """
    Getter method for vrf_lite_capability, mapped from YANG variable /rbridge_id/router/ospf/vrf_lite_capability (empty)
    """
    return self.__vrf_lite_capability
      
  def _set_vrf_lite_capability(self, v, load=False):
    """
    Setter method for vrf_lite_capability, mapped from YANG variable /rbridge_id/router/ospf/vrf_lite_capability (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_graceful_restart(self):
    """
    Getter method for graceful_restart, mapped from YANG variable /rbridge_id/router/ospf/graceful_restart (container)
  ...
  def _set_graceful_restart(self, v, load=False):
    """
    Setter method for graceful_restart, mapped from YANG variable /rbridge_id/router/ospf/graceful_restart (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_nonstop_routing(self):
    """
    Getter method for nonstop_routing, mapped from YANG variable /rbridge_id/router/ospf/nonstop_routing (empty)
    """
    return self.__nonstop_routing
      
  def _set_nonstop_routing(self, v, load=False):
    """
    Setter method for nonstop_routing, mapped from YANG variable /rbridge_id/router/ospf/nonstop_routing (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_maximum_paths(self):
    """
    Getter method for maximum_paths, mapped from YANG variable /rbridge_id/router/ospf/maximum_paths (uint8)
  ...
  def _set_maximum_paths(self, v, load=False):
    """
    Setter method for maximum_paths, mapped from YANG variable /rbridge_id/router/ospf/maximum_paths (uint8)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..32']}), is_leaf=True, yang_name="maximum-paths", rest_name="maximum-paths", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'The maximum number of paths to a destination.'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='uint8', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """maximum_paths must be of a type compatible with uint8""",
          'defined-type': "uint8",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..32']}), is_leaf=True, yang_name="maximum-paths", rest_name="maximum-paths", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'The maximum number of paths to a destination.'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='uint8', is_config=True)""",
        })
  ...
  def _get_global_bfd(self):
    """
    Getter method for global_bfd, mapped from YANG variable /rbridge_id/router/ospf/global_bfd (container)
  ...
  def _set_global_bfd(self, v, load=False):
    """
    Setter method for global_bfd, mapped from YANG variable /rbridge_id/router/ospf/global_bfd (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=global_bfd.global_bfd, is_container='container', yang_name="global-bfd", rest_name="bfd", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure BFD for OSPFv2 on all OSPFv2 enabled interfaces', u'alt-name': u'bfd', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
