...
class timers(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/timers. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__throttle = YANGDynClass(base=throttle.throttle, is_container='container', yang_name="throttle", rest_name="throttle", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'The OSPF SPF timers.', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'timers']
  ...
  def _get_lsa_group_pacing(self):
    """
    Getter method for lsa_group_pacing, mapped from YANG variable /rbridge_id/router/ospf/timers/lsa_group_pacing (common-def:time-interval-sec)
    """
    return self.__lsa_group_pacing
      
  def _set_lsa_group_pacing(self, v, load=False):
    """
    Setter method for lsa_group_pacing, mapped from YANG variable /rbridge_id/router/ospf/timers/lsa_group_pacing (common-def:time-interval-sec)
  ...
  def _get_throttle(self):
    """
    Getter method for throttle, mapped from YANG variable /rbridge_id/router/ospf/timers/throttle (container)
    """
  ...
  def _set_throttle(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=throttle.throttle, is_container='container', yang_name="throttle", rest_name="throttle", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'The OSPF SPF timers.', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """throttle must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=throttle.throttle, is_container='container', yang_name="throttle", rest_name="throttle", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'The OSPF SPF timers.', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
