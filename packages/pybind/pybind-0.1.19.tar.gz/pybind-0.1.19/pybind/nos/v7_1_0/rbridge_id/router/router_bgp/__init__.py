...
class router_bgp(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp']
  ...
  def _get_router_bgp_attributes(self):
    """
    Getter method for router_bgp_attributes, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes (container)
    """
    return self.__router_bgp_attributes
      
  def _set_router_bgp_attributes(self, v, load=False):
    """
    Setter method for router_bgp_attributes, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes (container)
  ...
  def _get_address_family(self):
    """
    Getter method for address_family, mapped from YANG variable /rbridge_id/router/router_bgp/address_family (container)
    """
    return self.__address_family
      
  def _set_address_family(self, v, load=False):
    """
    Setter method for address_family, mapped from YANG variable /rbridge_id/router/router_bgp/address_family (container)
    If this variable is read-only (config: false) in the
