...
class ethernet_interface(PybindBase):
  ...
  def _get_ethernet(self):
    """
    Getter method for ethernet, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/update_source/ethernet_interface/ethernet (interface:interface-type)
    """
    return self.__ethernet
      
  def _set_ethernet(self, v, load=False):
    """
    Setter method for ethernet, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/update_source/ethernet_interface/ethernet (interface:interface-type)
    If this variable is read-only (config: false) in the
