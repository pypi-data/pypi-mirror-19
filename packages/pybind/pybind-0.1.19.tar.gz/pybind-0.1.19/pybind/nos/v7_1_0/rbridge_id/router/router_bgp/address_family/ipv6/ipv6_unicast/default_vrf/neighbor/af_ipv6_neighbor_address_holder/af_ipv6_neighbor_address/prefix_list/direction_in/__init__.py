...
class direction_in(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv6/ipv6-unicast/default-vrf/neighbor/af-ipv6-neighbor-address-holder/af-ipv6-neighbor-address/prefix-list/direction-in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'default-vrf', u'neighbor', u'af-ipv6-neighbor-address-holder', u'af-ipv6-neighbor-address', u'prefix-list', u'direction-in']
  ...
  def _get_prefix_list_direction_in_prefix_name(self):
    """
    Getter method for prefix_list_direction_in_prefix_name, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/prefix_list/direction_in/prefix_list_direction_in_prefix_name (nei-prefix-list-filter)
    """
  ...
  def _get_prefix_list_direction_in(self):
    """
    Getter method for prefix_list_direction_in, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/prefix_list/direction_in/prefix_list_direction_in (empty)
    """
    return self.__prefix_list_direction_in
      
  def _set_prefix_list_direction_in(self, v, load=False):
    """
    Setter method for prefix_list_direction_in, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/prefix_list/direction_in/prefix_list_direction_in (empty)
    If this variable is read-only (config: false) in the
