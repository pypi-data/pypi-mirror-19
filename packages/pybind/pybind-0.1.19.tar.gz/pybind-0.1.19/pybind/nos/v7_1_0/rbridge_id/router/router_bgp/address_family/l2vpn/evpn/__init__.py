...
class evpn(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/l2vpn/evpn. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__retain = YANGDynClass(base=retain.retain, is_container='container', yang_name="retain", rest_name="retain", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Retain route targets'}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'l2vpn', u'evpn']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'l2vpn', u'evpn']

  def _get_client_to_client_reflection(self):
    """
    Getter method for client_to_client_reflection, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/client_to_client_reflection (empty)
    """
    return self.__client_to_client_reflection
      
  def _set_client_to_client_reflection(self, v, load=False):
    """
    Setter method for client_to_client_reflection, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/client_to_client_reflection (empty)
  ...
  def _get_graceful_restart(self):
    """
    Getter method for graceful_restart, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/graceful_restart (container)
    """
    return self.__graceful_restart
      
  def _set_graceful_restart(self, v, load=False):
    """
    Setter method for graceful_restart, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/graceful_restart (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_retain(self):
    """
    Getter method for retain, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/retain (container)
    """
  ...
  def _set_retain(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=retain.retain, is_container='container', yang_name="retain", rest_name="retain", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Retain route targets'}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """retain must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=retain.retain, is_container='container', yang_name="retain", rest_name="retain", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Retain route targets'}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)""",
        })
  ...
  def _get_vtep_discovery(self):
    """
    Getter method for vtep_discovery, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/vtep_discovery (empty)
    """
    return self.__vtep_discovery
      
  def _set_vtep_discovery(self, v, load=False):
    """
    Setter method for vtep_discovery, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/vtep_discovery (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_neighbor(self):
    """
    Getter method for neighbor, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/neighbor (container)
    """
    return self.__neighbor
      
  def _set_neighbor(self, v, load=False):
    """
    Setter method for neighbor, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/neighbor (container)
    If this variable is read-only (config: false) in the
