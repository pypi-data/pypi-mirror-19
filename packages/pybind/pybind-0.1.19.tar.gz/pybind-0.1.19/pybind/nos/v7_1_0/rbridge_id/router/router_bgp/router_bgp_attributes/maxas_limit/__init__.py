...
class maxas_limit(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/maxas-limit. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'maxas-limit']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'maxas-limit']

  def _get_in_(self):
    """
    Getter method for in_, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/maxas_limit/in (container)
    """
    return self.__in_
      
  def _set_in_(self, v, load=False):
    """
    Setter method for in_, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/maxas_limit/in (container)
