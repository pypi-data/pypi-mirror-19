...
class enforce_first_as(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ips/neighbor-addr/enforce-first-as. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'neighbor-ips', u'neighbor-addr', u'enforce-first-as']
  ...
  def _get_nei_enforce_first_as(self):
    """
    Getter method for nei_enforce_first_as, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/enforce_first_as/nei_enforce_first_as (empty)
    """
    return self.__nei_enforce_first_as
      
  def _set_nei_enforce_first_as(self, v, load=False):
    """
    Setter method for nei_enforce_first_as, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/enforce_first_as/nei_enforce_first_as (empty)
  ...
  def _get_nei_enforce_first_as_disable(self):
    """
    Getter method for nei_enforce_first_as_disable, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/enforce_first_as/nei_enforce_first_as_disable (empty)
    """
    return self.__nei_enforce_first_as_disable
      
  def _set_nei_enforce_first_as_disable(self, v, load=False):
    """
    Setter method for nei_enforce_first_as_disable, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/enforce_first_as/nei_enforce_first_as_disable (empty)
    If this variable is read-only (config: false) in the
