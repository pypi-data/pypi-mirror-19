...
class soft_reconfiguration(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ips/neighbor-addr/soft-reconfiguration. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'neighbor-ips', u'neighbor-addr', u'soft-reconfiguration']
  ...
  def _get_inbound(self):
    """
    Getter method for inbound, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/soft_reconfiguration/inbound (empty)
    """
    return self.__inbound
      
  def _set_inbound(self, v, load=False):
    """
    Setter method for inbound, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/soft_reconfiguration/inbound (empty)
