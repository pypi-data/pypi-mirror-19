...
import __builtin__
import neighbor_ipv6_addr
class neighbor_ipv6s(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ipv6s. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'neighbor-ipv6s']
  ...
  def _get_neighbor_ipv6_addr(self):
    """
    Getter method for neighbor_ipv6_addr, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ipv6s/neighbor_ipv6_addr (list)
    """
    return self.__neighbor_ipv6_addr
      
  def _set_neighbor_ipv6_addr(self, v, load=False):
    """
    Setter method for neighbor_ipv6_addr, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ipv6s/neighbor_ipv6_addr (list)
  ...
  _pyangbind_elements = {'neighbor_ipv6_addr': neighbor_ipv6_addr, }
