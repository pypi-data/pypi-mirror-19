...
class neighbor_peer_grp(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__alternate_as = YANGDynClass(base=alternate_as.alternate_as, is_container='container', yang_name="alternate-as", rest_name="alternate-as", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Add/Remove alternate-as.', u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)
  ...
  def _set_alternate_as(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=alternate_as.alternate_as, is_container='container', yang_name="alternate-as", rest_name="alternate-as", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Add/Remove alternate-as.', u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """alternate_as must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=alternate_as.alternate_as, is_container='container', yang_name="alternate-as", rest_name="alternate-as", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Add/Remove alternate-as.', u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)""",
        })
