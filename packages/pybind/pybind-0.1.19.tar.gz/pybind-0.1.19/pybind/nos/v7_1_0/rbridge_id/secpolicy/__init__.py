...
class secpolicy(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/secpolicy. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'secpolicy']
  ...
  def _get_defined_policy(self):
    """
    Getter method for defined_policy, mapped from YANG variable /rbridge_id/secpolicy/defined_policy (container)
  ...
  def _get_active_policy(self):
    """
    Getter method for active_policy, mapped from YANG variable /rbridge_id/secpolicy/active_policy (container)
