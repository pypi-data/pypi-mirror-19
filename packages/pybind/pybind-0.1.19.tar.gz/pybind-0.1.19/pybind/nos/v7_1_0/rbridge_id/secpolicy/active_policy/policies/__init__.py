...
class policies(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/secpolicy/active-policy/policies. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'secpolicy', u'active-policy', u'policies']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'secpolicy', u'active-policy']

  def _get_policy(self):
    """
    Getter method for policy, mapped from YANG variable /rbridge_id/secpolicy/active_policy/policies/policy (secpolicy-type)
    """
    return self.__policy
      
  def _set_policy(self, v, load=False):
    """
    Setter method for policy, mapped from YANG variable /rbridge_id/secpolicy/active_policy/policies/policy (secpolicy-type)
  ...
  def _get_member_entry(self):
    """
    Getter method for member_entry, mapped from YANG variable /rbridge_id/secpolicy/active_policy/policies/member_entry (list)
    """
    return self.__member_entry
      
  def _set_member_entry(self, v, load=False):
    """
    Setter method for member_entry, mapped from YANG variable /rbridge_id/secpolicy/active_policy/policies/member_entry (list)
    If this variable is read-only (config: false) in the
