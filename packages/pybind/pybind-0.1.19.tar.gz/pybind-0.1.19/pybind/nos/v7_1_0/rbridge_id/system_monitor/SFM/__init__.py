...
import __builtin__
import threshold
class SFM(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/system-monitor/SFM. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'system-monitor', u'SFM']
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /rbridge_id/system_monitor/SFM/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /rbridge_id/system_monitor/SFM/threshold (container)
