...
class telnet(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/telnet. Each member element of
  ...
  def _get_server(self):
    """
    Getter method for server, mapped from YANG variable /rbridge_id/telnet/server (container)
    """
    return self.__server
      
  def _set_server(self, v, load=False):
    """
    Setter method for server, mapped from YANG variable /rbridge_id/telnet/server (container)
