...
class below(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/threshold-monitor/sfp/policy/area/alert/below. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'threshold-monitor', u'sfp', u'policy', u'area', u'alert', u'below']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'threshold-monitor', u'sfp', u'policy', u'alert', u'below']

  def _get_below_highthresh_action(self):
    """
    Getter method for below_highthresh_action, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/area/alert/below/below_highthresh_action (supported-actions)
    """
    return self.__below_highthresh_action
      
  def _set_below_highthresh_action(self, v, load=False):
    """
    Setter method for below_highthresh_action, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/area/alert/below/below_highthresh_action (supported-actions)
  ...
  def _get_below_lowthresh_action(self):
    """
    Getter method for below_lowthresh_action, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/area/alert/below/below_lowthresh_action (supported-actions)
    """
    return self.__below_lowthresh_action
      
  def _set_below_lowthresh_action(self, v, load=False):
    """
    Setter method for below_lowthresh_action, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/area/alert/below/below_lowthresh_action (supported-actions)
    If this variable is read-only (config: false) in the
