...
class ip(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ip/unicast/ip. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: rtm commands
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__route','__import_',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ip', u'unicast', u'ip']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ipv4', u'unicast', u'ip']

  def _get_route(self):
    """
    Getter method for route, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route (container)
    """
    return self.__route
      
  def _set_route(self, v, load=False):
    """
    Setter method for route, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route (container)
  ...
  def _get_import_(self):
    """
    Getter method for import_, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/import (container)
    """
    return self.__import_
      
  def _set_import_(self, v, load=False):
    """
    Setter method for import_, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/import (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'route': route, 'import_': import_, }
