...
class route_attributes(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ipv6/unicast/ipv6/route/link-local-static-route-nh/route-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ipv6', u'unicast', u'ipv6', u'route', u'link-local-static-route-nh', u'route-attributes']
  ...
  def _get_metric(self):
    """
    Getter method for metric, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/route_attributes/metric (uint32)
    """
    return self.__metric
      
  def _set_metric(self, v, load=False):
    """
    Setter method for metric, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/route_attributes/metric (uint32)
  ...
  def _get_distance(self):
    """
    Getter method for distance, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/route_attributes/distance (uint32)
    """
    return self.__distance
      
  def _set_distance(self, v, load=False):
    """
    Setter method for distance, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/route_attributes/distance (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_tag(self):
    """
    Getter method for tag, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/route_attributes/tag (uint32)
...
Default value is 0, indicating no tag.
  ...
  def _set_tag(self, v, load=False):
    """
    Setter method for tag, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/route_attributes/tag (uint32)
    If this variable is read-only (config: false) in the
