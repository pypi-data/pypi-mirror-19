...
import __builtin__
import show
class show_rb_runcfg(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /rule/command/show-rb-runcfg. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show',)

  _yang_name = 'show-rb-runcfg'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rule', u'command', u'show-rb-runcfg']
  ...
  def _get_show(self):
    """
    Getter method for show, mapped from YANG variable /rule/command/show_rb_runcfg/show (container)
    """
    return self.__show
      
  def _set_show(self, v, load=False):
    """
    Setter method for show, mapped from YANG variable /rule/command/show_rb_runcfg/show (container)
  ...
  __choices__ = {u'cmdlist': {u'show-f': [u'show']}}
