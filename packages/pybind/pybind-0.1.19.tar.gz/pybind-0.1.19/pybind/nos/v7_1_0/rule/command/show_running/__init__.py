...
import __builtin__
import show
class show_running(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /rule/command/show-running. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show',)

  _yang_name = 'show-running'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rule', u'command', u'show-running']
  ...
  def _get_show(self):
    """
    Getter method for show, mapped from YANG variable /rule/command/show_running/show (container)
    """
    return self.__show
      
  def _set_show(self, v, load=False):
    """
    Setter method for show, mapped from YANG variable /rule/command/show_running/show (container)
  ...
  __choices__ = {u'cmdlist': {u'show-b': [u'show']}}
