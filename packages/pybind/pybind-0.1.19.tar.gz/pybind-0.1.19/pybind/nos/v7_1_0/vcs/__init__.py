...
class vcs(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__virtual','__virtual_fabric','__auto_config_backup',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__auto_config_backup = YANGDynClass(base=auto_config_backup.auto_config_backup, is_container='container', yang_name="auto-config-backup", rest_name="auto-config-backup", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Vcs Auto Configuration Backup', u'callpoint': u'vcs-auto-config-backup-callpoint', u'display-when': u'((/vcsmode/vcs-mode = "true") and (/vcsmode/vcs-cluster-mode = "true"))'}}, namespace='urn:brocade.com:mgmt:brocade-vcs', defining_module='brocade-vcs', yang_type='container', is_config=True)
  ...
  def _get_auto_config_backup(self):
    """
    Getter method for auto_config_backup, mapped from YANG variable /vcs/auto_config_backup (container)

    YANG Description: Vcs Auto Configuration Backup
    """
    return self.__auto_config_backup
      
  def _set_auto_config_backup(self, v, load=False):
    """
    Setter method for auto_config_backup, mapped from YANG variable /vcs/auto_config_backup (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_auto_config_backup is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_auto_config_backup() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=auto_config_backup.auto_config_backup, is_container='container', yang_name="auto-config-backup", rest_name="auto-config-backup", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Vcs Auto Configuration Backup', u'callpoint': u'vcs-auto-config-backup-callpoint', u'display-when': u'((/vcsmode/vcs-mode = "true") and (/vcsmode/vcs-cluster-mode = "true"))'}}, namespace='urn:brocade.com:mgmt:brocade-vcs', defining_module='brocade-vcs', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """auto_config_backup must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=auto_config_backup.auto_config_backup, is_container='container', yang_name="auto-config-backup", rest_name="auto-config-backup", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Vcs Auto Configuration Backup', u'callpoint': u'vcs-auto-config-backup-callpoint', u'display-when': u'((/vcsmode/vcs-mode = "true") and (/vcsmode/vcs-cluster-mode = "true"))'}}, namespace='urn:brocade.com:mgmt:brocade-vcs', defining_module='brocade-vcs', yang_type='container', is_config=True)""",
        })
  ...
  auto_config_backup = __builtin__.property(_get_auto_config_backup, _set_auto_config_backup)


  _pyangbind_elements = {'virtual': virtual, 'virtual_fabric': virtual_fabric, 'auto_config_backup': auto_config_backup, }
