...
interface.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__interface_type','__interface_name','__sfp','__on_board','__gbc','__xfp','__xff','__xfpe','__unknown','__qsfp','__qsfpp','__cfp','__qsfp28','__cfp2',)
...
'interface-type' must fail with an error.
  ...
  def _set_qsfp28(self, v, load=False):
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=qsfp28.qsfp28, is_container='container', yang_name="qsfp28", rest_name="qsfp28", parent=self, choice=(u'interface-identifier', u'qsfp28'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-interface-ext', defining_module='brocade-interface-ext', yang_type='container', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'interface_type': interface_type, 'interface_name': interface_name, 'sfp': sfp, 'on_board': on_board, 'gbc': gbc, 'xfp': xfp, 'xff': xff, 'xfpe': xfpe, 'unknown': unknown, 'qsfp': qsfp, 'qsfpp': qsfpp, 'cfp': cfp, 'qsfp28': qsfp28, 'cfp2': cfp2, }
