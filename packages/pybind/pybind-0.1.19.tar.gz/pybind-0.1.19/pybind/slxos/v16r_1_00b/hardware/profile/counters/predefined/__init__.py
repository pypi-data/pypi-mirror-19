...
class predefined(PybindBase):
  ...
  from YANG module brocade-hardware - based on the path /hardware/profile/counters/predefined. Each member element of
  ...
  def _get_counters_profiletype(self):
    ...
    """
    return self.__counters_profiletype
      
  def _set_counters_profiletype(self, v, load=False):
    """
    Setter method for counters_profiletype, mapped from YANG variable /hardware/profile/counters/predefined/counters_profiletype (counters-profile-subtype)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_counters_profiletype is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_counters_profiletype() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'counters_profiletype': counters_profiletype, }
