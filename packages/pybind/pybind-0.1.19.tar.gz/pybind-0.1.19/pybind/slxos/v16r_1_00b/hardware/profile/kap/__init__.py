...
class kap(PybindBase):
  ...
  from YANG module brocade-hardware - based on the path /hardware/profile/kap. Each member element of
  ...
  def _get_predefined(self):
    """
    Getter method for predefined, mapped from YANG variable /hardware/profile/kap/predefined (container)
    """
    return self.__predefined
      
  def _set_predefined(self, v, load=False):
    """
    Setter method for predefined, mapped from YANG variable /hardware/profile/kap/predefined (container)
  ...
  def _get_customized(self):
    """
    Getter method for customized, mapped from YANG variable /hardware/profile/kap/customized (container)
    """
    return self.__customized
      
  def _set_customized(self, v, load=False):
    """
    Setter method for customized, mapped from YANG variable /hardware/profile/kap/customized (container)
    If this variable is read-only (config: false) in the
