...
class lag(PybindBase):
  ...
  from YANG module brocade-hardware - based on the path /hardware/profile/lag. Each member element of
  ...
  def _get_predefined(self):
    """
    Getter method for predefined, mapped from YANG variable /hardware/profile/lag/predefined (container)
    """
    return self.__predefined
      
  def _set_predefined(self, v, load=False):
    """
    Setter method for predefined, mapped from YANG variable /hardware/profile/lag/predefined (container)
