...
class vlan_classification(PybindBase):
  ...
  from YANG module brocade-hardware - based on the path /hardware/profile/vlan-classification. Each member element of
  ...
  _rest_name = 'vlan-classification'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hardware', u'profile', u'vlan-classification']
  ...
  def _get_predefined(self):
    """
    Getter method for predefined, mapped from YANG variable /hardware/profile/vlan_classification/predefined (container)
    """
    return self.__predefined
      
  def _set_predefined(self, v, load=False):
    """
    Setter method for predefined, mapped from YANG variable /hardware/profile/vlan_classification/predefined (container)
