...
class predefined(PybindBase):
  ...
  from YANG module brocade-hardware - based on the path /hardware/profile/vlan-classification/predefined. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hardware', u'profile', u'vlan-classification', u'predefined']
  ...
  def _get_vlan_profiletype(self):
    """
    Getter method for vlan_profiletype, mapped from YANG variable /hardware/profile/vlan_classification/predefined/vlan_profiletype (vlan-classification-subtype)
    """
    return self.__vlan_profiletype
      
  def _set_vlan_profiletype(self, v, load=False):
    """
    Setter method for vlan_profiletype, mapped from YANG variable /hardware/profile/vlan_classification/predefined/vlan_profiletype (vlan-classification-subtype)
