...
class auth_check(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/interface-eth-isis-conf/intf-isis/interface-isis/auth-check. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'interface-eth-isis-conf', u'intf-isis', u'interface-isis', u'auth-check']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'isis', u'auth-check']

  def _get_auth_check_level1(self):
    """
    Getter method for auth_check_level1, mapped from YANG variable /interface/ethernet/interface_eth_isis_conf/intf_isis/interface_isis/auth_check/auth_check_level1 (container)
    """
    return self.__auth_check_level1
      
  def _set_auth_check_level1(self, v, load=False):
    """
    Setter method for auth_check_level1, mapped from YANG variable /interface/ethernet/interface_eth_isis_conf/intf_isis/interface_isis/auth_check/auth_check_level1 (container)
  ...
  def _get_auth_check_level2(self):
    """
    Getter method for auth_check_level2, mapped from YANG variable /interface/ethernet/interface_eth_isis_conf/intf_isis/interface_isis/auth_check/auth_check_level2 (container)
    """
    return self.__auth_check_level2
      
  def _set_auth_check_level2(self, v, load=False):
    """
    Setter method for auth_check_level2, mapped from YANG variable /interface/ethernet/interface_eth_isis_conf/intf_isis/interface_isis/auth_check/auth_check_level2 (container)
    If this variable is read-only (config: false) in the
