...
class interface_reverse_metric(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/interface-eth-isis-conf/intf-isis/interface-isis/interface-reverse-metric. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'interface-eth-isis-conf', u'intf-isis', u'interface-isis', u'interface-reverse-metric']
  ...
  def _get_rev_metric_common_attributes(self):
    """
    Getter method for rev_metric_common_attributes, mapped from YANG variable /interface/ethernet/interface_eth_isis_conf/intf_isis/interface_isis/interface_reverse_metric/rev_metric_common_attributes (container)
    """
    return self.__rev_metric_common_attributes
      
  def _set_rev_metric_common_attributes(self, v, load=False):
    """
    Setter method for rev_metric_common_attributes, mapped from YANG variable /interface/ethernet/interface_eth_isis_conf/intf_isis/interface_isis/interface_reverse_metric/rev_metric_common_attributes (container)
