...
class arp_node_config(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/arp-node-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'arp-node-config']
  ...
  def _get_arp(self):
    """
    Getter method for arp, mapped from YANG variable /interface/ethernet/ip/arp_node_config/arp (container)
    """
    return self.__arp
      
  def _set_arp(self, v, load=False):
    """
    Setter method for arp, mapped from YANG variable /interface/ethernet/ip/arp_node_config/arp (container)
