...
class igmp_phy_intf_cfg(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/igmp-phy-intf-cfg. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'igmp-phy-intf-cfg']
  ...
  def _get_igmp(self):
    """
    Getter method for igmp, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp (container)
    """
    return self.__igmp
      
  def _set_igmp(self, v, load=False):
    """
    Setter method for igmp, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp (container)
