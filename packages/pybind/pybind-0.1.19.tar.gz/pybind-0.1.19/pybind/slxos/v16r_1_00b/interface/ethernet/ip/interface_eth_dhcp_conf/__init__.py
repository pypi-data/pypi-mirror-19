...
import __builtin__
import dhcp
class interface_eth_dhcp_conf(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/interface-eth-dhcp-conf. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__dhcp',)

  _yang_name = 'interface-eth-dhcp-conf'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'interface-eth-dhcp-conf']
  ...
  def _get_dhcp(self):
    """
    Getter method for dhcp, mapped from YANG variable /interface/ethernet/ip/interface_eth_dhcp_conf/dhcp (container)
    """
    return self.__dhcp
      
  def _set_dhcp(self, v, load=False):
    """
    Setter method for dhcp, mapped from YANG variable /interface/ethernet/ip/interface_eth_dhcp_conf/dhcp (container)
