...
import __builtin__
import ospf1
class interface_eth_ospf_conf(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/interface-eth-ospf-conf. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ospf1',)

  _yang_name = 'interface-eth-ospf-conf'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'interface-eth-ospf-conf']
  ...
  def _get_ospf1(self):
    """
    Getter method for ospf1, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1 (container)
    """
    return self.__ospf1
      
  def _set_ospf1(self, v, load=False):
    """
    Setter method for ospf1, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1 (container)
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=ospf1.ospf1, is_container='container', yang_name="ospf1", rest_name="ospf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Open Shortest Path First (OSPF).', u'cli-incomplete-no': None, u'display-when': u'/vcsmode/vcs-mode = "false"', u'sort-priority': u'118', u'alt-name': u'ospf'}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='container', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'ospf1': ospf1, }
