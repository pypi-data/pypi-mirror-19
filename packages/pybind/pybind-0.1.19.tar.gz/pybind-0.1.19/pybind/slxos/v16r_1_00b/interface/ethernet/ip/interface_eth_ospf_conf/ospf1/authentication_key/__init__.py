...
class authentication_key(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/interface-eth-ospf-conf/ospf1/authentication-key. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'interface-eth-ospf-conf', u'ospf1', u'authentication-key']
  ...
  def _get_no_encrypt_auth_key_table(self):
    """
    Getter method for no_encrypt_auth_key_table, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/authentication_key/no_encrypt_auth_key_table (container)
    """
    return self.__no_encrypt_auth_key_table
      
  def _set_no_encrypt_auth_key_table(self, v, load=False):
    """
    Setter method for no_encrypt_auth_key_table, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/authentication_key/no_encrypt_auth_key_table (container)
  ...
  def _get_auth_key_table(self):
    """
    Getter method for auth_key_table, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/authentication_key/auth_key_table (container)
    """
    return self.__auth_key_table
      
  def _set_auth_key_table(self, v, load=False):
    """
    Setter method for auth_key_table, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/authentication_key/auth_key_table (container)
    If this variable is read-only (config: false) in the
