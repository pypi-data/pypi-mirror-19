...
class no_encrypt_auth_key_table(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/interface-eth-ospf-conf/ospf1/authentication-key/no-encrypt-auth-key-table. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'interface-eth-ospf-conf', u'ospf1', u'authentication-key', u'no-encrypt-auth-key-table']
  ...
  def _get_no_encrypt_auth_key(self):
    """
    Getter method for no_encrypt_auth_key, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/authentication_key/no_encrypt_auth_key_table/no_encrypt_auth_key (ospf-auth-psswd-string)
    """
    return self.__no_encrypt_auth_key
      
  def _set_no_encrypt_auth_key(self, v, load=False):
    """
    Setter method for no_encrypt_auth_key, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/authentication_key/no_encrypt_auth_key_table/no_encrypt_auth_key (ospf-auth-psswd-string)
