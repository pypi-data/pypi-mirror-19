...
class no_encrypt_key_table(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/interface-eth-ospf-conf/ospf1/md5-authentication/no-encrypt-key-table. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'interface-eth-ospf-conf', u'ospf1', u'md5-authentication', u'no-encrypt-key-table']
  ...
  def _get_no_encrypt_key_id(self):
    """
    Getter method for no_encrypt_key_id, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/md5_authentication/no_encrypt_key_table/no_encrypt_key_id (uint32)
    """
    return self.__no_encrypt_key_id
      
  def _set_no_encrypt_key_id(self, v, load=False):
    """
    Setter method for no_encrypt_key_id, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/md5_authentication/no_encrypt_key_table/no_encrypt_key_id (uint32)
  ...
  def _get_no_encrypt_key(self):
    """
    Getter method for no_encrypt_key, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/md5_authentication/no_encrypt_key_table/no_encrypt_key (ospf-auth-psswd-string)
    """
    return self.__no_encrypt_key
      
  def _set_no_encrypt_key(self, v, load=False):
    """
    Setter method for no_encrypt_key, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/md5_authentication/no_encrypt_key_table/no_encrypt_key (ospf-auth-psswd-string)
    If this variable is read-only (config: false) in the
