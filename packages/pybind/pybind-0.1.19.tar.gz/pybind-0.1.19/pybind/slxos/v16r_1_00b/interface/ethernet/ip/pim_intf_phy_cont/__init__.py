...
class pim_intf_phy_cont(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/pim-intf-phy-cont. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'pim-intf-phy-cont']
  ...
  def _get_pim_int_cmd(self):
    """
    Getter method for pim_int_cmd, mapped from YANG variable /interface/ethernet/ip/pim_intf_phy_cont/pim_int_cmd (container)
    """
    return self.__pim_int_cmd
      
  def _set_pim_int_cmd(self, v, load=False):
    """
    Setter method for pim_int_cmd, mapped from YANG variable /interface/ethernet/ip/pim_intf_phy_cont/pim_int_cmd (container)
