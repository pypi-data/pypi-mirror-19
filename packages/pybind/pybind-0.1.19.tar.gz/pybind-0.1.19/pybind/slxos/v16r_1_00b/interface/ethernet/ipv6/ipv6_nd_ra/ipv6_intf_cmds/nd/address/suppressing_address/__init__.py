...
class suppressing_address(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ipv6/ipv6-nd-ra/ipv6-intf-cmds/nd/address/suppressing-address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ipv6', u'ipv6-nd-ra', u'ipv6-intf-cmds', u'nd', u'address', u'suppressing-address']
  ...
  def _get_suppress_ipv6_address(self):
    """
    Getter method for suppress_ipv6_address, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/address/suppressing_address/suppress_ipv6_address (inet:ipv6-address)
    """
    return self.__suppress_ipv6_address
      
  def _set_suppress_ipv6_address(self, v, load=False):
    """
    Setter method for suppress_ipv6_address, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/address/suppressing_address/suppress_ipv6_address (inet:ipv6-address)
  ...
  def _get_suppress_per_address(self):
    """
    Getter method for suppress_per_address, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/address/suppressing_address/suppress_per_address (empty)
    """
    return self.__suppress_per_address
      
  def _set_suppress_per_address(self, v, load=False):
    """
    Setter method for suppress_per_address, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/address/suppressing_address/suppress_per_address (empty)
    If this variable is read-only (config: false) in the
