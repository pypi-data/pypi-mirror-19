...
class suppress_ra(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ipv6/ipv6-nd-ra/ipv6-intf-cmds/nd/suppress-ra. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ipv6', u'ipv6-nd-ra', u'ipv6-intf-cmds', u'nd', u'suppress-ra']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'ipv6', u'nd', u'suppress-ra']

  def _get_suppress_ra_flag(self):
    """
    Getter method for suppress_ra_flag, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/suppress_ra/suppress_ra_flag (empty)
    """
    return self.__suppress_ra_flag
      
  def _set_suppress_ra_flag(self, v, load=False):
    """
    Setter method for suppress_ra_flag, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/suppress_ra/suppress_ra_flag (empty)
  ...
  def _get_suppress_ra_mtu(self):
    """
    Getter method for suppress_ra_mtu, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/suppress_ra/suppress_ra_mtu (empty)
    """
    return self.__suppress_ra_mtu
      
  def _set_suppress_ra_mtu(self, v, load=False):
    """
    Setter method for suppress_ra_mtu, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/suppress_ra/suppress_ra_mtu (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_suppress_ra_all(self):
    """
    Getter method for suppress_ra_all, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/suppress_ra/suppress_ra_all (empty)
    """
    return self.__suppress_ra_all
      
  def _set_suppress_ra_all(self, v, load=False):
    """
    Setter method for suppress_ra_all, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/suppress_ra/suppress_ra_all (empty)
    If this variable is read-only (config: false) in the
