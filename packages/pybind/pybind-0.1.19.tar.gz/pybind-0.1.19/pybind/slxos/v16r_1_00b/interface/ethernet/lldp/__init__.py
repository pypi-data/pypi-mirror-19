...
class lldp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/lldp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'lldp']
  ...
  def _get_cee(self):
    """
    Getter method for cee, mapped from YANG variable /interface/ethernet/lldp/cee (container)
  ...
  def _set_cee(self, v, load=False):
    """
    Setter method for cee, mapped from YANG variable /interface/ethernet/lldp/cee (container)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=cee.cee, is_container='container', yang_name="cee", rest_name="cee", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'hidden': u'debug', u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-lldp', defining_module='brocade-lldp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """cee must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=cee.cee, is_container='container', yang_name="cee", rest_name="cee", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'hidden': u'debug', u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-lldp', defining_module='brocade-lldp', yang_type='container', is_config=True)""",
        })
  ...
  def _get_dcbx_version(self):
    """
    Getter method for dcbx_version, mapped from YANG variable /interface/ethernet/lldp/dcbx_version (enumeration)
    """
    return self.__dcbx_version
      
  def _set_dcbx_version(self, v, load=False):
    """
    Setter method for dcbx_version, mapped from YANG variable /interface/ethernet/lldp/dcbx_version (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_disable(self):
    """
    Getter method for disable, mapped from YANG variable /interface/ethernet/lldp/disable (empty)
    """
    return self.__disable
      
  def _set_disable(self, v, load=False):
    """
    Setter method for disable, mapped from YANG variable /interface/ethernet/lldp/disable (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_iscsi_priority(self):
    """
    Getter method for iscsi_priority, mapped from YANG variable /interface/ethernet/lldp/iscsi_priority (uint32)
    """
    return self.__iscsi_priority
      
  def _set_iscsi_priority(self, v, load=False):
    """
    Setter method for iscsi_priority, mapped from YANG variable /interface/ethernet/lldp/iscsi_priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_profile(self):
    """
    Getter method for profile, mapped from YANG variable /interface/ethernet/lldp/profile (string)
    """
    return self.__profile
      
  def _set_profile(self, v, load=False):
    """
    Setter method for profile, mapped from YANG variable /interface/ethernet/lldp/profile (string)
    If this variable is read-only (config: false) in the
