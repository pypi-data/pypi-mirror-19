...
class cee(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/lldp/cee. Each member element of
  ...
  def _get_lldp_cee_on_off(self):
    """
    Getter method for lldp_cee_on_off, mapped from YANG variable /interface/ethernet/lldp/cee/lldp_cee_on_off (enumeration)
    """
    return self.__lldp_cee_on_off
      
  def _set_lldp_cee_on_off(self, v, load=False):
    """
    Setter method for lldp_cee_on_off, mapped from YANG variable /interface/ethernet/lldp/cee/lldp_cee_on_off (enumeration)
