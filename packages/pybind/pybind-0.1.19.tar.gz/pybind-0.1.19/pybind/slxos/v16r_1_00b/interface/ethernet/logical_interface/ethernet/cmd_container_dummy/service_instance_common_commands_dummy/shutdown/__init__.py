...
class shutdown(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/logical-interface/ethernet/cmd-container-dummy/service-instance-common-commands-dummy/shutdown. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'logical-interface', u'ethernet', u'cmd-container-dummy', u'service-instance-common-commands-dummy', u'shutdown']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'logical-interface', u'ethernet', u'shutdown']

  def _get_shutdown_status(self):
    """
    Getter method for shutdown_status, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_common_commands_dummy/shutdown/shutdown_status (empty)
    """
    return self.__shutdown_status
      
  def _set_shutdown_status(self, v, load=False):
    """
    Setter method for shutdown_status, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_common_commands_dummy/shutdown/shutdown_status (empty)
