...
class tagged_outer_vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/logical-interface/ethernet/cmd-container-dummy/service-instance-vlan-cmds-dummy-container/tagged-outer-vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'logical-interface', u'ethernet', u'cmd-container-dummy', u'service-instance-vlan-cmds-dummy-container', u'tagged-outer-vlan']
  ...
  def _get_outer_tagged_vlan_id(self):
    """
    Getter method for outer_tagged_vlan_id, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_vlan_cmds_dummy_container/tagged_outer_vlan/outer_tagged_vlan_id (uint32)
    """
    return self.__outer_tagged_vlan_id
      
  def _set_outer_tagged_vlan_id(self, v, load=False):
    """
    Setter method for outer_tagged_vlan_id, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_vlan_cmds_dummy_container/tagged_outer_vlan/outer_tagged_vlan_id (uint32)
  ...
  def _get_inner_vlan(self):
    """
    Getter method for inner_vlan, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_vlan_cmds_dummy_container/tagged_outer_vlan/inner_vlan (empty)
    """
    return self.__inner_vlan
      
  def _set_inner_vlan(self, v, load=False):
    """
    Setter method for inner_vlan, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_vlan_cmds_dummy_container/tagged_outer_vlan/inner_vlan (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_inner_tagged_vlan_id(self):
    """
    Getter method for inner_tagged_vlan_id, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_vlan_cmds_dummy_container/tagged_outer_vlan/inner_tagged_vlan_id (uint32)
    """
    return self.__inner_tagged_vlan_id
      
  def _set_inner_tagged_vlan_id(self, v, load=False):
    """
    Setter method for inner_tagged_vlan_id, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_vlan_cmds_dummy_container/tagged_outer_vlan/inner_tagged_vlan_id (uint32)
    If this variable is read-only (config: false) in the
