...
class flowcontrol(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/qos/flowcontrol. Each member element of
  ...
  def _get_link_level_flowcontrol(self):
    """
    Getter method for link_level_flowcontrol, mapped from YANG variable /interface/ethernet/qos/flowcontrol/link_level_flowcontrol (container)
    """
    return self.__link_level_flowcontrol
      
  def _set_link_level_flowcontrol(self, v, load=False):
    """
    Setter method for link_level_flowcontrol, mapped from YANG variable /interface/ethernet/qos/flowcontrol/link_level_flowcontrol (container)
  ...
  def _get_pfc(self):
    """
    Getter method for pfc, mapped from YANG variable /interface/ethernet/qos/flowcontrol/pfc (list)
    """
    return self.__pfc
      
  def _set_pfc(self, v, load=False):
    """
    Setter method for pfc, mapped from YANG variable /interface/ethernet/qos/flowcontrol/pfc (list)
    If this variable is read-only (config: false) in the
