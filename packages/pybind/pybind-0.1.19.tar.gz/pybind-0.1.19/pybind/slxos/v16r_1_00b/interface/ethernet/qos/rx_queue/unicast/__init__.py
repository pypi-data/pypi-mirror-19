...
class unicast(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/qos/rx-queue/unicast. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__queue_size',)
  ...
  def _get_queue_size(self):
    """
    Getter method for queue_size, mapped from YANG variable /interface/ethernet/qos/rx_queue/unicast/queue_size (list)
    """
    return self.__queue_size
      
  def _set_queue_size(self, v, load=False):
    """
    Setter method for queue_size, mapped from YANG variable /interface/ethernet/qos/rx_queue/unicast/queue_size (list)
  ...
  _pyangbind_elements = {'queue_size': queue_size, }
