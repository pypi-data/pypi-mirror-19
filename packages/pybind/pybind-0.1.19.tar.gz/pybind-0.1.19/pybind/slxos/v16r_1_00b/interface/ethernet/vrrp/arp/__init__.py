...
class arp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/vrrp/arp. Each member element of
  ...
  def _get_unicast_request(self):
    """
    Getter method for unicast_request, mapped from YANG variable /interface/ethernet/vrrp/arp/unicast_request (container)
  ...
  def _set_unicast_request(self, v, load=False):
    """
    Setter method for unicast_request, mapped from YANG variable /interface/ethernet/vrrp/arp/unicast_request (container)
