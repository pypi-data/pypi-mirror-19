...
entry represents a port-channel.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__vlag','__po_speed','__ifindex','__description','__shutdown','__minimum_links','__mtu','__switchport_basic','__switchport','__ip','__ipv6','__track','__edge_loop_detection','__priority_tag_enable','__load_balance','__load_balance_type','__mac','__hide_vrrp_holer','__logical_interface','__fcoeport','__ip_acl_interface','__port_profile_port','__port_profile_to_interface_associations','__qos','__service_policy','__spanning_tree',)
