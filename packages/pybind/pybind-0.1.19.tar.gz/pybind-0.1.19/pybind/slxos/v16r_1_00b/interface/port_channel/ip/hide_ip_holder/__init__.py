...
import __builtin__
import ip_config
class hide_ip_holder(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/hide-ip-holder. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ip_config',)

  _yang_name = 'hide-ip-holder'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'hide-ip-holder']
  ...
  def _get_ip_config(self):
    """
    Getter method for ip_config, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config (container)
    """
    return self.__ip_config
      
  def _set_ip_config(self, v, load=False):
    """
    Setter method for ip_config, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config (container)
  ...
  _pyangbind_elements = {'ip_config': ip_config, }
