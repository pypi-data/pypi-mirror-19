...
class short_path_forwarding(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ipv6/hide-vrrpv3-holder/vrrpv3e/short-path-forwarding. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ipv6', u'hide-vrrpv3-holder', u'vrrpv3e', u'short-path-forwarding']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'ipv6', u'vrrp-extended-group', u'short-path-forwarding']

  def _get_basic(self):
    """
    Getter method for basic, mapped from YANG variable /interface/port_channel/ipv6/hide_vrrpv3_holder/vrrpv3e/short_path_forwarding/basic (empty)
    """
    return self.__basic
      
  def _set_basic(self, v, load=False):
    """
    Setter method for basic, mapped from YANG variable /interface/port_channel/ipv6/hide_vrrpv3_holder/vrrpv3e/short_path_forwarding/basic (empty)
  ...
  def _get_revert_priority(self):
    """
    Getter method for revert_priority, mapped from YANG variable /interface/port_channel/ipv6/hide_vrrpv3_holder/vrrpv3e/short_path_forwarding/revert_priority (uint8)
  ...
  def _set_revert_priority(self, v, load=False):
    """
    Setter method for revert_priority, mapped from YANG variable /interface/port_channel/ipv6/hide_vrrpv3_holder/vrrpv3e/short_path_forwarding/revert_priority (uint8)
    If this variable is read-only (config: false) in the
