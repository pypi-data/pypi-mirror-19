...
class interface(PybindBase):
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /interface/port_channel/ipv6/hide_vrrpv3_holder/vrrpv3e/track/interface/interface_name (track-ifname)
    """
    return self.__interface_name
      
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /interface/port_channel/ipv6/hide_vrrpv3_holder/vrrpv3e/track/interface/interface_name (track-ifname)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "brocade-vrrpv3:track-ifname",
