...
class service_instance_vlan_cmds_dummy_container(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/logical-interface/port-channel/pc-cmd-container-dummy/service-instance-vlan-cmds-dummy-container. Each member element of
  ...
  def _get_get_untagged_vlan_dummy(self):
    """
    Getter method for get_untagged_vlan_dummy, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/pc_cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy (container)
    """
    return self.__get_untagged_vlan_dummy
      
  def _set_get_untagged_vlan_dummy(self, v, load=False):
    """
    Setter method for get_untagged_vlan_dummy, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/pc_cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy (container)
  ...
  def _get_tagged_outer_vlan(self):
    """
    Getter method for tagged_outer_vlan, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/pc_cmd_container_dummy/service_instance_vlan_cmds_dummy_container/tagged_outer_vlan (container)
    """
