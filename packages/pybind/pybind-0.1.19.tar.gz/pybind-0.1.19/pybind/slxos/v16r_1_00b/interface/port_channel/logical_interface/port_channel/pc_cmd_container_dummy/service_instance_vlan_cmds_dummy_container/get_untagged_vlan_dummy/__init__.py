...
class get_untagged_vlan_dummy(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__untagged',)
  ...
  def _get_untagged(self):
    """
    Getter method for untagged, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/pc_cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy/untagged (container)
    """
    return self.__untagged
      
  def _set_untagged(self, v, load=False):
    """
    Setter method for untagged, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/pc_cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy/untagged (container)
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=untagged.untagged, is_container='container', yang_name="untagged", rest_name="untagged", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure untagged VLAN on this logical interface', u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-lif', defining_module='brocade-lif', yang_type='container', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'untagged': untagged, }
