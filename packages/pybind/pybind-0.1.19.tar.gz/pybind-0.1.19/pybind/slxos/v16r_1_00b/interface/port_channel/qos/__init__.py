...
class qos(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__default_cos','__default_tc','__trust','__cos_mutation','__traffic_class_cos','__cos_traffic_class','__dscp_mutation','__dscp_traffic_class','__dscp_cos','__random_detect','__drop_monitor','__flowcontrol',)
  ...
  def _get_default_cos(self):
    """
    Getter method for default_cos, mapped from YANG variable /interface/port_channel/qos/default_cos (cos-id-type)
    """
    return self.__default_cos
      
  def _set_default_cos(self, v, load=False):
    """
    Setter method for default_cos, mapped from YANG variable /interface/port_channel/qos/default_cos (cos-id-type)
  ...
  def _get_default_tc(self):
    """
    Getter method for default_tc, mapped from YANG variable /interface/port_channel/qos/default_tc (traffic-class-id-type)
    """
    return self.__default_tc
      
  def _set_default_tc(self, v, load=False):
    """
    Setter method for default_tc, mapped from YANG variable /interface/port_channel/qos/default_tc (traffic-class-id-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_traffic_class_cos(self):
    """
    Getter method for traffic_class_cos, mapped from YANG variable /interface/port_channel/qos/traffic_class_cos (map-name-type)
    """
    return self.__traffic_class_cos
      
  def _set_traffic_class_cos(self, v, load=False):
    """
    Setter method for traffic_class_cos, mapped from YANG variable /interface/port_channel/qos/traffic_class_cos (map-name-type)
    If this variable is read-only (config: false) in the
