...
class spanning_tree(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__autoedge','__cost','__portfast','__edgeport','__guard','__bpdu_mac','__link_type','__priority','__restricted_role','__restricted_tcn','__shutdown','__vlan','__instance','__peer_switch',)
  ...
  _pyangbind_elements = {'autoedge': autoedge, 'cost': cost, 'portfast': portfast, 'edgeport': edgeport, 'guard': guard, 'bpdu_mac': bpdu_mac, 'link_type': link_type, 'priority': priority, 'restricted_role': restricted_role, 'restricted_tcn': restricted_tcn, 'shutdown': shutdown, 'vlan': vlan, 'instance': instance, 'peer_switch': peer_switch, }
