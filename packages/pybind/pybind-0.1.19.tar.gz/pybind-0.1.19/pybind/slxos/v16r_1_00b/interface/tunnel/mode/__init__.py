...
class mode(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tunnel/mode. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__gre','__vxlan',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tunnel', u'mode']
  ...
  def _get_gre(self):
    """
    Getter method for gre, mapped from YANG variable /interface/tunnel/mode/gre (container)
    """
    return self.__gre
      
  def _set_gre(self, v, load=False):
    """
    Setter method for gre, mapped from YANG variable /interface/tunnel/mode/gre (container)
  ...
  def _get_vxlan(self):
    """
    Getter method for vxlan, mapped from YANG variable /interface/tunnel/mode/vxlan (empty)
    """
    return self.__vxlan
      
  def _set_vxlan(self, v, load=False):
    """
    Setter method for vxlan, mapped from YANG variable /interface/tunnel/mode/vxlan (empty)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="vxlan", rest_name="vxlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'vxlan', u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-gre-vxlan', defining_module='brocade-gre-vxlan', yang_type='empty', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vxlan must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vxlan", rest_name="vxlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'vxlan', u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-gre-vxlan', defining_module='brocade-gre-vxlan', yang_type='empty', is_config=True)""",
        })
  ...
  gre = __builtin__.property(_get_gre, _set_gre)
  vxlan = __builtin__.property(_get_vxlan, _set_vxlan)


  _pyangbind_elements = {'gre': gre, 'vxlan': vxlan, }
