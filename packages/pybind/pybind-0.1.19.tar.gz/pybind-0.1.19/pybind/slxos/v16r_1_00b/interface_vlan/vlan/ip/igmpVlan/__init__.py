...
import __builtin__
import snooping
class igmpVlan(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface-vlan/vlan/ip/igmpVlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface-vlan', u'vlan', u'ip', u'igmpVlan']
  ...
  def _set_snooping(self, v, load=False):
    """
    Setter method for snooping, mapped from YANG variable /interface_vlan/vlan/ip/igmpVlan/snooping (container)
