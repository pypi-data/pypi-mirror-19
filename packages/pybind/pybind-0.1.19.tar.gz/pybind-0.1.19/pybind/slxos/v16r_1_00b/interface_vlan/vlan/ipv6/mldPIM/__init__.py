...
class mldPIM(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/vlan/ipv6/mldPIM. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface-vlan', u'vlan', u'ipv6', u'mldPIM']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vlan', u'ipv6', u'pim']

  def _get_snooping(self):
    """
    Getter method for snooping, mapped from YANG variable /interface_vlan/vlan/ipv6/mldPIM/snooping (container)
    """
    return self.__snooping
      
  def _set_snooping(self, v, load=False):
    """
    Setter method for snooping, mapped from YANG variable /interface_vlan/vlan/ipv6/mldPIM/snooping (container)
