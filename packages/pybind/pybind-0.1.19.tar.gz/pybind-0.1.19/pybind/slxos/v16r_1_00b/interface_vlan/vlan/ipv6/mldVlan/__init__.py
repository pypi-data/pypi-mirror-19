...
class mldVlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/vlan/ipv6/mldVlan. Each member element of
  ...
  def _get_snooping(self):
    """
    Getter method for snooping, mapped from YANG variable /interface_vlan/vlan/ipv6/mldVlan/snooping (container)
    """
    return self.__snooping
      
  def _set_snooping(self, v, load=False):
    """
    Setter method for snooping, mapped from YANG variable /interface_vlan/vlan/ipv6/mldVlan/snooping (container)
