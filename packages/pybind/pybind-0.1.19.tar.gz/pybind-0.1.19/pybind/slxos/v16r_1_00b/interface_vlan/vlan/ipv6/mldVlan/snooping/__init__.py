...
class snooping(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__last_member_query_interval','__last_member_query_count','__startup_query_interval','__startup_query_count','__query_max_response_time','__query_interval','__mldVersion','__enable','__fast_leave','__querier','__mrouter','__static_group',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__mldVersion = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'v[1|2]'}), is_leaf=True, yang_name="mldVersion", rest_name="version", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'MLD Version [v1|v2]', u'cli-full-command': None, u'alt-name': u'version'}}, namespace='urn:brocade.com:mgmt:brocade-mld-snooping', defining_module='brocade-mld-snooping', yang_type='version-type', is_config=True)
    self.__querier = YANGDynClass(base=querier.querier, is_container='container', yang_name="querier", rest_name="querier", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Querier', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mld-snooping', defining_module='brocade-mld-snooping', yang_type='container', is_config=True)
  ...
  def _get_mldVersion(self):
    ...
    """
    return self.__mldVersion
      
  def _set_mldVersion(self, v, load=False):
    """
    Setter method for mldVersion, mapped from YANG variable /interface_vlan/vlan/ipv6/mldVlan/snooping/mldVersion (version-type)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mldVersion is considered as a private
    method. Backends looking to populate this variable should
    ...
    try:
      ...
      raise ValueError({
          'error-string': """mldVersion must be of a type compatible with version-type""",
          'defined-type': "brocade-mld-snooping:version-type",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'v[1|2]'}), is_leaf=True, yang_name="mldVersion", rest_name="version", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'MLD Version [v1|v2]', u'cli-full-command': None, u'alt-name': u'version'}}, namespace='urn:brocade.com:mgmt:brocade-mld-snooping', defining_module='brocade-mld-snooping', yang_type='version-type', is_config=True)""",
        })
  ...
  def _set_querier(self, v, load=False):
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=querier.querier, is_container='container', yang_name="querier", rest_name="querier", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Querier', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mld-snooping', defining_module='brocade-mld-snooping', yang_type='container', is_config=True)""",
        })
  ...
  mldVersion = __builtin__.property(_get_mldVersion, _set_mldVersion)
