...
class hide_ext_community_list_holder(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /ip/hide-ext-community-list-holder. Each member element of
  ...
  def _set_extcommunity_list(self, v, load=False):
    """
    Setter method for extcommunity_list, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list (container)
  ...
  _pyangbind_elements = {'extcommunity_list': extcommunity_list, }
