...
class standard(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ip/hide-ext-community-list-holder/extcommunity-list/standard. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__extcommunity_list_name','__ext_community_action','__ext_community_expr',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__extcommunity_list_name = YANGDynClass(base=unicode, is_leaf=True, yang_name="extcommunity-list-name", rest_name="extcommunity-list-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='ip-extcommunity-list-name-t', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ip', u'hide-ext-community-list-holder', u'extcommunity-list', u'standard']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ip', u'extcommunity-list', u'standard']
  ...
  def _set_extcommunity_list_name(self, v, load=False):
    """
    Setter method for extcommunity_list_name, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list/standard/extcommunity_list_name (ip-extcommunity-list-name-t)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="extcommunity-list-name", rest_name="extcommunity-list-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='ip-extcommunity-list-name-t', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """extcommunity_list_name must be of a type compatible with ip-extcommunity-list-name-t""",
          'defined-type': "brocade-ip-policy:ip-extcommunity-list-name-t",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="extcommunity-list-name", rest_name="extcommunity-list-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='ip-extcommunity-list-name-t', is_config=True)""",
        })
  ...
  def _set_ext_community_action(self, v, load=False):
    """
    Setter method for ext_community_action, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list/standard/ext_community_action (action-t)
    If this variable is read-only (config: false) in the
  ...
  def _set_ext_community_expr(self, v, load=False):
    """
    Setter method for ext_community_expr, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list/standard/ext_community_expr (extcommunity-list-expr-t)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'extcommunity_list_name': extcommunity_list_name, 'ext_community_action': ext_community_action, 'ext_community_expr': ext_community_expr, }
