...
class link_local_static_route_nh_vrf(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ipv6/route/link-local-static-route-nh-vrf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ipv6', u'route', u'link-local-static-route-nh-vrf']
  ...
  def _set_static_route_next_vrf_dest(self, v, load=False):
    """
    Setter method for static_route_next_vrf_dest, mapped from YANG variable /ipv6/route/link_local_static_route_nh_vrf/static_route_next_vrf_dest (inet:ipv6-prefix)
  ...
  def _set_next_hop_vrf(self, v, load=False):
    """
    Setter method for next_hop_vrf, mapped from YANG variable /ipv6/route/link_local_static_route_nh_vrf/next_hop_vrf (common-def:vrf-name)
    If this variable is read-only (config: false) in the
  ...
  def _set_link_local_next_hop(self, v, load=False):
    """
    Setter method for link_local_next_hop, mapped from YANG variable /ipv6/route/link_local_static_route_nh_vrf/link_local_next_hop (inet:ipv6-address)
    If this variable is read-only (config: false) in the
  ...
  def _set_link_local_route_oif_type(self, v, load=False):
    """
    Setter method for link_local_route_oif_type, mapped from YANG variable /ipv6/route/link_local_static_route_nh_vrf/link_local_route_oif_type (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _set_link_local_route_oif_name(self, v, load=False):
    """
    Setter method for link_local_route_oif_name, mapped from YANG variable /ipv6/route/link_local_static_route_nh_vrf/link_local_route_oif_name (string)
    If this variable is read-only (config: false) in the
