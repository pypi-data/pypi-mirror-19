...
class static(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ipv6/route/static. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ipv6', u'route', u'static']
  ...
  def _get_bfd(self):
    """
    Getter method for bfd, mapped from YANG variable /ipv6/route/static/bfd (container)
    """
    return self.__bfd
      
  def _set_bfd(self, v, load=False):
    """
    Setter method for bfd, mapped from YANG variable /ipv6/route/static/bfd (container)
