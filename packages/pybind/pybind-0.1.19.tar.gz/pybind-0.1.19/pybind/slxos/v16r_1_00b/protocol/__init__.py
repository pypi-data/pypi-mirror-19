...
class protocol(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__cfm','__edge_loop_detection','__lldp','__udld','__spanning_tree',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__cfm = YANGDynClass(base=cfm.cfm, is_container='container', yang_name="cfm", rest_name="cfm", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'CFM Protocol configuration mode', u'callpoint': u'setDot1agEnable', u'sort-priority': u'57', u'cli-full-command': None, u'cli-add-mode': None, u'cli-full-no': None, u'cli-mode-name': u'config-cfm'}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='container', is_config=True)
  ...
  def _set_cfm(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=cfm.cfm, is_container='container', yang_name="cfm", rest_name="cfm", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'CFM Protocol configuration mode', u'callpoint': u'setDot1agEnable', u'sort-priority': u'57', u'cli-full-command': None, u'cli-add-mode': None, u'cli-full-no': None, u'cli-mode-name': u'config-cfm'}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """cfm must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=cfm.cfm, is_container='container', yang_name="cfm", rest_name="cfm", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'CFM Protocol configuration mode', u'callpoint': u'setDot1agEnable', u'sort-priority': u'57', u'cli-full-command': None, u'cli-add-mode': None, u'cli-full-no': None, u'cli-mode-name': u'config-cfm'}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='container', is_config=True)""",
        })
...
leaf
  ...
  _pyangbind_elements = {'cfm': cfm, 'edge_loop_detection': edge_loop_detection, 'lldp': lldp, 'udld': udld, 'spanning_tree': spanning_tree, }
