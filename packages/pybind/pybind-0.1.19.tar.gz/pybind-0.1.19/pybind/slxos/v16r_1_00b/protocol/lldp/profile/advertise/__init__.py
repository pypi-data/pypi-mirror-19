...
class advertise(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /protocol/lldp/profile/advertise. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'protocol', u'lldp', u'profile', u'advertise']
  ...
  def _set_dcbx_fcoe_app_tlv(self, v, load=False):
    """
    Setter method for dcbx_fcoe_app_tlv, mapped from YANG variable /protocol/lldp/profile/advertise/dcbx_fcoe_app_tlv (empty)
  ...
  def _set_dcbx_fcoe_logical_link_tlv(self, v, load=False):
    """
    Setter method for dcbx_fcoe_logical_link_tlv, mapped from YANG variable /protocol/lldp/profile/advertise/dcbx_fcoe_logical_link_tlv (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_dcbx_iscsi_app_tlv(self, v, load=False):
    """
    Setter method for dcbx_iscsi_app_tlv, mapped from YANG variable /protocol/lldp/profile/advertise/dcbx_iscsi_app_tlv (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_dcbx_tlv(self, v, load=False):
    """
    Setter method for dcbx_tlv, mapped from YANG variable /protocol/lldp/profile/advertise/dcbx_tlv (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_dot1_tlv(self, v, load=False):
    """
    Setter method for dot1_tlv, mapped from YANG variable /protocol/lldp/profile/advertise/dot1_tlv (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_dot3_tlv(self, v, load=False):
    """
    Setter method for dot3_tlv, mapped from YANG variable /protocol/lldp/profile/advertise/dot3_tlv (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_optional_tlv(self, v, load=False):
    """
    Setter method for optional_tlv, mapped from YANG variable /protocol/lldp/profile/advertise/optional_tlv (container)
    If this variable is read-only (config: false) in the
