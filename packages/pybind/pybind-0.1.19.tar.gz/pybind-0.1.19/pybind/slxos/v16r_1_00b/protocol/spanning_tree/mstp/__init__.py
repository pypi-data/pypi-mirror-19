...
class mstp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__timer_config','__description','__bridge_priority','__error_disable_timeout','__port_channel','__shutdown','__cisco_interoperability','__instance','__region','__revision','__max_hops','__transmit_holdcount',)
  ...
  def _get_timer_config(self):
    """
    Getter method for timer_config, mapped from YANG variable /protocol/spanning_tree/mstp/timer_config (container)
    """
    return self.__timer_config
      
  def _set_timer_config(self, v, load=False):
    """
    Setter method for timer_config, mapped from YANG variable /protocol/spanning_tree/mstp/timer_config (container)
  ...
  _pyangbind_elements = {'timer_config': timer_config, 'description': description, 'bridge_priority': bridge_priority, 'error_disable_timeout': error_disable_timeout, 'port_channel': port_channel, 'shutdown': shutdown, 'cisco_interoperability': cisco_interoperability, 'instance': instance, 'region': region, 'revision': revision, 'max_hops': max_hops, 'transmit_holdcount': transmit_holdcount, }
