...
class vlan(PybindBase):
  ...
  def _get_timer_config(self):
    """
    Getter method for timer_config, mapped from YANG variable /protocol/spanning_tree/pvst/vlan/timer_config (container)
    """
    return self.__timer_config
      
  def _set_timer_config(self, v, load=False):
    """
    Setter method for timer_config, mapped from YANG variable /protocol/spanning_tree/pvst/vlan/timer_config (container)
    If this variable is read-only (config: false) in the
