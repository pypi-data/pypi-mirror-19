...
class vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /protocol/spanning-tree/rpvst/vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'protocol', u'spanning-tree', u'rpvst', u'vlan']
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /protocol/spanning_tree/rpvst/vlan/id (uint32)
  ...
  def _set_priority(self, v, load=False):
    """
    Setter method for priority, mapped from YANG variable /protocol/spanning_tree/rpvst/vlan/priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _set_timer_config(self, v, load=False):
    """
    Setter method for timer_config, mapped from YANG variable /protocol/spanning_tree/rpvst/vlan/timer_config (container)
    If this variable is read-only (config: false) in the
