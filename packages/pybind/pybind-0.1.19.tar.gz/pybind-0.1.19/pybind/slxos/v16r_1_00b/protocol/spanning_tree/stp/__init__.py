...
class stp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__timer_config','__description','__bridge_priority','__error_disable_timeout','__port_channel','__shutdown',)
  ...
  _pyangbind_elements = {'timer_config': timer_config, 'description': description, 'bridge_priority': bridge_priority, 'error_disable_timeout': error_disable_timeout, 'port_channel': port_channel, 'shutdown': shutdown, }
