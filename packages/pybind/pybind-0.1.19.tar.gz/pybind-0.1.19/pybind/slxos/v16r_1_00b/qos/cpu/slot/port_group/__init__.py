...
class port_group(PybindBase):
  ...
  from YANG module brocade-qos-mls - based on the path /qos/cpu/slot/port-group. Each member element of
  ...
  _pyangbind_elements = {'port': port, 'group': group, }
