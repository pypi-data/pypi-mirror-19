...
class email_list(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/maps/email/email-list. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'maps', u'email', u'email-list']
  ...
  def _get_email(self):
    """
    Getter method for email, mapped from YANG variable /rbridge_id/maps/email/email_list/email (string)
    """
    return self.__email
      
  def _set_email(self, v, load=False):
    """
    Setter method for email, mapped from YANG variable /rbridge_id/maps/email/email_list/email (string)
