...
class fabric_virtual_gateway(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /router/fabric-virtual-gateway. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Fabric virtual gateway
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__address_family',)

  _yang_name = 'fabric-virtual-gateway'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'fabric-virtual-gateway']
  ...
  def _get_address_family(self):
    """
    Getter method for address_family, mapped from YANG variable /router/fabric_virtual_gateway/address_family (container)
  ...
  def _set_address_family(self, v, load=False):
    """
    Setter method for address_family, mapped from YANG variable /router/fabric_virtual_gateway/address_family (container)
