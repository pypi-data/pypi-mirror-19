...
class routing_system(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__router','__ip','__ipv6','__protocol','__interface','__route_map',)
  ...
  _pyangbind_elements = {'router': router, 'ip': ip, 'ipv6': ipv6, 'protocol': protocol, 'interface': interface, 'route_map': route_map, }
