...
class interface_metric(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/intf-isis/interface-isis/interface-metric. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'intf-isis', u'interface-isis', u'interface-metric']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Loopback', u'isis', u'metric']
  ...
  def _set_interface_metric_level(self, v, load=False):
    """
    Setter method for interface_metric_level, mapped from YANG variable /routing_system/interface/loopback/intf_isis/interface_isis/interface_metric/interface_metric_level (enumeration)
  ...
  def _set_interface_metric_val(self, v, load=False):
    """
    Setter method for interface_metric_val, mapped from YANG variable /routing_system/interface/loopback/intf_isis/interface_isis/interface_metric/interface_metric_val (uint32)
    If this variable is read-only (config: false) in the
