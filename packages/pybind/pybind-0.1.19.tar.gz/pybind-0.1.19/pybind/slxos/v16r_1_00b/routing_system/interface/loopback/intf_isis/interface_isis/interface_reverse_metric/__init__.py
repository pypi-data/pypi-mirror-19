...
class interface_reverse_metric(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/intf-isis/interface-isis/interface-reverse-metric. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'intf-isis', u'interface-isis', u'interface-reverse-metric']
  ...
  def _set_rev_metric_common_attributes(self, v, load=False):
    """
    Setter method for rev_metric_common_attributes, mapped from YANG variable /routing_system/interface/loopback/intf_isis/interface_isis/interface_reverse_metric/rev_metric_common_attributes (container)
