...
class md5_authentication(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/ip/interface-loopback-ospf-conf/ospf1/md5-authentication. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'ip', u'interface-loopback-ospf-conf', u'ospf1', u'md5-authentication']
  ...
  def _set_key_activation_wait_time(self, v, load=False):
    """
    Setter method for key_activation_wait_time, mapped from YANG variable /routing_system/interface/loopback/ip/interface_loopback_ospf_conf/ospf1/md5_authentication/key_activation_wait_time (common-def:time-interval-sec)
  ...
  def _set_no_encrypt_key_table(self, v, load=False):
    """
    Setter method for no_encrypt_key_table, mapped from YANG variable /routing_system/interface/loopback/ip/interface_loopback_ospf_conf/ospf1/md5_authentication/no_encrypt_key_table (container)
    If this variable is read-only (config: false) in the
  ...
  def _set_key_table(self, v, load=False):
    """
    Setter method for key_table, mapped from YANG variable /routing_system/interface/loopback/ip/interface_loopback_ospf_conf/ospf1/md5_authentication/key_table (container)
    If this variable is read-only (config: false) in the
