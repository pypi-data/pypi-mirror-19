...
import __builtin__
import pim_int_cmd
class pim_intf_loopback_cont(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/ip/pim-intf-loopback-cont. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__pim_int_cmd',)

  _yang_name = 'pim-intf-loopback-cont'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'ip', u'pim-intf-loopback-cont']
  ...
  def _set_pim_int_cmd(self, v, load=False):
    """
    Setter method for pim_int_cmd, mapped from YANG variable /routing_system/interface/loopback/ip/pim_intf_loopback_cont/pim_int_cmd (container)
