...
class intf_ipv6_router_isis(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/ipv6/intf-ipv6-router-isis. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'ipv6', u'intf-ipv6-router-isis']
  ...
  def _set_int_ipv6_router_isis(self, v, load=False):
    """
    Setter method for int_ipv6_router_isis, mapped from YANG variable /routing_system/interface/loopback/ipv6/intf_ipv6_router_isis/int_ipv6_router_isis (container)
