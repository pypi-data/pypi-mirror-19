...
class ipv6_config(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/ipv6/ipv6-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'ipv6', u'ipv6-config']
  ...
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /routing_system/interface/loopback/ipv6/ipv6_config/address (container)
