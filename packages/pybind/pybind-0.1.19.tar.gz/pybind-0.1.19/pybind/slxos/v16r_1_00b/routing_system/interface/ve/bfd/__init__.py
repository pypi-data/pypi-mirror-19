...
class bfd(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/bfd. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'bfd']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'bfd']

  def _get_interval(self):
    """
    Getter method for interval, mapped from YANG variable /routing_system/interface/ve/bfd/interval (container)
  ...
  def _set_interval(self, v, load=False):
    """
    Setter method for interval, mapped from YANG variable /routing_system/interface/ve/bfd/interval (container)
  ...
  def _get_bfd_shutdown(self):
    """
    Getter method for bfd_shutdown, mapped from YANG variable /routing_system/interface/ve/bfd/bfd_shutdown (empty)
  ...
  def _set_bfd_shutdown(self, v, load=False):
    """
    Setter method for bfd_shutdown, mapped from YANG variable /routing_system/interface/ve/bfd/bfd_shutdown (empty)
    If this variable is read-only (config: false) in the
