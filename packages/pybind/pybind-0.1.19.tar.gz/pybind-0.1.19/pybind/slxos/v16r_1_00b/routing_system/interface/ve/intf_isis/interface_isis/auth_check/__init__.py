...
class auth_check(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/intf-isis/interface-isis/auth-check. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'intf-isis', u'interface-isis', u'auth-check']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'isis', u'auth-check']
  ...
  def _set_auth_check_level1(self, v, load=False):
    """
    Setter method for auth_check_level1, mapped from YANG variable /routing_system/interface/ve/intf_isis/interface_isis/auth_check/auth_check_level1 (container)
