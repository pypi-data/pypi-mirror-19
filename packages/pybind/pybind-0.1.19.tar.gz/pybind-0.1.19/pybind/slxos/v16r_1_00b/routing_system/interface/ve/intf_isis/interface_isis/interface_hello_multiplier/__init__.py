...
class interface_hello_multiplier(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/intf-isis/interface-isis/interface-hello-multiplier. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'intf-isis', u'interface-isis', u'interface-hello-multiplier']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'isis', u'hello-multiplier']
  ...
  def _set_interface_hello_multiplier_level(self, v, load=False):
    """
    Setter method for interface_hello_multiplier_level, mapped from YANG variable /routing_system/interface/ve/intf_isis/interface_isis/interface_hello_multiplier/interface_hello_multiplier_level (enumeration)
  ...
  def _set_interface_hello_multiplier_val(self, v, load=False):
    """
    Setter method for interface_hello_multiplier_val, mapped from YANG variable /routing_system/interface/ve/intf_isis/interface_isis/interface_hello_multiplier/interface_hello_multiplier_val (uint32)
    If this variable is read-only (config: false) in the
