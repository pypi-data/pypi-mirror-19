...
class rev_metric_common_attributes(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/intf-isis/interface-isis/interface-reverse-metric/rev-metric-common-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'intf-isis', u'interface-isis', u'interface-reverse-metric', u'rev-metric-common-attributes']
  ...
  def _set_rev_metric_val(self, v, load=False):
    """
    Setter method for rev_metric_val, mapped from YANG variable /routing_system/interface/ve/intf_isis/interface_isis/interface_reverse_metric/rev_metric_common_attributes/rev_metric_val (uint32)
  ...
  def _set_rev_metric_whole_lan(self, v, load=False):
    """
    Setter method for rev_metric_whole_lan, mapped from YANG variable /routing_system/interface/ve/intf_isis/interface_isis/interface_reverse_metric/rev_metric_common_attributes/rev_metric_whole_lan (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_rev_metric_te_def_metric(self, v, load=False):
    """
    Setter method for rev_metric_te_def_metric, mapped from YANG variable /routing_system/interface/ve/intf_isis/interface_isis/interface_reverse_metric/rev_metric_common_attributes/rev_metric_te_def_metric (empty)
    If this variable is read-only (config: false) in the
