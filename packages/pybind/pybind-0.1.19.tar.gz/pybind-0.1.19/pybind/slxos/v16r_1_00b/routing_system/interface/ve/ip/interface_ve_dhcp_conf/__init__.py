...
class interface_ve_dhcp_conf(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/interface-ve-dhcp-conf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'interface-ve-dhcp-conf']
  ...
  def _set_dhcp(self, v, load=False):
    """
    Setter method for dhcp, mapped from YANG variable /routing_system/interface/ve/ip/interface_ve_dhcp_conf/dhcp (container)
