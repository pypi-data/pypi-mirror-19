...
class authentication_key(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/interface-vlan-ospf-conf/ospf1/authentication-key. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'interface-vlan-ospf-conf', u'ospf1', u'authentication-key']
  ...
  def _set_no_encrypt_auth_key_table(self, v, load=False):
    """
    Setter method for no_encrypt_auth_key_table, mapped from YANG variable /routing_system/interface/ve/ip/interface_vlan_ospf_conf/ospf1/authentication_key/no_encrypt_auth_key_table (container)
  ...
  def _set_auth_key_table(self, v, load=False):
    """
    Setter method for auth_key_table, mapped from YANG variable /routing_system/interface/ve/ip/interface_vlan_ospf_conf/ospf1/authentication_key/auth_key_table (container)
    If this variable is read-only (config: false) in the
