...
class bfd(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/interface-vlan-ospf-conf/ospf1/bfd. Each member element of
  ...
  def _get_intf_bfd_enable(self):
    """
    Getter method for intf_bfd_enable, mapped from YANG variable /routing_system/interface/ve/ip/interface_vlan_ospf_conf/ospf1/bfd/intf_bfd_enable (empty)
  ...
  def _set_intf_bfd_enable(self, v, load=False):
    """
    Setter method for intf_bfd_enable, mapped from YANG variable /routing_system/interface/ve/ip/interface_vlan_ospf_conf/ospf1/bfd/intf_bfd_enable (empty)
