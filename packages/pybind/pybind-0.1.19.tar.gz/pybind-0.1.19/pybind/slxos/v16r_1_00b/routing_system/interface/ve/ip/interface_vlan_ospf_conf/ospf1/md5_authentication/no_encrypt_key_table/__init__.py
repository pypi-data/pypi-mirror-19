...
class no_encrypt_key_table(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/interface-vlan-ospf-conf/ospf1/md5-authentication/no-encrypt-key-table. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'interface-vlan-ospf-conf', u'ospf1', u'md5-authentication', u'no-encrypt-key-table']
  ...
  def _set_no_encrypt_key_id(self, v, load=False):
    """
    Setter method for no_encrypt_key_id, mapped from YANG variable /routing_system/interface/ve/ip/interface_vlan_ospf_conf/ospf1/md5_authentication/no_encrypt_key_table/no_encrypt_key_id (uint32)
  ...
  def _set_no_encrypt_key(self, v, load=False):
    """
    Setter method for no_encrypt_key, mapped from YANG variable /routing_system/interface/ve/ip/interface_vlan_ospf_conf/ospf1/md5_authentication/no_encrypt_key_table/no_encrypt_key (ospf-auth-psswd-string)
    If this variable is read-only (config: false) in the
