...
class load_balancing(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/ip-local-anycast-gateway/load-balancing. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'ip-local-anycast-gateway', u'load-balancing']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ip', u'fabric-virtual-gateway', u'load-balancing']

  def _get_basic(self):
    """
    Getter method for basic, mapped from YANG variable /routing_system/interface/ve/ip/ip_local_anycast_gateway/load_balancing/basic (empty)
    """
    return self.__basic
      
  def _set_basic(self, v, load=False):
    """
    Setter method for basic, mapped from YANG variable /routing_system/interface/ve/ip/ip_local_anycast_gateway/load_balancing/basic (empty)
  ...
  def _get_threshold_priority(self):
    """
    Getter method for threshold_priority, mapped from YANG variable /routing_system/interface/ve/ip/ip_local_anycast_gateway/load_balancing/threshold_priority (uint32)
  ...
  def _set_threshold_priority(self, v, load=False):
    """
    Setter method for threshold_priority, mapped from YANG variable /routing_system/interface/ve/ip/ip_local_anycast_gateway/load_balancing/threshold_priority (uint32)
    If this variable is read-only (config: false) in the
