...
class auth_type(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/ip-vrrp-extended/auth-type. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'ip-vrrp-extended', u'auth-type']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ip', u'vrrp-extended', u'auth-type']

  def _get_md5_auth(self):
    """
    Getter method for md5_auth, mapped from YANG variable /routing_system/interface/ve/ip/ip_vrrp_extended/auth_type/md5_auth (container)
  ...
  def _set_md5_auth(self, v, load=False):
    """
    Setter method for md5_auth, mapped from YANG variable /routing_system/interface/ve/ip/ip_vrrp_extended/auth_type/md5_auth (container)
