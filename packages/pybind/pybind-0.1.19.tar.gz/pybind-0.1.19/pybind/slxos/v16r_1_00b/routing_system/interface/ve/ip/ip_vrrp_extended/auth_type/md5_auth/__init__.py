...
class md5_auth(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/ip-vrrp-extended/auth-type/md5-auth. Each member element of
  ...
  def _get_auth_data(self):
    """
    Getter method for auth_data, mapped from YANG variable /routing_system/interface/ve/ip/ip_vrrp_extended/auth_type/md5_auth/auth_data (string)
  ...
  def _set_auth_data(self, v, load=False):
    """
    Setter method for auth_data, mapped from YANG variable /routing_system/interface/ve/ip/ip_vrrp_extended/auth_type/md5_auth/auth_data (string)
