...
class pim_intf_vlan_cont(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/pim-intf-vlan-cont. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'pim-intf-vlan-cont']
  ...
  def _get_pim_int_cmd(self):
    """
    Getter method for pim_int_cmd, mapped from YANG variable /routing_system/interface/ve/ip/pim_intf_vlan_cont/pim_int_cmd (container)
    """
    return self.__pim_int_cmd
      
  def _set_pim_int_cmd(self, v, load=False):
    """
    Setter method for pim_int_cmd, mapped from YANG variable /routing_system/interface/ve/ip/pim_intf_vlan_cont/pim_int_cmd (container)
