...
class ip_acl_interface(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip-acl-interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip-acl-interface']
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /routing_system/interface/ve/ip_acl_interface/ip (container)
