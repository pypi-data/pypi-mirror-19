...
class ip(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip-pbr-interface/ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip-pbr-interface', u'ip']
  ...
  def _get_policy(self):
    """
    Getter method for policy, mapped from YANG variable /routing_system/interface/ve/ip_pbr_interface/ip/policy (container)
  ...
  def _set_policy(self, v, load=False):
    """
    Setter method for policy, mapped from YANG variable /routing_system/interface/ve/ip_pbr_interface/ip/policy (container)
