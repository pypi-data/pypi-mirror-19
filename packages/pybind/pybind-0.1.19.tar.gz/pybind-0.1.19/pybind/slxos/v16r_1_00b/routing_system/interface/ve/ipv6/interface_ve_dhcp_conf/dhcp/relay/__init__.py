...
class relay(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ipv6/interface-ve-dhcp-conf/dhcp/relay. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ipv6', u'interface-ve-dhcp-conf', u'dhcp', u'relay']
  ...
  def _get_servers(self):
    """
    Getter method for servers, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ve_dhcp_conf/dhcp/relay/servers (list)
    """
    return self.__servers
      
  def _set_servers(self, v, load=False):
    """
    Setter method for servers, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ve_dhcp_conf/dhcp/relay/servers (list)
