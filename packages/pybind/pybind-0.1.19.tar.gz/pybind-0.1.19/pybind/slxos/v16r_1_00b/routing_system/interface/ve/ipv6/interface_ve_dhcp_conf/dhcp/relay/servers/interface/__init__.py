...
class interface(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ipv6/interface-ve-dhcp-conf/dhcp/relay/servers/interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ipv6', u'interface-ve-dhcp-conf', u'dhcp', u'relay', u'servers', u'interface']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ipv6', u'dhcp', u'relay', u'interface']

  def _get_interface_type(self):
    """
    Getter method for interface_type, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ve_dhcp_conf/dhcp/relay/servers/interface/interface_type (dhcpv6-iftype)
  ...
  def _set_interface_type(self, v, load=False):
    """
    Setter method for interface_type, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ve_dhcp_conf/dhcp/relay/servers/interface/interface_type (dhcpv6-iftype)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'ethernet': {'value': 0}, u'Ve': {'value': 4}},), is_leaf=True, yang_name="interface-type", rest_name="interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Interface type', u'cli-drop-node-name': None, u'alt-name': u'interface', u'cli-incomplete-command': None, u'cli-run-template': u'ipv6 dhcp relay address$(relay-ip-addr) $($(server-vrf-name)==.?: use-vrf $(server-vrf-name))\n'}}, namespace='urn:brocade.com:mgmt:brocade-dhcpv6', defining_module='brocade-dhcpv6', yang_type='dhcpv6-iftype', is_config=True)
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'ethernet': {'value': 0}, u'Ve': {'value': 4}},), is_leaf=True, yang_name="interface-type", rest_name="interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Interface type', u'cli-drop-node-name': None, u'alt-name': u'interface', u'cli-incomplete-command': None, u'cli-run-template': u'ipv6 dhcp relay address$(relay-ip-addr) $($(server-vrf-name)==.?: use-vrf $(server-vrf-name))\n'}}, namespace='urn:brocade.com:mgmt:brocade-dhcpv6', defining_module='brocade-dhcpv6', yang_type='dhcpv6-iftype', is_config=True)""",
        })
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ve_dhcp_conf/dhcp/relay/servers/interface/interface_name (dhcpv6-ifname)
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ve_dhcp_conf/dhcp/relay/servers/interface/interface_name (dhcpv6-ifname)
    If this variable is read-only (config: false) in the
