...
class ipv6_interface(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ipv6/ipv6-local-anycast-gateway/ipv6-track/ipv6-interface. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__ipv6_interface_name = YANGDynClass(base=[RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((([0-9]|[1][0-6]))/([1-9]|[1-9][0-9]|[1-9][0-9][0-9])(:[1-4])?)', 'length': [u'3..16']}),RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'([1-9]|[1-9][0-9]|[1-4][0-9]{2}|50[0-9]|51[0-2])'}),], is_leaf=True, yang_name="ipv6-interface-name", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-anycast-gateway', defining_module='brocade-anycast-gateway', yang_type='vrrp:track-ifname', is_config=True)
    self.__ipv6_interface_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'ethernet': {'value': 8}, u'port-channel': {'value': 3}},), is_leaf=True, yang_name="ipv6-interface-type", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-anycast-gateway', defining_module='brocade-anycast-gateway', yang_type='vrrp:track-iftype', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ipv6', u'ipv6-local-anycast-gateway', u'ipv6-track', u'ipv6-interface']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ipv6', u'fabric-virtual-gateway', u'track', u'interface']

  def _get_ipv6_interface_type(self):
    """
    Getter method for ipv6_interface_type, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_local_anycast_gateway/ipv6_track/ipv6_interface/ipv6_interface_type (vrrp:track-iftype)
    """
    return self.__ipv6_interface_type
      
  def _set_ipv6_interface_type(self, v, load=False):
    """
    Setter method for ipv6_interface_type, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_local_anycast_gateway/ipv6_track/ipv6_interface/ipv6_interface_type (vrrp:track-iftype)
  ...
  def _get_ipv6_interface_name(self):
    """
    Getter method for ipv6_interface_name, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_local_anycast_gateway/ipv6_track/ipv6_interface/ipv6_interface_name (vrrp:track-ifname)
    """
    return self.__ipv6_interface_name
      
  def _set_ipv6_interface_name(self, v, load=False):
    """
    Setter method for ipv6_interface_name, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_local_anycast_gateway/ipv6_track/ipv6_interface/ipv6_interface_name (vrrp:track-ifname)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=[RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((([0-9]|[1][0-6]))/([1-9]|[1-9][0-9]|[1-9][0-9][0-9])(:[1-4])?)', 'length': [u'3..16']}),RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'([1-9]|[1-9][0-9]|[1-4][0-9]{2}|50[0-9]|51[0-2])'}),], is_leaf=True, yang_name="ipv6-interface-name", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-anycast-gateway', defining_module='brocade-anycast-gateway', yang_type='vrrp:track-ifname', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipv6_interface_name must be of a type compatible with vrrp:track-ifname""",
          'defined-type': "vrrp:track-ifname",
          'generated-type': """YANGDynClass(base=[RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((([0-9]|[1][0-6]))/([1-9]|[1-9][0-9]|[1-9][0-9][0-9])(:[1-4])?)', 'length': [u'3..16']}),RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'([1-9]|[1-9][0-9]|[1-4][0-9]{2}|50[0-9]|51[0-2])'}),], is_leaf=True, yang_name="ipv6-interface-name", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-anycast-gateway', defining_module='brocade-anycast-gateway', yang_type='vrrp:track-ifname', is_config=True)""",
        })
  ...
  def _get_ipv6_interface_priority(self):
    """
    Getter method for ipv6_interface_priority, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_local_anycast_gateway/ipv6_track/ipv6_interface/ipv6_interface_priority (uint32)
  ...
  def _set_ipv6_interface_priority(self, v, load=False):
    """
    Setter method for ipv6_interface_priority, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_local_anycast_gateway/ipv6_track/ipv6_interface/ipv6_interface_priority (uint32)
    If this variable is read-only (config: false) in the
