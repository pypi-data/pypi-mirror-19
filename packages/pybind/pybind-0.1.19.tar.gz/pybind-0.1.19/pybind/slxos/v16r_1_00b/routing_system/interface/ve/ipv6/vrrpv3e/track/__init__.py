...
class track(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ipv6/vrrpv3e/track. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ipv6', u'vrrpv3e', u'track']
  ...
  def _set_network(self, v, load=False):
    """
    Setter method for network, mapped from YANG variable /routing_system/interface/ve/ipv6/vrrpv3e/track/network (list)
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /routing_system/interface/ve/ipv6/vrrpv3e/track/interface (list)
    If this variable is read-only (config: false) in the
