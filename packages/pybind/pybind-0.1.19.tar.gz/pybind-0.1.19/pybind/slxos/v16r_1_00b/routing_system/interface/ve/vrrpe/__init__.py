...
class vrrpe(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/vrrpe. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'vrrpe']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'vrrp-extended-group']
  ...
  def _set_vrid(self, v, load=False):
    """
    Setter method for vrid, mapped from YANG variable /routing_system/interface/ve/vrrpe/vrid (vrrpe-vrid-type)
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "brocade-vrrp:vrrpe-vrid-type",
  ...
  def _get_virtual_mac(self):
    """
    Getter method for virtual_mac, mapped from YANG variable /routing_system/interface/ve/vrrpe/virtual_mac (enumeration)
  ...
  def _set_virtual_mac(self, v, load=False):
    """
    Setter method for virtual_mac, mapped from YANG variable /routing_system/interface/ve/vrrpe/virtual_mac (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _set_virtual_ip(self, v, load=False):
    """
    Setter method for virtual_ip, mapped from YANG variable /routing_system/interface/ve/vrrpe/virtual_ip (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_track(self):
    """
    Getter method for track, mapped from YANG variable /routing_system/interface/ve/vrrpe/track (container)
  ...
  def _set_track(self, v, load=False):
    """
    Setter method for track, mapped from YANG variable /routing_system/interface/ve/vrrpe/track (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_advertisement_interval(self):
    """
    Getter method for advertisement_interval, mapped from YANG variable /routing_system/interface/ve/vrrpe/advertisement_interval (uint32)
  ...
  def _set_advertisement_interval(self, v, load=False):
    """
    Setter method for advertisement_interval, mapped from YANG variable /routing_system/interface/ve/vrrpe/advertisement_interval (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /routing_system/interface/ve/vrrpe/enable (empty)
  ...
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /routing_system/interface/ve/vrrpe/enable (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_hold_time(self):
    """
    Getter method for hold_time, mapped from YANG variable /routing_system/interface/ve/vrrpe/hold_time (uint32)
  ...
  def _set_hold_time(self, v, load=False):
    """
    Setter method for hold_time, mapped from YANG variable /routing_system/interface/ve/vrrpe/hold_time (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_preempt_mode(self):
    """
    Getter method for preempt_mode, mapped from YANG variable /routing_system/interface/ve/vrrpe/preempt_mode (empty)
  ...
  def _set_preempt_mode(self, v, load=False):
    """
    Setter method for preempt_mode, mapped from YANG variable /routing_system/interface/ve/vrrpe/preempt_mode (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_arp(self):
    """
    Getter method for arp, mapped from YANG variable /routing_system/interface/ve/vrrpe/arp (container)
  ...
  def _set_arp(self, v, load=False):
    """
    Setter method for arp, mapped from YANG variable /routing_system/interface/ve/vrrpe/arp (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_priority(self):
    """
    Getter method for priority, mapped from YANG variable /routing_system/interface/ve/vrrpe/priority (uint8)
  ...
  def _set_priority(self, v, load=False):
    """
    Setter method for priority, mapped from YANG variable /routing_system/interface/ve/vrrpe/priority (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /routing_system/interface/ve/vrrpe/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /routing_system/interface/ve/vrrpe/description (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_advertise_backup(self):
    """
    Getter method for advertise_backup, mapped from YANG variable /routing_system/interface/ve/vrrpe/advertise_backup (empty)
  ...
  def _set_advertise_backup(self, v, load=False):
    """
    Setter method for advertise_backup, mapped from YANG variable /routing_system/interface/ve/vrrpe/advertise_backup (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_vrrpe_garp_timer(self, v, load=False):
    """
    Setter method for vrrpe_garp_timer, mapped from YANG variable /routing_system/interface/ve/vrrpe/vrrpe_garp_timer (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_backup_advertisement_interval(self):
    """
    Getter method for backup_advertisement_interval, mapped from YANG variable /routing_system/interface/ve/vrrpe/backup_advertisement_interval (uint32)
  ...
  def _set_backup_advertisement_interval(self, v, load=False):
    """
    Setter method for backup_advertisement_interval, mapped from YANG variable /routing_system/interface/ve/vrrpe/backup_advertisement_interval (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_short_path_forwarding(self):
    """
    Getter method for short_path_forwarding, mapped from YANG variable /routing_system/interface/ve/vrrpe/short_path_forwarding (container)
  ...
  def _set_short_path_forwarding(self, v, load=False):
    """
    Setter method for short_path_forwarding, mapped from YANG variable /routing_system/interface/ve/vrrpe/short_path_forwarding (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_advertisement_interval_scale(self):
    """
    Getter method for advertisement_interval_scale, mapped from YANG variable /routing_system/interface/ve/vrrpe/advertisement_interval_scale (uint32)

    YANG Description: Ipv4 session advertisement interval scale factor
    """
    return self.__advertisement_interval_scale
      
  def _set_advertisement_interval_scale(self, v, load=False):
    """
    Setter method for advertisement_interval_scale, mapped from YANG variable /routing_system/interface/ve/vrrpe/advertisement_interval_scale (uint32)
    If this variable is read-only (config: false) in the
