...
class interface(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/vrrpe/track/interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'vrrpe', u'track', u'interface']
  ...
  def _set_interface_type(self, v, load=False):
    """
    Setter method for interface_type, mapped from YANG variable /routing_system/interface/ve/vrrpe/track/interface/interface_type (track-iftype)
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /routing_system/interface/ve/vrrpe/track/interface/interface_name (track-ifname)
    If this variable is read-only (config: false) in the
  ...
  def _get_track_priority(self):
    """
    Getter method for track_priority, mapped from YANG variable /routing_system/interface/ve/vrrpe/track/interface/track_priority (uint8)
  ...
  def _set_track_priority(self, v, load=False):
    """
    Setter method for track_priority, mapped from YANG variable /routing_system/interface/ve/vrrpe/track/interface/track_priority (uint8)
    If this variable is read-only (config: false) in the
