...
class relay(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/ip/dhcp/relay. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'ip', u'dhcp', u'relay']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ip', u'dhcp', u'relay']

  def _get_information(self):
    """
    Getter method for information, mapped from YANG variable /routing_system/ip/dhcp/relay/information (container)
