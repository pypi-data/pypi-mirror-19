...
class ipv6(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__router','__receive','__prefix_list',)
  ...
  _pyangbind_elements = {'router': router, 'receive': receive, 'prefix_list': prefix_list, }
