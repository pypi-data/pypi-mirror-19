...
class authentication(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/ipv6/router/ospf/area/authentication. Each member element of
  ...
  def _set_ipsec_auth_key_config(self, v, load=False):
    """
    Setter method for ipsec_auth_key_config, mapped from YANG variable /routing_system/ipv6/router/ospf/area/authentication/ipsec_auth_key_config (container)
