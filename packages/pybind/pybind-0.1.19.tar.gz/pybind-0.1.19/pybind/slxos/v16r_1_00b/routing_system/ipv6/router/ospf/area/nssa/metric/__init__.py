...
class metric(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/ipv6/router/ospf/area/nssa/metric. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'ipv6', u'router', u'ospf', u'area', u'nssa', u'metric']
  ...
  def _get_nssa_area_metric(self):
    """
    Getter method for nssa_area_metric, mapped from YANG variable /routing_system/ipv6/router/ospf/area/nssa/metric/nssa_area_metric (uint32)
  ...
  def _set_nssa_area_metric(self, v, load=False):
    """
    Setter method for nssa_area_metric, mapped from YANG variable /routing_system/ipv6/router/ospf/area/nssa/metric/nssa_area_metric (uint32)
