...
class community(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/match/community. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'route-map', u'content', u'match', u'community']
  ...
  def _set_community_access_list_name(self, v, load=False):
    """
    Setter method for community_access_list_name, mapped from YANG variable /routing_system/route_map/content/match/community/community_access_list_name (match-community-list-name-t)
