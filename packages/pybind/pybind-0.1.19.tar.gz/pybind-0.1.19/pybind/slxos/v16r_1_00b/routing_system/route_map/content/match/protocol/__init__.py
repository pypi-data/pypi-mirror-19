...
class protocol(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/match/protocol. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'route-map', u'content', u'match', u'protocol']
  ...
  def _set_protocol_static_container(self, v, load=False):
    """
    Setter method for protocol_static_container, mapped from YANG variable /routing_system/route_map/content/match/protocol/protocol_static_container (container)
  ...
  def _set_bgp_protocol_container(self, v, load=False):
    """
    Setter method for bgp_protocol_container, mapped from YANG variable /routing_system/route_map/content/match/protocol/bgp_protocol_container (container)
    If this variable is read-only (config: false) in the
