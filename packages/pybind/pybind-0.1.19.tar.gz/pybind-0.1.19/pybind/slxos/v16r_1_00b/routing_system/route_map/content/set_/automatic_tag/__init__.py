...
class automatic_tag(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/set/automatic-tag. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'route-map', u'content', u'set', u'automatic-tag']
  ...
  def _set_tag_empty(self, v, load=False):
    """
    Setter method for tag_empty, mapped from YANG variable /routing_system/route_map/content/set/automatic_tag/tag_empty (empty)
