...
class extcommunity(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/set/extcommunity. Each member element of
  ...
  def _get_rt(self):
    """
    Getter method for rt, mapped from YANG variable /routing_system/route_map/content/set/extcommunity/rt (container)
  ...
  def _set_rt(self, v, load=False):
    """
    Setter method for rt, mapped from YANG variable /routing_system/route_map/content/set/extcommunity/rt (container)
  ...
  def _get_soo(self):
    """
    Getter method for soo, mapped from YANG variable /routing_system/route_map/content/set/extcommunity/soo (container)
  ...
  def _set_soo(self, v, load=False):
    """
    Setter method for soo, mapped from YANG variable /routing_system/route_map/content/set/extcommunity/soo (container)
    If this variable is read-only (config: false) in the
