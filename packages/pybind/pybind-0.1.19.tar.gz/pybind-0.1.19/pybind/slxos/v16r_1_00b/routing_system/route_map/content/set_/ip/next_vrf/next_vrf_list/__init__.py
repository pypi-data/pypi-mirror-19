...
class next_vrf_list(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/set/ip/next-vrf/next-vrf-list. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'route-map', u'content', u'set', u'ip', u'next-vrf', u'next-vrf-list']
  ...
  def _set_vrf(self, v, load=False):
    """
    Setter method for vrf, mapped from YANG variable /routing_system/route_map/content/set/ip/next_vrf/next_vrf_list/vrf (string)
  ...
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /routing_system/route_map/content/set/ip/next_vrf/next_vrf_list/next_hop (inet:ipv4-address)
    If this variable is read-only (config: false) in the
