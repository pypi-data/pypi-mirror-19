...
class ipv6(PybindBase):
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /routing_system/route_map/content/set/ipv6/interface (container)
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /routing_system/route_map/content/set/ipv6/interface (container)
