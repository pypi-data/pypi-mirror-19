...
class global_(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/set/ipv6/global. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'route-map', u'content', u'set', u'ipv6', u'global']
  ...
  def _set_next_global_hop(self, v, load=False):
    """
    Setter method for next_global_hop, mapped from YANG variable /routing_system/route_map/content/set/ipv6/global/next_global_hop (list)
