...
class next_global_hop(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/set/ipv6/global/next-global-hop. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'route-map', u'content', u'set', u'ipv6', u'global', u'next-global-hop']
  ...
  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /routing_system/route_map/content/set/ipv6/global/next_global_hop/next_hop (inet:ipv6-address)
  ...
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /routing_system/route_map/content/set/ipv6/global/next_global_hop/next_hop (inet:ipv6-address)
