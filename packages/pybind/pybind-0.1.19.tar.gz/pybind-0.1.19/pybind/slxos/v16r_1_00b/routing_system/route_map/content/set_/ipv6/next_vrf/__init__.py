...
class next_vrf(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/set/ipv6/next-vrf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'route-map', u'content', u'set', u'ipv6', u'next-vrf']
  ...
  def _set_next_vrf_list(self, v, load=False):
    """
    Setter method for next_vrf_list, mapped from YANG variable /routing_system/route_map/content/set/ipv6/next_vrf/next_vrf_list (list)
