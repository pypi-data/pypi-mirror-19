...
class route_type(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/set/route-type. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'route-map', u'content', u'set', u'route-type']
  ...
  def _set_route_type_rms(self, v, load=False):
    """
    Setter method for route_type_rms, mapped from YANG variable /routing_system/route_map/content/set/route_type/route_type_rms (set-route-type-t)
