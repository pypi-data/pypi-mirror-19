...
import __builtin__
import pim
class hide_pim_holder(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /routing-system/router/hide-pim-holder. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__pim',)

  _yang_name = 'hide-pim-holder'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'hide-pim-holder']
  ...
  def _set_pim(self, v, load=False):
    """
    Setter method for pim, mapped from YANG variable /routing_system/router/hide_pim_holder/pim (container)
