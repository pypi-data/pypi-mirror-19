...
class pim(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/hide-pim-holder/pim. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__max_mcache','__hello_interval','__prune_wait','__nbr_timeout','__inactivity_timer','__message_interval','__spt_threshold','__rpf','__ssm_enable','__bsr_candidate','__rp_candidate','__anycast_rp','__anycast_rp_ip','__rp_address','__route_precedence',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__max_mcache = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..24576']}), default=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32)(24576), is_leaf=True, yang_name="max-mcache", rest_name="max-mcache", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Set maximum PIM mcache'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='uint32', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'hide-pim-holder', u'pim']
  ...
  def _set_max_mcache(self, v, load=False):
    """
    Setter method for max_mcache, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/max_mcache (uint32)
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..24576']}), default=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32)(24576), is_leaf=True, yang_name="max-mcache", rest_name="max-mcache", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Set maximum PIM mcache'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='uint32', is_config=True)""",
        })
  ...
  def _set_hello_interval(self, v, load=False):
    """
    Setter method for hello_interval, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/hello_interval (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _set_prune_wait(self, v, load=False):
    """
    Setter method for prune_wait, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/prune_wait (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _set_nbr_timeout(self, v, load=False):
    """
    Setter method for nbr_timeout, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/nbr_timeout (int16)
    If this variable is read-only (config: false) in the
  ...
  def _set_inactivity_timer(self, v, load=False):
    """
    Setter method for inactivity_timer, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/inactivity_timer (int16)
    If this variable is read-only (config: false) in the
  ...
  def _set_message_interval(self, v, load=False):
    """
    Setter method for message_interval, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/message_interval (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _set_spt_threshold(self, v, load=False):
    """
    Setter method for spt_threshold, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/spt_threshold (spt-thr-type)
    If this variable is read-only (config: false) in the
  ...
  def _set_rpf(self, v, load=False):
    """
    Setter method for rpf, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/rpf (container)
    If this variable is read-only (config: false) in the
  ...
  def _set_ssm_enable(self, v, load=False):
    """
    Setter method for ssm_enable, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/ssm_enable (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=ssm_enable.ssm_enable, is_container='container', yang_name="ssm-enable", rest_name="ssm-enable", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Enable/disable SSM mode for PIM'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)""",
        })
  ...
  def _set_bsr_candidate(self, v, load=False):
    """
    Setter method for bsr_candidate, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/bsr_candidate (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=bsr_candidate.bsr_candidate, is_container='container', yang_name="bsr-candidate", rest_name="bsr-candidate", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Set candidate bootstrap router', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)""",
        })
  ...
  def _set_rp_candidate(self, v, load=False):
    """
    Setter method for rp_candidate, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/rp_candidate (container)
    If this variable is read-only (config: false) in the
  ...
  def _set_rp_address(self, v, load=False):
    """
    Setter method for rp_address, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/rp_address (list)
    If this variable is read-only (config: false) in the
  ...
  def _set_route_precedence(self, v, load=False):
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=route_precedence.route_precedence, is_container='container', yang_name="route-precedence", rest_name="route-precedence", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Specify Route Selection criteria', u'callpoint': u'PimRoutePrecedenceCallpoint', u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)""",
        })
