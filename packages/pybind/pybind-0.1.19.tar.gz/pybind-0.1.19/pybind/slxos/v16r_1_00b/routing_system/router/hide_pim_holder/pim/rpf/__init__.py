...
class rpf(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/hide-pim-holder/pim/rpf. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ecmp',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'hide-pim-holder', u'pim', u'rpf']
  ...
  def _set_ecmp(self, v, load=False):
    """
    Setter method for ecmp, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/rpf/ecmp (container)
