...
class default_information_originate(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/isis/router-isis-cmds-holder/address-family/ipv6/af-ipv6-unicast/af-ipv6-attributes/af-common-attributes/default-information-originate. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'isis', u'router-isis-cmds-holder', u'address-family', u'ipv6', u'af-ipv6-unicast', u'af-ipv6-attributes', u'af-common-attributes', u'default-information-originate']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'isis', u'address-family', u'ipv6', u'unicast', u'default-information-originate']

  def _get_default_information_originate_route_map(self):
    """
    Getter method for default_information_originate_route_map, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/default_information_originate/default_information_originate_route_map (string)
    """
    return self.__default_information_originate_route_map
      
  def _set_default_information_originate_route_map(self, v, load=False):
    """
    Setter method for default_information_originate_route_map, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/default_information_originate/default_information_originate_route_map (string)
  ...
  def _get_default_information_originate_cr(self):
    """
    Getter method for default_information_originate_cr, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/default_information_originate/default_information_originate_cr (empty)
    """
    return self.__default_information_originate_cr
      
  def _set_default_information_originate_cr(self, v, load=False):
    """
    Setter method for default_information_originate_cr, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/default_information_originate/default_information_originate_cr (empty)
    If this variable is read-only (config: false) in the
