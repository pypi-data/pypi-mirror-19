...
import __builtin__
import reverse_metric_tlv
import rev_metric_common_attributes
class reverse_metric(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /routing-system/router/isis/router-isis-cmds-holder/router-isis-attributes/reverse-metric. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__reverse_metric_tlv','__rev_metric_common_attributes',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'isis', u'router-isis-cmds-holder', u'router-isis-attributes', u'reverse-metric']
  ...
  def _get_reverse_metric_tlv(self):
    """
    Getter method for reverse_metric_tlv, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/router_isis_attributes/reverse_metric/reverse_metric_tlv (container)
    """
    return self.__reverse_metric_tlv
      
  def _set_reverse_metric_tlv(self, v, load=False):
    """
    Setter method for reverse_metric_tlv, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/router_isis_attributes/reverse_metric/reverse_metric_tlv (container)
  ...
  def _get_rev_metric_common_attributes(self):
    """
    Getter method for rev_metric_common_attributes, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/router_isis_attributes/reverse_metric/rev_metric_common_attributes (container)
    """
    return self.__rev_metric_common_attributes
      
  def _set_rev_metric_common_attributes(self, v, load=False):
    """
    Setter method for rev_metric_common_attributes, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/router_isis_attributes/reverse_metric/rev_metric_common_attributes (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'reverse_metric_tlv': reverse_metric_tlv, 'rev_metric_common_attributes': rev_metric_common_attributes, }
