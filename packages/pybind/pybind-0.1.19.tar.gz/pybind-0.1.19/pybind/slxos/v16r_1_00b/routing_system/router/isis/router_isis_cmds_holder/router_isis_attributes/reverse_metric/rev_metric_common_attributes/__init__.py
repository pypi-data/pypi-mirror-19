...
class rev_metric_common_attributes(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/isis/router-isis-cmds-holder/router-isis-attributes/reverse-metric/rev-metric-common-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'isis', u'router-isis-cmds-holder', u'router-isis-attributes', u'reverse-metric', u'rev-metric-common-attributes']
  ...
  def _get_rev_metric_val(self):
    """
    Getter method for rev_metric_val, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/router_isis_attributes/reverse_metric/rev_metric_common_attributes/rev_metric_val (uint32)
    """
    return self.__rev_metric_val
      
  def _set_rev_metric_val(self, v, load=False):
    """
    Setter method for rev_metric_val, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/router_isis_attributes/reverse_metric/rev_metric_common_attributes/rev_metric_val (uint32)
  ...
  def _get_rev_metric_whole_lan(self):
    """
    Getter method for rev_metric_whole_lan, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/router_isis_attributes/reverse_metric/rev_metric_common_attributes/rev_metric_whole_lan (empty)
    """
    return self.__rev_metric_whole_lan
      
  def _set_rev_metric_whole_lan(self, v, load=False):
    """
    Setter method for rev_metric_whole_lan, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/router_isis_attributes/reverse_metric/rev_metric_common_attributes/rev_metric_whole_lan (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_rev_metric_te_def_metric(self):
    """
    Getter method for rev_metric_te_def_metric, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/router_isis_attributes/reverse_metric/rev_metric_common_attributes/rev_metric_te_def_metric (empty)
    """
    return self.__rev_metric_te_def_metric
      
  def _set_rev_metric_te_def_metric(self, v, load=False):
    """
    Setter method for rev_metric_te_def_metric, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/router_isis_attributes/reverse_metric/rev_metric_common_attributes/rev_metric_te_def_metric (empty)
    If this variable is read-only (config: false) in the
