...
class nssa(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/nssa. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'area', u'nssa']
  ...
  def _set_metric(self, v, load=False):
    """
    Setter method for metric, mapped from YANG variable /routing_system/router/ospf/area/nssa/metric (container)
  ...
  def _set_default_information_originate(self, v, load=False):
    """
    Setter method for default_information_originate, mapped from YANG variable /routing_system/router/ospf/area/nssa/default_information_originate (empty)
    If this variable is read-only (config: false) in the
