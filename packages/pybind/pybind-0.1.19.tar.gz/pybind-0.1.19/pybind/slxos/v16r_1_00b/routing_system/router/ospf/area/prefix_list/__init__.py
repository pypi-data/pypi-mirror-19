...
class prefix_list(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/prefix-list. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'area', u'prefix-list']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'area', u'prefix-list']
  ...
  def _set_direction_in(self, v, load=False):
    """
    Setter method for direction_in, mapped from YANG variable /routing_system/router/ospf/area/prefix_list/direction_in (container)
  ...
  def _set_direction_out(self, v, load=False):
    """
    Setter method for direction_out, mapped from YANG variable /routing_system/router/ospf/area/prefix_list/direction_out (container)
    If this variable is read-only (config: false) in the
