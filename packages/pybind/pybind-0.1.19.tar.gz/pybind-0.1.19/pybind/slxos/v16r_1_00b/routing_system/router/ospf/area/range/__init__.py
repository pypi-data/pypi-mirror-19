...
class range(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/range. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'area', u'range']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'area', u'range']

  def _get_range_address(self):
    """
    Getter method for range_address, mapped from YANG variable /routing_system/router/ospf/area/range/range_address (inet:ipv4-address)
    """
    return self.__range_address
      
  def _set_range_address(self, v, load=False):
    """
    Setter method for range_address, mapped from YANG variable /routing_system/router/ospf/area/range/range_address (inet:ipv4-address)
  ...
  def _get_range_mask(self):
    """
    Getter method for range_mask, mapped from YANG variable /routing_system/router/ospf/area/range/range_mask (inet:ipv4-address)
    """
    return self.__range_mask
      
  def _set_range_mask(self, v, load=False):
    """
    Setter method for range_mask, mapped from YANG variable /routing_system/router/ospf/area/range/range_mask (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_range_effect(self):
    """
    Getter method for range_effect, mapped from YANG variable /routing_system/router/ospf/area/range/range_effect (enumeration)
    """
    return self.__range_effect
      
  def _set_range_effect(self, v, load=False):
    """
    Setter method for range_effect, mapped from YANG variable /routing_system/router/ospf/area/range/range_effect (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_range_cost(self):
    """
    Getter method for range_cost, mapped from YANG variable /routing_system/router/ospf/area/range/range_cost (range-metric)
    """
    return self.__range_cost
      
  def _set_range_cost(self, v, load=False):
    """
    Setter method for range_cost, mapped from YANG variable /routing_system/router/ospf/area/range/range_cost (range-metric)
    If this variable is read-only (config: false) in the
