...
class stub(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/stub. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__metric',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'area', u'stub']
  ...
  def _get_metric(self):
    """
    Getter method for metric, mapped from YANG variable /routing_system/router/ospf/area/stub/metric (container)
    """
    return self.__metric
      
  def _set_metric(self, v, load=False):
    """
    Setter method for metric, mapped from YANG variable /routing_system/router/ospf/area/stub/metric (container)
