...
class metric(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/stub/metric. Each member element of
  ...
  def _get_stub_value(self):
    """
    Getter method for stub_value, mapped from YANG variable /routing_system/router/ospf/area/stub/metric/stub_value (big-metric)
    """
    return self.__stub_value
      
  def _set_stub_value(self, v, load=False):
    """
    Setter method for stub_value, mapped from YANG variable /routing_system/router/ospf/area/stub/metric/stub_value (big-metric)
  ...
  def _get_no_summary(self):
    """
    Getter method for no_summary, mapped from YANG variable /routing_system/router/ospf/area/stub/metric/no_summary (empty)
    """
    return self.__no_summary
      
  def _set_no_summary(self, v, load=False):
    """
    Setter method for no_summary, mapped from YANG variable /routing_system/router/ospf/area/stub/metric/no_summary (empty)
    If this variable is read-only (config: false) in the
