...
class authentication_key(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/virtual-link/authentication-key. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'area', u'virtual-link', u'authentication-key']
  ...
  def _get_no_encrypt_auth_key_table(self):
    """
    Getter method for no_encrypt_auth_key_table, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/authentication_key/no_encrypt_auth_key_table (container)
    """
    return self.__no_encrypt_auth_key_table
      
  def _set_no_encrypt_auth_key_table(self, v, load=False):
    """
    Setter method for no_encrypt_auth_key_table, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/authentication_key/no_encrypt_auth_key_table (container)
  ...
  def _get_auth_key_table(self):
    """
    Getter method for auth_key_table, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/authentication_key/auth_key_table (container)
    """
    return self.__auth_key_table
      
  def _set_auth_key_table(self, v, load=False):
    """
    Setter method for auth_key_table, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/authentication_key/auth_key_table (container)
    If this variable is read-only (config: false) in the
