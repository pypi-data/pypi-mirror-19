...
class no_encrypt_key_table(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/virtual-link/md5-authentication/no-encrypt-key-table. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'area', u'virtual-link', u'md5-authentication', u'no-encrypt-key-table']
  ...
  def _get_no_encrypt_key_id(self):
    """
    Getter method for no_encrypt_key_id, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/md5_authentication/no_encrypt_key_table/no_encrypt_key_id (uint32)
    """
    return self.__no_encrypt_key_id
      
  def _set_no_encrypt_key_id(self, v, load=False):
    """
    Setter method for no_encrypt_key_id, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/md5_authentication/no_encrypt_key_table/no_encrypt_key_id (uint32)
  ...
  def _get_no_encrypt_key(self):
    """
    Getter method for no_encrypt_key, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/md5_authentication/no_encrypt_key_table/no_encrypt_key (ospf-auth-psswd-string)
    """
    return self.__no_encrypt_key
      
  def _set_no_encrypt_key(self, v, load=False):
    """
    Setter method for no_encrypt_key, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/md5_authentication/no_encrypt_key_table/no_encrypt_key (ospf-auth-psswd-string)
    If this variable is read-only (config: false) in the
