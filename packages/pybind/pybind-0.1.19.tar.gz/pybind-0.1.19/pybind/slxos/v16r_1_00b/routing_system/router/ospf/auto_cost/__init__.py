...
class auto_cost(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/auto-cost. Each member element of
  ...
  def _set_reference_bandwidth(self, v, load=False):
    """
    Setter method for reference_bandwidth, mapped from YANG variable /routing_system/router/ospf/auto_cost/reference_bandwidth (container)
