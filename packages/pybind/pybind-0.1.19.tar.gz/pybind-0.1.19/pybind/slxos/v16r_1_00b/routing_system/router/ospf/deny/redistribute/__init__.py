...
class redistribute(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/deny/redistribute. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'deny', u'redistribute']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'deny', u'redistribute']
  ...
  def _set_redist_value(self, v, load=False):
    """
    Setter method for redist_value, mapped from YANG variable /routing_system/router/ospf/deny/redistribute/redist_value (uint32)
  ...
  def _set_route_option(self, v, load=False):
    """
    Setter method for route_option, mapped from YANG variable /routing_system/router/ospf/deny/redistribute/route_option (route-option-type)
    If this variable is read-only (config: false) in the
  ...
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /routing_system/router/ospf/deny/redistribute/address (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _set_mask(self, v, load=False):
    """
    Setter method for mask, mapped from YANG variable /routing_system/router/ospf/deny/redistribute/mask (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _set_set_metric_val(self, v, load=False):
    """
    Setter method for set_metric_val, mapped from YANG variable /routing_system/router/ospf/deny/redistribute/set_metric_val (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _set_match_metric_val(self, v, load=False):
    """
    Setter method for match_metric_val, mapped from YANG variable /routing_system/router/ospf/deny/redistribute/match_metric_val (uint32)
    If this variable is read-only (config: false) in the
