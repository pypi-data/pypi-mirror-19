...
class distribute_list(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/distribute-list. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'distribute-list']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'distribute-list']

  def _get_route_map(self):
    """
    Getter method for route_map, mapped from YANG variable /routing_system/router/ospf/distribute_list/route_map (container)
    """
    return self.__route_map
      
  def _set_route_map(self, v, load=False):
    """
    Setter method for route_map, mapped from YANG variable /routing_system/router/ospf/distribute_list/route_map (container)
