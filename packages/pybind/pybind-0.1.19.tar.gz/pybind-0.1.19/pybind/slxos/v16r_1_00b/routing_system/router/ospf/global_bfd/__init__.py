...
class global_bfd(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/global-bfd. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'global-bfd']
  ...
  def _set_bfd_enable(self, v, load=False):
    """
    Setter method for bfd_enable, mapped from YANG variable /routing_system/router/ospf/global_bfd/bfd_enable (empty)
  ...
  def _get_holdover_interval(self):
    """
    Getter method for holdover_interval, mapped from YANG variable /routing_system/router/ospf/global_bfd/holdover_interval (uint8)
  ...
  def _set_holdover_interval(self, v, load=False):
    """
    Setter method for holdover_interval, mapped from YANG variable /routing_system/router/ospf/global_bfd/holdover_interval (uint8)
    If this variable is read-only (config: false) in the
