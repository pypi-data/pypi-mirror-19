...
class max_metric(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/max-metric. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'max-metric']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'max-metric']
  ...
  def _set_router_lsa(self, v, load=False):
    """
    Setter method for router_lsa, mapped from YANG variable /routing_system/router/ospf/max_metric/router_lsa (container)
