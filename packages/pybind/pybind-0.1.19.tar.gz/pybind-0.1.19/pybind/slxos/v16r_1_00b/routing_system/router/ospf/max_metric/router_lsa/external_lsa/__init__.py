...
class external_lsa(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/max-metric/router-lsa/external-lsa. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'max-metric', u'router-lsa', u'external-lsa']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'max-metric', u'router-lsa', u'external-lsa']
  ...
  def _set_external_lsa_val(self, v, load=False):
    """
    Setter method for external_lsa_val, mapped from YANG variable /routing_system/router/ospf/max_metric/router_lsa/external_lsa/external_lsa_val (uint32)
