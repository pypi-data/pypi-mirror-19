...
class spf(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/timers/throttle/spf. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__init_delay = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'0..60000']}), is_leaf=True, yang_name="init-delay", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='common-def:time-interval-msec', is_config=True)
    self.__hold_time = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'0..60000']}), is_leaf=True, yang_name="hold-time", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Hold time (msec) between two SPF \ncalculations, default is 5000 msec', u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='common-def:time-interval-msec', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'timers', u'throttle', u'spf']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'timers', u'throttle', u'spf']

  def _get_init_delay(self):
    """
    Getter method for init_delay, mapped from YANG variable /routing_system/router/ospf/timers/throttle/spf/init_delay (common-def:time-interval-msec)
    """
    return self.__init_delay
      
  def _set_init_delay(self, v, load=False):
    """
    Setter method for init_delay, mapped from YANG variable /routing_system/router/ospf/timers/throttle/spf/init_delay (common-def:time-interval-msec)
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'0..60000']}), is_leaf=True, yang_name="init-delay", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='common-def:time-interval-msec', is_config=True)""",
        })
  ...
  def _get_hold_time(self):
    """
    Getter method for hold_time, mapped from YANG variable /routing_system/router/ospf/timers/throttle/spf/hold_time (common-def:time-interval-msec)
    """
    return self.__hold_time
      
  def _set_hold_time(self, v, load=False):
    """
    Setter method for hold_time, mapped from YANG variable /routing_system/router/ospf/timers/throttle/spf/hold_time (common-def:time-interval-msec)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "common-def:time-interval-msec",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'0..60000']}), is_leaf=True, yang_name="hold-time", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Hold time (msec) between two SPF \ncalculations, default is 5000 msec', u'cli-drop-node-name': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='common-def:time-interval-msec', is_config=True)""",
        })
  ...
  def _get_max_hold_time(self):
    """
    Getter method for max_hold_time, mapped from YANG variable /routing_system/router/ospf/timers/throttle/spf/max_hold_time (common-def:time-interval-msec)
    """
    return self.__max_hold_time
      
  def _set_max_hold_time(self, v, load=False):
    """
    Setter method for max_hold_time, mapped from YANG variable /routing_system/router/ospf/timers/throttle/spf/max_hold_time (common-def:time-interval-msec)
    If this variable is read-only (config: false) in the
