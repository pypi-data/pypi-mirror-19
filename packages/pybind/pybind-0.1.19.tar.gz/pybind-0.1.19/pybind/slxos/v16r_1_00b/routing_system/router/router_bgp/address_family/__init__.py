...
class address_family(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ipv4','__ipv6','__evpn',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__evpn = YANGDynClass(base=evpn.evpn, is_container='container', yang_name="evpn", rest_name="evpn", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'EVPN address Family', u'cli-full-command': None, u'callpoint': u'AfEvpn', u'cli-add-mode': None, u'cli-mode-name': u'config-bgp-evpn'}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)
  ...
  def _get_evpn(self):
    """
    Getter method for evpn, mapped from YANG variable /routing_system/router/router_bgp/address_family/evpn (container)
    """
    return self.__evpn
      
  def _set_evpn(self, v, load=False):
    """
    Setter method for evpn, mapped from YANG variable /routing_system/router/router_bgp/address_family/evpn (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=evpn.evpn, is_container='container', yang_name="evpn", rest_name="evpn", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'EVPN address Family', u'cli-full-command': None, u'callpoint': u'AfEvpn', u'cli-add-mode': None, u'cli-mode-name': u'config-bgp-evpn'}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'ipv4': ipv4, 'ipv6': ipv6, 'evpn': evpn, }
