...
class maximum_paths(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/af-vrf/maximum-paths. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'af-vrf', u'maximum-paths']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv4', u'unicast', u'vrf', u'maximum-paths']

  def _get_load_sharing_value(self):
    """
    Getter method for load_sharing_value, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/maximum_paths/load_sharing_value (uint32)
    """
    return self.__load_sharing_value
      
  def _set_load_sharing_value(self, v, load=False):
    """
    Setter method for load_sharing_value, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/maximum_paths/load_sharing_value (uint32)
  ...
  def _get_ebgp(self):
    """
    Getter method for ebgp, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/maximum_paths/ebgp (ebgp-paths)
    """
    return self.__ebgp
      
  def _set_ebgp(self, v, load=False):
    """
    Setter method for ebgp, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/maximum_paths/ebgp (ebgp-paths)
    If this variable is read-only (config: false) in the
  ...
  def _get_ibgp(self):
    """
    Getter method for ibgp, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/maximum_paths/ibgp (ibgp-paths)
    """
    return self.__ibgp
      
  def _set_ibgp(self, v, load=False):
    """
    Setter method for ibgp, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/maximum_paths/ibgp (ibgp-paths)
    If this variable is read-only (config: false) in the
  ...
  def _get_use_load_sharing(self):
    """
    Getter method for use_load_sharing, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/maximum_paths/use_load_sharing (empty)
    """
    return self.__use_load_sharing
      
  def _set_use_load_sharing(self, v, load=False):
    """
    Setter method for use_load_sharing, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/maximum_paths/use_load_sharing (empty)
    If this variable is read-only (config: false) in the
