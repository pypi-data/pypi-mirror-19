...
class neighbor(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/af-vrf/neighbor. Each member element of
  ...
  def _get_af_ipv4_vrf_neighbor_address_holder(self):
    """
    Getter method for af_ipv4_vrf_neighbor_address_holder, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder (container)
    """
    return self.__af_ipv4_vrf_neighbor_address_holder
      
  def _set_af_ipv4_vrf_neighbor_address_holder(self, v, load=False):
    """
    Setter method for af_ipv4_vrf_neighbor_address_holder, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder (container)
