...
class enforce_first_as(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/af-vrf/neighbor/af-ipv4-vrf-neighbor-address-holder/af-ipv4-neighbor-addr/enforce-first-as. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'af-vrf', u'neighbor', u'af-ipv4-vrf-neighbor-address-holder', u'af-ipv4-neighbor-addr', u'enforce-first-as']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv4', u'unicast', u'vrf', u'neighbor', u'enforce-first-as']

  def _get_nei_enforce_first_as(self):
    """
    Getter method for nei_enforce_first_as, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/enforce_first_as/nei_enforce_first_as (empty)
    """
    return self.__nei_enforce_first_as
      
  def _set_nei_enforce_first_as(self, v, load=False):
    """
    Setter method for nei_enforce_first_as, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/enforce_first_as/nei_enforce_first_as (empty)
  ...
  def _get_nei_enforce_first_as_disable(self):
    """
    Getter method for nei_enforce_first_as_disable, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/enforce_first_as/nei_enforce_first_as_disable (empty)
    """
    return self.__nei_enforce_first_as_disable
      
  def _set_nei_enforce_first_as_disable(self, v, load=False):
    """
    Setter method for nei_enforce_first_as_disable, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/enforce_first_as/nei_enforce_first_as_disable (empty)
    If this variable is read-only (config: false) in the
