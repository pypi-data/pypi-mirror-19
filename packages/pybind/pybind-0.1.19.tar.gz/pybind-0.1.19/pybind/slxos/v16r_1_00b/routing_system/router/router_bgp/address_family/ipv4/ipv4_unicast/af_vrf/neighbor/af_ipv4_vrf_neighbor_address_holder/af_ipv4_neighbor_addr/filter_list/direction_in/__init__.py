...
class direction_in(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/af-vrf/neighbor/af-ipv4-vrf-neighbor-address-holder/af-ipv4-neighbor-addr/filter-list/direction-in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'af-vrf', u'neighbor', u'af-ipv4-vrf-neighbor-address-holder', u'af-ipv4-neighbor-addr', u'filter-list', u'direction-in']
  ...
  def _get_filter_list_direction_in_acl_name(self):
    """
    Getter method for filter_list_direction_in_acl_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/filter_list/direction_in/filter_list_direction_in_acl_name (ip-filter-name)
    """
    return self.__filter_list_direction_in_acl_name
      
  def _set_filter_list_direction_in_acl_name(self, v, load=False):
    """
    Setter method for filter_list_direction_in_acl_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/filter_list/direction_in/filter_list_direction_in_acl_name (ip-filter-name)
  ...
  def _get_filter_list_name_direction_in(self):
    """
    Getter method for filter_list_name_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/filter_list/direction_in/filter_list_name_direction_in (empty)
    """
    return self.__filter_list_name_direction_in
      
  def _set_filter_list_name_direction_in(self, v, load=False):
    """
    Setter method for filter_list_name_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/filter_list/direction_in/filter_list_name_direction_in (empty)
    If this variable is read-only (config: false) in the
