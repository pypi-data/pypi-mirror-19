...
class next_hop_self(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/af-vrf/neighbor/af-ipv4-vrf-neighbor-address-holder/af-ipv4-neighbor-addr/next-hop-self. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'af-vrf', u'neighbor', u'af-ipv4-vrf-neighbor-address-holder', u'af-ipv4-neighbor-addr', u'next-hop-self']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv4', u'unicast', u'vrf', u'neighbor', u'next-hop-self']

  def _get_next_hop_self_always(self):
    """
    Getter method for next_hop_self_always, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/next_hop_self/next_hop_self_always (empty)
    """
    return self.__next_hop_self_always
      
  def _set_next_hop_self_always(self, v, load=False):
    """
    Setter method for next_hop_self_always, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/next_hop_self/next_hop_self_always (empty)
  ...
  def _get_next_hop_self_status(self):
    """
    Getter method for next_hop_self_status, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/next_hop_self/next_hop_self_status (empty)
    """
    return self.__next_hop_self_status
      
  def _set_next_hop_self_status(self, v, load=False):
    """
    Setter method for next_hop_self_status, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/next_hop_self/next_hop_self_status (empty)
    If this variable is read-only (config: false) in the
