...
class values(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/default-vrf/af-common-cmds-holder/dampening/values. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'default-vrf', u'af-common-cmds-holder', u'dampening', u'values']
  ...
  def _get_half_time(self):
    """
    Getter method for half_time, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/values/half_time (htime)
    """
    return self.__half_time
      
  def _set_half_time(self, v, load=False):
    """
    Setter method for half_time, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/values/half_time (htime)
  ...
  def _get_reuse_value(self):
    """
    Getter method for reuse_value, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/values/reuse_value (damp-reuse-value)
    """
    return self.__reuse_value
      
  def _set_reuse_value(self, v, load=False):
    """
    Setter method for reuse_value, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/values/reuse_value (damp-reuse-value)
    If this variable is read-only (config: false) in the
  ...
  def _get_start_suppress_time(self):
    """
    Getter method for start_suppress_time, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/values/start_suppress_time (damp-start-suppress-value)
    """
    return self.__start_suppress_time
      
  def _set_start_suppress_time(self, v, load=False):
    """
    Setter method for start_suppress_time, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/values/start_suppress_time (damp-start-suppress-value)
    If this variable is read-only (config: false) in the
  ...
  def _get_max_suppress_time(self):
    """
    Getter method for max_suppress_time, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/values/max_suppress_time (damp-max-suppress-value)
    """
    return self.__max_suppress_time
      
  def _set_max_suppress_time(self, v, load=False):
    """
    Setter method for max_suppress_time, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/values/max_suppress_time (damp-max-suppress-value)
    If this variable is read-only (config: false) in the
