...
class direction_in(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/default-vrf/neighbor/af-ipv4-neighbor-address-holder/af-ipv4-neighbor-address/prefix-list/direction-in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'default-vrf', u'neighbor', u'af-ipv4-neighbor-address-holder', u'af-ipv4-neighbor-address', u'prefix-list', u'direction-in']
  ...
  def _get_prefix_list_direction_in_prefix_name(self):
    """
    Getter method for prefix_list_direction_in_prefix_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_address_holder/af_ipv4_neighbor_address/prefix_list/direction_in/prefix_list_direction_in_prefix_name (nei-prefix-list-filter)
    """
  ...
  def _get_prefix_list_direction_in(self):
    """
    Getter method for prefix_list_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_address_holder/af_ipv4_neighbor_address/prefix_list/direction_in/prefix_list_direction_in (empty)
    """
    return self.__prefix_list_direction_in
      
  def _set_prefix_list_direction_in(self, v, load=False):
    """
    Setter method for prefix_list_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_address_holder/af_ipv4_neighbor_address/prefix_list/direction_in/prefix_list_direction_in (empty)
    If this variable is read-only (config: false) in the
