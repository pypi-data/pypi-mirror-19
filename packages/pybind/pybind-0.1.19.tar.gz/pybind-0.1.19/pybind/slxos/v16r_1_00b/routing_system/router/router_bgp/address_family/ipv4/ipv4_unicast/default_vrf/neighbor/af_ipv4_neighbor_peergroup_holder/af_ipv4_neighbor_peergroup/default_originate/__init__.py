...
class default_originate(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/default-vrf/neighbor/af-ipv4-neighbor-peergroup-holder/af-ipv4-neighbor-peergroup/default-originate. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'default-vrf', u'neighbor', u'af-ipv4-neighbor-peergroup-holder', u'af-ipv4-neighbor-peergroup', u'default-originate']
  ...
  def _get_default_originate_status(self):
    """
    Getter method for default_originate_status, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_peergroup_holder/af_ipv4_neighbor_peergroup/default_originate/default_originate_status (empty)
    """
    return self.__default_originate_status
      
  def _set_default_originate_status(self, v, load=False):
    """
    Setter method for default_originate_status, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_peergroup_holder/af_ipv4_neighbor_peergroup/default_originate/default_originate_status (empty)
  ...
  def _get_default_originate_route_map(self):
    """
    Getter method for default_originate_route_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_peergroup_holder/af_ipv4_neighbor_peergroup/default_originate/default_originate_route_map (rmap-type)
    """
    return self.__default_originate_route_map
      
  def _set_default_originate_route_map(self, v, load=False):
    """
    Setter method for default_originate_route_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_peergroup_holder/af_ipv4_neighbor_peergroup/default_originate/default_originate_route_map (rmap-type)
    If this variable is read-only (config: false) in the
