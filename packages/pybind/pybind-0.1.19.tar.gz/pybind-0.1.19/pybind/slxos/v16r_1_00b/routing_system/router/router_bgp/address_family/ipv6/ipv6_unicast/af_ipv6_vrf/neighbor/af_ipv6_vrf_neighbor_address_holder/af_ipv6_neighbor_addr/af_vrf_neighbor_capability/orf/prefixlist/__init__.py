...
class prefixlist(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv6/ipv6-unicast/af-ipv6-vrf/neighbor/af-ipv6-vrf-neighbor-address-holder/af-ipv6-neighbor-addr/af-vrf-neighbor-capability/orf/prefixlist. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'af-ipv6-vrf', u'neighbor', u'af-ipv6-vrf-neighbor-address-holder', u'af-ipv6-neighbor-addr', u'af-vrf-neighbor-capability', u'orf', u'prefixlist']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv6', u'unicast', u'vrf', u'neighbor', u'capability', u'orf', u'prefixlist']

  def _get_prefixlist_status(self):
    """
    Getter method for prefixlist_status, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/af_vrf_neighbor_capability/orf/prefixlist/prefixlist_status (empty)
  ...
  def _set_prefixlist_status(self, v, load=False):
    """
    Setter method for prefixlist_status, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/af_vrf_neighbor_capability/orf/prefixlist/prefixlist_status (empty)
  ...
  def _get_prefixlist_send(self):
    """
    Getter method for prefixlist_send, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/af_vrf_neighbor_capability/orf/prefixlist/prefixlist_send (empty)
  ...
  def _set_prefixlist_send(self, v, load=False):
    """
    Setter method for prefixlist_send, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/af_vrf_neighbor_capability/orf/prefixlist/prefixlist_send (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_prefixlist_receive(self):
    """
    Getter method for prefixlist_receive, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/af_vrf_neighbor_capability/orf/prefixlist/prefixlist_receive (empty)
  ...
  def _set_prefixlist_receive(self, v, load=False):
    """
    Setter method for prefixlist_receive, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/af_vrf_neighbor_capability/orf/prefixlist/prefixlist_receive (empty)
    If this variable is read-only (config: false) in the
