...
class ebgp_multihop(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv6/ipv6-unicast/af-ipv6-vrf/neighbor/af-ipv6-vrf-neighbor-address-holder/af-ipv6-neighbor-addr/ebgp-multihop. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'af-ipv6-vrf', u'neighbor', u'af-ipv6-vrf-neighbor-address-holder', u'af-ipv6-neighbor-addr', u'ebgp-multihop']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv6', u'unicast', u'vrf', u'neighbor', u'ebgp-multihop']

  def _get_ebgp_multihop_flag(self):
    """
    Getter method for ebgp_multihop_flag, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/ebgp_multihop/ebgp_multihop_flag (empty)
    """
    return self.__ebgp_multihop_flag
      
  def _set_ebgp_multihop_flag(self, v, load=False):
    """
    Setter method for ebgp_multihop_flag, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/ebgp_multihop/ebgp_multihop_flag (empty)
  ...
  def _get_ebgp_multihop_count(self):
    """
    Getter method for ebgp_multihop_count, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/ebgp_multihop/ebgp_multihop_count (uint32)
    """
    return self.__ebgp_multihop_count
      
  def _set_ebgp_multihop_count(self, v, load=False):
    """
    Setter method for ebgp_multihop_count, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/ebgp_multihop/ebgp_multihop_count (uint32)
    If this variable is read-only (config: false) in the
