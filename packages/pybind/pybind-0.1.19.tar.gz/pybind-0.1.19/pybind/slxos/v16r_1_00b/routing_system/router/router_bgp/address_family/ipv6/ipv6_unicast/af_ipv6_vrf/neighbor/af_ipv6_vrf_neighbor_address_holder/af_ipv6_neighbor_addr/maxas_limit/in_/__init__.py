...
class in_(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv6/ipv6-unicast/af-ipv6-vrf/neighbor/af-ipv6-vrf-neighbor-address-holder/af-ipv6-neighbor-addr/maxas-limit/in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'af-ipv6-vrf', u'neighbor', u'af-ipv6-vrf-neighbor-address-holder', u'af-ipv6-neighbor-addr', u'maxas-limit', u'in']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv6', u'unicast', u'vrf', u'neighbor', u'maxas-limit', u'in']

  def _get_num_as_in_as_path(self):
    """
    Getter method for num_as_in_as_path, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/maxas_limit/in/num_as_in_as_path (num-as-in-as-path)
    """
    return self.__num_as_in_as_path
      
  def _set_num_as_in_as_path(self, v, load=False):
    """
    Setter method for num_as_in_as_path, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/maxas_limit/in/num_as_in_as_path (num-as-in-as-path)
  ...
  def _get_maxas_limit_disable(self):
    """
    Getter method for maxas_limit_disable, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/maxas_limit/in/maxas_limit_disable (empty)
    """
    return self.__maxas_limit_disable
      
  def _set_maxas_limit_disable(self, v, load=False):
    """
    Setter method for maxas_limit_disable, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/maxas_limit/in/maxas_limit_disable (empty)
    If this variable is read-only (config: false) in the
