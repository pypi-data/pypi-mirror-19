...
class bfd(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/bfd. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__holdover_interval','__interval',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'router-bgp-attributes', u'bfd']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'bfd']

  def _get_holdover_interval(self):
    """
    Getter method for holdover_interval, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/bfd/holdover_interval (bfd:bfd-holdover-interval)
    """
    return self.__holdover_interval
      
  def _set_holdover_interval(self, v, load=False):
    """
    Setter method for holdover_interval, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/bfd/holdover_interval (bfd:bfd-holdover-interval)
  ...
  def _get_interval(self):
    """
    Getter method for interval, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/bfd/interval (container)
  ...
  def _set_interval(self, v, load=False):
    """
    Setter method for interval, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/bfd/interval (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'holdover_interval': holdover_interval, 'interval': interval, }
