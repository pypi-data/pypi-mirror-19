...
class maxas_limit(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/maxas-limit. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'router-bgp-attributes', u'maxas-limit']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'maxas-limit']
  ...
  def _set_in_(self, v, load=False):
    """
    Setter method for in_, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/maxas_limit/in (container)
