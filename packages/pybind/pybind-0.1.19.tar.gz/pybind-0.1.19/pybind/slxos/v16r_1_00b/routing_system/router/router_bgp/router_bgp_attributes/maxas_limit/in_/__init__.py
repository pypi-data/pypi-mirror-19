...
class in_(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/maxas-limit/in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'router-bgp-attributes', u'maxas-limit', u'in']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'maxas-limit', u'in']
  ...
  def _set_num_as_in_path(self, v, load=False):
    """
    Setter method for num_as_in_path, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/maxas_limit/in/num_as_in_path (num-as-in-path)
