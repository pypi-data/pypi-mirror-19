...
class timers(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ips/neighbor-addr/timers. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'neighbor-ips', u'neighbor-addr', u'timers']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'neighbor', u'timers']

  def _get_nei_keep_alive(self):
    """
    Getter method for nei_keep_alive, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/timers/nei_keep_alive (nei-keep-alive)
    """
    return self.__nei_keep_alive
      
  def _set_nei_keep_alive(self, v, load=False):
    """
    Setter method for nei_keep_alive, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/timers/nei_keep_alive (nei-keep-alive)
  ...
  def _get_nei_hold_time(self):
    """
    Getter method for nei_hold_time, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/timers/nei_hold_time (nei-hold-time)
    """
    return self.__nei_hold_time
      
  def _set_nei_hold_time(self, v, load=False):
    """
    Setter method for nei_hold_time, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/timers/nei_hold_time (nei-hold-time)
    If this variable is read-only (config: false) in the
