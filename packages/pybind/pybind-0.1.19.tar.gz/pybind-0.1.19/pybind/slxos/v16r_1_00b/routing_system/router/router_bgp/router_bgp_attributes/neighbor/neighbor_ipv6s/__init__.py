...
class neighbor_ipv6s(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ipv6s. Each member element of
  ...
  def _get_neighbor_ipv6_addr(self):
    """
    Getter method for neighbor_ipv6_addr, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ipv6s/neighbor_ipv6_addr (list)
    """
    return self.__neighbor_ipv6_addr
      
  def _set_neighbor_ipv6_addr(self, v, load=False):
    """
    Setter method for neighbor_ipv6_addr, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ipv6s/neighbor_ipv6_addr (list)
