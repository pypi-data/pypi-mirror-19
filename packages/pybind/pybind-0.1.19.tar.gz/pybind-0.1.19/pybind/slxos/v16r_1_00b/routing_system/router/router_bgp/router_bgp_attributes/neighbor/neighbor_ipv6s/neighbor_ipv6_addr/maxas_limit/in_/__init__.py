...
class in_(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ipv6s/neighbor-ipv6-addr/maxas-limit/in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'neighbor-ipv6s', u'neighbor-ipv6-addr', u'maxas-limit', u'in']
  ...
  def _set_num_as_in_as_path(self, v, load=False):
    """
    Setter method for num_as_in_as_path, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ipv6s/neighbor_ipv6_addr/maxas_limit/in/num_as_in_as_path (num-as-in-as-path)
  ...
  def _set_maxas_limit_disable(self, v, load=False):
    """
    Setter method for maxas_limit_disable, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ipv6s/neighbor_ipv6_addr/maxas_limit/in/maxas_limit_disable (empty)
    If this variable is read-only (config: false) in the
