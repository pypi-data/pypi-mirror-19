...
class as4(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/neighbor/peer-grps/neighbor-peer-grp/af-neighbor-capability/as4. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'peer-grps', u'neighbor-peer-grp', u'af-neighbor-capability', u'as4']
  ...
  def _set_neighbor_as4_enable(self, v, load=False):
    """
    Setter method for neighbor_as4_enable, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/af_neighbor_capability/as4/neighbor_as4_enable (empty)
  ...
  def _set_neighbor_as4_disable(self, v, load=False):
    """
    Setter method for neighbor_as4_disable, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/af_neighbor_capability/as4/neighbor_as4_disable (empty)
    If this variable is read-only (config: false) in the
