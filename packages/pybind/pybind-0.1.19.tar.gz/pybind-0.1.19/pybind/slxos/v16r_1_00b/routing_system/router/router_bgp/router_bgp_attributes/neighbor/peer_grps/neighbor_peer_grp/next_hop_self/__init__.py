...
class next_hop_self(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/neighbor/peer-grps/neighbor-peer-grp/next-hop-self. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'peer-grps', u'neighbor-peer-grp', u'next-hop-self']
  ...
  def _get_next_hop_self_always(self):
    """
    Getter method for next_hop_self_always, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/next_hop_self/next_hop_self_always (empty)
    """
    return self.__next_hop_self_always
      
  def _set_next_hop_self_always(self, v, load=False):
    """
    Setter method for next_hop_self_always, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/next_hop_self/next_hop_self_always (empty)
  ...
  def _get_next_hop_self_status(self):
    """
    Getter method for next_hop_self_status, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/next_hop_self/next_hop_self_status (empty)
    """
    return self.__next_hop_self_status
      
  def _set_next_hop_self_status(self, v, load=False):
    """
    Setter method for next_hop_self_status, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/next_hop_self/next_hop_self_status (empty)
    If this variable is read-only (config: false) in the
