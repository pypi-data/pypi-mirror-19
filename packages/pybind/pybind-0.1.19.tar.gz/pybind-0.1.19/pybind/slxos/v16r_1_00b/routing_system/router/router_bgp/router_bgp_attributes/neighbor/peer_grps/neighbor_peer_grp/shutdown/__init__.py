...
class shutdown(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/neighbor/peer-grps/neighbor-peer-grp/shutdown. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'peer-grps', u'neighbor-peer-grp', u'shutdown']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'neighbor', u'shutdown']

  def _get_shutdown_status(self):
    """
    Getter method for shutdown_status, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/shutdown/shutdown_status (empty)
    """
    return self.__shutdown_status
      
  def _set_shutdown_status(self, v, load=False):
    """
    Setter method for shutdown_status, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/shutdown/shutdown_status (empty)
  ...
  def _get_generate_rib_out(self):
    """
    Getter method for generate_rib_out, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/shutdown/generate_rib_out (empty)
    """
    return self.__generate_rib_out
      
  def _set_generate_rib_out(self, v, load=False):
    """
    Setter method for generate_rib_out, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/shutdown/generate_rib_out (empty)
    If this variable is read-only (config: false) in the
