...
class compact_flash(PybindBase):
  ...
  from YANG module brocade-system-monitor - based on the path /system-monitor/compact-flash. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system-monitor', u'compact-flash']
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /system_monitor/compact_flash/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /system_monitor/compact_flash/threshold (container)
