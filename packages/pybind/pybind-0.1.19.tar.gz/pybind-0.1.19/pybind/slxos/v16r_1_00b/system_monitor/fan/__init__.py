...
class fan(PybindBase):
  ...
  from YANG module brocade-system-monitor - based on the path /system-monitor/fan. Each member element of
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /system_monitor/fan/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /system_monitor/fan/threshold (container)
  ...
  def _get_alert(self):
    """
    Getter method for alert, mapped from YANG variable /system_monitor/fan/alert (container)
    """
    return self.__alert
      
  def _set_alert(self, v, load=False):
    """
    Setter method for alert, mapped from YANG variable /system_monitor/fan/alert (container)
    If this variable is read-only (config: false) in the
