...
class threshold_monitor(PybindBase):
  ...
  from YANG module brocade-threshold-monitor - based on the path /threshold-monitor-hidden/threshold-monitor. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__sfp','__security','__Cpu','__Memory','__interface','__Buffer',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor-hidden', u'threshold-monitor']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor']

  def _get_sfp(self):
    """
    Getter method for sfp, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/sfp (container)
    """
    return self.__sfp
      
  def _set_sfp(self, v, load=False):
    """
    Setter method for sfp, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/sfp (container)
  ...
  def _get_security(self):
    """
    Getter method for security, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security (container)
    """
    return self.__security
      
  def _set_security(self, v, load=False):
    """
    Setter method for security, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_Cpu(self):
    """
    Getter method for Cpu, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Cpu (container)
    """
    return self.__Cpu
      
  def _set_Cpu(self, v, load=False):
    """
    Setter method for Cpu, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Cpu (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_Memory(self):
    """
    Getter method for Memory, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory (container)
    """
    return self.__Memory
      
  def _set_Memory(self, v, load=False):
    """
    Setter method for Memory, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/interface (container)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/interface (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_Buffer(self):
    """
    Getter method for Buffer, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Buffer (container)
    """
    return self.__Buffer
      
  def _set_Buffer(self, v, load=False):
    """
    Setter method for Buffer, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Buffer (container)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=Buffer.Buffer, is_container='container', yang_name="Buffer", rest_name="Buffer", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure settings for component:Buffer', u'cli-compact-syntax': None, u'callpoint': u'BufferMonitor', u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-threshold-monitor', defining_module='brocade-threshold-monitor', yang_type='container', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'sfp': sfp, 'security': security, 'Cpu': Cpu, 'Memory': Memory, 'interface': interface, 'Buffer': Buffer, }
