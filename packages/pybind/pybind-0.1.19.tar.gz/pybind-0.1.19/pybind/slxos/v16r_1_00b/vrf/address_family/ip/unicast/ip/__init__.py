...
class ip(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ip/unicast/ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ip', u'unicast', u'ip']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv4', u'unicast', u'ip']

  def _get_route(self):
    """
    Getter method for route, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route (container)
    """
    return self.__route
      
  def _set_route(self, v, load=False):
    """
    Setter method for route, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route (container)
  ...
  def _get_import_(self):
    """
    Getter method for import_, mapped from YANG variable /vrf/address_family/ip/unicast/ip/import (container)
    """
    return self.__import_
      
  def _set_import_(self, v, load=False):
    """
    Setter method for import_, mapped from YANG variable /vrf/address_family/ip/unicast/ip/import (container)
    If this variable is read-only (config: false) in the
