...
class bfd_interval_attributes(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ip/unicast/ip/route/static/bfd/bfd-static-route/bfd-interval-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ip', u'unicast', u'ip', u'route', u'static', u'bfd', u'bfd-static-route', u'bfd-interval-attributes']
  ...
  def _get_interval(self):
    """
    Getter method for interval, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_interval_attributes/interval (uint16)
    """
    return self.__interval
      
  def _set_interval(self, v, load=False):
    """
    Setter method for interval, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_interval_attributes/interval (uint16)
  ...
  def _get_min_rx(self):
    """
    Getter method for min_rx, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_interval_attributes/min_rx (uint16)
    """
    return self.__min_rx
      
  def _set_min_rx(self, v, load=False):
    """
    Setter method for min_rx, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_interval_attributes/min_rx (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_multiplier(self):
    """
    Getter method for multiplier, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_interval_attributes/multiplier (uint8)
    """
    return self.__multiplier
      
  def _set_multiplier(self, v, load=False):
    """
    Setter method for multiplier, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_interval_attributes/multiplier (uint8)
    If this variable is read-only (config: false) in the
