...
class route_attributes(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ip/unicast/ip/route/static-route-oif/route-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ip', u'unicast', u'ip', u'route', u'static-route-oif', u'route-attributes']
  ...
  def _get_metric(self):
    """
    Getter method for metric, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif/route_attributes/metric (uint32)
    """
    return self.__metric
      
  def _set_metric(self, v, load=False):
    """
    Setter method for metric, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif/route_attributes/metric (uint32)
  ...
  def _get_distance(self):
    """
    Getter method for distance, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif/route_attributes/distance (uint32)
    """
    return self.__distance
      
  def _set_distance(self, v, load=False):
    """
    Setter method for distance, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif/route_attributes/distance (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_tag(self):
    """
    Getter method for tag, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif/route_attributes/tag (uint32)
...
Default value is 0, indicating no tag.
  ...
  def _set_tag(self, v, load=False):
    """
    Setter method for tag, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif/route_attributes/tag (uint32)
    If this variable is read-only (config: false) in the
