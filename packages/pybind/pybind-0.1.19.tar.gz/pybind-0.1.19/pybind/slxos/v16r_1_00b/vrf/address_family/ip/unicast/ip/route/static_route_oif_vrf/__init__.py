...
class static_route_oif_vrf(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ip/unicast/ip/route/static-route-oif-vrf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ip', u'unicast', u'ip', u'route', u'static-route-oif-vrf']
  ...
  def _get_static_route_next_vrf_dest(self):
    """
    Getter method for static_route_next_vrf_dest, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif_vrf/static_route_next_vrf_dest (inet:ipv4-prefix)
    """
    return self.__static_route_next_vrf_dest
      
  def _set_static_route_next_vrf_dest(self, v, load=False):
    """
    Setter method for static_route_next_vrf_dest, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif_vrf/static_route_next_vrf_dest (inet:ipv4-prefix)
  ...
  def _get_next_hop_vrf(self):
    """
    Getter method for next_hop_vrf, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif_vrf/next_hop_vrf (common-def:vrf-name)
    """
    return self.__next_hop_vrf
      
  def _set_next_hop_vrf(self, v, load=False):
    """
    Setter method for next_hop_vrf, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif_vrf/next_hop_vrf (common-def:vrf-name)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_route_oif_type(self):
    """
    Getter method for static_route_oif_type, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif_vrf/static_route_oif_type (enumeration)
    """
    return self.__static_route_oif_type
      
  def _set_static_route_oif_type(self, v, load=False):
    """
    Setter method for static_route_oif_type, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif_vrf/static_route_oif_type (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_route_oif_name(self):
    """
    Getter method for static_route_oif_name, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif_vrf/static_route_oif_name (string)
    """
    return self.__static_route_oif_name
      
  def _set_static_route_oif_name(self, v, load=False):
    """
    Setter method for static_route_oif_name, mapped from YANG variable /vrf/address_family/ip/unicast/ip/route/static_route_oif_vrf/static_route_oif_name (string)
    If this variable is read-only (config: false) in the
