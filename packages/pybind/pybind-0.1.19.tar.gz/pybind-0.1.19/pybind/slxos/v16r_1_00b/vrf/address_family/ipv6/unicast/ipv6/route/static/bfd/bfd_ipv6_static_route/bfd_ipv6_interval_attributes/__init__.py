...
class bfd_ipv6_interval_attributes(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/ipv6/route/static/bfd/bfd-ipv6-static-route/bfd-ipv6-interval-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'ipv6', u'route', u'static', u'bfd', u'bfd-ipv6-static-route', u'bfd-ipv6-interval-attributes']
  ...
  def _get_interval(self):
    """
    Getter method for interval, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route/bfd_ipv6_interval_attributes/interval (uint16)
    """
    return self.__interval
      
  def _set_interval(self, v, load=False):
    """
    Setter method for interval, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route/bfd_ipv6_interval_attributes/interval (uint16)
  ...
  def _get_min_rx(self):
    """
    Getter method for min_rx, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route/bfd_ipv6_interval_attributes/min_rx (uint16)
    """
    return self.__min_rx
      
  def _set_min_rx(self, v, load=False):
    """
    Setter method for min_rx, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route/bfd_ipv6_interval_attributes/min_rx (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_multiplier(self):
    """
    Getter method for multiplier, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route/bfd_ipv6_interval_attributes/multiplier (uint8)
    """
    return self.__multiplier
      
  def _set_multiplier(self, v, load=False):
    """
    Setter method for multiplier, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route/bfd_ipv6_interval_attributes/multiplier (uint8)
    If this variable is read-only (config: false) in the
