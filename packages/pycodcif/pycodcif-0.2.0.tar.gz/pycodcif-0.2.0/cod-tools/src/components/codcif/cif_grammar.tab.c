...
union YYSTYPE
{
#line 87 "cif_grammar.y" /* yacc.c:355  */
...
{
       0,   116,   116,   118,   119,   120,   121,   122,   126,   141,
     165,   166,   170,   187,   186,   206,   212,   221,   222,   226,
     231,   264,   265,   270,   271,   275,   276,   280,   287,   316,
     321,   336,   335,   365,   379,   396,   401,   410,   409,   422,
     423,   424,   428,   430,   432,   437,   484,   486
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 8:
#line 127 "cif_grammar.y" /* yacc.c:1646  */
    {
            ...
            freex( (yyvsp[0].typed_value).vstr );
        }
#line 1361 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 142 "cif_grammar.y" /* yacc.c:1646  */
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
                    print_message( "WARNING", "stray CIF values at the "
            ...
            freex( (yyvsp[-1].typed_value).vstr );
            freex( (yyvsp[0].typed_value).vstr );
        }
#line 1381 "y.tab.c" /* yacc.c:1646  */
  ...
  case 12:
#line 171 "cif_grammar.y" /* yacc.c:1646  */
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
                    print_message( 
...
#line 1401 "y.tab.c" /* yacc.c:1646  */
  ...
  case 13:
#line 187 "cif_grammar.y" /* yacc.c:1646  */
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
                    print_message( 
...
#line 1421 "y.tab.c" /* yacc.c:1646  */
  ...
  case 15:
#line 207 "cif_grammar.y" /* yacc.c:1646  */
    {
            if( (yyvsp[-1].s) == NULL ) {
...
#line 1431 "y.tab.c" /* yacc.c:1646  */
  ...
  case 16:
#line 213 "cif_grammar.y" /* yacc.c:1646  */
    {
            if( (yyvsp[0].s) == NULL ) {
                yywarning( "data block header has no data block name", px );
            }
...
#line 1441 "y.tab.c" /* yacc.c:1646  */
  ...
  case 19:
#line 227 "cif_grammar.y" /* yacc.c:1646  */
    {
            cif_start_datablock( cif_cc->cif, (yyvsp[0].s), px );
            freex( (yyvsp[0].s) );
        }
#line 1450 "y.tab.c" /* yacc.c:1646  */
  ...
  case 20:
#line 232 "cif_grammar.y" /* yacc.c:1646  */
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_string_quotes( cif_cc ) ||
                isset_fix_datablock_names( cif_cc ) ) {
                char buf[strlen((yyvsp[-1].s))+strlen((yyvsp[0].typed_value).vstr)+2];
                strcpy( buf, (yyvsp[-1].s) );
                buf[strlen((yyvsp[-1].s))] = '_';
                int i;
                for( i = 0; i < strlen((yyvsp[0].typed_value).vstr); i++ ) {
                    if( (yyvsp[0].typed_value).vstr[i] != ' ' ) {
                        buf[strlen((yyvsp[-1].s))+1+i] = (yyvsp[0].typed_value).vstr[i];
                    } else {
                        buf[strlen((yyvsp[-1].s))+1+i] = '_';
                    } 
                }
                buf[strlen((yyvsp[-1].s))+strlen((yyvsp[0].typed_value).vstr)+1] = '\0';
                ...
                cif_start_datablock( cif_cc->cif, (yyvsp[-1].s), px );
...
#line 1484 "y.tab.c" /* yacc.c:1646  */
  ...
  case 27:
#line 281 "cif_grammar.y" /* yacc.c:1646  */
    {
            assert_datablock_exists( px );
            add_tag_value( (yyvsp[-1].s), (yyvsp[0].typed_value).vstr, (yyvsp[0].typed_value).vtype, px );
            freex( (yyvsp[-1].s) );
            freex( (yyvsp[0].typed_value).vstr );
        }
#line 1495 "y.tab.c" /* yacc.c:1646  */
  ...
  case 28:
#line 288 "cif_grammar.y" /* yacc.c:1646  */
    {
                assert_datablock_exists( px );
                if( isset_fix_errors( cif_cc ) ||
                    isset_fix_string_quotes( cif_cc ) ) {
                    yywarning( "string with spaces without quotes -- fixed", px );
                    char *buf = mallocx(strlen((yyvsp[-1].typed_value).vstr)+strlen((yyvsp[0].typed_value).vstr)+2,px);
                    buf = strcpy( buf, (yyvsp[-1].typed_value).vstr );
                    buf = strcat( buf, " \0" );
                    buf = strcat( buf, (yyvsp[0].typed_value).vstr );
                    ...
                    add_tag_value( (yyvsp[-2].s), buf, tag_type, px );
                    freex( buf );
                } else {
                    yyerror_previous( "incorrect CIF syntax", px );
                }
...
#line 1525 "y.tab.c" /* yacc.c:1646  */
  ...
  case 29:
#line 317 "cif_grammar.y" /* yacc.c:1646  */
    {
            (yyval.typed_value).vstr  = (yyvsp[0].typed_value).vstr;
            (yyval.typed_value).vtype = (yyvsp[0].typed_value).vtype;
        }
#line 1534 "y.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 322 "cif_grammar.y" /* yacc.c:1646  */
    {
            char *buf = mallocx( strlen((yyvsp[-1].typed_value).vstr) + strlen((yyvsp[0].typed_value).vstr) + 2, px );
            buf = strcpy( buf, (yyvsp[-1].typed_value).vstr );
            buf = strcat( buf, " \0" );
            ...
            freex( (yyvsp[-1].typed_value).vstr );
            freex( (yyvsp[0].typed_value).vstr );
            (yyval.typed_value).vstr  = buf;
            (yyval.typed_value).vtype = CIF_UNKNOWN;
        }
#line 1549 "y.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 336 "cif_grammar.y" /* yacc.c:1646  */
    {
           assert_datablock_exists( px );
           loop_tag_count = 0;
           loop_value_count = 0;
...
#line 1562 "y.tab.c" /* yacc.c:1646  */
  ...
  case 32:
#line 345 "cif_grammar.y" /* yacc.c:1646  */
    {
...
#line 1584 "y.tab.c" /* yacc.c:1646  */
  ...
  case 33:
#line 366 "cif_grammar.y" /* yacc.c:1646  */
    {
            size_t tag_nr = cif_tag_index( cif_cc->cif, (yyvsp[0].s) );
            if( tag_nr != -1 ) {
                print_message(
                    "ERROR",
                    cxprintf( "tag %s appears more than once", (yyvsp[0].s) ), "",
                    cif_flex_current_line_number(), -1, px );
                yyincrease_error_counter();
            }
            loop_tag_count++;
            cif_insert_value( cif_cc->cif, (yyvsp[0].s), NULL, CIF_UNKNOWN, px );
            freex( (yyvsp[0].s) );
        }
#line 1602 "y.tab.c" /* yacc.c:1646  */
  ...
  case 34:
#line 380 "cif_grammar.y" /* yacc.c:1646  */
    {
            size_t tag_nr = cif_tag_index( cif_cc->cif, (yyvsp[0].s) );
            if( tag_nr != -1 ) {
                print_message(
...
#line 1620 "y.tab.c" /* yacc.c:1646  */
  ...
  case 35:
#line 397 "cif_grammar.y" /* yacc.c:1646  */
    {
            loop_value_count++;
            cif_push_loop_value( cif_cc->cif, (yyvsp[0].typed_value).vstr, (yyvsp[0].typed_value).vtype, px );
        }
#line 1629 "y.tab.c" /* yacc.c:1646  */
    break;

  case 36:
#line 402 "cif_grammar.y" /* yacc.c:1646  */
    {
            loop_value_count++;
            cif_push_loop_value( cif_cc->cif, (yyvsp[0].typed_value).vstr, (yyvsp[0].typed_value).vtype, px );
        }
#line 1638 "y.tab.c" /* yacc.c:1646  */
  ...
  case 37:
#line 410 "cif_grammar.y" /* yacc.c:1646  */
    {
            cif_start_save_frame( cif_cc->cif, /* name = */ (yyvsp[0].s), px );
            freex( (yyvsp[0].s) );
        }
...
#line 1655 "y.tab.c" /* yacc.c:1646  */
  ...
  case 42:
#line 429 "cif_grammar.y" /* yacc.c:1646  */
    { (yyval.typed_value).vstr = (yyvsp[0].s); (yyval.typed_value).vtype = CIF_SQSTRING; }
#line 1661 "y.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 431 "cif_grammar.y" /* yacc.c:1646  */
    { (yyval.typed_value).vstr = (yyvsp[0].s); (yyval.typed_value).vtype = CIF_DQSTRING; }
#line 1667 "y.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 433 "cif_grammar.y" /* yacc.c:1646  */
    { (yyval.typed_value).vstr = (yyvsp[0].s); (yyval.typed_value).vtype = CIF_UQSTRING; }
#line 1673 "y.tab.c" /* yacc.c:1646  */
    break;

  case 45:
#line 438 "cif_grammar.y" /* yacc.c:1646  */
    { (yyval.typed_value).vstr = (yyvsp[0].s);
          int unprefixed = 0;
          if( isset_do_not_unprefix_text( cif_cc ) == 0 ) {
              size_t str_len = strlen( (yyval.typed_value).vstr );
              char * unprefixed_text = cif_unprefix_textfield( (yyval.typed_value).vstr );
              free( (yyval.typed_value).vstr );
              (yyval.typed_value).vstr = unprefixed_text;
              if( str_len != strlen( (yyval.typed_value).vstr ) ) {
                  unprefixed = 1;
              }
          }
          int unfolded = 0;
          if( isset_do_not_unfold_text( cif_cc ) == 0 &&
              (yyval.typed_value).vstr[0] == '\\' ) {
              size_t str_len = strlen( (yyval.typed_value).vstr );
              char * unfolded_text = cif_unfold_textfield( (yyval.typed_value).vstr );
              free( (yyval.typed_value).vstr );
              (yyval.typed_value).vstr = unfolded_text;
              if( str_len != strlen( (yyval.typed_value).vstr ) ) {
                  unfolded = 1;
              }
          }
         ...
         */
          if( unprefixed == 1 && unfolded == 0 ) {
              if( (yyval.typed_value).vstr[0] == '\n' ) {
                  size_t i = 0;
                  while((yyval.typed_value).vstr[i] != '\0') {
                      (yyval.typed_value).vstr[i] = (yyval.typed_value).vstr[i+1];
                      i++;
                  }
                  (yyval.typed_value).vstr[i] = '\0';
              }
          }

          (yyval.typed_value).vtype = CIF_TEXT; }
#line 1721 "y.tab.c" /* yacc.c:1646  */
    break;

  case 46:
#line 485 "cif_grammar.y" /* yacc.c:1646  */
    { (yyval.typed_value).vstr = (yyvsp[0].s); (yyval.typed_value).vtype = CIF_FLOAT; }
#line 1727 "y.tab.c" /* yacc.c:1646  */
    break;

  case 47:
#line 487 "cif_grammar.y" /* yacc.c:1646  */
    { (yyval.typed_value).vstr = (yyvsp[0].s); (yyval.typed_value).vtype = CIF_INT; }
...
#line 490 "cif_grammar.y" /* yacc.c:1906  */
