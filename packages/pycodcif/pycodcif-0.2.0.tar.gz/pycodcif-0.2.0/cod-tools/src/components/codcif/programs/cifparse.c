...
**$Revision: 4748 $
**$URL: svn://www.crystallography.net/cod-tools/trunk/src/components/codcif/programs/cifparse.c $
\*---------------------------------------------------------------------------*/
...
static char *source_URL = "$URL: svn://www.crystallography.net/cod-tools/trunk/src/components/codcif/programs/cifparse.c $";
