/*---------------------------------------------------------------------------*\
**$Author: andrius $
**$Date: 2016-10-12 13:20:16 +0000 (Wed, 12 Oct 2016) $ 
**$Revision: 4748 $
**$URL: svn://www.crystallography.net/cod-tools/trunk/src/components/codcif/programs/cifvalues.c $
\*---------------------------------------------------------------------------*/
...
static char *source_URL = "$URL: svn://www.crystallography.net/cod-tools/trunk/src/components/codcif/programs/cifvalues.c $";
