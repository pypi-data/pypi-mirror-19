...
#         print 'max_cores',max_cores         
    ...
    def do_windowing_with_fft(self, win_x=None, win_y=None, win_step_x=1, win_step_y=1,
        ...
        '''
        Create Plot Groups for the Real and FFT of the windows
        '''
        h5_pos_inds, h5_pos_vals, h5_spec_inds, h5_spec_vals = aux_ds_names

        win_plot_grp_slice = (slice(None), slice(None, win_y))
        fft_plot_grp_slice = (slice(None), slice(win_y+1, None))
