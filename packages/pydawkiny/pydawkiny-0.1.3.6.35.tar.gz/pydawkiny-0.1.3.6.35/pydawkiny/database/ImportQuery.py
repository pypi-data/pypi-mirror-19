...
def db2SQL(query, h=None, port=None, db=None, u=None, p=None):
	...
	euqry_result.columns = execonn.keys()
...
def mariaDB(dataframe, name=None, h=None, port=None, db=None, u=None, p=None, if_exists='append'):
	...
	# Get a DataFrame
	dataframe.to_sql(con=conn, name=None, if_exists=if_exists, flavor='mysql', index=False, chunksize=None)
