...
tmp = pd.read_csv('/media/dawkiny/M/BigData/Datasets/wine/wine.data', sep=',')
...
tmp.columns = tmp.columns.str.replace(' ', '_')
tmp.to_csv('/media/dawkiny/M/BigData/Datasets/wine/winequality-white.csv', sep=',', header=True, index=False)

tmp = pd.read_csv('/media/dawkiny/M/BigData/Datasets/wine/winequality-red.csv', sep=',')
tmp.columns = tmp.columns.str.replace(' ', '_')
tmp.to_csv('/media/dawkiny/M/BigData/Datasets/wine/winequality-red.csv', sep=',', header=True, index=False)
