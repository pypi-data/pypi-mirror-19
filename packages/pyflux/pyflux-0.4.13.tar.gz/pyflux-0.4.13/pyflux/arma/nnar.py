...
class NNAR(tsm.TSM):
    ...
    **** NEURAL NETWORK AUTOREGRESSIVE INTEGRATED (NNAR) MODELS ****
    ...
    def _create_latent_variables(self):
        ...
        self.latent_variables.create(name='Wide weight', dim=[self.ar], prior=fam.Cauchy(0, 1, transform=None), q=fam.Normal(0, 3))
    ...
    def _model(self, beta):
        ...
        wide_weights = z[self.latent_variables.z_indices['Wide weight']['start']:self.latent_variables.z_indices['Wide weight']['end']+1]
        ...
        return self.X.T.dot(wide_weights) + h.dot(output_weights) + output_bias, Y
    ...
    def _mb_model(self, beta, mini_batch):
        ...
        return X.T.dot(wide_weights) + h.dot(output_weights) + output_bias, Y
    ...
    def predict_new(self, X, z):
        ...
        return X.T.dot(wide_weights) + h.dot(output_weights) + output_bias
