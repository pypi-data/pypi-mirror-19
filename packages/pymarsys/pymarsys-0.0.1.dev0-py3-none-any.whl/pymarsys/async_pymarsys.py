...
class AsyncEmarsys:
    ...
    def get_authentication_variables(self):
        """
    ...
    async def make_async_call(
        ...
        nonce, created, password_digest = self.get_authentication_variables()
    ...
    async def get_all_available_fields(self):
        """

        :return:
        """
        return await self.make_async_call('api/v2/field', method='GET')
