...
class portfolio(_object):
    ...
    def actual_reward(self, actual_returns):
        return _ppslp.portfolio_actual_reward(self, actual_returns)
    ...
    def Actualreturn(self, actual):
        return _ppslp.portfolio_Actualreturn(self, actual)
