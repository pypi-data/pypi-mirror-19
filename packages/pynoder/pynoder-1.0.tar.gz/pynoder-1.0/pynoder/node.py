...
class NodeTitle(QtWidgets.QGraphicsWidget):
    __color = QtGui.QColor("#000000")
    __font = QtGui.QFont('Arial', 15)
    __font.setLetterSpacing(QtGui.QFont.PercentageSpacing, 115)
    __labelBottomSpacing = 15
...
class Node(QtWidgets.QGraphicsWidget):
    ...
    __defaultColor = QtGui.QColor("#E6E6E6")
    __unselectedColor = QtGui.QColor("#7F7070")
    __selectedColor = QtGui.QColor("#F15800")

    __unselectedPen = QtGui.QPen(__unselectedColor, 1.0)
    __selectedPen = QtGui.QPen(__selectedColor, 1.0)
    ...
    def paint(self, painter, option, widget):
        ...
        painter.setBrush(QtGui.QColor("#A7FF99"))
