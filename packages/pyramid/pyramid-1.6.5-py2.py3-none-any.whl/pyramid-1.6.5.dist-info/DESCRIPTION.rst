...
- Pin to ``zope.interface < 4.2.0`` on Python 3.2.
  See https://github.com/Pylons/pyramid/pull/2767
...
- Fix an inconsistency in the documentation between view predicates and
  ...
  See https://github.com/Pylons/pyramid/pull/2766

- Fix incompatibilities in the ``prequest`` test suite caused by changes in
  WebOb 1.7. See https://github.com/Pylons/pyramid/pull/2789
