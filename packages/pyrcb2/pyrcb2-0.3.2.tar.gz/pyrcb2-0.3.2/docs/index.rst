...
This documentation is for pyrcb2 version **0.3.2**.
See the :doc:`changelog <release-notes/0.3>`
for information about this version.

Source code for pyrcb2 and this documentation is available at
`<https://github.com/nickolas360/pyrcb2/tree/0.3.2/>`_.

.. _examples: https://github.com/nickolas360/pyrcb2/tree/0.3.2/examples/
...
.. toctree::
   ...
   custom-commands
   release-notes/index
   Source code <https://github.com/nickolas360/pyrcb2/tree/0.3.2/>
   Examples <https://github.com/nickolas360/pyrcb2/tree/0.3.2/examples/>
   License <https://github.com/nickolas360/pyrcb2/blob/0.3.2/LICENSE>
