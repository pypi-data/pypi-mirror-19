...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initlibcsamfile(void); /*proto*/
PyMODINIT_FUNC initlibcsamfile(void)
#else
PyMODINIT_FUNC PyInit_libcsamfile(void); /*proto*/
PyMODINIT_FUNC PyInit_libcsamfile(void)
#endif
{
  __Pyx_TraceDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_libcsamfile(void)", 0);
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "pysam.libcsamfile")) {
      if (unlikely(PyDict_SetItemString(modules, "pysam.libcsamfile", __pyx_m) < 0)) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /*--- Type init code ---*/
  __pyx_ptype_5pysam_18libcalignedsegment_AlignedSegment = __Pyx_ImportType("pysam.libcalignedsegment", "AlignedSegment", sizeof(struct __pyx_obj_5pysam_18libcalignedsegment_AlignedSegment), 1); if (unlikely(!__pyx_ptype_5pysam_18libcalignedsegment_AlignedSegment)) __PYX_ERR(1, 1, __pyx_L1_error)
  __pyx_vtabptr_5pysam_18libcalignedsegment_AlignedSegment = (struct __pyx_vtabstruct_5pysam_18libcalignedsegment_AlignedSegment*)__Pyx_GetVtable(__pyx_ptype_5pysam_18libcalignedsegment_AlignedSegment->tp_dict); if (unlikely(!__pyx_vtabptr_5pysam_18libcalignedsegment_AlignedSegment)) __PYX_ERR(1, 1, __pyx_L1_error)
  ...
  if (PyType_Ready(&__pyx_type_5pysam_11libcsamfile_AlignedRead) < 0) __PYX_ERR(1, 33, __pyx_L1_error)
  __pyx_type_5pysam_11libcsamfile_AlignedRead.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_5pysam_11libcsamfile_AlignedRead.tp_dict, __pyx_vtabptr_5pysam_11libcsamfile_AlignedRead) < 0) __PYX_ERR(1, 33, __pyx_L1_error)
  if (PyObject_SetAttrString(__pyx_m, "AlignedRead", (PyObject *)&__pyx_type_5pysam_11libcsamfile_AlignedRead) < 0) __PYX_ERR(1, 33, __pyx_L1_error)
  __pyx_ptype_5pysam_11libcsamfile_AlignedRead = &__pyx_type_5pysam_11libcsamfile_AlignedRead;
  __pyx_ptype_5pysam_17libcalignmentfile_AlignmentFile = __Pyx_ImportType("pysam.libcalignmentfile", "AlignmentFile", sizeof(struct __pyx_obj_5pysam_17libcalignmentfile_AlignmentFile), 1); if (unlikely(!__pyx_ptype_5pysam_17libcalignmentfile_AlignmentFile)) __PYX_ERR(1, 1, __pyx_L1_error)
  __pyx_vtabptr_5pysam_17libcalignmentfile_AlignmentFile = (struct __pyx_vtabstruct_5pysam_17libcalignmentfile_AlignmentFile*)__Pyx_GetVtable(__pyx_ptype_5pysam_17libcalignmentfile_AlignmentFile->tp_dict); if (unlikely(!__pyx_vtabptr_5pysam_17libcalignmentfile_AlignmentFile)) __PYX_ERR(1, 1, __pyx_L1_error)
  ...
  if (PyType_Ready(&__pyx_type_5pysam_11libcsamfile_Samfile) < 0) __PYX_ERR(1, 25, __pyx_L1_error)
  __pyx_type_5pysam_11libcsamfile_Samfile.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_5pysam_11libcsamfile_Samfile.tp_dict, __pyx_vtabptr_5pysam_11libcsamfile_Samfile) < 0) __PYX_ERR(1, 25, __pyx_L1_error)
  if (PyObject_SetAttrString(__pyx_m, "Samfile", (PyObject *)&__pyx_type_5pysam_11libcsamfile_Samfile) < 0) __PYX_ERR(1, 25, __pyx_L1_error)
  ...
  __pyx_ptype_5pysam_10libchtslib_HTSFile = __Pyx_ImportType("pysam.libchtslib", "HTSFile", sizeof(struct __pyx_obj_5pysam_10libchtslib_HTSFile), 1); if (unlikely(!__pyx_ptype_5pysam_10libchtslib_HTSFile)) __PYX_ERR(5, 1904, __pyx_L1_error)
  __pyx_vtabptr_5pysam_10libchtslib_HTSFile = (struct __pyx_vtabstruct_5pysam_10libchtslib_HTSFile*)__Pyx_GetVtable(__pyx_ptype_5pysam_10libchtslib_HTSFile->tp_dict); if (unlikely(!__pyx_vtabptr_5pysam_10libchtslib_HTSFile)) __PYX_ERR(5, 1904, __pyx_L1_error)
  ...
  __pyx_ptype_5pysam_18libcalignedsegment_PileupColumn = __Pyx_ImportType("pysam.libcalignedsegment", "PileupColumn", sizeof(struct __pyx_obj_5pysam_18libcalignedsegment_PileupColumn), 1); if (unlikely(!__pyx_ptype_5pysam_18libcalignedsegment_PileupColumn)) __PYX_ERR(7, 69, __pyx_L1_error)
  __pyx_ptype_5pysam_18libcalignedsegment_PileupRead = __Pyx_ImportType("pysam.libcalignedsegment", "PileupRead", sizeof(struct __pyx_obj_5pysam_18libcalignedsegment_PileupRead), 1); if (unlikely(!__pyx_ptype_5pysam_18libcalignedsegment_PileupRead)) __PYX_ERR(7, 77, __pyx_L1_error)
  ...
  #endif
  __Pyx_TraceCall("PyMODINIT_FUNC PyInit_libcsamfile(void)", __pyx_f[1], 1, 0, __PYX_ERR(1, 1, __pyx_L1_error));
