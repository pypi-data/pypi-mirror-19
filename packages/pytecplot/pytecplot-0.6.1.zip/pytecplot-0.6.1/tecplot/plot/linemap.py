...
class LinemapBars(LinemapStyle):
    ...
    .. code-block:: python
        ...
        tp.export.save_png('linemap_bars.png', 600)
...
class LinemapCurve(LinemapStyle):
    ...
    .. code-block:: python
        :emphasize-lines: 33,35-37,39-42,44-46
        ...
        tp.export.save_png('linemap_curve.png', 600)
...
class LinemapErrorBars(LinemapStyle):
    ...
    .. code-block:: python
        ...
        tp.export.save_png('linemap_error_bars.png', 600)
...
class LinemapIndices(LinemapStyle):
    ...
    .. code-block:: python
        ...
        # save image to file
        tp.export.save_png('linemap_indices.png', 600)
...
class LinemapLine(LinemapStyle):
    ...
    .. code-block:: python
        ...
        # save image to file
        tp.export.save_png('linemap_line.png', 600)
...
class LinemapSymbols(LinemapStyle):
    ...
    .. code-block:: python
        ...
        from os import path
        import tecplot as tp
        from tecplot.constant import PlotType, Color, FillMode
        ...
        # save image to file
        tp.export.save_png('linemap_symbols.png', 600)
...
class Linemap(session.Style):
    ...
    @property
    def zone_index(self):
        """Zero-based index of the `Zone <data_access>` this `Linemap` will draw.
    ...
    @property
    def zone(self):
        """`Zone <data_access>` this `Linemap` will draw.
    ...
    def sort_mode(self):
        ...
        Possible values:  `LineMapSort.SpecificVar`,
        `LineMapSort.IndependentVar`, `LineMapSort.DependentVar` or
        `LineMapSort.None_`.

        Example usage::

            >>> from tecplot.constant import LineMapSort
            >>> plot.linemap(0).sort_mode = LineMapSort.DependentVar
        """
    ...
    def sort_variable(self):
        ...
        The ``sort_mode`` attribute must be set to `LineMapSort.SpecificVar`::

            >>> from tecplot.constant import LineMapSort
            >>> plot.linemap(0).sort_by = LineMapSort.SpecificVar
...
class XYLinemap(Linemap):
    ...
    Linemaps connect a specific `Zone <data_access>`/`Variable` combination to a line or set
    ...
    .. code-block:: python
        ...
        tp.export.save_png('linemap_xy.png', 600)
