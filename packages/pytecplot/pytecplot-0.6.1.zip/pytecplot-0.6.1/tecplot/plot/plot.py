...
class SketchPlot(Plot):
    ...
    .. code-block:: python
        ...
        tp.export.save_png('plot_sketch.png', 600)
...
class FieldPlot(Plot):
    ...
    .. code-block:: python
        ...
        # save image to file
        tp.export.save_png('plot_field.png', 600)
    ...
    def fieldmap_index(self, zone):
        ...
        Parameter:
            zone (`Zone <data_access>`): The `Zone <data_access>` object that belongs to the `Dataset`
...
class Cartesian2DFieldPlot(FieldPlot):
    ...
    .. code-block:: python
        ...
        # save image to file
        tp.export.save_png('plot_field2d.png', 600)
    ...
    def fieldmap(self, key):
        ...
        Parameter:
            key (`Zone <data_access>` or `integer <int>`): The `Zone <data_access>` must be in the `Dataset`
    ...
    def draw_order(self):
        ...
        The order is either by `Zone <data_access>` or by visual layer (contour, mesh, etc.)::
...
class Cartesian3DFieldPlot(FieldPlot):
    ...
    .. code-block:: python
        ...
        # save image to file
        tp.export.save_png('plot_field3d.png', 600)
...
class LinePlot(Plot):
    ...
    .. code-block:: python
        ...
        # save image to file
        tp.export.save_png('plot_line.png', 600)
...
class XYLinePlot(LinePlot):
    ...
    .. code-block:: python
        ...
        # save image to file
        tp.export.save_png('plot_xyline.png', 600)
    ...
    def add_linemap(self, name, zone, x, y, show=True):
        ...
        Parameters:
            ...
            zone (`Zone <data_access>`): The data to be used when drawing this linemap.
...
class PolarLinePlot(LinePlot):
    ...
    .. code-block:: python
        ...
        tp.export.save_png('plot_polar.png', 600)
