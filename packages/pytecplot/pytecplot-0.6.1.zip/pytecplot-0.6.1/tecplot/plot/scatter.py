...
from ..tecutil import color_spec, inherited_property, log_setattr, sv, Index
...
class TextSymbol(Symbol):
    ...
    def font_override(self):
        ...
        Possible values: `Font.Greek`, `Font.Math` or Font.UserDefined`.
...
class TextScatterSymbol(TextSymbol):
    ...
    .. code-block:: python
        ...
        tp.export.save_png('fieldmap_scatter_text.png', 600)
...
class GeometrySymbol(Symbol):
    ...
    .. code-block:: python
        ...
        # save image to file
        tp.export.save_png('linemap_symbols_geometry.png', 600)
...
class GeometryScatterSymbol(GeometrySymbol):
    ...
    .. code-block:: python
        ...
        tp.export.save_png('fieldmap_scatter_geometry.png', 600)
