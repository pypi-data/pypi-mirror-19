...
class EncodersPigpio(BanyanBase):
    """
    This class publishes encoder ticks for each encoder
    It uses separate callback method for each wheel
    """
