...
class I2CPcf8591(BanyanBase):
    """
    This class continuously reads the 3 A/D ports for line follower data. It may be stopped or
    started by other components
    ...
    def __init__(self, back_plane_ip_address=None, subscriber_port='43125', publisher_port='43124',
        ...
        self.publisher_topic = 'i2c_pfc8591_' + str(device_address)
    ...
    def incoming_message_processing(self, topic, payload):
        ...
        try:
            ...
            if topic == "I2C" + str(self.device_address):
                # data1 = payload[0]['data']
                # data2 = payload[1]['data']
                # data3 = payload[2]['data']
                # self.last_data = [data1, data2, data3]
                if payload['tag'] == 0:
                    self.last_data[0] = payload['data']
                if payload['tag'] == 1:
                    self.last_data[1] = payload['data']
                if payload['tag'] == 2:
                    self.last_data[2] = payload['data']
