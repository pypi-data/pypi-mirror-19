...
class I2CAdxl345(BanyanBase):
    """
    This class continuously reads accelerometer data_. It may be stopped
    started by other processes that publish an adxl345 topic message with python_banyan payload of enable or
    disable
    ...
    def __init__(self, back_plane_ip_address=None, subscriber_port='43125', publisher_port='43124',
        ...
        self.publisher_topic = 'i2c_adxl345_' + str(device_address)
    ...
    def get_last_data(self):
        """
        This method retrieves the data_retrieved from the last read - continuous or manual
        :return:
        """
