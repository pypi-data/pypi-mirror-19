...
class SwitchesPigpio(BanyanBase):
    """
    This class monitors the push-button switch and left and right bumpers. It uses pigpio glitch filtering to do switch
    de-bounce. Each switch has its own pigpio callback routine. It uses python_banyan glitch value of 20 ms.
    """
