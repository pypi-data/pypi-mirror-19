...
from .exceptions import DailyMedRemoteException
...
class DailyMed(object):
    ...
    def get_spls(self, **kwargs):
        ...
        Args:
            ...
            rxcui (str): RxNorm Concept Unique Identifier (RXCUI) code.
                See the documentation for resource /rxcuis for more information.
            setid (str): Set ID of a label.
            unii_code (str): Unique Ingredient Identifier (UNII) code.
                See the documentation for resource /uniis for more information.
        """
        return self.call('spls', models.SPLMeta, kwargs)
    ...
    def get_spl(self, set_id):
        ...
        Returns:
            SPLDocument: Representation of the Structured Product Label.
        """
        response = requests.get(
            url='%s/spls/%s.xml' % (self.API_BASE, set_id),
        )
        return models.SPLDocument(response.text)
