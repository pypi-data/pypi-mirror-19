...
def main():
    ...
    bam_signpost_id = args.bam_normal_signpost_id
    ...
    status_dict = dict()
    status_dict['bam_normal_signpost_id'] = bam_signpost_id
    ...
    status_dict['s3_bam_url'] = s3_bam_normal_url
