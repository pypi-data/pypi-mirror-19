...
from fabric.contrib.files import exists, append, upload_template as fab_upload_template
...
def upload_mako_template(local_path, remote_path, owner='root:root', context={}, **kwargs):
    """
