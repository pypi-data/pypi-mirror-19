...
# Limit the start between 0 <= start <= chromosome.length - 10
if (start < 0) {start = 0}
if (start > chromosome.length) {start = chromosome.length - 10}

# Limit the stop between 10 <= stop <= chromosome.length
if (stop < 10) {stop = 10}
