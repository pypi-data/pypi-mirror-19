...
The sources for s3workers can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/bradrf/s3workers
.. _tarball: https://github.com/bradrf/s3workers/tarball/master
