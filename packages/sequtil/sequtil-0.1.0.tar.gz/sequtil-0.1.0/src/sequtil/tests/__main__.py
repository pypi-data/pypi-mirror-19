...
from sequtil import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('sequtil')
...
def main(args=None):
    """
    Called with ``python -m sequtil.tests``: run main test suite.
    """
    ...
    import sequtil.tests as test_module
