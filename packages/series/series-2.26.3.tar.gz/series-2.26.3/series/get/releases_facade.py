...
class ReleasesFacade(DbFacade):
    ...
    def create(self, series, season, episode, airdate=None, search_name=None,
               **kw):
        fact = ReleaseFactory()
    ...
    def status(self):
        ...
        return Map(
            ...
            caching=caching / _.release.info,
            search=search / _.release.info,
            downloading=downloading / _.release.info,
            failed=failed / _.release.info,
        )
