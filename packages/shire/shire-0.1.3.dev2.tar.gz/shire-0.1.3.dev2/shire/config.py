...
class Config(dict):
    ...
    SHIRE_PROJECT_DIR = 'project_dir'
    SHIRE_PROJECT_DIR_DEFAULT = ''
    ...
    SHELVE_SECTION = 'shelve'
    SHELVE_PATH = 'shelve_path'
    SHELVE_PATH_DEFAULT = 'shelves/'
    ...
    def make_default(self):
        ...
        self.update({
            self.SHIRE_SECTION: {
                ...
                self.SHIRE_PROJECT_DIR: self.SHIRE_PROJECT_DIR_DEFAULT
            },
            ...
            self.SHELVE_SECTION: {
                self.SHELVE_PATH: self.SHELVE_PATH_DEFAULT
            },
            self.POOL_SECTION: {
    ...
    def save_to_cp(self):
        self.cp = SafeConfigParser()
        for section, variables in self.iteritems():
