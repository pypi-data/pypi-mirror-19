System.register(["app/admin/cls/css_classes"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var classes, cls_type, cls_has_options, formset_total_forms, formset, formset_form_add, formset_form, field_value, field_lang_switch, field_order, field_delete;
    return {
        setters: [
            function (classes_1) {
                classes = classes_1;
