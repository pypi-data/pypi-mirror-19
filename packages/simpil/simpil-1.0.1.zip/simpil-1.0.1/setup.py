...
def get_package_parameter(parameter,
    ...
    with open(init_file_name, u'r') as init_file:
...
setup(
    ...
    url=u'https://bitbucket.org/daycoder/simpil.git',  # Use the url to the git repo
    download_url=(u'https://bitbucket.org/daycoder/'
                  u'simpil.git/get/{version}.tar'
    ...
    description=u"Simplifies use is Pillow for adding text to images",
    ...
    # Dependencies
    install_requires=[u"requests>=2.13.0",
                      u'Pillow>=4.0.0'],
...
# twine register dist/simpil-0.0.1-py2.py3-none-any.whl
# twine upload dist/*
