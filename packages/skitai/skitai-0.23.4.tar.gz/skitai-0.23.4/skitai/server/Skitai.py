...
class Loader:
	...
	def switch_fifo (self):
		...
		asynconnect.AsynConnect.fifo_class = ready_producer_fifo
		asynconnect.AsynSSLConnect.fifo_class = ready_producer_fifo
		http_server.http_channel.fifo_class = ready_producer_fifo
		https_server.https_channel.fifo_class = ready_producer_fifo
