...
This spec is for very special situation. It will handle only one websocket for one client. And if new websocekt connected, will be created new thread and this thread will be long until your loop is ended. It is designed for long running app and few users like web version of telnet.
