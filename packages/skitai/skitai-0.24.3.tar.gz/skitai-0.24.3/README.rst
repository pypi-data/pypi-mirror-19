...
First 2 args (message, client_id except 'was') are essential. Although you need other args, you must position after theses 2 essential args. client_id is unique channel id for distinquishing websocket channel and it can be managed state using global object.
