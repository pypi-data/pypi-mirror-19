...
I wnat to use JInja2 with Vue.js without conflicts, and I like python because there aren't {, } in statement. Anyway it's a personal favor and if you like this style, just call 'app.jinja_overlay ()'.
