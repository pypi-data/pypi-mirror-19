...
app.jinja_overlay ("%", "#", "#", "[rd-", "/>") changes jinja environment,
...
.. code:: html
  ...
  [rd-extends "layout.htm" /]
  [rd-block title />Dash Board[rd-endblock /]
  
  [rd-for group in stat|groupby ('nation') /]
    <h1>[rd-block sectionname /]Population of #group.grouper#[rd-endblock /]</h1>
    [rd-for row in group.list /]
      <h2>#row.state#</h1>
