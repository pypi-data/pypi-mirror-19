...
skitaid_files = [
	...
	"etc/skitaid/certifications/README.txt",
	"wsgi/example/*.py",
	"wsgi/example/static/*.*",	
...
if os.name == "nt":
	...
	data_files = [
		("c:\\skitaid\\etc\\certifications", ["skitaid/etc/skitaid/certifications/README.txt"]),
	...
	data_files = [
		("/etc/skitaid/certifications", ["skitaid/etc/skitaid/certifications/README.txt"]),
