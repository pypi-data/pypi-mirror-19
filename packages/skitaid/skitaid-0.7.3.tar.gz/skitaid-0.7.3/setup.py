...
if os.name == "nt":
	...
	data_files = [
		...
		("c:\\skitaid\\wsgi\\example", ["skitaid/wsgi/example/webapp.py", "skitaid/wsgi/example/gateway.py"]),
	...
	data_files = [		
		...
		("/var/wsgi/example", ["skitaid/wsgi/example/webapp.py", "skitaid/wsgi/example/gateway.py"]),
...
setup(
	...
	install_requires = ["skitai>=0.21.3"],
