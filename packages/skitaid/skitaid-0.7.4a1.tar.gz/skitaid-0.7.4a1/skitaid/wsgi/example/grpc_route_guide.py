...
import time, math
import json
from sitepackages import route_guide_pb2
from aquests.protocols.grpc import discover

"""
import importlib.machinery
pb = importlib.machinery.SourceFileLoader(
	'proto.route_guide_pb2',
	r'D:\apps\skitai\skitai\examples\grpc\route_guide_pb2.py'
).load_module()
"""
...
app.securekey = "asd234gfsd47656769+-0956d"
...
@app.route ("/test")
def test (was):	
	stub = was.grpc ("http://ibizcast.skitai.com:5000/routeguide.RouteGuide")
