...
.. code:: python
  ...
  class Tokens: 
    ...
    def get (self, request, callback):
      username, roles, expores = self.tokens.get (request.token)	
...
Object Tokens may be any object has get (request, callback) method. This method should call callback with request, username, roles.
