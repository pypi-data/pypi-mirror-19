...
if os.name == "nt":
	...
	data_files = [
		...
		("c:\\skitaid\\wsgi\\example", ["skitaid/wsgi/example/webapp.py", "skitaid/wsgi/example/gateway.py", "skitaid/wsgi/example/grpc_route_guide.py"]),
...
setup(
	...
	install_requires = ["skitai>=0.24.2"],
