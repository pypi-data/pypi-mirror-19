...
if os.name == "nt":
	...
	data_files = [
		...
		(
			"c:\\skitaid\\wsgi\\example", [
				"skitaid/wsgi/example/app.py", "skitaid/wsgi/example/gateway.py", "skitaid/wsgi/example/grpc_route_guide.py",
				"skitaid/wsgi/example/proxy.py", "skitaid/wsgi/example/reverse_proxy.py", "skitaid/wsgi/example/rpc2.py", 
				"skitaid/wsgi/example/tls12.py", "skitaid/wsgi/example/websocket.py", "skitaid/wsgi/example/websocket-flask.py",
				"skitaid/wsgi/example/auth.py"
			]	
		),
	...
	data_files = [		
		...
		("/var/wsgi/example", ["skitaid/wsgi/example/webapp.py", "skitaid/wsgi/example/gateway.py", "skitaid/wsgi/example/grpc_route_guide.py"]),
...
with open('skitaid/__init__.py', 'r') as fd:
...
setup(
	...
	install_requires = ["skitai>=0.24.3"],
