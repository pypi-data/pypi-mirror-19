...
def handle_response (reqid, rs, producer):
	...
	producer [reqid]	= content	
	if producer.fetched_all ():
		producer.push (producer.render_all ("documentation2.html"))
		
@app.route ("/documentation2")
def documentation2 (was):
	producer = was.aresponse (handle_response)
	producer.get ('skitai', "https://pypi.python.org/pypi/skitai")
	return producer
