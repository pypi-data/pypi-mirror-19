...
SoundScrape |Build Status| |Python 2| |Python 3| |PyPI|
=======================================================
...
For some strange reason, it also works for MusicBed.com. Thanks @brachna
for this feature.
...
.. |Python 3| image:: https://img.shields.io/badge/Python-3-brightgreen.svg
   :target: https://pypi.python.org/pypi/soundscrape/
.. |PyPI| image:: https://img.shields.io/pypi/v/soundscrape.svg
   :target: https://pypi.python.org/pypi/SoundScrape
