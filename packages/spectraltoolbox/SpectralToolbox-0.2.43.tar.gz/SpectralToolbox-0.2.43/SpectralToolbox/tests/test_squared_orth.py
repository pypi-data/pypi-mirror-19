...
class TestConstantExtendedHermiteHermitePhysicistsFunction(TestSquared):
    def setUp(self):
        super(TestConstantExtendedHermiteHermitePhysicistsFunction,self).setUp()
    def get_basis(self):
        return S1D.SquaredConstantExtendedHermitePhysicistsFunction()
    def get_sampler(self):
        return stats.norm()

class TestPositiveDefiniteConstantExtendedHermiteHermitePhysicistsFunction(TestSquared):
    def setUp(self):
        super(TestPositiveDefiniteConstantExtendedHermiteHermitePhysicistsFunction,
              self).setUp()
    def get_basis(self):
...
class TestConstantExtendedHermiteHermiteProbabilistsFunction(TestSquared):
    def setUp(self):
        super(TestConstantExtendedHermiteHermiteProbabilistsFunction,self).setUp()
    def get_basis(self):
        return S1D.SquaredConstantExtendedHermiteProbabilistsFunction()
    def get_sampler(self):
        return stats.norm()

class TestPositiveDefiniteConstantExtendedHermiteHermiteProbabilistsFunction(TestSquared):
    def setUp(self):
        super(TestPositiveDefiniteConstantExtendedHermiteHermiteProbabilistsFunction,
              self).setUp()
    def get_basis(self):
...
class TestNormedConstantExtendedHermitePhysicistsFunction(
        TestConstantExtendedHermiteHermitePhysicistsFunction, TestNormed): pass
class TestNotNormedConstantExtendedHermitePhysicistsFunction(
        TestConstantExtendedHermiteHermitePhysicistsFunction, TestNotNormed): pass
class TestNormedPositiveDefiniteConstantExtendedHermitePhysicistsFunction(
        TestPositiveDefiniteConstantExtendedHermiteHermitePhysicistsFunction,
        TestNormed): pass
...
class TestNormedConstantExtendedHermiteProbabilistsFunction(
        TestConstantExtendedHermiteHermiteProbabilistsFunction, TestNormed): pass
class TestNotNormedConstantExtendedHermiteProbabilistsFunction(
        TestConstantExtendedHermiteHermiteProbabilistsFunction, TestNotNormed): pass
class TestNormedPositiveDefiniteConstantExtendedHermiteProbabilistsFunction(
        TestPositiveDefiniteConstantExtendedHermiteHermiteProbabilistsFunction,
        TestNormed): pass
