...
datafiles = [(d, [os.path.join(d,f) for f in files]) for d, folders, files in os.walk('www')]
datafiles.extend([(d, [os.path.join(d,f) for f in files]) for d, folders, files in os.walk('docs')])
