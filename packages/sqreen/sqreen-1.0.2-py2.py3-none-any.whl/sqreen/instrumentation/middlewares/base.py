...
from ..hook_point import execute_pre_callbacks, execute_post_callbacks, execute_failing_callbacks
...
class BaseMiddleware(object):
    ...
    def execute_pre_callbacks(self, args=None):
    ...
    def execute_post_callbacks(self, response, args=None):
