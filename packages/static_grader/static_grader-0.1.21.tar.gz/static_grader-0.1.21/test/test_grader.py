...
class TestServer(unittest.TestCase):
  def test_grader_server(self):
    grade_server = GraderServer([SerializedQuestion('one_plus_one', 'ExactIntScorer', {}, TEST_CASES)])
  ...
  def test_serialized_grader_server(self):
    q_ser = SerializedQuestion('one_plus_one', 'ExactIntScorer', {}, TEST_CASES).dumps()
