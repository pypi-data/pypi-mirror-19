...
from static_grader import SerializedGraderServer, SerializedQuestion, SerializedSubmission, SerializedScore
...
class TestFlask(unittest.TestCase):
  ...
  def setUp(self):
    app = Flask(__name__)
    q_ser = SerializedQuestion('one_plus_one', 'ExactListScorer', {}, [{'args':[], 'kwargs':{}, 'answer': 2, 'type_str': 'number'}]).dumps()
