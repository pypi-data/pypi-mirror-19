...
File version 0.7 date 2017-02-04
...
Copyright (C) 2015-2017 Lukasz Laba (e-mail : lukaszlab@o2.pl)
-------------Project info-------------
http://struthon.org/
...
class MAINWINDOW(QtGui.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.pushButton_SSMS.clicked.connect(self.run_SSMS)
    ...
    #----
    def run_SCMS(self):
        subprocess.Popen(['python', '-m', 'ConcreteMonoSection.ConcreteMonoSection'])
        
    def run_SCP(self): 
        subprocess.Popen(['python', '-m', 'ConcretePanel.ConcretePanel'])   
           
    def run_SSSB(self):
        subprocess.Popen(['python', '-m', 'SteelSectionBrowser.SteelSectionBrowser']) 
        
    def run_SSMS(self):
        subprocess.Popen(['python', '-m', 'SteelMonoSection.SteelMonoSection']) 

    def run_SSBC(self):
        subprocess.Popen(['python', '-m', 'SteelBoltedConnection.SteelBoltedConnection']) 
