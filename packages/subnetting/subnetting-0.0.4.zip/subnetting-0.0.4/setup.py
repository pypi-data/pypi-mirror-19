...
setup(
    ...
    download_url = 'https://github.com/thimoonxy/subnetting/tarball/0.0.4',
    # Author details
    author='Simon Xie',
    ...
    keywords=['subnetting', 'CIDR', 'calculating', 'network', 'troubleshooting',],
    ...
    entry_points={
        'console_scripts': [
            'subnetting=subnetting.subnetting:main',
        ],
    },
)
