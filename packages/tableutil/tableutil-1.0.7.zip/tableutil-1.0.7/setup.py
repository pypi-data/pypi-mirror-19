...
setup(
    name=u"tableutil",  # The module name must match this!
    ...
    url=u'https://bitbucket.org/daycoder/tableutil.git',  # Use the url to the git repo
    download_url=(u'https://bitbucket.org/daycoder/'
                  u'tableutil.git/get/{version}.tar'.format(version=VERSION)),
    ...
    description=u"A collection of table creation utilities.",
