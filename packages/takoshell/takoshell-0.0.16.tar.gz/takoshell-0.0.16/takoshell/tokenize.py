...
"""Tokenization help for tako programs.
...
It is modified to properly tokenize tako code, including backtick regex
path and several tako-specific operators.
...
EXACT_TOKEN_TYPES.update(_tako_tokens)
