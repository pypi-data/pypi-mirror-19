...
#
#
# This file is (slightly) modified from braceexpand v0.1.2
# ( https://pypi.python.org/pypi/braceexpand )
# There it was licensed under an 2-Clause BSD License
...
def make_int_range(start, end, step=None):
    ...
    r = range(start, end+1, step) if start < end else \
