...
class TBATeam:
    def __init__(self, raw_json):
        ...
        self.country = raw_json['country_name']
...
class TBAEventRankings:
    def __init__(self, raw_json):
        ...
        for key in raw_json:
                team_dictionary = TBAEventTeamRank(self.keys, key, str(key[1]), str(key[0])) #creates a TBAEventTeamRank object for the given team as found in the rank dictionary passed back by TBA
...
class TBAEventTeamRank:
    def __init__(self, key_list, team_list, team_number, team_rank):
        self.keys = key_list
        self.raw = team_list
