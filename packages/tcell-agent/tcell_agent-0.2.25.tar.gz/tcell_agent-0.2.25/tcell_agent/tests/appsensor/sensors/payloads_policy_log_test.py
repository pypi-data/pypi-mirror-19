...
class PayloadsPolicyTest(unittest.TestCase):
    ...
    def false_log_payloads_log_test(self):
        ...
        old_allow = CONFIGURATION.log_appfirewall_events
        CONFIGURATION.log_appfirewall_events = False
        ...
        with patch("tcell_agent.appsensor.sensors.payloads_policy.get_payloads_logger") as patched_get_payloadds_logger:
            ...
            CONFIGURATION.log_appfirewall_events = old_allow

            self.assertFalse(patched_get_payloadds_logger.called)

    def true_log_payloads_false_log_appfirewall_events_log_test(self):
    ...
    def true_log_payloads_true_log_appfirewall_events_no_blacklist_no_whitelist_log_test(self):
        policy_json = {"payloads": {"log_payloads": True}}
        policy = PayloadsPolicy.from_json(policy_json)
        appsensor_meta = AppSensorMeta()
        appsensor_meta.remote_address = "remote_addr"
        ...
        old_allow = CONFIGURATION.log_appfirewall_events
        CONFIGURATION.log_appfirewall_events = True
    ...
    def true_log_payloads_true_log_appfirewall_events_no_blacklist_with_whitelist_missing_param_log_test(self):
    ...
    def true_log_payloads_true_log_appfirewall_events_no_blacklist_param_in_whitelist_but_incorrect_location_log_test(self):
        policy_json = {
            "payloads": {
                "log_payloads": True,
                "log_whitelist": {
    ...
    def true_log_payloads_true_log_appfirewall_events_no_blacklist_param_in_whitelist_log_test(self):
        policy_json = {
            "payloads": {
                "log_payloads": True,
                "log_whitelist": {
    ...
    def true_log_payloads_true_log_appfirewall_events_no_whitelist_with_blacklist_missing_param_log_test(self):
        ...
        mock_logger = Mock()
        with patch("tcell_agent.appsensor.sensors.payloads_policy.get_payloads_logger", return_value=mock_logger) as patched_get_payloadds_logger:
            policy.log("xss", appsensor_meta, GET_PARAM, "password", "123password123", {"l": "query"}, "pattern")
    ...
    def true_log_payloads_true_log_appfirewall_events_no_whitelist_param_in_blacklist_but_incorrect_location_log_test(self):
        policy_json = {
            "payloads": {
                "log_payloads": True,
                "log_blacklist": {
    ...
    def true_log_payloads_true_log_appfirewall_events_no_whitelist_param_in_blacklist_log_test(self):
        policy_json = {
            "payloads": {
                "log_payloads": True,
                "log_blacklist": {
