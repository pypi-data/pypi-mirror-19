...
class ResponseCodesSensorTest(unittest.TestCase):
    ...
    def with_enabled_sensor_and_400_response_code_check_test(self):
        ...
        with patch('tcell_agent.appsensor.sensors.response_codes_sensor.send_event') as patched_send_event:
            sensor.check(appsensor_meta, 400)
            patched_send_event.assert_called_once_with(appsensor_meta, ResponseCodesSensor.RESPONSE_CODE_DP_DICT[4], None, {"code": 400})
    ...
    def with_enabled_sensor_and_401_response_code_check_test(self):
        ...
        with patch('tcell_agent.appsensor.sensors.response_codes_sensor.send_event') as patched_send_event:
            ...
            patched_send_event.assert_called_once_with(appsensor_meta, ResponseCodesSensor.RESPONSE_CODE_DP_DICT[401], None, {"code": 401})
    ...
    def with_enabled_sensor_and_403_response_code_check_test(self):
        ...
        with patch('tcell_agent.appsensor.sensors.response_codes_sensor.send_event') as patched_send_event:
            ...
            patched_send_event.assert_called_once_with(appsensor_meta, ResponseCodesSensor.RESPONSE_CODE_DP_DICT[403], None, {"code": 403})
    ...
    def with_enabled_sensor_and_404_response_code_check_test(self):
        ...
        with patch('tcell_agent.appsensor.sensors.response_codes_sensor.send_event') as patched_send_event:
            ...
            patched_send_event.assert_called_once_with(appsensor_meta, ResponseCodesSensor.RESPONSE_CODE_DP_DICT[404], None, {"code": 404})
    ...
    def with_enabled_sensor_and_500_response_code_check_test(self):
        ...
        with patch('tcell_agent.appsensor.sensors.response_codes_sensor.send_event') as patched_send_event:
            sensor.check(appsensor_meta, 500)
            patched_send_event.assert_called_once_with(appsensor_meta, ResponseCodesSensor.RESPONSE_CODE_DP_DICT[500], None, {"code": 500})
    ...
    def with_enabled_sensor_and_501_response_code_check_test(self):
        ...
        with patch('tcell_agent.appsensor.sensors.response_codes_sensor.send_event') as patched_send_event:
            ...
            patched_send_event.assert_called_once_with(appsensor_meta, ResponseCodesSensor.RESPONSE_CODE_DP_DICT[5], None, {"code": 501})
