...
class RetrSensorTest(unittest.TestCase):
    ...
    def with_disabled_sensor_check_test(self):
        sensor = RetrSensor({"enabled": False, "patterns": ["1"]})
    ...
    def applicable_for_param_type_test(self):
        ...
        self.assertFalse(sensor.applicable_for_param_type(POST_PARAM))
        self.assertFalse(sensor.applicable_for_param_type(JSON_PARAM))
