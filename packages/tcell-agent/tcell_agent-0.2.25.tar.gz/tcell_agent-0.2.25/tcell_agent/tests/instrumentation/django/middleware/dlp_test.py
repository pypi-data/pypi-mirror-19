...
class DLPMiddlewareTest(TestCase):
    ...
    def test_db_protect(self):
        ...
        for action in actions:
            request._tcell_context.add_response_db_filter("hello", action, "test", "test", "work_infos", "income")
        response =  HttpResponse("<html>\n<head>Title</head><body>hello world: 101012301200123 \n\nhello 101012301200123</body><html>",content_type="application/html")
        self.middleware_after(request, response)
    ...
    def test_db_protect_by_route(self):
        ...
        actions = TCellAgent.get_policy("dlp").get_actions_for_db_field("test","test","work_infos","income",route="abcdefg")
        for action in actions:
            request._tcell_context.add_response_db_filter("hello", action, "test", "test", "work_infos", "SSN")
        response =  HttpResponse("<html>\n<head>Title</head><body>hello world: 101012301200123 \n\nhello 101012301200123</body><html>",content_type="application/html")
        self.middleware_after(request, response)
    ...
    def test_request_header_protect_by_route(self):
        ...
        self.middleware_before(request, route_id="abcdef")
        response =  HttpResponse("<html>\n<head>Title</head><body>heyathere world: 101012301200123 \n\nheyathere hello 101012301200123</body><html>",content_type="application/html")
        self.middleware_after(request, response)
    ...
    def test_logger_header_protect_by_route(self):
        ...
        from tcell_agent.instrumentation.django import dlp
        dlp.dlp_instrumentation()
