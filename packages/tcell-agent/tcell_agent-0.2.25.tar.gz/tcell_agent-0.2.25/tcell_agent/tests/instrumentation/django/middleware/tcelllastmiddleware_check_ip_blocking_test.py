...
from tcell_agent.instrumentation.django.middleware.tcelllastmiddleware import check_ip_blocking
...
class CheckIpBlockingTest(unittest.TestCase):
    ...
    def wiki_example_one_test(self):
        ...
        request = Mock(encoding='utf-8',_tcell_context=tcell_context, FILES={}, META={"REQUEST_METHOD": "GET"})
