...
if sys.version_info >= (3, 0):
    ...
    class LoginRegisterLoginEvent(object):
        @classmethod
        def send(cls,
                 status,
                 session_id,
