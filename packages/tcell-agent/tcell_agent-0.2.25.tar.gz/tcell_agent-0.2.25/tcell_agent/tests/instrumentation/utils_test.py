    ...
    def flask_header_keys_from_request_env_test(self):
        header_keys = header_keys_from_request_env(
            {'wsgi.multiprocess': False,
             'HTTP_COOKIE': 'mp_None_mixpanel=%7B%22distinct_id%22%3A%20%221585686a4f31ba-0202073dae6fe5-133e6c52-15f900-1585686a4f41b2%22%2C%22%24initial_referrer%22%3A%20%22%24direct%22%2C%22%24initial_referring_domain%22%3A%20%22%24direct%22%7D; csrftoken=cxmew6RpISKOVF9kFcfzbjTfuIbh3W2N4es1Dnk8nk7n0gDXi8bC5mgLVYoEiRg1; sessionid=g2tvb015d8l6afts2bxrcixziuf1olmi; _ga=GA1.1.1722707835.1481849908',
             ...
             'wsgi.version': (1, 0),
             'wsgi.run_once': False,
             'wsgi.errors': "<open file '<stderr>', mode 'w' at 0x7f8ee141a1e0>",
    ...
    def django_header_keys_from_request_env_test(self):
        header_keys = header_keys_from_request_env(
            {'HTTP_REFERER': 'http://192.168.99.100:3000/',
             ...
             'HTTP_USER_AGENT': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.95 Safari/537.36',
             'HTTP_CONNECTION': 'keep-alive',
             'HTTP_COOKIE': 'mp_None_mixpanel=%7B%22distinct_id%22%3A%20%221585686a4f31ba-0202073dae6fe5-133e6c52-15f900-1585686a4f41b2%22%2C%22%24initial_referrer%22%3A%20%22%24direct%22%2C%22%24initial_referring_domain%22%3A%20%22%24direct%22%7D; _ga=GA1.1.1722707835.1481849908; _gat=1; csrftoken=ODH20G82vO39cxdvIVvDkBfprSW3946a',
