...
_SparseAccumulatorTakeGradientOutput = collections.namedtuple("SparseAccumulatorTakeGradient",
...
_TensorArrayConcatV2Output = collections.namedtuple("TensorArrayConcatV2",
...
def _tensor_array_concat_v2(handle, flow_in, dtype,
  ...
  Args:
    handle: A `Tensor` of type `string`. The handle to a TensorArray.
    flow_in: A `Tensor` of type `float32`.
...
def _tensor_array_v2(size, dtype, dynamic_size=None, clear_after_read=None,
                     tensor_array_name=None, name=None):
  ...
  Returns:
    A `Tensor` of type `string`. The handle to the TensorArray.
  """
...
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArrayCloseV2"
  }
}
op {
...
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArrayConcatV2"
  }
}
op {
...
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArrayGatherV2"
  }
}
op {
...
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArrayGradV2"
  }
  is_stateful: true
}
op {
...
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArrayGatherV2 with RangeOp"
  }
}
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArrayReadV2"
  }
}
op {
...
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArrayScatterV2"
  }
}
op {
...
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArraySizeV2"
  }
}
op {
...
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArraySplitV2"
  }
}
op {
...
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArrayScatterV2 with RangeOp"
  }
}
op {
  name: "TensorArrayV2"
...
op {
  ...
  deprecation {
    version: 16
    explanation: "Use TensorArrayWriteV2"
  }
}
op {
