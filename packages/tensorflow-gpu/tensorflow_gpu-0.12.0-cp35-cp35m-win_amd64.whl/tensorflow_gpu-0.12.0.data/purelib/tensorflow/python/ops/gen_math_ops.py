...
_RequantizationRangeOutput = collections.namedtuple("RequantizationRange",
...
_RequantizeOutput = collections.namedtuple("Requantize", _requantize_outputs)
