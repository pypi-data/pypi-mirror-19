...
_FractionalAvgPoolOutput = collections.namedtuple("FractionalAvgPool",
...
_FractionalMaxPoolOutput = collections.namedtuple("FractionalMaxPool",
...
_fused_batch_norm_outputs = ["y", "batch_mean", "batch_variance",
                            "reserve_space_1", "reserve_space_2"]


_FusedBatchNormOutput = collections.namedtuple("FusedBatchNorm",
                                               _fused_batch_norm_outputs)


def fused_batch_norm(x, scale, offset, mean, variance, epsilon=None,
...
_FusedBatchNormGradOutput = collections.namedtuple("FusedBatchNormGrad",
