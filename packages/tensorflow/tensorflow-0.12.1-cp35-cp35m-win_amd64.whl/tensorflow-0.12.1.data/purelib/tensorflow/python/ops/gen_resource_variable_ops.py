...
_create_variable_op_outputs = [""]


def create_variable_op(resource, value, name=None):
  r"""Creates a variable resource.
  ...
  Returns:
    The created Operation.
  """
  result = _op_def_lib.apply_op("CreateVariableOp", resource=resource,
                                value=value, name=name)
  return result
