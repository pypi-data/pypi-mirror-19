...
setup(
    name=u"timingsutil",  # The module name must match this!
    ...
    url=u'https://bitbucket.org/daycoder/timingsutil.git',  # Use the url to the git repo
    download_url=(u'https://bitbucket.org/daycoder/'
                  u'timingsutil.git/get/{version}.tar'.format(version=VERSION)),
    ...
    description=u"A collection of timing utilities.",
