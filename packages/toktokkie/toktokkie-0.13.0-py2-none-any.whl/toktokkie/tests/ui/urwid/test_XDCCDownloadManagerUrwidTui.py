...
class UnitTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        shutil.copytree(os.path.join(u"toktokkie", u"tests", u"resources", u"directories"), u"temp_testing")

        self.namibsun_packs = [XDCCPack(IrcServer(u"namibsun.net"), u"xdcc_servbot", 1),
                               XDCCPack(IrcServer(u"namibsun.net"), u"xdcc_servbot", 2),
    ...
    def test_parsing_directory(self):
        self.tui.target_directory_edit.set_edit_text(os.path.join(u"temp_testing", u"Game of Thrones"))
        self.assertEqual(self.tui.series_name_edit.get_edit_text(), u"Game of Thrones")
    ...
    def test_downloading_with_iconization_and_renaming(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(u"temp_testing", u"Game of Thrones", u"Season 2",
        ...
        if procedure != GenericProcedure:
            self.assertNotEqual(procedure.get_icon_file(os.path.join(u"temp_testing", u"Game of Thrones")), None)
    ...
    def test_downloading_without_iconizing_and_renaming(self):
        ...
        self.assertFalse(os.path.isfile(os.path.join(u"temp_testing", u"Game of Thrones", u"Season 2",
                                                     u"Game of Thrones - S02E11 - Episode 11.txt")))
        self.assertFalse(os.path.isfile(os.path.join(u"temp_testing", u"Game of Thrones", u"Season 2",
                                                     u"Game of Thrones - S02E12 - Episode 12.txt")))
        self.assertFalse(os.path.isfile(os.path.join(u"temp_testing", u"Game of Thrones", u"Season 2",
                                                     u"Game of Thrones - S02E13 - Episode 13.txt")))
        self.assertTrue(os.path.isfile(os.path.join(u"temp_testing", u"Game of Thrones", u"Season 2", u"1_test.txt")))
        self.assertTrue(os.path.isfile(os.path.join(u"temp_testing", u"Game of Thrones", u"Season 2", u"2_test.txt")))
        self.assertTrue(os.path.isfile(os.path.join(u"temp_testing", u"Game of Thrones", u"Season 2", u"3_test.txt")))

        procedure = ProcedureManager.get_applicable_procedure()

        if procedure != GenericProcedure:
            self.assertEqual(procedure.get_icon_file(os.path.join(u"temp_testing", u"Game of Thrones")), None)
    ...
    def test_search_while_searching(self):
        ...
        self.assertEqual(len(self.tui.search_results), 1)
        self.assertEqual(self.tui.search_results[0].get_filename(), u"1_test.txt")
