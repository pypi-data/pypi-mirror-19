...
class PlayerStatKeeper(object):
    ...
    def __init__(self, gameRecorder, player):
        ...
        self.player.onStarsSpent.addListener(self.starsSpent)
    ...
    def stop(self):
        self.player.onStarsSpent.removeListener(self.starsSpent)
    ...
    def died(self, killer, deathType):
        ...
        self.starsWasted += self.player.starsAtLastDeath
    ...
    def killed(self, victim, deathType):
        self.kills += 1
...
class StatKeeper(object):
    ...
    def stop(self):
        ...
        for playerStats in self.allPlayerStatLists.itervalues():
            playerStats.stop()
    ...
    def save(self, force=False):
        ...
        stats = {}
        stats['players'] = {}
        for playerStat in self.allPlayerStatLists.itervalues():
    ...
    def gameOver(self, team, timeOver):
        self.winningTeamId = team.id
...
class ServerGameStats(object):
    ...
    def stopAndSave(self):
        ...
        winner = self.world.getWinningTeam()
        self.gameRecord.winningTeam = winner.id if winner else ''
        ...
        for playerStat in self.statKeeper.allPlayerStatLists.itervalues():
            ...
            record = GamePlayer(
                ...
                starsEarned=playerStat.starsEarned,
                starsWasted=playerStat.starsWasted,
                starsUsed=playerStat.starsUsed,
