...
from trosnoth.messages import GameOverMsg
...
class TutorialLevel(Level):
    ...
    def setupMap(self, world):
        self.world = world
        self.blueTeam = world.teams[0]
        self.redTeam = world.teams[1]
    ...
    def start(self):
        ...
        self.playSound(self.world, 'tutorial6.ogg')
        ...
        self.playSound(self.world, 'tutorial5.ogg')
        ...
        self.playSound(self.world, 'tutorial7.ogg')
        ...
        self.playSound(self.world, 'tutorial10.ogg')
        ...
        self.playSound(self.world, 'tutorial11.ogg')
        ...
        while True:
            ...
            if not playedSound12 and human.dead:
                ...
                self.playSound(self.world, 'tutorial12.ogg')
        ...
        #         self.playSound(self.world, 'custom-not-there.ogg')
        #         self.sendPrivateChat(
        #             self.helperBot.player, human, 'No, not over there')
        #         continue
        #     break
        #
        # self.playSound(self.world, 'custom-follow-me.ogg')
        # self.sendPrivateChat(
        ...
        #     self.playSound(self.world, 'custom-come-on.ogg')
        ...
        #             break
        #
        # self.playSound(self.world, 'custom-capture-orb.ogg')
        # self.sendPrivateChat(
        ...
        # yield self.helperBot.onOrderFinished.wait()
        #
        # self.playSound(self.world, 'custom-i-win.ogg')
        # self.sendPrivateChat(self.helperBot.player, human, 'Game over. I win.')
        #
        # yield self.world.sleep(2)
        # self.world.sendServerCommand(GameOverMsg(self.blueTeam.id, False))
