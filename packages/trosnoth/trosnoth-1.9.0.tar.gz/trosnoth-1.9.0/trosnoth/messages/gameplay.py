...
class CreateCollectableStarMsg(ServerCommand):
    idString = 'StCr'
    fields = 'starId', 'xPos', 'yPos'
    packspec = 'cff'


class RemoveCollectableStarMsg(ServerCommand):
    idString = 'StCo'
    fields = 'starId'
    packspec = 'c'
...
class BasePlayerUpdate(ServerCommand):
    ...
    '''
    fields = (
        'playerId', 'xPos', 'yPos', 'yVel', 'angle', 'ghostThrust',
        'jumpTime', 'gunReload', 'respawn', 'attached', 'stars', 'health',
        'resync', 'leftKey', 'rightKey', 'jumpKey', 'downKey')
    packspec = 'cffffffffcBB?????'
