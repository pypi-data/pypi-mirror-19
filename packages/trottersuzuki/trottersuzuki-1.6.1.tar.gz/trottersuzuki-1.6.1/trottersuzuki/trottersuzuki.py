...
class Lattice1D(Lattice):
    ...
    def __init__(self, dim, length, periodic_x_axis=False):
        this = _trottersuzuki.new_Lattice1D(dim, length, periodic_x_axis)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class Lattice2D(Lattice):
    ...
    def __init__(self, dim_x, length_x, dim_y, length_y, periodic_x_axis=False, periodic_y_axis=False, angular_velocity=0.):
        """
        ...
        * `Lattice2D` : Lattice2D object 
        ...
        """
        this = _trottersuzuki.new_Lattice2D(dim_x, length_x, dim_y, length_y, periodic_x_axis, periodic_y_axis, angular_velocity)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class ExponentialState(State):
    ...
    def __init__(self, _grid, _n_x=1, _n_y=1, _norm=1, _phase=0, _p_real=None, _p_imag=None):
        """
        ...
        * `ExponentialState` : State object. 
        ...
        """
        this = _trottersuzuki.new_ExponentialState(_grid, _n_x, _n_y, _norm, _phase, _p_real, _p_imag)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class GaussianState(State):
    ...
    def __init__(self, grid, omega_x, omega_y=-1., mean_x=0, mean_y=0, norm=1, phase=0, p_real=None, p_imag=None):
        """
        ...
        * `GaussianState` : State object. 
        ...
        """
        this = _trottersuzuki.new_GaussianState(grid, omega_x, omega_y, mean_x, mean_y, norm, phase, p_real, p_imag)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class SinusoidState(State):
    ...
    def __init__(self, _grid, _n_x=1, _n_y=1, _norm=1, _phase=0, _p_real=None, _p_imag=None):
        ...
        * `SinusoidState` : State object. 
        ...
        """
        this = _trottersuzuki.new_SinusoidState(_grid, _n_x, _n_y, _norm, _phase, _p_real, _p_imag)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class Hamiltonian(_object):
    ...
    def __init__(self, _grid, _potential=None, _mass=1., _coupling_a=0., _angular_velocity=0., _rot_coord_x=0, _rot_coord_y=0):
        """
        ...
        * `Hamiltonian` : Hamiltonian object
        ...
        """
        this = _trottersuzuki.new_Hamiltonian(_grid, _potential, _mass, _coupling_a, _angular_velocity, _rot_coord_x, _rot_coord_y)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
