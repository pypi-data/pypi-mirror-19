	...
	class _Users(_CommonAPIClass):
		...
		class _Appliances(_CommonAPIClass):
			...
			class _Exports(_CommonAPIClass):
				...
				def Export(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
		...
		class _Stats(_CommonAPIClass):
			...
			#URL: users/{uid}/stats
			def Get(self, Type=None, body=None, element_name=None, streamingResponseFile=None):
				kwargs = {'type': Type}
		...
		class _Mysoftware(_CommonAPIClass):
			...
			def __init__(self, parent, **kwargs):
				self._parent = parent
				self.__dict__.update(kwargs)
				self.Restrictions = Api._Users._Mysoftware._Restrictions(self)
				...
				self.Distributions = Api._Users._Mysoftware._Distributions(self)
				pass
			...
			class _Restrictions(_CommonAPIClass):
				...
				def __init__(self, parent, **kwargs):
					self._parent = parent
					self.__dict__.update(kwargs)
					self.Distributions = Api._Users._Mysoftware._Restrictions._Distributions(self)
					pass
				
				#URL: users/{uid}/mysoftware/{msid}/restrictions
				def Add(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/restrictions', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/restrictions
				def Deleteall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/restrictions', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/restrictions/{brid}
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/restrictions/' + str(self._get('Brid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/restrictions
				def Getall(self, Query=None, Descending=None, Orderby=None, Count=None, Offset=None, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'query': Query, 'descending': Descending, 'orderBy': Orderby, 'count': Count, 'offset': Offset}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/restrictions', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/restrictions/{brid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/restrictions/' + str(self._get('Brid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: users/{uid}/mysoftware/{msid}/restrictions/{brid}
				def Update(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/restrictions/' + str(self._get('Brid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
				class _Distributions(_CommonAPIClass):
					...
					#URL: users/{uid}/mysoftware/{msid}/restrictions/{brid}/distributions
					def Getall(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/restrictions/' + str(self._get('Brid')) + '/distributions', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Distributions(_CommonAPIClass):
				...
				#URL: users/{uid}/mysoftware/{msid}/distributions
				def Getall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/users/' + str(self._get('Uid')) + '/mysoftware/' + str(self._get('Msid')) + '/distributions', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Scannedinstances(_CommonAPIClass):
			...
			class _Scans(_CommonAPIClass):
				...
				def Get(self, Validated=None, Pkgs=None, Added=None, Pkgfiles=None, Dir=None, Rellevel=None, Delta=None, Comparewith=None, body=None, element_name=None, streamingResponseFile=None):
	...
	class _Orgs(_CommonAPIClass):
		...
		class _Projects(_CommonAPIClass):
			...
			def __init__(self, parent, **kwargs):
				...
				self.Distributions = Api._Orgs._Projects._Distributions(self)
				self.Restrictions = Api._Orgs._Projects._Restrictions(self)
				pass
			...
			class _Distributions(_CommonAPIClass):
				...
				#URL: orgs/{oid}/projects/{pid}/distributions
				def Getall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/orgs/' + str(self._get('Oid')) + '/projects/' + str(self._get('Pid')) + '/distributions', 'GET', body, element_name, streamingResponseFile, **kwargs)
			...
			class _Restrictions(_CommonAPIClass):
				...
				def __init__(self, parent, **kwargs):
					self._parent = parent
					self.__dict__.update(kwargs)
					self.Distributions = Api._Orgs._Projects._Restrictions._Distributions(self)
					pass
				
				#URL: orgs/{oid}/projects/{pid}/restrictions/{brid}
				def Get(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/orgs/' + str(self._get('Oid')) + '/projects/' + str(self._get('Pid')) + '/restrictions/' + str(self._get('Brid')) + '', 'GET', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: orgs/{oid}/projects/{pid}/restrictions/{brid}
				def Update(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/orgs/' + str(self._get('Oid')) + '/projects/' + str(self._get('Pid')) + '/restrictions/' + str(self._get('Brid')) + '', 'PUT', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: orgs/{oid}/projects/{pid}/restrictions
				def Add(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/orgs/' + str(self._get('Oid')) + '/projects/' + str(self._get('Pid')) + '/restrictions', 'POST', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: orgs/{oid}/projects/{pid}/restrictions/{brid}
				def Delete(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/orgs/' + str(self._get('Oid')) + '/projects/' + str(self._get('Pid')) + '/restrictions/' + str(self._get('Brid')) + '', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: orgs/{oid}/projects/{pid}/restrictions
				def Deleteall(self, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {}
					return self._REST('/orgs/' + str(self._get('Oid')) + '/projects/' + str(self._get('Pid')) + '/restrictions', 'DELETE', body, element_name, streamingResponseFile, **kwargs)
				
				#URL: orgs/{oid}/projects/{pid}/restrictions
				def Getall(self, Query=None, Descending=None, Orderby=None, Count=None, Offset=None, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'query': Query, 'descending': Descending, 'orderBy': Orderby, 'count': Count, 'offset': Offset}
					return self._REST('/orgs/' + str(self._get('Oid')) + '/projects/' + str(self._get('Pid')) + '/restrictions', 'GET', body, element_name, streamingResponseFile, **kwargs)
				class _Distributions(_CommonAPIClass):
					def __init__(self, parent, **kwargs):
						self._parent = parent
						self.__dict__.update(kwargs)
					...
					#URL: orgs/{oid}/projects/{pid}/restrictions/{brid}/distributions
					def Getall(self, body=None, element_name=None, streamingResponseFile=None):
						kwargs = {}
						return self._REST('/orgs/' + str(self._get('Oid')) + '/projects/' + str(self._get('Pid')) + '/restrictions/' + str(self._get('Brid')) + '/distributions', 'GET', body, element_name, streamingResponseFile, **kwargs)
		...
		class _Distributions(_CommonAPIClass):
			...
			class _Goldens(_CommonAPIClass):
				...
				#URL: orgs/{oid}/distributions/{did}/goldens
				def Delete(self, Prname=None, Goldendate=None, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'prname': Prname, 'goldenDate': Goldendate}
				...
				#URL: orgs/{oid}/distributions/{did}/goldens
				def Add(self, Language=None, Edition=None, Type=None, Goldendate=None, Filename=None, Force=None, body=None, element_name=None, streamingResponseFile=None):
					kwargs = {'language': Language, 'edition': Edition, 'type': Type, 'goldenDate': Goldendate, 'fileName': Filename, 'force': Force}
