...
setup(
    ...
    version = '0.0.3-1',
    description = "Vectorized implementations of sample entropy (SampEn) and approximate entropy (ApEn)",
    author = 'Kira Huselius Gylling',
    author_email = 'kira.gylling@gmail.com',
    url = 'https://github.com/kirahg/vectorized-sample-entropy',
    download_url = 'https://github.com/kirahg/vectorized-sample-entropy/tarball/0.0.3-1',
