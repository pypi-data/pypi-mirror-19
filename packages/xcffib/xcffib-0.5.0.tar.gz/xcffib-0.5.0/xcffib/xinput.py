...
class InputInfo(xcffib.Struct):
    ...
    fixed_size = 2
    @classmethod
    def synthetic(cls, class_id, len):
        self = cls.__new__(cls)
        self.class_id = class_id
        self.len = len
        return self
...
class FeedbackState(xcffib.Struct):
    ...
    def pack(self):
        ...
        return buf.getvalue()
    @classmethod
    def synthetic(cls, class_id, feedback_id, len, uninterpreted_data):
        self = cls.__new__(cls)
        self.class_id = class_id
        self.feedback_id = feedback_id
        self.len = len
        self.uninterpreted_data = uninterpreted_data
        return self
...
class InputState(xcffib.Struct):
    ...
    def pack(self):
        ...
        return buf.getvalue()
    @classmethod
    def synthetic(cls, class_id, len, num_items, uninterpreted_data):
        self = cls.__new__(cls)
        self.class_id = class_id
        self.len = len
...
class DeviceState(xcffib.Struct):
    ...
    def pack(self):
        ...
        return buf.getvalue()
    @classmethod
    def synthetic(cls, control_id, len, uninterpreted_data):
        self = cls.__new__(cls)
        self.control_id = control_id
        self.len = len
        self.uninterpreted_data = uninterpreted_data
...
class HierarchyChange(xcffib.Struct):
    ...
    def pack(self):
        ...
        return buf.getvalue()
    @classmethod
    def synthetic(cls, type, len, uninterpreted_data):
        self = cls.__new__(cls)
        self.type = type
        self.len = len
        self.uninterpreted_data = uninterpreted_data
...
class DeviceClass(xcffib.Struct):
    ...
    def pack(self):
        ...
        return buf.getvalue()
    @classmethod
    def synthetic(cls, type, len, sourceid, uninterpreted_data):
        self = cls.__new__(cls)
        self.type = type
        self.len = len
        self.sourceid = sourceid
...
class KeyPressEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        return buf.getvalue()
    @classmethod
    def synthetic(cls, deviceid, time, detail, root, event, child, root_x, root_y, event_x, event_y, buttons_len, valuators_len, sourceid, flags, mods, group, button_mask, valuator_mask):
        self = cls.__new__(cls)
        self.deviceid = deviceid
        self.time = time
        self.detail = detail
...
class RawKeyPressEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        return buf.getvalue()
    @classmethod
    def synthetic(cls, deviceid, time, detail, sourceid, valuators_len, flags, valuator_mask):
        self = cls.__new__(cls)
        self.deviceid = deviceid
        self.time = time
        self.detail = detail
...
class xinputExtension(xcffib.Extension):
    ...
    def GetDeviceKeyMapping(self, device_id, first_keycode, count, is_checked=True):
        buf = six.BytesIO()
        buf.write(struct.pack("=xx2xBBB", device_id, first_keycode, count))
    ...
    def SetDeviceModifierMapping(self, device_id, keycodes_per_modifier, keymaps, is_checked=True):
        buf = six.BytesIO()
        buf.write(struct.pack("=xx2xBBx", device_id, keycodes_per_modifier))
