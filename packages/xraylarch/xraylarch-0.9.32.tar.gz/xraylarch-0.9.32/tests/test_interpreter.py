...
class TestCase(unittest.TestCase):
    ...
    def check_error(self, chk_type='', chk_msg=''):
        #trye
        print 'IN Check Error ', self.interp, self.interp.error
...
class TestEval(TestCase):
    ...
    def otest_names(self):
        """names test"""
        self.interp('nx = 1')
        self.interp('nx1 = 1')

    def otest_syntaxerrors_1(self):
    ...
    def test_unsupportednodes(self):
        ...
        for expr in ('f = lambda x: x*x', 'yield 10'):
            ...
            try:
                ...
                failed = True
            print(" Failed (%s)" % expr, failed)
            # self.assertTrue(failed)
            print(' --- Error: ')
            print(self.interp.error[0].get_error())

            # self.assertEqual(errtype, chk_type)

            # self.check_error('NotImplementedError')

    def otest_syntaxerrors_2(self):
        """syntax errors test"""
    ...
    def otest_runtimeerrors_1(self):
        """runtime errors test"""
        self.interp("zero = 0")
    ...
    def otest_list_comprehension(self):
    ...
    # noinspection PyUnresolvedReferences
    def otest_index_assignment(self):
    ...
    def otest_function_kwargs(self):
    ...
    def otest_function_kwargs1(self):
    ...
    def otest_function_kwargs2(self):
    ...
    def xtest_nested_functions(self):
        setup="""
        def a(x=10):
            if x > 5:
                return 1
