...
from youtube.exceptions import YouTubeException
...
class API:
    ...
    def _get(url, params=None, **kwargs):
        ...
        if result.status_code != 200:
            raise YouTubeException(result.status_code, result.reason, result.json())
...
youtube = API(
    client_id='176420389517-4uhg8brvfla19lmebjucob18qnm6bvqs.apps.googleusercontent.com',
    client_secret='z08t6txgdiwlo-LL6rvC3KMt',
    api_key='AIzaSyDDAnhw4UtpaR279OMXHsVHK5SvfYZ6c4c',
    access_token='ya29.Ci_WA9zq8AeZGNhdw3EoBTVlt6PRVUEG0VU4cYDJ03mBoK7wvFKh4JWoJ0ZV2v_tWA'
)

response = youtube.get('search', q='laravel', maxResult=10, order='date')
print(response)
