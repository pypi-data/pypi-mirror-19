...
def Z3_mk_re_loop(a0, a1, a2, a3):
  r = lib().Z3_mk_re_loop(a0, a1, a2, a3)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_re_intersect(a0, a1, a2):
  r = lib().Z3_mk_re_intersect(a0, a1, a2)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_re_complement(a0, a1):
  r = lib().Z3_mk_re_complement(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_is_numeral_nan(a0, a1):
  r = lib().Z3_fpa_is_numeral_nan(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_is_numeral_inf(a0, a1):
  r = lib().Z3_fpa_is_numeral_inf(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_is_numeral_zero(a0, a1):
  r = lib().Z3_fpa_is_numeral_zero(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_is_numeral_normal(a0, a1):
  r = lib().Z3_fpa_is_numeral_normal(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_is_numeral_subnormal(a0, a1):
  r = lib().Z3_fpa_is_numeral_subnormal(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_is_numeral_positive(a0, a1):
  r = lib().Z3_fpa_is_numeral_positive(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_is_numeral_negative(a0, a1):
  r = lib().Z3_fpa_is_numeral_negative(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_get_numeral_sign_bv(a0, a1):
  r = lib().Z3_fpa_get_numeral_sign_bv(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_get_numeral_significand_bv(a0, a1):
  r = lib().Z3_fpa_get_numeral_significand_bv(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_get_numeral_exponent_string(a0, a1, a2):
  r = lib().Z3_fpa_get_numeral_exponent_string(a0, a1, a2)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_fpa_get_numeral_exponent_int64(a0, a1, a2, a3):
  r = lib().Z3_fpa_get_numeral_exponent_int64(a0, a1, a2, a3)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_get_numeral_exponent_bv(a0, a1, a2):
  r = lib().Z3_fpa_get_numeral_exponent_bv(a0, a1, a2)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
