...
from ztfy.media.interfaces import IMediaInfo, IMediaConversions, IMediaConversionUtility, \
                                  CUSTOM_AUDIO_TYPES, CUSTOM_VIDEO_TYPES, MEDIA_CONVERSIONS_KEY
...
class MediaConversionsAdapter(object):
    ...
    def getConversions(self):
        ...
        if (self.context.contentType.startswith('video/') and not converter.force_video_conversion) or \
           (self.context.contentType.startswith('audio/') and not converter.force_audio_conversion):
