...
class IMediaConversionUtility(Interface):
    ...
    force_video_conversion = Bool(title=_("Force video conversion?"),
                                  description=_("Convert video even when source file has same target content type"),
                                  required=True,
                                  default=False)
    ...
    force_audio_conversion = Bool(title=_("Force audio conversion?"),
                                  description=_("Convert audio file even when source file has same target content "
                                                "type"),
                                  required=True,
                                  default=True)
